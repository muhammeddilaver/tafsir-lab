...
**Ve sûrenin Kur'an içindeki yeri biçimseldir:** Kur'an'da **tek bir kıssanın, başından sonuna, kesintisiz ve tek bir sûrede anlatıldığı tek yer burasıdır.** Bu, bir yorum değil sayılabilir bir veridir: Mûsâ kıssası `028-kasas.md`, `020-taha.md`, `026-suara.md`, `079-naziat.md` ve daha birçok sûreye dağılmıştır; İbrâhîm, Nûh, Lût, Şuayb kıssaları da öyle. **Yûsuf kıssası ise yalnızca bu sûrededir ve burada parçalanmadan anlatılır.**
...
## Sûrenin biçimi: neden tek bir kıssa?

**Sûre kendi anlattığı şeye bir ad veriyor ve bu ad üçüncü ayette geçiyor: *ahsenü'l-kasas*.**
...
## Sûrenin omurgası: تَأْوِيلُ ٱلْأَحَادِيثِ

**Sûre boyunca üç kez, birebir aynı terkip geçiyor ve üçü de kıssanın üç ayrı eşiğinde duruyor:**
...
**Kelime `018-kehf.md`'de Mûsâ ile ilim verilen kul kıssasının anahtarıydı** (*zâlike **te'vîlü** mâ lem testı' aleyhi sabrâ*, 18/82) — orada da anlamı aynıydı: **görülen olayın nereye vardığını göstermek.**

**أَحَادِيث** — *hadîs*in çoğulu: **olup biten, anlatılan şey; haber.** **Kök `045-casiye.md` 45/6, `056-vakia.md` 56/81 ve `018-kehf.md` 18/6'da kitabın "söz" diye anılması bağlamında işlendi.**
...
## Sûrenin kapanışında buluşan kök

**Sûre *te'vîl* ve *ta'bîr* ile başlayıp *ibret* ile bitiyor — ve son iki kelime aynı köktendir: ع-ب-ر.**
...
**Bu, sûrenin en güçlü metin verisidir ve bir yorum değildir: iki kelime aynı köktür.** Kökün ayrıntılı çözümlemesi `059-hasr.md` 59/2, `079-naziat.md` 79/25-26 ve `023-muminun.md` 23/21-22'de yapıldı; 111. ayette oraya dayanacağım.

---

## 12/1-2 — الٓر تِلْكَ ءَايَٰتُ ٱلْكِتَٰبِ ٱلْمُبِينِ · إِنَّآ أَنزَلْنَٰهُ قُرْءَٰنًا عَرَبِيًّا لَّعَلَّكُمْ تَعْقِلُونَ

*Elif-Lâm-Râ · Tilke âyâtü'l-kitâbi'l-mübîn · İnnâ enzelnâhü kur'ânen arabiyyen lealleküm ta'kılûn*
...
### تِلْكَ ءَايَٰتُ ٱلْكِتَٰبِ — açılış kalıbı

**Aynı açılış Kur'an'da birkaç sûrede tekrarlanır** ve `026-suara.md` 26/2'de tablolandı: *tilke âyâtü'l-kitâbi'l-hakîm* (Yûnus 10/1), *tilke âyâtü'l-kitâbi'l-mübîn* (burada ve Şuarâ 26/2), *tilke âyâtü'l-kitâbi'l-hakîm* (Lokmân 31/2). **Oraya dayanıyorum.**
...
**Bu cümle Zuhruf 43/3'te kelime kelime aynıdır** ve **`043-zuhruf.md` 43/3'te işlendi;** orada Kur'an'ın kendini "Arapça" diye nitelediği bütün yerler listelenmişti (Tâhâ 20/113, Zümer 39/28, Fussilet 41/3, Şûrâ 42/7, Ahkāf 46/12, Ra'd 13/37). **`042-sura.md` 42/7'de de aynı bağ kurulmuştu.** **Tekrarlamıyorum.**
...
|---|---|---|---|
| **1** | **Masdar** — anlatma işi | **"En güzel anlatım"** — anlatışın kendisi övülüyor | *Kasas* kelimesi Arapçada masdar olarak kullanılır; ve cümlenin fiili *nekussu*dur — yani öne çıkan iş, anlatmadır |
...
**Şu kaydedilmeye değer ve metinden doğrulanır:** aynı kök ayette **iki kez** geçiyor — bir kez fiil (*nekussu*), bir kez isim (*el-kasas*). **Arapçada bu, *mef'ûl-i mutlak*a yakın bir pekiştirmedir ve iki okumanın ikisini de besler:** fiil anlatma işini, isim anlatılan şeyi taşıyor.
...
**Buradaki إِن, *in muhaffefe*dir** — yani *inne*nin hafifletilmiş biçimi, olumsuzluk değil. Alâmeti, sonraki cümledeki **لَ** harfidir (*lâm-ı fârika*). **Anlam: "gerçekten sen bundan önce habersizlerdendin."**
...
**غَٰفِلِين** — kök **غ-ف-ل**: **bir şeyden habersiz olmak, dikkatin o yönde bulunmaması.** **Kök `021-enbiya.md` 21/1'de (*ve hüm fî ğafletin mu'ridûn*) işlendi.**

**Ve kelimenin seçimi kaydedilmeye değer:** ayet "bilmiyordun" demiyor, "habersizdin" diyor. **Gaflet, bilgi eksikliği değil dikkatin başka yerde olmasıdır.** Bu ayrım, `028-kasas.md` 28/44-46'da işlenen delille aynı yerden gelir: *ve mâ künte bi-cânibi'l-ğarbiyy* — bilginin kaynağı üzerine kurulan delil.
...
### رَأَيْتُ … رَأَيْتُهُمْ — tekrarlanan fiil
...
### سَٰجِدِين — akıllı varlık kalıbı
...
**Bu nükte `026-suara.md` 26/4'te tablo içinde kaydedilmişti** — orada boyunların (*a'nâk*) eğilmesi tartışılırken bu ayet delil olarak anılmıştı. **Oraya dayanıyorum.** Orada kaydedilen:
...
|---|---|---|---|---|
| **3** | *Nekussu* | **Allah** | Peygamber'e | **Anlatılıyor** |
| **5** | *Lâ taksus* | **Baba** | Oğluna | **Anlatılmasın** |
...
**كَيْد** — kök **ك-ي-د**: **gizlice ve dolaylı yoldan bir sonuca yürümek; tertip.** **Kök `068-kalem.md` 68/44-47'de ve `086-tarik.md` 86/15-16'da ayrıntılı işlendi.** Orada kaydedilen:
...
**Bu ayet `048-fetih.md` 48/2'de (*ve yütimme ni'metehû aleyk*) anılmıştı ve orada şu kayıt düşülmüştü:**
...
**Dilciler kelimenin *ıstıfâ*dan (seçme) farkını şöyle kaydeder:** *ictibâ*, seçilen şeyi **kendine yakın kılmayı** da içerir — yalnız ayırmak değil, ayırıp toplamak.

### مِن تَأْوِيلِ ٱلْأَحَادِيثِ — *min* harfi
...
**Ve `018-kehf.md`'nin ekseniyle bağı burada kurulabilir:** Kehf, dört kıssa boyunca **bilginin sınırını** işliyordu (*ve lem tuhıt bihî hubrâ*, 18/68). **Yûsuf sûresi aynı sınırı, verilenin ölçüsünü bildiren tek bir harfle koyuyor.**

---

## 12/7 — لَّقَدْ كَانَ فِى يُوسُفَ وَإِخْوَتِهِۦٓ ءَايَٰتٌ لِّلسَّآئِلِينَ

*Le-kad kâne fî Yûsufe ve ihvetihî âyâtün li's-sâilîn*

"**Andolsun, Yûsuf ve kardeşlerinde, soranlar için âyetler vardır.**"

### إِخْوَة — kardeşlik kelimesi

**Kelime `049-hucurat.md` 49/10'da tablolandı** ve orada tam bu ayet örnek verilmişti:
...
**Kelimenin çoğul gelmesi kaydedilmeye değer: *âyât*, tekil *âyet* değil.**
...
**لِّلسَّآئِلِين** — "soranlar için". **Kök س-أ-ل.**

**Ve muhatabın belirlenmesi kaydedilmelidir ve kendi okumam olarak veriyorum:** işaretler herkes için değil, **soran** için. Yani kıssanın verimi, okuyucunun getirdiği soruya bağlanıyor. **Bu, sûrenin son ayetiyle örtüşüyor:** orada da ibret **üli'l-elbâb**a (akıl sahiplerine) tahsis edilecek (111).
...
**Kardeşlerin cümlesi `113-felak.md`'de haset bölümünde işlendi.** Orada kaydedilen:
...
**Oraya dayanıyorum ve buraya bir dizim kaydı ekliyorum.**
...
**Kelime `093-duha.md`'de *dalâl* kökünün Kur'an'daki kullanımları listelenirken anıldı** ve orada tam bu ayrım kaydedilmişti: burada *dalâl*, **küfür isnadı değil**, "yanlış değerlendirme, şaşırma" anlamındadır. **Oraya dayanıyorum.** Aynı kök 95. ayette, aynı ağızdan tekrar geçecek: *inneke le-fî dalâlike'l-kadîm.*
...
**غَيَٰبَة** — kök **غ-ي-ب**: **görünmez olmak, kaybolmak.** **Kelime `082-infitar.md` 82/16'da çözümlendi ve tam bu ayet örnek verilmişti:**
...
**`073-muzzemmil.md` 73/5'te de aynı ayet anılmıştı** (*elkūhü fî ğayâbeti'l-cübb*). **Oraya dayanıyorum.**
...
**وَهُمْ لَا يَشْعُرُونَ** — "**farkında olmadıkları hâlde.**"
...
**Kök س-ب-ق, VIII. bâb: yarışmak.** **Fiil `079-naziat.md` 79/1-5'te (*fe's-sâbikāti sebkā*) çözümlenirken tam bu ayet anılmıştı:**
...
**Bu terkip `047-muhammed.md` 47/25'te (*eş-şeytânü sevvele lehüm*) tablolanmıştı** ve orada tam bu iki ayet örnek verilmişti:
...
**Terkip `070-mearic.md` 70/5'te (*fe'sbir sabran cemîlâ*) ayrıntılı işlendi.** Orada kaydedilenler:

> **ص-ب-ر** kökünün asıl anlamı **tutmak, alıkoymak, hapsetmek**tir… **Sabır etkendir: nefsi tutmak, gitmek istediği yere gitmesine izin vermemek.**
>
> *Cemîl* sıfatını alan dört kelime vardır ve dördü de **bir incinme karşısında verilen tepkidir:** *sabr* (Meâric 70/5), *safh* (Hicr 15/85), *hecr* (Müzzemmil 73/10), *serâh* (Ahzâb 33/28).
>
> Klasik kaynaklarda en yaygın izah şudur: **içinde şikâyet bulunmayan sabır.**

**Oraya dayanıyorum.** **`073-muzzemmil.md` 73/10'daki tabloda da bu ayet (12/18, 12/83) yer alıyordu.**
...
**Arapçada isim cümlesi *sübût* (yerleşiklik, süreklilik) bildirir; fiil cümlesi *teceddüd* (yenilenme).** Buradaki yapı bir emir değil, **bir durum tespiti**dir: "artık iş, güzel bir sabırdır."
...
### بِثَمَنٍۭ بَخْسٍ — ب-خ-س kökü

**Kök `083-mutaffifin.md` 83/1'de ölçü meselesi işlenirken çözümlendi ve orada tam bu ayet örnek verilmişti:**

> **بخس** — kök **ب-خ-س**: **bir şeyin değerini düşürerek almak, hakkını eksik vermek.** Kur'an'daki en tanınmış kullanımı Yûsuf kıssasındadır: *"Onu değersiz bir fiyata, sayılı birkaç dirheme sattılar."* (Yûsuf 12/20). *Semenin bahsin* — **düşürülmüş bedel.**
>
...
**Oraya dayanıyorum.** **Fiil, Şuayb'ın Medyen'e söylediği sözde de geçer: *ve lâ tebhasü'n-nâse eşyâehüm* (Şuarâ 26/183; A'râf 7/85; Hûd 11/85) — ve o ayetler `083-mutaffifin.md`'de tablolandı.**
...
### دَرَٰهِمَ مَعْدُودَةٍ — "sayılı birkaç dirhem"
...
**Ve üç kelimenin üst üste bindiği kaydedilmelidir:**
...
**Üç ayrı eksiltme, tek cümlede.** Bu, metinden doğrulanabilir bir yığılmadır.
...
**م-ك-ن** kökü: **yer sahibi olmak, sağlamlaşmak.** **Kök `023-muminun.md` 23/13'te (*fî karârin mekîn*) çözümlendi** ve orada tam bu sûredeki kullanım anılmıştı: *inneke'l-yevme ledeynâ **mekînün** emîn* (12/54). **`077-murselat.md` 77/20-23'te de aynı bağ kurulmuştu.** **Oraya dayanıyorum.**
...
**Bu cümle üzerinde dilciler ayrılır:** *emrihî*deki zamir kime aittir?
...
"**Olgunluk çağına erdiğinde ona hüküm ve ilim verdik. İyilik edenleri işte böyle ödüllendiririz.**"
...
**حُكْمًا وَعِلْمًا** — iki nekre kelime.
...
**حُكْم** — kök **ح-ك-م**: bir şeyi sağlamlaştırmak, yerli yerine koymak; buradan hüküm vermek. **Kök `031-lokman.md` 31/12-13'te (*ve le-kad âteynâ Lukmâne'l-hikme*) işlendi.**
...
**Kök ر-و-د ve bu terkip `054-kamer.md` 54/37'de (*ve le-kad râvedûhü an dayfihî*) ayrıntılı çözümlendi.** Orada kaydedilenler:

> **Kök: ر-و-د.** Somut anlamı: **bir şeyi aramak için gidip gelmek, dolaşmak.** *Râd* — otlak arayan öncü. *Râid* — kavim adına yer araştırmaya gönderilen kişi. *İrâde* — istemek; bir şeye doğru yönelmek.
>
...
>
> **Ve kalıbın anahtarı edattır: عَنْ.** *Râvede fülânen **an** şey'in* — **birini bir şeyden vazgeçirmeye çalışmak, o şeyden koparmak için üstelemek.**
...
**Kelime `113-felak.md` 113/1'de çözümlendi ve tam bu ayet örnek verilmişti:**
...
**Oraya dayanıyorum.** **Kalıp *mef'ûl-i mutlak*tır ve fiili hazfedilmiştir:** *eûzü maâze'llâh* — "Allah'a sığınmakla sığınırım".
...
**Bu cümledeki *rabbî* kelimesi `001-fatiha.md`'de bir dil notu olarak işlendi:**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı ayetin son iki cümlesidir:** **ayet, sahneyi anlatırken bile hükmü kendisi veriyor.** Yani metin, okuyucuyu hüküm vermekte serbest bırakmıyor — *sû'* ve *fahşâ*nın **uzaklaştırıldığını** ve kişinin *muhlas* olduğunu söylüyor. **Bu iki cümle, ihtilafın hangi sınır içinde kalması gerektiğini belirliyor.**

### بُرْهَٰن

**Kelime `028-kasas.md` 28/75'te (*hâtû burhâneküm*) çözümlendi:**

> **بُرْهَان** — **kesin delil.** Dilciler kelimeyi, **karşı tarafı bağlayan ve tartışmayı bitiren delil** olarak tarif eder.

**Oraya dayanıyorum. Kelime `021-enbiya.md`, `027-neml.md` ve `034-sebe.md`'de de geçti.**
...
| Okuyuş | Kalıp | Anlam |
|---|---|---|
| *el-muhla**s**în* (fetha ile) | **İsm-i mef'ûl** | **İhlâsa erdirilmiş** — arındırılan; fiil Allah'a ait |
| *el-muhli**s**în* (kesre ile) | **İsm-i fâil** | **İhlâslı** — arındıran; fiil kula ait |

**İki okuyuş da kıraat imamları arasında nakledilir.** **`039-zumer.md` 39/1-3'te *ihlâs* kavramı ayrıntılı işlendi** (*muhlisan lehü'd-dîn*); **oraya dayanıyorum.**
...
**Bu, sayılabilir bir dizim verisidir ve anlatı tekniği bakımından kayda değer.**

### إِنَّ كَيْدَكُنَّ عَظِيمٌ

**Cümlenin kapsamı üzerinde durmak gerekiyor, çünkü sıkça genelleştirilerek okunur.**
...
**Bu, sûre içinde doğrulanabilir bir gerilimdir: delil vardır, hüküm delile göre değildir.**
...
### مَكْر — dedikodunun adlandırılması
...
**م-ك-ر** kökü: **gizlice, dolaylı yoldan bir sonuca yönelmek.** **Kök `035-fatir.md` 35/43'te (*ve lâ yehīku'l-mekru's-seyyiü illâ bi-ehlih*) ayrıntılı işlendi.** **Tekrarlamıyorum.**
...
### مَا هَٰذَا بَشَرًا — kalıp

**Bu cümle `058-mucadele.md` 58/2'de bir gramer örneği olarak işlendi:**
...
**Ve hemen ardından gelen cümle aynı işi tersinden yapıyor: *in hâzâ illâ melekün kerîm* — *in … illâ* hasr kalıbı.** **Bu kalıp `053-necm.md` 53/4'te ayrıntılı çözümlendi.**
...
**Ve buradaki bir imlâ ayrıntısı `096-alak.md` 96/15-16'da anıldı:**

> Yûsuf 12/32: *ve le-yekûnen mine's-sâğirîn* (وَلَيَكُونًا مِّنَ ٱلصَّٰغِرِينَ)

**Fiilin sonundaki nûn-i te'kîd-i hafîfe, mushafta *elif* ile yazılmıştır (tenvin gibi).** **Bu, Kur'an'da yalnız iki yerde görülen bir imlâdır** ve `096-alak.md`'de öteki örnekle birlikte kaydedildi. **Oraya dayanıyorum.**
...
### أَحَبُّ إِلَىَّ — sûredeki ikinci *ehabb*
...
### Cümlenin dikkatle kurulduğu yer
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı şart edatıdır (*illâ* = *in lâ*):** cümle bir **direnç ilanı** değil, bir **acz ikrarı**dır. **Ve bu, 53. ayetteki *ve mâ überriü nefsî* cümlesiyle aynı yerden gelir.** İki cümle karşılaştırılabilir:
...
**İki cümlenin de aynı sûrede olması metnin verisidir.**

**وَأَكُن مِّنَ ٱلْجَٰهِلِين** — *cehl*, burada bilgisizlik değil **davranış** bildiriyor. **`028-kasas.md` 28/52-55'te (*lâ nebteğı'l-câhilîn*) aynı anlam işlendi:** Arapçada *cehl*in karşıtı yalnız *ilm* değil, **hilm** (ölçülülük) de olabilir. **Oraya dayanıyorum.**
...
**Bu belirsizlik `018-kehf.md`'nin ekseniyle örtüşüyor** — orada dört kıssada da **süre** bilinmiyordu. **Burada da aynı: zindanda kalınacak süre metinde ölçülmüyor.** Nitekim 42. ayette de yalnız *bid'a sinîn* denecek: "birkaç yıl".
...
### إِنِّىٓ أَرَىٰنِىٓ — "kendimi görüyorum"
...
**Bu, sûre içinde sayılabilir bir fark.**
...
**نَبِّئْنَا بِتَأْوِيلِهِۦ** — ve talep, sûrenin anahtar kelimesiyle geliyor: ***te'vîl***.
...
### Dizim nüktesi: rüyayı yorumlamadan önce ne yapıyor?

**Ve bu, sûrenin en dikkate değer dizim nüktelerinden biridir; ayrıntılı işlenmeyi hak ediyor.**
...
**Kökün somut anlamı üzerinde dilciler durur:** *melle* — bir şeyi kızgın küle gömerek pişirmek; *melle*nin bir başka anlamı da yazdırmak (*imlâ* ile akraba). **Buradan *mille*: izlenen yol, takip edilen düzen** — özellikle **bir topluluğun tuttuğu yol** anlamında.
...
### ءَأَرْبَابٌ مُّتَفَرِّقُونَ — Zümer'deki iki köle temsiliyle karşılaştırma

**Bu ayetteki delil `039-zumer.md` 39/29'da başka bir biçimde işlendi ve iki ayet doğrudan karşılaştırılabilir.** Zümer'de kaydedilenler:

> **Örnek, o günün hayatından alınmıştır: birden fazla sahibi bulunan bir köle ile tek sahibi olan bir köle.** **مُتَشَٰكِسُون** — kök **ش-ك-س**: huysuz, geçimsiz, çekişen…
>
> **Ayet çokluğun *teorik* yanlışlığını tartışmıyor — *pratik sonucunu* gösteriyor.** Birden çok sahibi olan kişi, kime göre davranacağını bilemez; her biri ayrı şey ister, hiçbirini tam memnun edemez. **Yani mesele bir inanç tartışması olmaktan çıkıp bir *yön* meselesi hâline getiriliyor.**
...
**Aynı delil, iki ayrı biçim.** Bu, iki sûre arasında doğrulanabilir bir örtüşmedir.
...
**ٱلْوَٰحِدُ ٱلْقَهَّارُ** — **İki isim birlikte geliyor ve bu, Kur'an'da bir kalıptır.** **`112-ihlas.md`, `093-duha.md` ve `038-sad.md` 38/65-66'da bu isim çifti tablolandı:**

> **`038-sad.md`'de kaydedilen:** ismin geçtiği yerlerin neredeyse tamamında ***el-Vâhıd* ile birlikte gelir** (Yûsuf 12/39; Ra'd 13/16; Sâd 38/65; Zümer 39/4; Ğâfir 40/16).

**Oraya dayanıyorum.** **`112-ihlas.md`'de de bu ayet, "Allâhu vâhid" denebilecekken *ehad* denmesi tartışılırken örnek verilmişti.**
...
**Bu ifade `053-necm.md` 53/23'te (*in hiye illâ esmâün semmeytümûhâ entüm ve âbâüküm*) ayrıntılı çözümlendi ve buraya mutlaka dayanmak gerekiyor.** Orada kaydedilenler:

> **Kök: س-م-و.** Dilcilerin çoğunluğu ismi bu köke bağlar: **ad, bir şeyi yükselten, onu diğerlerinin arasından çıkarıp görünür kılan şeydir.**
>
> **Ayet "yanlış isimlendirdiniz" demiyor; "isimlendirdiniz" diyor.** Eğer "yanlış ad koydunuz" denseydi, doğru bir adın olabileceği ima edilirdi. **Ayet fiilin kendisini gösteriyor: ad koyma işlemi, ortada adlandırılacak bir şey olduğunu ispat etmez.**
>
> İnsan zihni, bir ad duyduğunda ona karşılık gelen bir şey olduğunu varsayar… **Ayet bu otomatik varsayımı kesiyor.** Ad, insanın koyduğu bir işarettir; **işaretin varlığı, işaret edilenin varlığını gerektirmez.**
>
> **سُلْطَان** — *burhân* ya da *beyyine* denebilirdi; **sultân** denmiş — ve kökünde **hâkimiyet** var. **Bu adların, sizi bağlayan bir *gücü* yok.**

**Oraya dayanıyorum ve buraya iki fark ekliyorum, çünkü iki ayet birebir aynı değildir:**
...
**ٱلدِّينُ ٱلْقَيِّم** — **ق-و-م kökü: dosdoğru duran, dengede olan.** **Kök `018-kehf.md` 18/1-8'de (*kayyimen*) ve `002-bakara.md` 2/255'te (*el-Kayyûm*) işlendi.** **Tekrarlamıyorum.**
...
**Cevap, *emmâ … ve emmâ* kalıbıyla veriliyor** — **Arapçada ayrıntılandırma edatı; her defasında *fâ* ile cevap alır.** **Kalıp `056-vakia.md` 56/88-94'te üçlü biçimiyle işlendi.** **Tekrarlamıyorum.**
...
**Bu cümledeki *rabbike* kelimesi `001-fatiha.md` 1/1'de bir dil kaydı olarak anıldı:** *rabb*, insan için ancak **tamlamayla** kullanılabilir. **Oraya dayanıyorum.**
...
**بِضْعَ سِنِين** — **ب-ض-ع kökü: bir şeyden bir parça koparmak.** *Bid'* — Arapçada **üç ile dokuz arası** belirsiz bir sayı için kullanılır. **Kelime Kur'an'da bir kez daha geçer: *fî bid'ı sinîn* (Rûm 30/4) — `030-rum.md` 30/1-5'te işlendi.**

**Ve belirsizliğin sürdüğü kaydedilmelidir:** 35. ayette *hattâ hîn* (bir süreye kadar) denmişti; burada *bid'a sinîn* (birkaç yıl). **Süre iki kez anılıyor ve iki kez de ölçülmüyor.** Bu, `018-kehf.md`'nin ekseniyle örtüşen bir kayıttır.
...
**Kök `059-hasr.md` 59/2'de (*fa'tebirû yâ üli'l-ebsâr*) ayrıntılı çözümlendi ve orada tam bu ayet örnek verilmişti:**

> **Kök: ع-ب-ر.** Kökün somut anlamı **bir şeyin bir yanından öbür yanına geçmek**tir.
>
...
> | **عَبْرَة (abre)** | Gözyaşı | Gözden yanağa geçen su |
...
>
> *"Eğer rüya **yorumlamasını** (**تَعْبُرُونَ**) biliyorsanız"* (Yûsuf 12/43). Kral, gördüğü rüyayı anlatıp yorum istiyor — **yani görüntüden anlama geçilmesini.**

**Oraya dayanıyorum. Kök ayrıca `079-naziat.md` 79/25-26'da ve `023-muminun.md` 23/21-22'de işlendi.**
...
**ضِغْث** — kelime `038-sad.md` 38/41-44'te çözümlendi:
...
| Kim | Kullandığı kelime |
|---|---|
| **Melik** (43) | *Ru'yâ* — **görülen** |
| **İleri gelenler** (44) | *Ahlâm* — **düşler** |
...
**وَمَا نَحْنُ بِتَأْوِيلِ ٱلْأَحْلَٰمِ بِعَٰلِمِين** — **ve ikrar açıktır: bilmiyorlar.**
...
**ٱدَّكَرَ** — kök **ذ-ك-ر**, VIII. bâb. **Aslı *izdekera*dır; *zâl* ve *dâl* birleşerek *iddekera* olmuştur.** Bu, Arapçada bilinen bir idgam kaidesidir.
...
**Kelime `057-hadid.md` 57/19'da (*ve'lezîne âmenû billâhi ve rusülihî ülâike hümü's-sıddîkūn*) işlendi ve orada Kur'an'da bu sıfatla anılanlar listelenmişti:**
...
**Ve sahnenin en dikkate değer tarafı budur: zindandan çıkma emri gelmiştir ve çıkılmamıştır.**
...
**Terkip `047-muhammed.md` 47/2'de (*ve asleha bâlehüm*) tablolandı** ve orada tam bu ayet örnek verilmişti:
...
**Ve cümlenin sonu kaydedilmelidir:** talep insanlara yöneltiliyor, ama bilgi **Allah'a** nispet ediliyor.
...
**Terkip `051-zariyat.md` 51/31-34'te (*fe-mâ hatbüküm eyyühe'l-mürselûn*) çözümlendi ve orada bu ayet örnek verilmişti:**
...
**Terkip `075-kiyame.md` 75/2'de tablolandı** (nefsin Kur'an'daki nitelemeleri) ve **`091-sems.md` 91/7-8'de ayrıntılı işlendi.** Orada kaydedilenler:

> **İnsanın içindeki eğilim yönü.** Yûsuf kıssasında: *"Nefis kötülüğü çokça emredicidir"* (Yûsuf 12/53).
>
> Gelenekte nefsin üç hâli sıkça anılır: **emmâre** (kötülüğü emreden — Yûsuf 12/53), **levvâme** (kendini kınayan — Kıyâme 75/2), **mutmainne** (yatışmış — Fecr 89/27). **Üçü de Kur'an'da geçen tabirlerdir; ama Kur'an bunları bir "mertebeler sistemi" olarak sunmaz.** Sistemleştirme sonraki dönemin işidir.
...
**Ve `091-sems.md` 91/8'de kaydedilen bir okuma buraya bağlanmıştı:**
...
**Terkip `023-muminun.md` 23/13'te ve `077-murselat.md` 77/20-23'te anıldı:**
...
**Ve iki sıfatın birlikte gelmesi, `028-kasas.md` 28/22-28'deki ölçüyle karşılaştırılmalıdır:**

| Yer | Sıfatlar | Kim söylüyor |
|---|---|---|
| **Kasas 28/22-28** | *el-**Kaviyy**ü'l-**emîn*** | **Medyen'de bir kız** — işe alma ölçüsü |
...
**`062-cuma.md` 62/2'de ve `053-necm.md` 53/32'de tezkiye meselesi ayrıntılı işlendi; oraya dayanıyorum.**
...
|---|---|---|---|
| **Yûsuf** | *Fe-**arafe**hüm* | **Mâzî fiil** — ع-ر-ف | **Tanıdı** — olup bitmiş, anlık bir iş |
...
**ك-ي-ل** kökü: **hacim ölçüsüyle ölçmek.** **Kök `083-mutaffifin.md` 83/1'de ayrıntılı işlendi** (*ellezîne ize'ktâlû ale'n-nâsi yestevfûn*). **Tekrarlamıyorum.**

**Ve kelimenin bu bölümde tekrar tekrar geçmesi kaydedilmeye değer: 59, 60, 63, 65, 88.** **Sûrenin bu bölümü baştan sona bir *ölçek* meselesi üzerinden yürüyor** — ve `083-mutaffifin.md`'de işlenen ilkenin (ölçüyü tam vermek) burada **uygulanmış** biçimi görülüyor: *ennî **ûfi'l-keyl***.
...
| Ayet | İfade | Zaman |
|---|---|---|
| **11** | *Mâ leke lâ **te'menn**â alâ Yûsuf* | **O gün** — kardeşler soruyor |
| **64** | *Hel **âmen**üküm aleyhi illâ kemâ **emint**üküm alâ ehîhi min kabl* | **Yıllar sonra** — baba cevap veriyor |
...
**و-ث-ق** kökü: **sağlam bağlamak, güvenmek.** *Vesîka* — belge; *mîsâk* — antlaşma. **Kök `033-ahzab.md` 33/7-8'de (*mîsâkan ğalîzâ*) işlendi.**

**Ve şartın istisnası kaydedilmeye değer: *illâ en yühâta biküm* — "kuşatılmanız dışında".**

**ح-و-ط** kökü: **çepeçevre sarmak.** **Bu kök `018-kehf.md` 18/60-70'te (*ve keyfe tasbiru alâ mâ lem tuhıt bihî hubrâ*) sûrenin anahtarı olarak işlenmişti.**
...
**أ-و-ي** kökü: **bir yere sığınmak, barındırmak.** **Kök `018-kehf.md` 18/9-12'de (*iz eve'l-fityetü ile'l-kehf*) işlendi.**

**Ve aynı fiil sûrede iki kez geçiyor ve ikisi de bir kavuşma anıdır:**

| Ayet | İfade | Kim |
|---|---|---|
| **69** | *Âvâ ileyhi **ehâhü*** | **Kardeşi** |
| **99** | *Âvâ ileyhi **ebeveyh*** | **Anne-babası** |

**Bu, sûre içinde sayılabilir bir tekrardır.**

**فَلَا تَبْتَئِسْ** — kök **ب-أ-س**, VIII. bâb: **sıkıntıya düşmek, kederlenmek.** **Kök `069-hakka.md` ve `070-mearic.md`'de (*be's* — güç, sıkıntı) işlendi.**
...
**Kap, 72. ayette başka bir kelimeyle anılacak: *suvâa'l-melik*.** **`043-zuhruf.md` 43/53'te bu kelime anılmıştı:**
...
**عِير** — **yük taşıyan kervan, özellikle develer.**
...
**Oraya dayanıyorum.** **ز-ع-م** kökü: **söz vermek, üstlenmek; ve dayanaksız iddia etmek.** **Kelimenin iki ucu vardır: kefalet ve boş iddia.** **Ve `028-kasas.md` 28/61-70'te aynı kökün olumsuz ucu işlendi** (*ellezîne küntüm **tez'umûn***).

**Bunu bir gözlem olarak kaydediyorum: aynı kök, bir yerde bir taahhüdün, bir yerde temelsiz bir iddianın adıdır.** Ortak çekirdek, **bir şeyi üstlenmek**tir; belirleyici olan, arkasında bir dayanağın bulunup bulunmadığıdır.

### Cezayı kendileri belirliyor
...
**Kelime `084-insikak.md` 84/22-23'te ve `069-hakka.md` 69/12'de işlendi:**

> Kökün somut merkezi bir **eşya**dır: **وِعَاء** — kap, çuval, içine bir şey konan şey. **Yûsuf 12/76'da kelime düpedüz bir yük çuvalıdır.**
>
> *"Kardeşinin **kabından** (*vi'âi ehîhi*) önce onların **kaplarını** (*ev'iyetihim*) aramaya başladı."* (Yûsuf 12/76)

**Oraya dayanıyorum.**

**Ve aramanın sırası kaydedilmeye değer: *fe-bedee bi-ev'ıyetihim kable viâi ehîh*.**
...
**Ve bu, Kur'an'ın *keyd* kökünü Allah'a nispet ettiği yerlerden biridir.**

**Konu `086-tarik.md` 86/15-16'da (*ve ekîdü keydâ*) ve `105-fil.md`'de işlendi. Orada kaydedilenler:**
...
**Ve `068-kalem.md` 68/44-47'de de aynı kayıt düşülmüştü:**
...
**Ve sûrenin en yoğun cümlelerinden biri burada. Cümlenin kuruluşu kaydedilmelidir:**
...
**Cümlenin kimi kastettiği üzerinde dilciler ayrılır:**
...
**İki okuma da klasik tefsirlerde yer alır ve birbirini dışlamaz; tercih dayatmıyorum.**
...
**Bu ifadenin gramer nüktesi `113-felak.md` 113/2'de işlendi:**
...
| Ayet | Kim söylüyor |
|---|---|
| **36** | **İki genç** — zindanda |
| **78** | **Kardeşler** — sarayda |
...
**İki yerde de reddedilen şey aynı yerdedir: bir haksızlık.** Birincisinde bir ihanet, ikincisinde suçsuz birini tutmak. **Ve ikisinde de gerekçe aynı kökle bitiyor: *lâ yüflihu'z-**zâlim**ûn* (23) — *innâ izen le-**zâlim**ûn* (79).**
...
**Terkip `058-mucadele.md` 58/7'de *necvâ* kavramı işlenirken örnek verilmişti:**
...
**Ve bu cümle, sûrenin bilgi eksenine bağlanan en açık ifadelerden biridir.**
...
### Aynı cümle, altmış beş ayet sonra
...
**Bu, sûre içinde sayılabilir bir tekrardır ve `047-muhammed.md` 47/2'de bu iki ayet birlikte tablolanmıştı.**

**Ve iki ayet arasındaki fark, cümlenin devamındadır — kaydedilmelidir:**
...
**عَسَىٰ** — Arapçada **umut ve beklenti** bildiren fiil. **Kelime, kesinlik bildirmez.** **`028-kasas.md` 28/22-28'de (*asâ rabbî en yehdiyenî sevâe's-sebîl*) aynı kalıp işlendi.**

---

## 12/84 — وَتَوَلَّىٰ عَنْهُمْ وَقَالَ يَٰٓأَسَفَىٰ عَلَىٰ يُوسُفَ وَٱبْيَضَّتْ عَيْنَاهُ مِنَ ٱلْحُزْنِ فَهُوَ كَظِيمٌ

"**Onlardan yüz çevirdi ve 'Vah Yûsuf'a!' dedi. Üzüntüden gözleri ağardı; içi doluydu.**"

### يَٰٓأَسَفَىٰ

**أ-س-ف** kökü: **şiddetli üzüntü; ve öfke.** **Kelime `043-zuhruf.md` 43/54-56'da (*fe-lemmâ âsefûnâ*) işlendi ve orada bu ayet örnek verilmişti:**
...
**ٱبْيَضَّتْ** — kök **ب-ي-ض**, **IX. bâb (*if'ilâl*)**. **Bu bâb üzerinde `043-zuhruf.md` 43/17-18'de durulmuştu:**
...
**Ve sebep açıkça yazılıyor: *mine'l-huzn*.** **Yani ayet, bedensel bir değişimi bir duyguya bağlıyor.**

**Bunu bir gözlem olarak kaydediyorum:** Kur'an burada üzüntüyü **soyut bir hâl** olarak değil, **görünür bir iz** olarak veriyor. **Ve `057-hadid.md` 57/22-23'te bu kayıt düşülmüştü:**
...
**Kök `068-kalem.md` 68/44-47'de (*mekzûm*) ayrıntılı çözümlendi ve `043-zuhruf.md` 43/17-18'de kalıp farkıyla birlikte tablolandı. `040-gafir.md` 40/18-20'de (*kâzımîn*) de işlendi.** Oralarda kaydedilenler:

> **Kökün somut anlamı: *kezeme'l-kırbe* — su tulumunun ağzını doldurup bağladı.** Yani **içi doldurulmuş ve ağzı kapatılmış bir kap.**
>
> **Türevleri:** **كَظِيم (kazîm)** — kederini içine gömmüş; **كَاظِم (kâzım)** — öfkesini yutan (*el-kâzımîne'l-ğayz*, Âl-i İmrân 3/134); **كِظَامَة (kizâme)** — bir şeyin ağzını bağlayan bağ.
>
> **Ve şimdi kelimenin resmi tam: ağzına kadar dolu, ağzı bağlı bir tulum.** İçindeki basınç var; ama dışarı çıkamıyor.
>
> **Kalıp farkı** (`043-zuhruf.md`): *mekzûm* **ism-i mef'ûl** — bastırılmış, dışarıdan tıkanan; *kezîm/kazîm* **fa'îl mübalağa** — içini kendisi tıkayan. **Yani *mekzûm* olanın ağzını başkası bağlar; *kezîm* olan kendi ağzını bağlar.**
...
**`088-gasiye.md` 88/12-16'da ise *bess* kelimesi üzerinden:**
...
| Kelime | Kök | Ne |
|---|---|---|
| *Bess* | ب-ث-ث | **Yayılan, taşan** — dışarı çıkan taraf |
| *Huzn* | ح-ز-ن | **Keder** — içerideki hâl |

**Ve *innemâ* hasr edatı kaydedilmelidir: "yalnız Allah'a".** **Sınırlanan şey şikâyetin varlığı değil — muhatabıdır.**

**Bunu kendi okumam olarak kaydediyorum ve dayanağı *innemâ* edatıdır:** cümle "şikâyet etmiyorum" demiyor. **"Şikâyetimi başka yere değil, oraya götürüyorum" diyor.** **Ve bu, 18. ve 83. ayetlerdeki *sabr-ı cemîl* ile birlikte okunmalıdır** — `070-mearic.md` 70/5'te tam bu bağ kurulmuştu.

### وَلَا تَا۟يْـَٔسُوا۟ مِن رَّوْحِ ٱللَّهِ — ر-و-ح kökü

**Kök `056-vakia.md` 56/88-94'te (*fe-ravhun ve rayhân*) ayrıntılı çözümlendi:**
...
| Ayet | Kelime | Resim |
|---|---|---|
| **84** | *Kazîm* | **Ağzı bağlı tulum** — hava çıkmıyor |
| **87** | *Ravhillâh* | **Esinti** — havanın açılması |
...
**Kök ي-أ-س. `060-mumtehine.md` 60/13'te bu ayet delil olarak kullanılmıştı:**
...
**Kelime `049-hucurat.md` 49/12'de (*ve lâ tecessesû*) işlenirken tam bu ayet karşılaştırma için verilmişti:**
...
**ص-د-ق** kökü: **doğruluk.** *Sadaka*nın bu kökten gelmesi dilcilerce şöyle açıklanır: **veren kişinin imanındaki doğruluğu gösteren fiil.**
...
| Ayet | İfade |
|---|---|
| **15** | *Le-**tünebbienne**hüm bi-emrihim hâzâ ve hüm lâ yeş'urûn* |
...
| Fiil | Kök | Ne |
|---|---|---|
| *Yetteki* | و-ق-ي | **Korunmak** — kendini bir şeyden sakınmak |
| *Yasbir* | ص-ب-ر | **Sabretmek** — kendini tutmak |

**İki kökün ortak yanı kaydedilmeye değer, kendi okumam olarak veriyorum:** ikisi de **tutma** bildiriyor. **و-ق-ي: bir şeyin önüne siper koymak (`002-bakara.md`'de işlendi); ص-ب-ر: nefsi bir yerde tutmak (`070-mearic.md` 70/5'te işlendi).** **Yani ikisi de etken fiillerdir; katlanmayı değil, tutmayı anlatır.**
...
**Ve buradaki *in* de *in muhaffefe*dir (3. ayette işlendi): "biz gerçekten hata edenlerdendik."**
...
**Ve `042-sura.md` 42/40'ta (*fe-men afâ ve asleha*) af meselesi ayrıntılı işlenmişti; oraya dayanıyorum.**

---

## 12/93 — ٱذْهَبُوا۟ بِقَمِيصِى هَٰذَا فَأَلْقُوهُ عَلَىٰ وَجْهِ أَبِى يَأْتِ بَصِيرًا وَأْتُونِى بِأَهْلِكُمْ أَجْمَعِينَ

"'**Şu gömleğimi götürün, babamın yüzüne koyun; görmesi geri gelir. Ve bütün ailenizi bana getirin.**'"

### Gömleğin üçüncü geçişi

**Ve sûrenin nesne örgüsü burada tamamlanıyor; 18. ayette tablolamıştım.**

| Ayet | Gömlek | İşlevi |
|---|---|---|
| **18** | Kan içinde | **Yalan delil** |
| **26-28** | Arkadan yırtık | **Doğru delil** |
| **93, 96** | Yüze konuyor | **Müjde** |

**Bu, sûre içinde sayılabilir bir örgüdür.**
...
**يَأْتِ بَصِيرًا** — "**görür olarak gelir**". **Fiil *ye'ti* (gelmek), *yeûdü* (dönmek) değil.**
...
### رِيحَ يُوسُفَ — kökün geri dönüşü

**Ve bu, sûrenin en ince kelime bağlarından biridir: *rîh*, 87. ayetteki *ravh* ile aynı köktendir (ر-و-ح).**

| Ayet | Kelime | Anlam |
|---|---|---|
| **87** | *Ravhillâh* | **Ferahlık** — umut kesilmeyecek şey |
| **94** | *Rîha Yûsuf* | **Koku** — havayla taşınan |

**Kökün ortak çekirdeği `056-vakia.md` 56/88-94'te "hareket eden hava" olarak verilmişti; 87. ayette dayanmıştım.** **Yedi ayet arayla aynı kök, iki türevle geri geliyor** — ve ikincisi, birincinin somut karşılığı gibi duruyor: **umut esintisi ve gerçek bir koku.**
...
**Cümle `093-duha.md` 93/7'de (*ve vecedeke dâllen fe-hedâ*) *dalâl* kökünün Kur'an'daki kullanımları listelenirken işlendi:**
...
**Ve iki ayeti yan yana koymak kayda değer:**
...
**ر-د-د** kökü, VIII. bâb: **geri dönmek.** **Ve fiil, 93. ayetteki *ye'ti basîrâ*dan farklıdır** — orada işlenmişti.

**أَلَمْ أَقُل لَّكُمْ إِنِّىٓ أَعْلَمُ مِنَ ٱللَّهِ مَا لَا تَعْلَمُونَ** — **ve cümle, 86. ayetin birebir tekrarıdır.**

| Ayet | Bağlam |
|---|---|
| **86** | **İddia** — henüz hiçbir şey olmamış |
| **96** | **Doğrulanma** — "size dememiş miydim?" |
...
|---|---|
| **91** | **Yûsuf'a** — zarar verdikleri kişiye |
| **97** | **Babaya** — zarar verdikleri öteki kişiye |
...
**ذُنُوب** — kök **ذ-ن-ب**: *zeneb* — kuyruk. **Dilciler *zenb*i "arkadan gelen sonuç" resmiyle açıklar:** fiilin peşine takılan şey.
...
**Dördüncü ayette rüya görülmüştü; yüzüncü ayette *te'vîl*i geliyor.** **Ve terkip tam olarak beklendiği gibi işliyor: *te'vîl* — "vardığı yer".**
...
| **2** | **Yönelme** — secde Allah'a, Yûsuf ise yönelinen taraf; *lehû*daki *lâm* "onun için/onun sebebiyle" anlamında |

**İki okuma da klasik tefsirlerde yer alır; tercih dayatmıyorum.**

**Ve şu kaydedilmelidir, metinden doğrulanır:** Kur'an, ibadet anlamındaki secdenin yalnız Allah'a olacağını başka yerlerde açıkça bildirir (Fussilet 41/37: *lâ tescüdû li'ş-şemsi ve lâ li'l-kamer*). **`041-fussilet.md` 41/37-39'da bu ilke işlendi.** **Bu ayetin o ilkeyle çelişecek biçimde okunmaması gerektiği, klasik tefsirlerin ortak kaydıdır.**
...
**Kelime `067-mulk.md` 67/13-14'te (*ve hüve'l-latîfü'l-habîr*) çözümlendi ve orada tam bu ayet örnek verilmişti:**

> *"Şüphesiz Rabbim dilediği şeyde **latîf**tir"* (Yûsuf 12/100) — Yûsuf'un, uzun yıllar sonra tamamlanan bir planın sonunda söylediği söz. **Burada *lutf* açıkça "fark edilmeden işleyen tedbir" anlamındadır.**

**Oraya dayanıyorum.**

**ل-ط-ف** kökü: **incelik, ele gelmeyecek kadar ince olma; ve nüfuz etme.**

**Ve kelimenin bu ayetteki yeri kayda değer, kendi okumam olarak veriyorum:** kıssanın bütün olayları — kuyu, satış, iftira, zindan, unutulma, kıtlık — **hiçbiri sonuca gider gibi görünmüyordu.** **Ve kişinin bunların sonunda seçtiği kelime, "fark edilmeden işleyen" anlamındaki *latîf*tir.**
...
**Ve iki *min* harfi kaydedilmelidir:** ***min**e'l-mülk* ve ***min** te'vîli'l-ehâdîs*.
...
**Ve bu talep `029-ankebut.md` 29/9'da işlenen cümleyle aynı yerden gelir:**

> *"İman edip sâlih ameller işleyenleri, mutlaka **sâlihler arasına katarız**"* (29/9). **Ayet "onları cennete koyarız" demiyor — *fi's-sâlihîn*, yani bir *topluluğun içine* katarız diyor.**
>
> **Karşılık, bir yer olarak değil bir *aidiyet* olarak veriliyor.**
...
**و-ف-ي** kökü: **tam olarak almak, eksiksiz teslim almak.** *Teveffâ* — bir hakkı tam olarak almak; buradan **vefat.** **Kök `039-zumer.md` 39/42'de (*Allâhü yeteveffe'l-enfüse*) işlendi.**

**Ve kelimenin seçimi kaydedilmeye değer:** ölüm, **eksiltme** değil **tam alma** olarak adlandırılıyor.

**فَاطِرَ ٱلسَّمَٰوَٰتِ وَٱلْأَرْضِ** — **ف-ط-ر kökü: yarmak, ilk kez açmak.** **Kök `035-fatir.md` 35/1'de sûre adı vesilesiyle ayrıntılı işlendi.** **Tekrarlamıyorum.**

**Ve bu terkip `082-infitar.md` 82/1'de anılmıştı:**

> *"Gökleri ve yeri yoktan yaran! Dünyada da âhirette de benim velim sensin."* (Yûsuf 12/101)

**Oraya dayanıyorum.**

**Ve ismin bu duada seçilmiş olması kayda değer, kendi okumam olarak veriyorum:** dua, **başlangıcı yapan**a hitap ediyor — ve istenen şey **sonla** ilgili. **Yani cümle, ilk açanla son kapanışı birbirine bağlıyor.**
...
### وَمَا كُنتَ لَدَيْهِمْ — delilin kuruluşu

**Ve kıssa bittiğinde, sûre bir delile dönüyor.**

**Bu kalıp `028-kasas.md` 28/43-51'de üç kez tekrarlanan biçimiyle ayrıntılı işlendi:**

> **Bölüm boyunca aynı kalıp üç kez tekrarlanıyor:** *Ve mâ künte bi-cânibi'l-ğarbiyy* (44), *ve mâ künte sâviyen fî ehli Medyen* (45), *ve mâ künte bi-cânibi't-Tûri iz nâdeynâ* (46). **Delil, bilginin kaynağı üzerine kuruluyor.**
>
> **Ve `029-ankebut.md` 29/48'de aynı yöntem işlenmişti** (*ve mâ künte tetlû min kablihî min kitâb*) — orada okuma ve yazmanın yokluğu delil yapılıyordu.

**Oraya dayanıyorum ve bu ayeti aynı örgüye ekliyorum:**
...
**Bu ayet `026-suara.md` 26/8-9'da karşılaştırma için verilmişti:**
...
**Kalıp *in … illâ* hasrdır ve `053-necm.md` 53/4'te ayrıntılı işlendi.** **Tekrarlamıyorum.**
...
**Ve cümlenin resmi kayda değer:** iki fiil birlikte — **geçmek** ve **yüz çevirmek.**
...
**Ve *ayet* kelimesinin sûredeki dolaşımı kaydedilmelidir:**
...
**كَأَيِّن** — Arapçada **çokluk bildiren bileşik bir edat**: "nice, ne kadar çok".
...
**Klasik tefsirlerde nakledilen izahlar:**
...
**غ-ش-ي** kökü: **örtmek, bürümek, kaplamak.** **Kök `088-gasiye.md` 88/1'de sûre adı vesilesiyle ayrıntılı işlendi.** **Tekrarlamıyorum.**
...
**بَغْتَةً** — **ansızın, hazırlıksız yakalanacak biçimde.**
...
**ب-ص-ر** kökü: **görmek; ve iç görü.** *Basar* — göz; *basîret* — **kavrayış, gördüğünü anlama.**
...
**Bu, metnin verisi olan bir örtüşmedir; aradaki bağı kurmak bana aittir.**
...
| Ayet | İfade |
|---|---|
| **106** | *Ve mâ yü'minü ekseruhüm billâhi illâ ve hüm **müşrikûn*** |
| **108** | *Ve mâ ene **mine'l-müşrikîn*** |

**Aynı kelime, iki ayet arayla, biri teşhis biri beyan.** Bu, sûre içinde sayılabilir bir tekrardır.
...
**Kalıp Kur'an'da birkaç yerde tekrarlanır** (Enbiyâ 21/7; Nahl 16/43) **ve `021-enbiya.md` 21/7'de işlendi.**
...
**أَفَلَمْ يَسِيرُوا۟ فِى ٱلْأَرْضِ** — **ve delil, gezmeye ve bakmaya dayandırılıyor.** **Bu kalıp `030-rum.md` 30/8-10'da ve `035-fatir.md` 35/43'te işlendi.**
...
| Okuyuş | Kalıp | Anlam |
|---|---|---|
| *kü**zz**ibû* (şeddeli) | **II. bâb, meçhul** | **"Yalanlandıklarını"** — yani kavimleri tarafından yalanlandıklarını anladılar |
| *kü**z**ibû* (şeddesiz) | **I. bâb, meçhul** | **"Kendilerine yalan söylendiğini"** — zannın öznesi tartışmalıdır |
...
**Kökün çözümlemesi `059-hasr.md` 59/2'de, `079-naziat.md` 79/25-26'da ve `023-muminun.md` 23/21-22'de yapıldı ve 43. ayette dayanmıştım.** Orada kaydedilenler:

> **Kökün ortak çekirdeği: bir yakadan öbür yakaya geçmek.** *Ubûr* — karşıya geçme; *ma'ber* — geçit; *ibâre* — anlamı bir zihinden ötekine geçiren söz; *ta'bîr* — rüyanın **görüntüden anlama** geçirilmesi; *abre* — gözden taşan yaş.
>
> **İbret almak, bu iki yaka arasındaki geçişi yapmaktır:** *Bu yaka:* olay onların başına geldi, ben seyrediyorum. *Öbür yaka:* aynı şey benim de başıma gelebilir; onları oraya götüren şey bende de var mı?
>
> **Bir olay tek başına ibret değildir.** İbret, olayın **görünen** yüzünden **görünmeyen** yüzüne geçildiğinde ortaya çıkar.
...
| Ayet | İfade |
|---|---|
| **3** | *Nahnü **nekussu** aleyke **ahsene'l-kasas*** |
| **111** | *Le-kad kâne fî **kasasıhim** ıbrah* |
...
**Terkip `038-sad.md` 38/41-44'te (*ve zikrâ li-üli'l-elbâb*) de geçmişti.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı iki yerdeki aynı kelimedir:** sûre boyunca *ehâdîs* **yorumlanacak olaylar** anlamındaydı; **kapanışta aynı kelime, anlatının kendisi için kullanılıyor.** **Yani anlatı da yorumlanacak bir *hadîs*tir.**
...
| **24** | ***Hemmet bihî ve hemme bihâ*** — dört ayrı okuma; *levlâ*nın cevabının yeri |
