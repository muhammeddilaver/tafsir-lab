...
| Ayet | Cümle |
|---|---|
| **4** | *Lehû mâ fi's-semâvâti ve mâ fi'l-ard* |
| **53** | *…ellezî **lehû mâ fi's-semâvâti ve mâ fi'l-ard*** |
...
| **ح-ج-ج** | *lâ **hüccete** beynenâ* (15) — *yu**hâccû**ne… **hüccetühüm*** (16) | Kapatılan tartışma, sürdüren taraf |
...
**Bu bir gözlemdir; bir hesap ya da sayı iddiası kurulmuyor.**
...
Sûre *hâ-mîm* ile açılan yedi sûrenin (**el-havâmîm**) üçüncüsüdür. Bu grubun ortak özelliği — açılışın hemen ardından kitaptan ya da vahiyden söz edilmesi — `046-ahkaf.md`'de kaydedildi. **Şûrâ'da da öyledir:** üçüncü ayet *kezâlike yûhî ileyk* ile başlar.

**Muhtevanın Mekkî karakterini destekleyen noktalar:**
...
### Önce genel kayıt — ve o tekrarlanmayacak

**Hurûf-ı mukattaa hakkındaki geniş inceleme `002-bakara.md` 2/1 bölümünde yapıldı; `050-kaf.md` 50/1'de bir kez daha ve daha kalın olarak tekrarlandı. Burada onu yeniden yazmıyorum.** Özeti şudur:
...
**Şûrâ'daki tek fark budur ve yalnızca onu işliyorum: dizinin ikiye bölünmesi.**

### Kur'an'da iki satır hâlinde gelen tek mukattaa dizisi

Bu, doğrulanabilir bir mushaf olgusudur ve Şûrâ'ya özgüdür.
...
**Şûrâ'da ise beş harf iki ayrı ayete bölünmüştür:**
...
### Bu bölünmenin sebebi hakkında ne biliyoruz?
...
Klasik kaynaklarda nakledilen izahları, **bir tercih listesi olarak değil, dökümü olarak** veriyorum:
...
| **Harflere yüklenen anlamlar** | Her harfin bir isme ya da kelimeye işaret ettiği söylenir | `002-bakara.md`'de kaydedildiği gibi sistematik değil; aynı yöntem bütün gruplara uygulandığında tutarlı sonuç vermiyor |

**Ve hepsinin üstüne yazılması gereken şudur: yukarıdaki hiçbir izah "bölünmenin sebebi budur" demeye yetmez.**

### Kaydedilebilecek olan

**Şunu bir gözlem olarak, kendi okumam olarak veriyorum ve bağlayıcı değildir:**
...
Ve ardından üçüncü ayet geliyor: *kezâlike yûhî ileyke ve ile'llezîne min kablik* — "işte böyle vahyediyor sana ve senden öncekilere." **Yani harflerden sonra gelen ilk şey, `002-bakara.md`'de kurulan örüntüye uygun olarak, yine vahiy alanına aittir.** Bu, tek başına harflerin anlamı hakkında bir şey söylemiyor; söylediği şey, harflerin **nereye bağlandığı**dır.
...
**Kök و-ح-ي `053-necm.md`'de ayrıntılı işlendi; tekrarlamıyorum.** Oradaki tespit şuydu: kökün somut anlamı **hızlı ve gizli bildirim**dir — *sürat* ve *gizlilik*. Ve kelime yalnız peygamberlere gelen bildirim için kullanılmaz; Zekeriyyâ'nın işareti, arının bildiği, şeytanların fısıltısı da aynı kökle anılır.
...
**Bu, `046-ahkaf.md` 46/9'da aynı meselenin farklı bir kelimeyle söylendiği yerdir:** *mâ küntü bid'an mine'r-rusül* — "ben peygamberler içinde türedi biri değilim." Orada kelime *bid'* idi (örneği olmayan); burada kalıp bir bağlaç: *ve ilâ.*
...
**ٱلْعَزِيز** — kök **ع-ز-ز**: sağlam, ulaşılmaz, üstün olmak. **ٱلْحَكِيم** — kök **ح-ك-م**: engelleyip yerinde tutmak. **İkisi de `046-ahkaf.md` 46/2'de işlendi**; oradaki kayıt şuydu: biri **güç**, öteki **yerindelik** bildirir; güç tek başına anılmıyor.
...
*Lehû mâ fi's-semâvâti ve mâ fi'l-ard, ve hüve'l-aliyyü'l-azîm*

"Göklerde ne varsa, yerde ne varsa O'nundur. O yücedir, büyüktür."

### Cümlenin dizimi: *lehû* öne alınmış

**Normal sıra "mâ fi's-semâvâti ve mâ fi'l-ardı lehû" olurdu.** Cümle böyle kurulmamış: câr-mecrûr (*lehû*) öne alınmış.

**Arapçada bir öğenin öne alınması (*takdîm*) tahsis bildirir:** "yalnız O'nun". `057-hadid.md` 57/2 ve 57/5'te aynı yapı işlendi (*lehû mülkü's-semâvâti ve'l-ard*) ve orada kaydedilen şuydu: tekrarın kendisi bir iştir.
...
**Ve iki geçiş arasında bir fark var, o da kaydedilmelidir:**
...
**Bu iki isim Kur'an'da bir kez daha yan yana gelir ve orası Âyetü'l-Kürsî'nin son cümlesidir:** *ve hüve'l-aliyyü'l-azîm* (Bakara 2/255). **`002-bakara.md`'de o ayetin yapısı tablolandı** ve orada kaydedilen şuydu: ayet içten dışa doğru genişliyor — zattan sıfata, sıfattan mülke, mülkten kapsama — **ve sonunda iki isimle kapanıyor.**
...
**Kökün somut anlamı: yarmak, uzunlamasına açmak.** Kök dizinde `082-infitar.md` ve `084-insikak.md` bölümlerinde işlendi; tekrarlamıyorum. Özeti: *fatr*, bir şeyin yarılarak açılmasıdır; *iftâr* (orucu açmak) ve *fıtrat* (ilk yarılış, ilk kuruluş) aynı köktendir.
...
***Sebbeha bi-hamdihî* kalıbı `057-hadid.md` 57/1'de işlendi:** *tesbîh* uzaklaştırmadır (noksandan tenzih), *hamd* yakınlaştırmadır (nimete karşılık övgü). İkisinin birlikte gelmesi, iki yönü aynı fiilde toplar.

**لِمَن فِى ٱلْأَرْضِ — "yeryüzünde olanlar için".** İfade **genel**dir: mümin-kâfir ayrımı yapılmıyor.
...
**حَفِيظ** — kök **ح-ف-ظ**: korumak, gözetmek, kayıtta tutmak. **Kök `050-kaf.md` ve `082-infitar.md`'de işlendi**; oradaki kayıt şuydu: kökte hem **koruma** hem **kayıt tutma** vardır ve Kur'an ikisini de kullanır.
...
**وَكِيل** — kök **و-ك-ل**. **`067-mulk.md`'de işlendi**; oradaki tarif şuydu: bir işi başkasına havale etmek, vekil tayin etmek; *vekîl* — kendisine iş bırakılan. Ve orada kaydedilen nükte önemlidir: **tevekkül iş yapmamak değil, işin sonucunu havale etmektir.**
...
**Ve bu, çağrıda bulunan herkes için geçerli bir ölçüdür:** sonuç, çağrıyı yapanın sorumluluğunda değildir. Sorumluluk *belâğ*tadır — ulaştırmakta. Kırk sekizinci ayet bunu açıkça söyleyecek.
...
### قُرْءَانًا عَرَبِيًّا — nekre gelmesi
...
**Aynı terkip Kur'an'da birkaç yerde daha geçer ve hepsinde bir amaç cümlesi eşlik eder:**
...
**Fark kaydedilmeye değer:** diğer yerlerde amaç **anlama** (*akl*, *ilm*), burada **uyarma**dır. Yani aynı nitelik (Arapça oluş) farklı bağlamlarda farklı işe bağlanıyor. **Şûrâ'da dilin anlaşılırlığı, uyarının ulaşabilmesi için gerekçe olarak konuyor.**
...
### أُمَّ ٱلْقُرَىٰ — kök أ-م-م

**Sûrenin en yoğun terkiplerinden biri ve kök üzerinde durulmalı.**

**Kök أ-م-م.** Dizinde `002-bakara.md` 2/78'de ve `062-cuma.md`'de *ümmî* kelimesi bağlamında ele alındı; oradaki kayıt şuydu: kök **anne** demektir, *ümmî* klasik izahıyla "annesinden doğduğu hal üzere kalmış", yani okuma yazma öğrenmemiş kişidir.

**Buraya ait olan, kökün diğer dallarıdır** — çünkü *ümmü'l-kurâ* terkibini anlaşılır kılan onlardır:
...
**Arapçada bu yüzden bir şeyin merkezî ve aslî olan parçasına *ümm* denir:**

- **أُمّ الرَّأْس** — başın merkezi; beynin zarı.
- **أُمّ الكِتَاب** — kitabın aslı. Kur'an bu terkibi kullanır: Âl-i İmrân 3/7, Ra'd 13/39, Zuhruf 43/4.
- **أُمّ القُرَىٰ** — şehirlerin anası.

### Terkibin anlamı: neden "anne"?

**Klasik tefsirlerde bu terkip için verilen izahlar, kökün yukarıdaki iki dalına dayanır:**
...
**Üçü birbirini dışlamıyor** ve klasik kaynaklarda üçü de nakledilir. **Tercih dayatmıyorum.**
...
### وَمَنْ حَوْلَهَا — dairenin genişlemesi

**Terkip Kur'an'da iki kez geçer ve ikisinde de aynı ek gelir:**
...
***Havl* — kök ح-و-ل: dönmek, bir şeyin etrafında dolaşmak.** *Havle* — etraf, çevre. *Hâl* (durum) ve *tahavvül* (dönüşüm) aynı köktendir; ortak resim **dönme**dir.

**Ve dizim şu daireyi çiziyor:**
...
### يَوْمَ ٱلْجَمْعِ — toplanma günü

**Kök ج-م-ع: bir araya getirmek, toplamak.** *Cuma* aynı köktendir ve `062-cuma.md`'de işlendi.

**Bu ad, kıyamet günü için Kur'an'ın kullandığı adlardan biridir.** `050-kaf.md`'de Kāf sûresinin aynı güne verdiği üç adın tablosu yapılmıştı (*yevmü'l-vaîd*, *yevmü'l-hulûd*, *yevmü'l-hurûc*). **Şûrâ'nın verdiği ad başka bir yönü öne çıkarıyor:** o gün, **ayrılmışların bir araya getirildiği** gündür.
...
**Ve toplanmanın hemen ardından bir ayrılma geliyor.**

**فَرِيق — kök ف-ر-ق.** `075-kiyame.md`'de işlendi: ayırmak, bölmek, aralarını açmak; türevleri *fark*, *fırka*, *tefrika*, *ferîk*, *iftirâk*, *furkān*.

**Şimdi bu sûredeki kullanımlara bakın — bu, sûrenin en dikkat çekici kelime örgüsüdür:**
...
**Aynı kök, üç ayrı ayette, üç ayrı işte: yasak, ihlal, sonuç.**
...
1. **Belirlilik** — *el-veliyy*, takılı. Soruda *evliyâ* nekre ve çoğuldu.
2. **Ayırma zamiri** — *hüve* (*zamîru'l-fasl*): "yalnız O".
3. **Tekillik** — çoğula karşı tekil.
...
**حُكْم — kök ح-ك-م:** `046-ahkaf.md`'de kaydedildiği gibi kökün somut anlamı **engelleyip yerinde tutmak**tır; *hakeme* (atın gemi) aynı köktendir. *Hüküm*, bir işi yerine oturtup dağılmasını engelleyen karardır.
...
**Cümlenin ortasında konuşan kişi değişiyor ve bu, bir *iltifat*tır (hitabın yön değiştirmesi).**

- İlk yarı: *me'htelef**tüm*** — "siz". Muhatap topluluk.
- İkinci yarı: *rab**bî**… tevekkel**tü**… ünî**bü*** — "ben". Konuşan Peygamber.
...
**Kök `050-kaf.md`'de işlendi** (*münîb*, *evvâb* bağlamında). Özeti: *inâbe*, bir yere **tekrar tekrar dönmek**tir; *nevbet* (sıra, dönüşümlü iş) aynı köktendir. **Kökte tek seferlik bir dönüş değil, düzenli bir geri geliş vardır.**
...
|---|---|---|
| *tevekkeltü* | **Mâzî** | Bir kez verilmiş karar |
| *ünîb* | **Muzâri** | **Tekrarlanan dönüş** |
...
**Ve eşleşme, yaratılmışlar dünyasında *benzerliğin* kaynağıdır.** Bir çift olmak, aynı türden olmak demektir; eş, kişinin **dengi** olandır. Nitekim *zevc* kelimesi Arapçada "bir çiftin her bir teki" anlamındadır ve `056-vakia.md` ile `081-tekvir.md`'de kökün bu yanı işlendi.
...
**`112-ihlas.md`'de *lem yelid ve lem yûled* cümlesi bu mantıkla işlenmişti.** Şûrâ'da aynı sonuç başka bir yoldan geliyor: İhlâs doğurmayı reddediyor; Şûrâ **benzerliği** reddediyor — ve doğurma, benzerlik üretmenin yoludur.
...
| **2. *Misl* zâiddir / kinayedir** | *Misl* burada "zât, kendisi" anlamında bir kinayedir. Arapçada *"mislüke lâ yef'alü hâzâ"* denir ve "sen bunu yapmazsın" demektir. Cümle "*leyse ke-hû şey'*" demektir | Bu kullanım Arap dilinde yerleşiktir ve örnekleri çoktur | *Misl*i işlevsiz saymak da ilk görüşün karşılaştığı itirazla karşılaşır |
...
**Cümlenin ismi (*leyse*nin ismi) sona bırakılmıştır: *şey'*.** Ve bu kelime kaydedilmelidir.
...
**Birincisi, `002-bakara.md` 2/255 (Âyetü'l-Kürsî).** Orada kaydedilen şuydu: ayet baştan sona haber cümlelerinden oluşur, içinde tek bir emir yoktur; yapı içten dışa genişler; ve **bir sınır konmuştu** — *kürsî* kelimesi Allah'a mekân, cisim ya da oturma nispet edecek şekilde anlaşılamaz, **çünkü aynı ayet uykunun bile O'nu tutamayacağını bildiriyor.** Yani orada tenzih, ayetin **kendi iç tutarlılığından** çıkarılmıştı.

**İkincisi, `112-ihlas.md`.** Orada *ehad* ile *vâhid* arasındaki fark tablolanmış ve şu kaydedilmişti: *vâhid* sayısal tekliktir ve sayısal teklik daima bir karşılaştırmaya açıktır; *ehad* ise "kendisinden başkası düşünülemeyen"dir — sayının değil, **eşsizliğin** ifadesidir. *Samed* ise bağlaçsız gelerek *ehad*'in açılımı olmuştu.
...
**Ve son satır, Şûrâ'ya özgü olanı gösteriyor.** İhlâs'ta tenzih metnin **konusu**dur; Âyetü'l-Kürsî'de bir **dizinin parçası**dır. Şûrâ'da ise **bir cümlelik**tir ve iki yanı doludur: önünde yaratma ve çoğalma, arkasında işitme ve görme.
...
**Bu tefsirde bu tartışmada taraf tutulmuyor.** Aynı kayıt `002-bakara.md` 2/255'te ve `057-hadid.md`'de de düşülmüştü.
...
**Ve pratik sonucu şudur:** insanın Tanrı tasavvuru denetimsiz bırakıldığında, er ya da geç kendisine benzemeye başlar — kendi öfkesini, kendi tarafgirliğini, kendi hesabını oraya taşır. `112-ihlas.md`'de bu, "kul" emri üzerinden kaydedilmişti. Burada aynı şey doğrudan yasaklanıyor.
...
### يَبْسُطُ … وَيَقْدِرُ — iki fiil, tek özne

**Cümle iki zıt fiili yan yana koyuyor ve ikisinin de fâili aynı.**

**بَسَطَ — kök ب-س-ط.** **`071-nuh.md`'de işlendi**; oradaki kayıt şuydu: yaymak, sermek, açmak, genişletmek; *bisât* — yere serilen yaygı; *basît* — yayılmış, sade; ve karşıtı *kabz* (toplamak).

**قَدَرَ — kök ق-د-ر.** **`097-kadr.md`'de üç anlamıyla ayrıntılı işlendi** ve `054-kamer.md`'de o üçlü tablo tekrar kullanıldı. Oradaki tablo şuydu: **ölçü/takdir**, **değer/şeref**, **darlık/doluluk.** *Yakdir* fiili burada **üçüncü** anlamdadır: daraltmak, ölçüyü kısmak.

**Ve kökün bu iki anlamı — ölçmek ve daraltmak — birbirine bağlıdır:** bir şeyi ölçmek, ona bir sınır koymaktır; sınır koymak da daraltmaktır. **`097-kadr.md`'de bu bağ zaten kurulmuştu.**
...
**Kökün somut anlamı, dilcilerin tariflerinde açıktır ve bir su resmi taşır:**
...
**Dilciler bu yerin özelliklerini de kaydeder ve özellikler kelimenin anlamını taşır:**
...
**Kökün türevleri bu resmi genişletiyor:**
...
**Kur'an kökü birkaç yerde kullanır ve kullanımlar somut anlamı destekler:**
...
### Somut anlamdan çıkan sonuç

**Kendi okumam olarak kaydediyorum ve dayanağı kökün dilcilerdeki tarifidir:**
...
### Beş peygamber — ve listenin sırası

**Ayette beş isim geçiyor:**

1. **Nûh**
2. **"Sana vahyettiğimiz"** — Muhammed
3. **İbrâhîm**
4. **Mûsâ**
5. **Îsâ**
...
**Aynı beş isim Kur'an'da bir kez daha, bir arada geçer:**

> *"Hani biz peygamberlerden söz almıştık — **senden**, **Nûh**'tan, **İbrâhîm**'den, **Mûsâ**'dan ve Meryem oğlu **Îsâ**'dan."* (Ahzâb 33/7)

**İki listeyi yan yana koyuyorum — bu, metinden doğrulanabilir bir olgudur:**

| Sıra | **Şûrâ 42/13** | **Ahzâb 33/7** |
|---|---|---|
| 1 | **Nûh** | **Sen** (*minke*) |
| 2 | **Sen** (*evhaynâ ileyke*) | **Nûh** |
| 3 | İbrâhîm | İbrâhîm |
| 4 | Mûsâ | Mûsâ |
| 5 | Îsâ | Îsâ |

**Son üç isim aynı sırada; ilk iki isim yer değiştirmiş.** Bu, kaydedilmeye değer bir olgudur.

**Sıra hakkında nakledilen izahlar:**
...
| **Bağlam** | Şûrâ'da vurgulanan şey **süreklilik**tir; en eskiden başlanıp muhatap hemen ardına konarak zincir kapatılır |
...
**Ve bir fiil değişimi var, o da kaydedilmelidir:**
...
**Yani cümle üçüncü şahısla başlayıp birinci çoğula geçiyor — bu bir *iltifat*tır (hitabın yön değiştirmesi).** Ve geçiş tam olarak muhataba gelindiği noktada oluyor.
...
- **أوحى** — `053-necm.md`'de işlendi: **hızlı ve gizli bildirim.**
...
### أَنْ أَقِيمُوا۟ ٱلدِّينَ وَلَا تَتَفَرَّقُوا۟ فِيهِ — ortak esas
...
**إِقَامَة — kök ق-و-م.** `002-bakara.md` 2/255'te *el-Kayyûm* bağlamında işlendi: ayakta durmak, bir işin başında durup onu yürütmek. **İkinci bâb (*ikāme*) geçişlidir: bir şeyi ayakta tutmak, düşmesine izin vermemek.**
...
### `002-bakara.md` 2/213 ile bağ

**Ayrılığın niçin ortaya çıktığı `002-bakara.md` 2/213'te işlendi. Orada kaydedilen şuydu:**
...
**كَبُرَ — kök ك-ب-ر.** `046-ahkaf.md` ve `074-muddessir.md`'de işlendi. **Burada fiil "büyük geldi, ağır geldi" anlamındadır** — bir yükün ağırlığı gibi.
...
**Ayet iki fiille kapanıyor ve iki fiilin nesneleri farklı:**
...
**İki cümle arasındaki fark kaydedilmelidir ve önemlidir:**
...
**Ve *yünîb* fiili, onuncu ayette Peygamber'in kendisi için kullandığı fiildir:** *ve ileyhi **ünîb***.
...
**Bu ayet ile `002-bakara.md` 2/213 arasındaki örtüşme, Kur'an'ın Kur'an'la tefsirinin en açık örneklerinden biridir. İki metni yan yana koyuyorum.**

> **Bakara 2/213:** *"…**ve me'htelefe fîhi** ille'llezîne ûtûhü **min ba'di mâ câethümü'l-beyyinâtü bağyen beynehum**…"*
>
> **Şûrâ 42/14:** *"**Ve mâ teferrakû** illâ **min ba'di mâ câehümü'l-ilmü bağyen beynehum**…"*
...
| Ayet | Cümle |
|---|---|
| **13** | *ve **lâ teteferrakû** fîh* — "**ayrılmayın**" |
| **14** | *ve **mâ teferrakû** illâ…* — "**ayrıldılar**" |

**Aynı kökün nehiy (yasak) ve mâzî (olmuş) hâlleri, art arda iki ayette.** Bu, metinden doğrulanabilir bir olgudur ve `002-bakara.md`'de bulunmayan bir keskinlik katıyor: **emir ile ihlal, yan yana duruyor.**

**Ve ikinci fark üzerinde de durulmalı: *beyyinât* → *ilm*.**

*Beyyinât* dışarıdan gelen, gösterilebilir delillerdir. *İlm* ise **bilme hâli**dir — delilin karşı tarafta ürettiği sonuç. **Yani Şûrâ, Bakara'nın bir adım ötesine geçiyor:** Bakara "deliller geldikten sonra" der, Şûrâ "bilgi geldikten sonra" der.
...
**Kök `049-hucurat.md` 49/9'da ayrıntılı işlendi; tekrarlamıyorum.** Oradaki tespit şuydu:
...
***ilâ ecelin müsemmâ* — "adı konmuş bir süreye kadar".** Bu terkip `046-ahkaf.md` 46/3'te işlendi; oradaki kayıt şuydu: yaratmaya konan iki kayıttan biri **süre**dir — sonsuz değil, adı konmuş bir vadeyle.
...
***Ûrisû* — و-ر-ث kökü, meçhul: "mirasçı kılındılar".** `057-hadid.md` 57/10'da *mîrâsü's-semâvâti ve'l-ard* bağlamında kökün "sahibinden sonra kalan" anlamı işlendi.
...
**Ve `002-bakara.md` 2/2 ile bir karşıtlık kaydedilebilir:** orada Kitap için *lâ raybe fîh* — "onda şüphe yoktur" deniyordu. **Burada Kitab'a mirasçı olanlar *fî şekkin minhu mürîb* — "ondan kuşku veren bir şüphe içinde" diye anılıyor.**
...
**حُجَّة — kök ح-ج-ج.** `002-bakara.md` 2/139'da işlendi: **delil getirmek, tartışmada üstün gelmek.** Ve orada kaydedilen şuydu: kalıp *mufâale*dir (*muhâcce*) — **iki taraflı, karşılıklı bir tartışma.**
...
> **Bakara 2/139:** *"Kul **e-tuhâccûnenâ fi'llâhi ve hüve rabbunâ ve rabbuküm; ve lenâ a'mâlünâ ve leküm a'mâlüküm**; ve nahnü lehû muhlisûn."*
>
> **Şûrâ 42/15-16:** *"…**Allâhu rabbunâ ve rabbuküm; lenâ a'mâlünâ ve leküm a'mâlüküm**… ve'llezîne **yuhâccûne fi'llâhi**…"*
...
**`002-bakara.md`'de o ayet hakkında kaydedilen şuydu:**
...
**Ve dizim nüktesi şudur: fiil *beynenâ* alıyor — "aramızı".** Yani toplanan şey iki taraf değil, **aralarındaki mesafe**dir.
...
**Sûrenin kurduğu ölçü budur ve `002-bakara.md` 2/213'te kaydedilen ölçüyle aynıdır: sorun bilgiden önce değil, sonra çıkıyor.**
...
**غَضَب — kök غ-ض-ب.** `048-fetih.md`'de kaydedildiği gibi kökte **kabarma, şiddetlenme** fikri vardır.
...
**Biri üstlerinde, öteki onlar için.** Bu ayrım Arapçada yerleşiktir ve `001-fatiha.md`'deki *el-mağdûbi aleyhim* terkibi de aynı harfi kullanır.
...
### ٱلْكِتَٰبَ … وَٱلْمِيزَانَ — Kur'an'da iki kez gelen bir çift
...
**`057-hadid.md` 57/25'te bu üçlü ayrıntılı işlendi.** Oradaki tablo şuydu: *kitâb* ölçünün **ilkesi**, *mîzân* ölçünün **aleti**, *hadîd* ölçünün **korunması**. Ve orada şu kaydedilmişti:
...
**Şûrâ ise bir *ayrılık* sûresidir.** Ve burada mîzânın ardından gelen şey adalet değil, **zaman**dır: *lealle's-sâate karîb.*
...
**Bir dizim kaydı:** *bi'l-hakk* kaydı yalnız *kitâb*a mı yoksa ikisine birden mi bağlanır — bu, gramerciler arasında tartışılmıştır. **Lafız ikisine de elverir; tercih dayatmıyorum.**

### وَمَا يُدْرِيكَ — kök د-ر-ي

**Kök `090-beled.md`, `101-karia.md` ve `104-humeze.md`'de işlendi.** Oradaki kayıt: *dirâyet*, **bir şeyi çabayla, iz sürerek bilmek**tir; *ilm*den farkı budur — *derâ* fiili "araştırarak öğrendi" anlamı taşır.
...
**İSTİ'CÂL — kök ع-ج-ل, X. bâb: bir şeyin acele gelmesini istemek.** *Acele*, kökün asıl anlamıyla **vaktinden önce istemek**tir.
...
**Kök `052-tur.md`, `070-mearic.md` ve `084-insikak.md`'de işlendi.** Oradaki tarif: *şefak*, gündüz ile gece arasındaki **ara ışık**; ve *işfâk*, korku ile umut arasında duran **kaygı** — saf korku değil.
...
**Bu, kelimenin buradaki işini açıklıyor:** müminlerin hâli kaçış değil, **dikkat**tir.
...
**Kök `054-kamer.md`'de işlendi** (*fe-temârav bi'n-nüzür*) ve orada kaydedilen okuma şuydu: *temârî*, "tartışmaya açarak etkisiz kılmak"tır.
...
**Kök `067-mulk.md`'de işlendi** (*ve hüve'l-latîfü'l-habîr*). Oradaki kayıt: kökün somut anlamı **incelik ve gizlilik**tir — *latîf*, çok ince olduğu için gözle ayırt edilemeyen; ve buradan **en dar yere nüfuz edebilen.**
...
**قَوِىّ** — kök **ق-و-ي**: güç, kuvvet; kökte **iplerin bükülüp sağlamlaşması** fikri vardır (*kuvâ* — ipin bükümleri). **`057-hadid.md` 57/25'te *kaviyyün azîz* çifti aynı sırada geçmişti.**
...
- **`056-vakia.md` 56/63'te**: *hars* insanın yaptığıdır — sürmek, atmak, sulamak; *zer'* ise tohumun içinde olup bitendir — çatlama, kök salma, yeşerme. **Ve orada kaydedilen sonuç şuydu: "ekmek sizin, bitirmek sizin değil."**
- **`002-bakara.md` 2/205 ve 2/223'te**: kökün "geleceğe uzanan şey" olması; bozguncunun *harsi* helâk etmesi (2/205), ve 2/223'te kaydedilen şu: ***hars* Arapçada değer verilen, emek harcanan, korunan şeydir; ekin sahibinin geçim kaynağıdır, ihmal edilen değil üzerine titrenendir.**
...
**Kelimenin `056-vakia.md`'de çıkarılan anlamı burada bütün ağırlığıyla işliyor. *Hars* şu üç şeyi birden söylüyor:**
...
| **Sonucu ekene ait değildir** | `056-vakia.md`'de kaydedildiği gibi: bitirmek insanın işi değil |
...
**Ve bu ayrım, `002-bakara.md`'de kaydedilen iki dua tablosunun tam karşılığıdır.**

### `002-bakara.md` 2/200-202 ile karşılaştırma
...
| Kelime | Kök | Anlamı |
|---|---|---|
| **خَلَاق** (*halâk*) | خ-ل-ق — ölçüp biçmek | **Ayrılmış pay.** `002-bakara.md`'de işlendi |
...
1. **Ayet miktar bildirmiyor.** *Nü'tihî minhâ* — "ondan veririz" der; ne kadar, söylenmiyor. Ve *min* kısmîlik bildirir.
2. **On ikinci ayet zaten dağılımın kişiye göre değiştiğini söylemişti** (*yebsutu… ve yakdir*); yani dünyalık miktarı bir gösterge değil.
3. **Yirmi yedinci ayet bunu daha da açacak:** rızkın sınırsız yayılmaması bir **koruma** olarak sunulacak.

**Ayetin ölçüsü mala değil, *irâde*ye bakıyor: *men kâne yürîd* — "kim istiyorsa".** Ve *kâne yürîd* kalıbı süregelen bir isteği bildirir: bir anlık arzuyu değil, **yönelmiş bir hayatı.**
...
|---|---|---|
| **20** | *ne**zid** lehû fî harsih* | **Ekine** |
| **23** | *ne**zid** lehû fîhâ husnâ* | **İyiliğe** |
| **26** | *ve ye**zîdü**hum min fadlih* | **Cevaba** |
...
**Ve pratik sonucu şudur:** yalnız görünen sonucu hedefleyen bir çaba, o sonucu elde edebilir. Ayet bunu inkâr etmiyor — *nü'tihî minhâ*, "veririz" diyor. Söylediği şey, o çabanın **kendi sınırını da beraberinde getirdiği**dir: alınan şey, istenen şey kadardır.
...
### شَرَعُوا۟ — aynı fiil, başka fâil
...
**Aynı fiil, aynı harf-i cer (*mine'd-dîn*), aynı yapı. Değişen tek şey: kim koyuyor.**
...
### مَا لَمْ يَأْذَنۢ بِهِ ٱللَّهُ — ölçü nerede

**Cümle, sahte yolun ne olduğunu tarif etmiyor; onu tanımanın ölçüsünü veriyor: *izin*.**

**أَذِنَ — kök أ-ذ-ن.** Kökün somut anlamı **kulak**tır (*üzün*); *izin*, "kulak vermek"ten türemiştir — bir talebi işitip onaylamak.
...
### كَلِمَةُ ٱلْفَصْلِ — ayırma sözü
...
***Kesebû* — kök ك-س-ب.** `074-muddessir.md`'de işlendi: **elde etmek, kazanmak, toplayıp getirmek.** Ve orada kaydedilen şuydu: **kök Kur'an'da hem iyi hem kötü için kullanılır ve nötrdür.**

**Buradaki kullanımda kelimenin nötrlüğü bir keskinlik üretiyor:** insanın korktuğu şey, dışarıdan gelen bir ceza değil, **kendi kazancı**dır. Cümle "kazandıkları"nı korkulan şeyin yerine koyuyor.

**وَهُوَ وَاقِعٌۢ بِهِمْ — "oysa o başlarına gelecektir".** *Vâkı'* ism-i fâildir ve gelecek zaman bildiriyor. **Kök و-ق-ع `056-vakia.md`'de sûrenin adı olarak işlendi:** düşmek, yere inmek, gerçekleşmek.
...
**Ve `056-vakia.md` ile `050-kaf.md`'de kaydedilen cennet tasvirlerinden farkı şudur:** orada meyve, gölge, eş, kap gibi **nesneler** sayılıyordu. Burada bir **yer** adlandırılıyor ve ardından tek bir cümle geliyor: *lehum mâ yeşâûn* — "diledikleri onlarındır."
...
***el-Fadlü'l-kebîr* — kök ف-ض-ل: bir şeyin gereğinden fazla olan kısmı; artan.** `062-cuma.md` ve `057-hadid.md`'de işlendi. **Kökün asıl anlamı "fazlalık"tır; yani *fadl*, hak edilenin üstüne konan şeydir.**
...
**Kök `085-buruc.md`'de *el-Vedûd* ismi bağlamında işlendi.** Oradaki kayıt şuydu:
...
**Kökün diğer türevleri:** *vüdd* (sevgi), *vedûd* (çok seven / çok sevilen), *vedd* (İslam öncesinde bilinen bir putun adı — `085-buruc.md`'de bu ilişki hakkında hüküm verilmediği kaydedildi), *tevaddüd* (sevgi göstermek).

### قُرْبَىٰ — kök ق-ر-ب

**Kök `050-kaf.md`, `056-vakia.md` ve `090-beled.md`'de işlendi:** yakınlık; mesafe yakınlığı ve akrabalık yakınlığı.

***Kurbâ* kalıbı (fu'lâ) bir isimdir ve Arapçada iki anlamda kullanılır:**
...
### إِلَّا — istisnanın türü

**Bir üçüncü belirsizlik daha var ve tartışmanın merkezindedir: *illâ* burada hangi tür istisnadır?**
...
> *"De ki: Sizden istediğim ücret **sizin olsun**; benim ecrim ancak Allah'a aittir."* (Sebe' 34/47)
>
> *"De ki: Buna karşılık sizden bir ücret istemiyorum — **Rabbine bir yol tutmak isteyen kimse müstesna.**"* (Furkān 25/57)
...
| *İllâ*nın türü | İki (muttasıl / munkatı') |
...
***Lâ es'elüküm aleyhi ecrâ*** — **"sizden bir ücret istemiyorum."**
...
**غَفُور — kök غ-ف-ر: örtmek.** `058-mucadele.md`'de *Afüvv* ile karşılaştırmalı olarak işlendi: *ğufrân* örter, *afv* siler.

**شَكُور — kök ش-ك-ر.** Ve bu ismin Allah için kullanılması üzerinde durulmalıdır.
...
**Ve kök sûrede bir kez daha, bu kez insan için geçecek:**

| Ayet | Kelime | Kim |
|---|---|---|
| **23** | *ğafûrun **şekûr*** | **Allah** |
| **33** | *li-külli sabbârin **şekûr*** | **İnsan** |
...
***Hatm* — kök خ-ت-م: mühürlemek, bir şeyin ağzını kapatıp mühür basmak.** `083-mutaffifin.md`'de *rahîkın mahtûm* bağlamında işlendi. **Kökte iki şey vardır: kapatma ve işaretleme.**

### وَيَمْحُ ٱللَّهُ ٱلْبَٰطِلَ — bir mushaf yazımı kaydı

**Bu fiil mushaflarda sondaki *vâv* harfi olmadan yazılır: وَيَمْحُ.** Okunuşu *ve yemhu*'dur.
...
**مَحْو — kök م-ح-و: silmek, izini bırakmadan yok etmek.** Ve `058-mucadele.md`'de kaydedilen ayrım burada işliyor: *ğufrân* örter, *mahv* siler. **Bâtıl örtülmüyor, siliniyor.**

### وَيُحِقُّ ٱلْحَقَّ بِكَلِمَٰتِهِۦ

***Yuhıkku* (IV. bâb) — "gerçekleştirmek, sabit kılmak".** Aynı kökten *hakk*.

**İki fiil karşıtlık kuruyor:**

| Fiil | Nesne | İş |
|---|---|---|
| *Yemhû* | *el-bâtıl* | **Siler** |
| *Yuhıkku* | *el-hakk* | **Sabit kılar** |
...
***Alîmun bi-zâti's-sudûr* — "göğüslerin özünü bilen".** Terkip `057-hadid.md` 57/6'da işlendi. ***Zât* burada "sahip olunan, içinde bulunan" anlamındadır; *zâtü's-sudûr* — göğüslerin içindekiler.**
...
**ع-ف-و kökü `058-mucadele.md`'de işlendi.** Oradaki kayıt şuydu: **kökün somut anlamı silmek, izini yok etmektir; rüzgârın kum üzerindeki ayak izlerini silmesi gibi.** Ve *ğufrân* ile farkı: **örtülen şey oradadır ama görünmez; silinen şey artık yoktur.**
...
**Bu bir *iltifat*tır** ve etkisi kaydedilmeye değer: cümle genel bir bilgi olarak başlıyor, muhataba dönerek bitiyor. **Yani "kullarından tövbeyi kabul eder" cümlesi, "yaptıklarınızı bilir" ile doğrudan okuyucunun üzerine geliyor.**
...
**Kök `089-fecr.md`'de işlendi** (*câbû's-sahra bi'l-vâd* — "vadide kayaları oydular"). Oradaki kayıt: **kökün somut anlamı yarmak, delip geçmek**tir.
...
| **26** | *ye**stecîb**ü'llezîne âmenû* | **Allah** | İman edenlere |
| **38** | *e**stecâb**û li-rabbihim* | **İman edenler** | Rablerine |
| **47** | *i**stecîb**û li-rabbiküm* | **Emir** — muhataba | Rablerine |
...
**Kök `071-nuh.md`'de işlendi:** yaymak, sermek, açmak, genişletmek; *bisât* — yere serilen yaygı; karşıtı *kabz*.
...
***Lev* kalıbı gerçekleşmemiş şartı bildirir.** Yani ayet **olmuş bir şeyden** değil, **olmamış bir ihtimalden** söz ediyor. Bu, `056-vakia.md` 56/65'te aynı kalıp için kaydedilen tespitle aynıdır: *lev neşâü* — "dileseydik" — gerçekleşmemiş şart.

### لَبَغَوْا۟ — ve kökün sûredeki yeri

***Bağy* kökü on dördüncü ayette işlendi ve `049-hucurat.md` 49/9'a dayandırıldı: isteğin haddi aşmış hâli.**
...
***Kader* — kök ق-د-ر.** **`097-kadr.md`'de üç anlamıyla ayrıntılı işlendi:**
...
**Ve `054-kamer.md` 54/49'da (*innâ külle şey'in halaknâhu bi-kader*) aynı kalıp — *bi-kader* — işlendi.** Oradaki kayıt şuydu: Kamer'de kök **iki ayrı kelimeye dağılmış** durumdadır — *bi-kader* ölçü dalını, *muktedir* kudret dalını taşır; ve bu, kırk dokuzuncu ayeti kader tartışmasından bağımsız okumayı kolaylaştırır.

**Şûrâ'da da aynı ayrışma var ve bunu kaydediyorum:**

| Kelime | Ayet | Hangi dal |
|---|---|---|
| *yakdir* | **12** | **Darlık** — kısmak |
| *bi-kader* | **27** | **Ölçü** |
| *kadîr* | **9, 29, 50** | **Kudret** |
...
***Bi-kader* burada Kamer 54/49'daki anlamıyla aynıdır: ölçü, miktar.** Ve `054-kamer.md`'de kaydedildiği gibi bu tefsirde kader meselesinin kelâmî tartışmasına girilmiyor; kelimenin ne dediğine bakılıyor.

***Yünezzilü* — II. bâb, tef'îl.** `057-hadid.md` 57/9'da kaydedildiği gibi bu bâb **parça parça, tekrarlanarak** indirmeyi bildirir. **Yani ölçü yalnız miktarda değil, zamanda da var: toptan değil, aralıklı.**
...
1. **Ayetin konusu bir kişinin değil, *toplamın* rızkıdır.** *Li-ibâdihî* — "kullarına", çoğul ve genel. Ayet, sınırsız bir yayılmanın yokluğundan söz ediyor; bir kişinin darlığını açıklamıyor.
2. **Kur'an aynı zamanda rızık aramayı emreder:** *"…yeryüzüne dağılın ve Allah'ın lütfundan **arayın**"* (Cum'a 62/10) — `062-cuma.md`'de işlendi. **Aynı kökle (ب-غ-ي, *ibtiğâ*),** ve orada olumlu.
3. **Sûrenin kendisi infakı emreder** (38): *ve mimmâ razaknâhum yünfikūn*. **Bir metin, hem paylaşmayı emredip hem darlığı savunamaz.**
...
| **صَيِّب** (*sayyib*) | ص-و-ب | Hedefini bulan sağanak — `002-bakara.md`'de işlendi |
...
***Kunût* — umudun tamamen kesilmesi.** Dilciler bunu *ye's*ten (umutsuzluk) daha şiddetli sayar: *ye's* umudun bitmesi, *kunût* ise umudun bitmesiyle birlikte gelen çöküntü.
...
***Neşr* — kök ن-ش-ر: yaymak, açmak; dürülmüş bir şeyi açıp sermek.** Aynı kökten *neşr* (dirilip yayılma), *münteşir* (yayılmış) — `054-kamer.md`'de işlendi.
...
**حَمِيد — kök ح-م-د.** `057-hadid.md` 57/24'te işlendi: *hamîd*, "övülen" (*mahmûd*) anlamında bir mübalağa kalıbıdır. **Ve orada kaydedilen şuydu: *ğanî* tek başına söylenseydi bir mesafe kurardı; *hamîd* bunu dengeliyor — ihtiyaçsız olan aynı zamanda övgüye lâyıktır, yani ilişki devam ediyor.**
...
**Ve `050-kaf.md`'de kaydedilen yöntemle aynı yöntem işliyor:** delil bir mucize değil, **her gün görülen** şeydir. `002-bakara.md` 2/163-164'te de aynı tespit yapılmıştı: *"Ayet, delil olarak mucize göstermiyor — alışılmış olanı gösteriyor."*
...
*Ve mâ esâbeküm min musîbetin fe-bimâ kesebet eydîküm ve ya'fû an kesîr*

"Başınıza gelen her musibet, kendi ellerinizin kazandığı yüzündendir. **Ve O çoğunu affeder.**"
...
**Kök `002-bakara.md` 2/155'te işlendi.** Oradaki kayıt şuydu:
...
**Bu kayıt burada da geçerlidir ve tekrarlamıyorum.**
...
**Üçünde de aynı yapı, ikisinde el kelimesi.** Bu, doğrulanabilir bir olgudur.

### وَيَعْفُوا۟ عَن كَثِيرٍ — ayetin ikinci yarısı ve öne çıkarılması gereken kayıt

**Ayetin çoğu zaman düşürülen yarısı burasıdır ve düşürüldüğünde ayetin anlamı değişir.**

**Cümle şudur: *ve ya'fû an kesîr* — "**ve çoğunu affeder**".**
...
### Bu ayetten çıkarılamayacak olan — ve bu açıkça yazılmalıdır
...
**Bu genelleme metinden desteklenmiyor, ve gerekçelerini sıralıyorum:**
...
**İkincisi: Kur'an aynı olguyu başka yerde imtihan olarak adlandırıyor. `002-bakara.md` 2/155'te işlendi:**
...
**Üçüncüsü: `002-bakara.md` 2/214'te sıkıntının kimlere isabet ettiği açıkça söyleniyor.** Orada kaydedilen şuydu:
...
**Dördüncüsü: hitabın kime olduğu.** Ayet *esâbe**küm*** der — ikinci çoğul. **Yani muhatap belirli bir topluluktur ve cümle onlara söylenmektedir.** Bir kişinin başka bir kişi hakkında hüküm kurması için kullanılabilecek bir yapı değildir.

### Teselli–sorumluluk dengesi

**Ayetin ne yaptığını kendi okumam olarak kaydediyorum ve dayanağı cümlenin iki yarısıdır:**
...
**Bir kayıt düşmek gerekiyor ve bu, ayetin kullanımına dairdir.**
...
**Ve *in yeşe'* kalıbı kaydedilmelidir:** *lev* değil *in*. **`056-vakia.md`'de *lev neşâü* gerçekleşmemiş şartı bildiriyordu; burada *in* kullanılmış** ve *in* mümkün olan şartı bildirir. **Yani rüzgârın durması, olmamış bir ihtimal değil; olabilecek bir durum.**

### رَوَاكِد — kök ر-ك-د

***Râkid* — hareketsiz, durgun.** Kök **ر-ك-د**: durmak, sabit kalmak. Arapçada durgun su için *mâün râkid* denir.

**Kelime çoğuldur ve müennes çoğul kalıbında geliyor** (*fe-yazlel**ne***) — gemiler dişil sayılıyor, çünkü *cevâr* kelimesi müennestir.
...
| Kelime | Kalıp | Anlam |
|---|---|---|
| **صَبَّار** | *fa''âl* | **Çok sabreden** |
| **شَكُور** | *fa'ûl* | **Çok şükreden** |

***Sabr* kökü `050-kaf.md` ve `049-hucurat.md`'de işlendi:** kökün asıl anlamı **bir şeyi bir yerde tutmak, hapsetmek**; sabır, nefsi bir hâl üzerinde tutmaktır.
...
*Ev yûbikhünne bimâ kesebû ve ya'fu an kesîr*

"Yahut kazandıkları yüzünden onları helâk eder — ve çoğunu affeder."

### يُوبِقْ — kök و-ب-ق

***Vebeka* — helâk oldu; IV. bâbta *evbeka* — helâk etti.** Aynı kökten **مَوْبِق** (*mevbik*) — helâk yeri; Kur'an'da Kehf 18/52'de geçer.

**Fiil geminin batmasını anlatıyor** ve bir önceki ayetteki durmayla birlikte iki ihtimal kuruyor:

| Ayet | Ne oluyor | Şiddet |
|---|---|---|
| **33** | Gemiler **durur** | Hafif |
| **34** | Gemiler **helâk olur** | Ağır |

**Ve dizim hafiften ağıra gidiyor.** Bu, `002-bakara.md` 2/255'te *sine* ve *nevm* için kaydedilen *terakkî* yapısıdır.

### وَيَعْفُ عَن كَثِيرٍ — otuzuncu ayetin tekrarı
...
**Kelime `050-kaf.md`'de Kāf sûresinin fâsıla dizisinde geçmişti** (*hel min mahîs*, 50/36) ve orada tarihî toplulukların kaçış aradığı bağlamda kullanılıyordu.
...
**Bunu kendi okumam olarak kaydediyorum; dayanağı vasıfların kendi konularıdır.**
...
**Ve ayet bunu kelimenin kendisiyle söylüyor, sonra karşısına *ebkā* koyuyor.**

### خَيْرٌ وَأَبْقَىٰ — iki üstünlük kalıbı

**İki kelime de *ef'al* (üstünlük) kalıbındadır:**

| Kelime | Kök | Ne bildiriyor |
|---|---|---|
| **خَيْر** | خ-ي-ر | **Daha hayırlı** — nitelik |
| **أَبْقَىٰ** | ب-ق-ي | **Daha kalıcı** — süre |
...
**Aynı ikili Kur'an'da birkaç yerde daha geçer** ve `087-ala.md`'de A'lâ 87/17 (*ve'l-âhiratü **hayrun ve ebkā***) bağlamında işlendi.

### يَتَوَكَّلُون — kök و-ك-ل

**Kök altıncı ayette *vekîl* olarak geçmişti ve `067-mulk.md`'ye dayandırılmıştı.** Oradaki kayıt tekrarlanmaya değer, çünkü listenin ikinci vasfı budur:
...
**Bu ikili `053-necm.md` 53/32'de işlendi** (*ellezîne yectenibûne kebâira'l-ismi ve'l-fevâhışe ille'l-lemem*) **ve orada tablolandı:**
...
**غَضَب — kök غ-ض-ب.** `048-fetih.md`'de kaydedildiği gibi kökte **kabarma, şiddetlenme** vardır.
...
**Bal, kovanın içindedir; görünmez, kapalıdır, ve çıkarılması hem emek hem dikkat ister.** *Şâre* fiili, o balı **oradan alıp ortaya koymak**tır.
...
**İkincisi: süreklilik.** Arapçada isim cümlesi sabitlik ve süreklilik bildirir; fiil cümlesi ise oluş ve yenilenme. **`112-ihlas.md`'de bu ayrım kaydedilmişti:** *"isim cümlesi sabitlik ve süreklilik bildirir… bir olay değil, bir hâl."*

**Yani danışma, olağanüstü durumlarda başvurulan bir usul olarak değil, topluluğun *sürekli hâli* olarak tarif ediliyor.**

**Üçüncüsü: işin sahibi topluluktur.** *Emru**hum*** — "**onların** işi". Ve *beyne**hum*** — "**aralarında**". **İki zamir de topluluğu gösteriyor.**
...
- **Âl-i İmrân 3/159'da** bir **emir**dir ve muhatabı tek kişidir: *şâvirhum* — "onlara danış". **Yani karar yetkisi kendisinde olan birine, danışması emrediliyor.**
...
***min* iki kez:** *mimmâ* = *min mâ*. **`057-hadid.md` 57/7'de bu kalıp işlendi:** *min*, kısmîlik bildirir — "ondan bir kısmını". **Tamamı değil.**

**Ve *razaknâhum* — "bizim verdiğimiz".** İnfak edilen şeyin kaynağı, harcayan kişi değil. **`057-hadid.md`'de bu, *müstahlefîn* kelimesi üzerinden ayrıntılı işlendi ve tekrarlamıyorum.**
...
| **(46)** | *evliyâe **yensurûne**hum* | Yardımcısızlık — olumsuz |
...
### سَيِّئَةٌ مِّثْلُهَا — karşılığın da "kötülük" diye adlandırılması
...
**Dayanağım, iki cümlenin adlandırma farkıdır:**
...
### مِّثْلُهَا — ölçü kaydı

***Misl* — denk, eşit.** Kök **م-ث-ل**; `047-muhammed.md`'de işlendi.

**Ve bu kelime, cümlenin en önemli sınırlayıcısıdır:** karşılık **denk** olmalıdır. Fazlası zulümdür.

**Ve ayet bunu sonda açıkça söylüyor: *innehû lâ yuhıbbu'z-zâlimîn*.** Yani izin verilen şeyin yanına bir sınır konmuş.

**`002-bakara.md` 2/223'te kaydedilen desen burada da işliyor:** *"Sûrede tekrarlanan biçim: ruhsatın yanına sorumluluk kaydı."*

**Ve *misl* kelimesi sûrede ikinci kez geçiyor** — on birinci ayette *leyse ke-**misli**hî şey'* ifadesindeydi. **Aynı kök, iki ayrı işte: biri benzerliği reddediyor, öteki denkliği şart koşuyor.** Bu, doğrulanabilir bir olgudur; bilinçli bir tercih iddiası kurmuyorum.

### فَمَنْ عَفَا وَأَصْلَحَ — iki şart, tek karşılık

**Ve burada kaydedilmesi gereken bir ayrıntı var: af tek başına yeterli görülmüyor. Yanına ikinci bir fiil ekleniyor.**

| Fiil | Kök | Ne |
|---|---|---|
| **عَفَا** | ع-ف-و | **Silmek** — hakkından vazgeçmek |
| **أَصْلَحَ** | ص-ل-ح | **Düzeltmek** — bozulanı onarmak |

***Islâh* — kök ص-ل-ح.** `049-hucurat.md` 49/9-10'da işlendi: bozulmuş olanı **kullanılır hâle getirmek.** *Sâlih* — işe yarar, bozulmamış.
...
### فَأَجْرُهُۥ عَلَى ٱللَّهِ — ölçüsüz bırakılan karşılık
...
**`057-hadid.md` 57/11'de *karz-ı hasen* (Allah'a güzel borç verme) bahsinde aynı yapı işlenmişti:** insanın verdiği şey bir borç olarak adlandırılıyor ve karşılığı katlanarak vaat ediliyordu. **Burada aynı yapı, mal yerine hak üzerinde kuruluyor.**
...
| **42** | *innem**e's-sebîl**ü alâ'llezîne yazlimûn* | **Zalim** — aleyhine yol var |
...
| Ayet | Kime yol yok / var |
|---|---|
| **41** | Hakkını alana — **yok** |
| **42** | Zulmedene ve haddi aşana — **var, ve yalnız ona** |

### يَظْلِمُونَ ٱلنَّاسَ — nesnesi "insanlar"
...
***Bağy* kökünün sûredeki dördüncü ve son geçişi.** On dördüncü ayette tablolanan dizinin sonu:
...
|---|---|---|
| **41** | *ve **le-men**i'ntesara ba'de zulmihî* | **Hakkını alan** |
...
***Azm* — kök ع-ز-م.** `046-ahkaf.md` 46/35'te *ulü'l-azm* bağlamında geçti. **Kökün anlamı: bir işe kesin karar vermek, niyeti sağlamlaştırmak.** Dilciler kökte **kesinlik ve sağlamlık** bulunduğunu kaydeder.
...
**Ve dikkat edilmesi gereken şudur: sûre bir tercih dayatmıyor.** İki yol da açık bırakılıyor. Söylenen şey, **iki yolun da meşru olduğu ve birinin karşılığının başka bir yerden geleceği**dir.
...
**Bu kalıp kelâm tarihinde tartışılmıştır ve `069-hakka.md`, `089-fecr.md` ile `054-kamer.md`'de bu tefsirin tavrı kaydedildi: kelâmî taraf tutulmuyor ve kader meselesi bir ayetin altında çözülmeye çalışılmıyor.**
...
***Tarf* — kök ط-ر-ف.** `055-rahman.md`'de işlendi. **Kökün somut anlamı: bir şeyin ucu, kenarı.** *Tarf* özel olarak **göz kapağının kenarı**, ve buradan **göz, bakış** anlamına gelir.
...
**Bu, korku ile merakın aynı anda bulunduğu bir hâlin tarifidir.** Ve `081-tekvir.md`'de kaydedilen ölçüyle uyumludur: Kur'an, bir hâli anlatırken çoğu zaman o hâlin **bedendeki karşılığını** verir.
...
***Züll* — kök ذ-ل-ل:** `067-mulk.md` ve `002-bakara.md`'de işlendi: **bir şeyin boyun eğmiş, ram olmuş hâli.** Ve kökün olumlu dalı da vardır (*zelûl* — uysal, kullanılabilir hayvan). **Buradaki kullanım olumsuz daldır: aşağılanma.**

### إِنَّ ٱلْخَٰسِرِينَ ٱلَّذِينَ خَسِرُوٓا۟ أَنفُسَهُمْ وَأَهْلِيهِمْ

**خُسْر — kök خ-س-ر:** `103-asr.md`'de işlendi. **Kökün somut anlamı ticarîdir: sermayenin eksilmesi, zarar.**
...
| Ayet | Biçim |
|---|---|
| **8, 31** | *Veliyy* + *nasîr* — **iki isim** |
| **46** | *Evliyâ* + *yensurûne* — **isim + fiil** |
...
***Belâğ* — kök ب-ل-غ: bir şeye ulaşmak, erişmek.** `046-ahkaf.md`'de işlendi. ***Belâğ*, "ulaştırma"dır** — sözün muhataba varması.

**Ve kelimenin sınırı kendi içindedir ve kendi okumam olarak kaydediyorum:** *belâğ* **ulaştırmak**tır, **kabul ettirmek** değil. Bir mektubun ulaştırılması, okunmasını garanti etmez.
...
***Ezâka* — kök ذ-و-ق: tatmak.** Kök `054-kamer.md` ve `051-zariyat.md`'de geçti. Ve fiilin seçimi kaydedilmeye değer: **tatmak, azıcık almaktır.** Kur'an bu fiili hem nimet hem azap için kullanır ve ikisinde de **bir kısmının verildiğini** bildirir.

***Kefûr* — kök ك-ف-ر, *fa'ûl* mübalağa kalıbı: çok nankör.** **Kökün asıl anlamı örtmektir** (*kâfir* — tohumu örten çiftçi, geceyi örten karanlık) ve `109-kafirun.md` ile `076-insan.md`'de işlendi. **Nankörlük, görülen iyiliğin üstünü örtmektir.**

**Ve kalıp, yirmi üçüncü ve otuz üçüncü ayetlerdeki *şekûr* ile aynı vezindedir (*fa'ûl*).**

| Ayet | Kelime | Kim | Ne |
|---|---|---|---|
| **23** | *şekûr* | Allah | **Karşılık veren** |
| **33** | *şekûr* | Mümin | **Çok şükreden** |
| **48** | *kefûr* | İnsan | **Çok nankör** |

**Üç kelime, aynı kalıp, sûrenin üç ayrı yerinde.** Bu, metinden doğrulanabilir bir olgudur ve *şükr* ile *küfr*ün karşıtlığını kalıp düzeyinde görünür kılıyor.
...
**`081-tekvir.md` 81/8-9'da (*el-mev'ûde*) bu konu ayrıntılı işlendi ve orada tablolanan şuydu:**

> | Ayet | Ne diyor | Saik |
> |---|---|---|
> | *Nahl 16/58-59* | Kız müjdesi alan babanın yüzü kararır, saklanır, gömmeyi düşünür | **Utanç, âr** |
> | *İsrâ 17/31* | *"Yoksulluk korkusuyla çocuklarınızı öldürmeyin"* | **Yoksulluk korkusu** |
...
**Ayrıca `081-tekvir.md`'de yaygınlık konusunda iki abartıdan da kaçınıldığı kaydedilmişti** — "herkes yapıyordu" ve "hiç olmadı" abartılarının ikisi de reddedilmişti. **Bu kaydı tekrarlamıyorum; oraya dayanıyorum.**
...
| Kelime | Durumu |
|---|---|
| *inâsen* | **Nekre** (belirsiz) |
| *ez-zükûr* | **Belirli** (harf-i tarifli) |
...
**Kesin bilgi yoktur ve tercih dayatmıyorum.** Kaydedilecek olan, farkın **var olduğu**dur.
...
***Akīm* — kök ع-ق-م.** **Kök `051-zariyat.md` 51/29'da işlendi** (*acûzün akīm*). Oradaki kayıt: **kökün merkezinde kuruluk, verimsizlik, bir şeyin kesilmiş olması vardır.**
...
**Bu, `053-necm.md`'de kaydedilen tespitle uyumludur:** kökün somut anlamı **hızlı ve gizli bildirim**dir ve kullanım alanı geniştir. **Ayet bu genişliği kendi içinde gösteriyor.**
...
**Kök `056-vakia.md` 56/89'da (*ravh ve rayhân*) ayrıntılı işlendi. Oradaki tablo şuydu:**
...
> *"Melekleri, **emrinden bir ruh ile**, kullarından dilediğine indirir."* (Nahl 16/2)
>
> *"Kullarından dilediğine, **emrinden ruhu** ilkā eder."* (Mü'min 40/15)
...
|---|---|---|
| 1 | **Vahyin / Kur'an'ın kendisi** | Cümlenin devamı: *mâ künte tedrî **me'l-kitâb**…* ve *cealnâ**hu** nûrâ* — zamir vahyedilene dönüyor |
...
**Kendi okumam olarak kaydediyorum ve dayanağı kökün `056-vakia.md`'de çıkarılan anlamıdır:**
...
**Bu cümle üzerinde dikkatli durmak gerekiyor ve `046-ahkaf.md` 46/9 ile karşılaştırmak, doğru çerçeveyi veriyor.**
...
**Ve bu karşılaştırma bir hat gösteriyor. `046-ahkaf.md`'de o ayet için kaydedilen şuydu:**
...
**Şûrâ 42/52 aynı şeyi söylüyor ama zaman kipini değiştirerek.** Ahkāf'ta sınır **hâlâ durmakta**dır; Şûrâ'da sınırın **aşıldığı an** anlatılıyor — ve aşan, kendisi değil.
...
**Önce lafzın ne dediğini kaydediyorum: cümle *"sen mümin değildin"* demiyor. *"Bilmezdin"* diyor** — fiil *derâ*dır, *âmene* değil.
...
**Ve `093-duha.md` 93/7'deki (*ve vecedeke dâllen fe-hedâ*) bahis, aynı çerçevede işlenmişti; oraya dayanıyorum ve tekrarlamıyorum.**
...
| Cümle | Ne diyor |
|---|---|
| *Mâ künte tedrî* | **Bilmezdin** |
| *Ve inneke le-tehdî* | **Ve sen yol gösteriyorsun** |
...
***Sırât* kelimesi `001-fatiha.md`'de ayrıntılı işlendi** (*ihdine's-sırâta'l-müstakîm*) **ve `047-muhammed.md`'de de geçti; tekrarlamıyorum.** Özeti: *sırât* geniş, açık, herkesin geçtiği ana yoldur; kelimenin aslı **yutmak** (*serata*) ile ilişkilendirilir — yolcuyu içine alan yol.
...
**Birincisi: ص-ي-ر kökü.** On beşinci ayette *ve ileyhi'l-**masîr*** geçmişti; burada aynı kök fiil olarak geliyor: *te**sîru**'l-umûr*.
...
**Şûrâ, bir ayrılık sûresidir ve ayrılığı üç ayrı düzeyde ele alır:**

| Düzey | Nerede | Ne söylüyor |
|---|---|---|
| **İnanç** | 13-16 | Ayrılık bilgiden **sonra** çıkar; sebep *bağy*dir |
...
**Bunların hepsi metinden sayılabilir olgulardır; yorum değildir.**
...
### Kur'an'ın Kur'an'la tefsiri — bu bölümde kurulan başlıca bağlar

| Şûrâ ayeti | Bağlandığı yer | Ne için |
|---|---|---|
| **42/1-2** | `002-bakara.md` 2/1, `050-kaf.md` 50/1 | Mukattaa genel kaydı; buradaki tek fark: **dizinin ikiye bölünmesi** |
| **42/7** | `062-cuma.md`, `002-bakara.md` 2/78 | أ-م-م kökü; ve En'âm 6/92 ile *ümmü'l-kurâ* terkibinin ikinci geçişi |
| **42/11** | `002-bakara.md` 2/255, `112-ihlas.md` | Tenzih kayıtları; üzerine **dizim nüktesi** eklendi |
| **42/13** | `002-bakara.md` 2/213; Ahzâb 33/7; Mâide 5/48 | Ortak esas; beş peygamber listesinin sırası |
| **42/14** | `002-bakara.md` 2/213, `049-hucurat.md` 49/9 | Birebir karşılaştırma; ب-غ-ي kökü |
| **42/15** | `002-bakara.md` 2/139 | *Rabbunâ ve rabbuküm* / *lenâ a'mâlünâ* örtüşmesi |
| **42/17** | `057-hadid.md` 57/25 | Kitap + mîzân ikilisinin iki geçişi |
| **42/20** | `056-vakia.md` 56/63, `002-bakara.md` 2/205, 2/223, 2/200-202 | ح-ر-ث kökü; iki dua tablosuyla karşılaştırma |
| **42/23** | `085-buruc.md`; Sebe' 34/47, Furkān 25/57 | و-د-د kökü; ücret reddi kalıbı |
| **42/27** | `071-nuh.md`, `097-kadr.md`, `054-kamer.md`, `062-cuma.md` | ب-س-ط ve ق-د-ر kökleri; ve rızık arama emri |
| **42/30** | `002-bakara.md` 2/155, 2/214, `074-muddessir.md` | Musibet–imtihan ayrımı; ك-س-ب kökü |
| **42/33** | `056-vakia.md` 56/65 | Delilin "olağanın garanti sanılması"na karşı kurulması |
| **42/37** | `053-necm.md` 53/32 | *Kebâiru'l-ism* ve *fevâhiş* ikilisi |
...
| **42/49-50** | `081-tekvir.md` 81/8-9, `051-zariyat.md` 51/29 | *Mev'ûde* bahsi; ع-ق-م kökü |
| **42/51** | `053-necm.md`, `083-mutaffifin.md` | و-ح-ي ve ح-ج-ب kökleri |
| **42/52** | `056-vakia.md` 56/89, `046-ahkaf.md` 46/9, `093-duha.md` | ر-و-ح kökü; **bilgi sınırı hattı** |
