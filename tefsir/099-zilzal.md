...
Sûre ilk kelimesiyle bir iddia kurmuyor; bir tarih koyuyor ve tarihin içeriğini boş bırakıyor.

### زُلْزِلَتْ — kökün sesi
...
- **صَلْصَلَ** — çınlamak, kuru çamurun tıngırdaması (*salsâl*, Rahmân 55/14)
- **قَلْقَلَ** — kımıldatıp yerinden oynatmak
- **زَعْزَعَ** — sarsıp savurmak
- **دَمْدَمَ** — üstüne çökmek, gümbürdemek (Şems 91/14)
- **كَبْكَبَ** — tepetakla yuvarlamak (Şuarâ 26/94)
- **وَسْوَسَ** — tekrar tekrar fısıldamak
...
### Fiilin meçhul gelmesi

**زُلْزِلَتْ** edilgendir: "sarsıldı", "sarsılmıştır". Sarsanın kim olduğu söylenmiyor.
...
### زِلْزَالَهَا — "kendi sarsıntısı"

Cümlenin can alıcı yeri burası.
...
Bu izafet ne yapıyor? Müfessirlerin üzerinde durduğu izahlar şunlardır:
...
Aynı kök Kur'an'da hem âhiret hem dünya bağlamında geçer:
...
Bu dağılım şunu gösteriyor: kök, **bir şeyin oturduğu zeminden koparılması**nı anlatıyor. Zemin fizikî de olabilir, zihnî de.
...
Yani "çıkarma" fiili sadece bir tasvir değil, bir **delil hatırlatması**dır. Diriltme, yerin zaten her mevsim yaptığı işin bir kez daha yapılmasıdır.
...
"O gün yer haberlerini anlatır — çünkü Rabbin ona vahyetmiştir."
...
### يَوْمَئِذٍ — şartın cevabı meselesi

Sûre üç *"…dığında"* ile açıldı (sarsıldığında, çıkardığında, dediğinde). Bunların cevabı nerede?

Müfessirler ve nahivciler ikiye ayrılır:
...
**Kök: ح-د-ث.** Kökün asıl anlamı **yeni olmak, olmak, meydana gelmek**tir. *Hâdis* — sonradan olan, yeni. *Hudûs* — meydana geliş. Kelam geleneğinde *kadîm* (başlangıcı olmayan) ile *hâdis* (sonradan olan) ayrımı bu kökten kurulur; İhlâs sûresi bölümünde bu ayrıma değinilmişti.
...
Ve şu bağlantı kayda değer: **bir sonraki sûre, yani Âdiyât, tam olarak bu kelimeyle biter.** *"O gün Rableri onlardan elbette haberdardır (habîr)"* (Âdiyât 100/11). Zilzâl'de yer *ahbâr* verir; Âdiyât'ta Rab *habîr*dir. Mushaf düzeninde art arda gelen iki sûre, aynı kökün iki ucunu tutuyor: haberi veren ve haberi zaten bilen.
...
### أَوْحَىٰ — yere vahyedilmesi

Ayetin en çok soru doğuran kelimesi. Vahiy peygamberlere gelen bir şey değil miydi?
...
Kur'an bu kökü peygamberler dışında da kullanır ve kullanımların dağılımı meseleyi çözer:
...
Bu dağılım şunu gösteriyor: Kur'an'da *vahy*, **her varlığa kendi diliyle verilen emir**dir. Peygambere gelen vahiy bu genel kategorinin en yüksek ve en özel biçimidir; ama kategorinin tamamı değildir.
...
### لَهَا — "ona" değil, "onun için"

Küçük bir harf, ama üzerinde durulmuş.
...
Bu ayette ise **لَ** (lâm) kullanılmış: *evhâ **lehâ**.*

Nahivcilerin verdiği izahlar:
...
Bunu bir ses gözlemi olarak kaydediyorum; bir hüküm olarak değil.

### رَبَّكَ — hitabın yön değiştirmesi
...
### Yerin şahitliği — meselenin kendisi

Şimdi asıl konuya gelebiliriz: **zemin neden şahittir?**
...
Zilzâl bu listeye zemini ekliyor — ve zemin, listedeki en kapsayıcı üyedir. Çünkü:
...
*Yevmeizin yasdurun-nâsü eştâten li-yürav a'mâlehüm*
...
**Kök: ش-ت-ت.** Dağılmak, ayrı düşmek, birbirinden kopmak. *Şettet* — dağıldı. *Tefarruk* ile yakın ama farklı: *şett*te ayrılığın yanında bir de **birbirine benzememe** vardır.

Türevleri:

- **شَتَّى** (*şettâ*) — çeşitli, birbirinden farklı, ayrı ayrı.
- **شَتِيت** — dağınık, seyrek.
- **أَشْتَات** — *şett*in ya da *şetît*in çoğulu: dağınık gruplar, birbirinden ayrı topluluklar.

**Leyl 92/4 ile bağ.** Aynı kök Kur'an'da çok dikkat çekici bir yerde geçer:

*"Şüphesiz sizin çabalarınız **şettâ**dır — birbirinden ayrıdır."* (Leyl 92/4)
...
**Bir karşıtlık daha.** Bir sonraki sûrede atlar *"bir topluluğun (**جَمْع**) ortasına dalarlar"* (Âdiyât 100/5). *Cem'* — toplanma, bir araya gelme; *eştât*ın tam zıddı. Zilzâl dağılmayla, Âdiyât toplanmaya dalmayla çalışıyor.
...
Bu, Tekâsür sûresi bölümünde işlenen ayrımın aynısıdır: bilgi tercihe bağlıdır, görme değildir. Orada sûre *bilmek*ten *görmek*e geçiyordu; burada görme baştan **edilgen** kuruluyor.
...
*Fe-men ya'mel miskâle zerretin hayran yerah · Ve men ya'mel miskâle zerretin şerran yerah*
"Kim zerre ağırlığınca bir iyilik yaparsa onu görür; kim zerre ağırlığınca bir kötülük yaparsa onu görür."
...
Önce yapıya bakalım. İki ayet arasında **tek bir kelime** farklıdır:
...
Beş öğeden dördü aynı; biri farklı. Ve farklı olan tam ortada duruyor.
...
### مِثْقَال — ağırlık ölçüsü

**Kök: ث-ق-ل** — sûrenin ikinci ayetindeki *eskâl* ile aynı kök.
...
Sûrenin dizisi şudur:

- **2. ayet:** yer **أَثْقَال**ını çıkarır — taşıyabildiği en ağır yükler.
...
Sûrenin en çok tartışılan kelimesi ve modern dönemde en çok yanlış kullanılan kelimesi.
...
**Kelimenin klasik dildeki karşılığı üzerine nakledilen izahlar:**
...
Nitekim Kur'an aynı işi başka kelimeyle de yapar: *"Hardal tanesi ağırlığınca bile olsa, bir kayanın içinde ya da göklerde ya da yerin dibinde olsa, Allah onu getirir"* (Lokman 31/16). Orada birim hardal tanesidir. Kur'an'ın derdi belirli bir parçacık değil, **en küçüğün kayıt dışı kalmaması**dır.

### خَيْرًا / شَرًّا — gramerdeki yeri

İki kelime de mansûbdur ve nahivciler i'râbında ayrılır:

- **Temyîz** — *miskâle zerre*deki belirsizliği gideren ayırtman: "zerre ağırlığınca — iyilik cinsinden".
- **Bedel** ya da **atf-ı beyân** — *miskâl*i açıklayan öğe.
- **Hâl** — durum bildirir.
- Mahzuf bir fiilin **mef'ûlü**: *ya'mel amelen hayran.*

Anlamda pratik bir fark doğmuyor. Kaydedilmeye değer olan şey şudur: iyilik ve kötülük burada **tartılan madde** konumundadır. Kefeye konan şey niyet ya da kişilik değil, **amelin kendisi**dir.

### يَرَهُۥ — "görür"

Sûrenin kilit kelimesi ve en kolay atlanan yeri.

Ayet şunları söyleyebilirdi ve söylemiyor:

- *yücza bihî* — onun karşılığını görür / cezalandırılır
- *yüsel anhu* — ondan sorulur
- *yeciduhu* — onu bulur
...
Ayet iki ayrı fiil kullanmayarak — ikisi için de *"görür"* diyerek — bu simetriyi koruyor.
...
### Ölçünün mutlaklığı — iki kapının kapanması
...
### Şartın kimseyi dışarıda bırakmaması

Dikkat edilecek bir nokta daha var ve önemlidir:
...
- *"Kıyamet günü için adalet terazilerini kurarız; hiç kimseye zerre kadar haksızlık edilmez. Bir hardal tanesi ağırlığınca bile olsa onu getiririz."* (Enbiyâ 21/47). **Bu ayet iki sûreyi birleştiriyor:** hem Zilzâl'in *zerre*sini hem Kâria'nın *mevâzîn*ini içeriyor.
...
Altıncı ayette fasıla **-hüm**e dönüyor: konu insanlara geçiyor ve ses onlarla birlikte değişiyor. Son iki ayet ise **yerah** ile, iki kez, aynı kelimeyle kapanıyor.
...
### Sûrenin söylemedikleri

Zilzâl'de bulunmayan şeyler dikkat çekicidir:
...
**Birincisi: zeminin sabitliği, insanın son varsayımıdır.**
...
Sûrenin ilk ayeti tam olarak bu varsayımı hedef alıyor. Deprem, insanın hesaba katmadığı tek şeyin hesaba katılmasıdır. Ve bunu deneyimlemiş olan herkes şunu bilir: bir depremin insanda bıraktığı asıl etki maddî hasar değil, **zemin duygusunun kaybı**dır.
...
**İkincisi: küçük fiillerin muhasebe dışı bırakılması.**
...
**Üçüncüsü: iyiliğin ölçeğe göre değersizleştirilmesi.**
...
Ayetin cevabı, gözlemi düzeltmek değil, **ölçüyü değiştirmek**tir. Fiilin değeri, sorunu çözüp çözmediğine göre değil, yapılıp yapılmadığına göre belirleniyor. Bu, bir teselli cümlesi değil; bir muhasebe kuralı.
...
**Beşincisi: görmek — hesabın en sert kısmı.**

Sûre ceza tasviri yapmıyor; **görme** diyor. Ve bunu ikisi için de aynı kelimeyle söylüyor.
