...
Bu, bir metnin yapabileceği en yalın şeydir: tehlikeyi saymak ve sığınağı göstermek.

### Muavvizeteyn — iki sûrenin birlikte anılması
...
**Felak dışarıdan gelen şerlere, Nâs içeriden gelen şerre karşı sığınmadır.**
...
"De ki: Sığınırım felakın (yarılıp aydınlığın çıktığı sabahın / yarılan her şeyin) Rabbine."
...
Sûrenin fiili ve iki sûrenin ortak omurgası.

**Kök: ع-و-ذ.** Kökün asıl anlamı **bir şeye tutunmak, yapışmak, onun arkasına geçip korunmak**tır. *Âze bihî* — ona sığındı, ona yapıştı, onunla korundu. Sığınmakta iki hareket birden vardır: tehlikeden uzaklaşmak ve bir şeye yaklaşmak. Türkçedeki "sığınmak" kelimesi de bu ikiliği taşır: sığınan, bir şeyin arkasına, altına, içine geçer.
...
Yani isim seçimi bağlama göre değişir ve daima anlamlıdır.

### ٱلْفَلَق — felak

Sûrenin en çok tartışılan kelimesi ve adı.

**Kök: ف-ل-ق.** Somut anlamı **yarmak, çatlatmak, ikiye ayırmak**tır. Ama Arapçadaki *falq* herhangi bir kesme değildir; kapalı bir şeyin **içeriden ya da bir kuvvetle açılması**, bütünün ayrılıp arasından bir şeyin çıkmasıdır. *Fılka*, yarılmış parçanın adıdır — bir kayanın, bir çekirdeğin, bir tahtanın yarısı.

Kökün türevleri ve Kur'an'daki kullanımları meselenin kalbini gösteriyor:

**فَالِق — yaran.** Kur'an bu ism-i fâili art arda iki ayette, Allah için kullanır:
...
Bununla birlikte anlam alanları çarpıcı biçimde örtüşür:
...
Bunu sûrenin sonunda tekrar göreceğiz.
...
*Şerr*, en genel anlamda **istenmeyen, zarar veren, kaçınılan** demektir. Karşıtı *hayr*dır. Bu iki kelime Arapçada bir çift oluşturur ve Kur'an onları sık sık yan yana kullanır: *"Kim zerre ağırlığınca hayır işlerse onu görür; kim zerre ağırlığınca şer işlerse onu görür"* (Zilzâl 99/7-8).
...
Ben birinci okumayı esas alıyorum; ikincisini sadece kaydediyorum.
...
### Şerrin yaratılmış olması meselesi
...
**Birincisi: ayet "yarattığı şerden" demiyor.** Terkip *min şerri mâ halaka*dır: "yarattığı **şeyin şerrinden**". Şer, doğrudan yaratma fiilinin nesnesi olarak değil, yaratılmış olanın bir **hali/eseri** olarak anılıyor. Bu ince bir fark gibi görünebilir ama Arapçada bilinçli bir tercih olarak okunmuştur.
...
### Genelden özele: neden önce genel şer?
...
Ve üç örneğin seçimi rastgele değildir. Bunu beşinci ayetten sonra topluca ele alacağız.
...
"Ve çöktüğünde karanlığın şerrinden."
...
**Kök: ع-ق-د.** Somut anlamı **düğüm atmak, bağlamak, iki ucu birbirine bağlamak**tır. *Ukde* — düğüm; çoğulu *ukad*.
...
Bu tanımın iki parçası var ve ikisi de gerekli:
1. Başkasında bir nimet vardır.
2. Haset eden, o nimetin **ondan alınmasını** ister.
...
## Üç şerrin sıralaması

Sûrenin en dikkat çekici tarafı, üç örneğin **sırası**dır. Bu sıra rastgele değildir ve birkaç eksende birden ilerler.
...
Sûrenin beş ayetinin son harflerine bakalım: **ق ق ب د د** (*felaq — halaq — vekab — ukad — hased*).
...
**Bu rivayetin durumu hakkında dürüst olmak gerekir; ve mesele iki ayrı parçaya ayrılmalıdır.**
...
### Rivayetin etrafındaki tartışma

Birinci parça, yani sihir haberinin kendisi de tartışmasız kabul edilmiş değildir. İtiraz şu noktadan gelir:

**Kur'an, "büyülenmiş adam" ifadesini müşriklerin bir iftirası olarak kaydeder.** İki yerde geçer:
...
**Benim kaydettiğim sonuç şudur ve bağlayıcı değildir:**

1. Sihir haberinin kendisi güçlü kaynaklarda yer alır; kolayca reddedilemez.
2. Sûrelerin bu olay üzerine indiği iddiası ise zayıftır; "sûre bunun üzerine indi" demeye yetmez.
3. Tartışma, hadis usulünün değil, kelamın alanına taşındığında çözülmemiştir ve bugün de sürmektedir.
4. Ve en önemlisi: **sûrenin anlaşılması bu rivayete bağlı değildir.** Metin, hiçbir nüzul sebebi bilinmese de tamamen anlaşılır durumdadır.

### İbn Mes'ûd'un mushafı meselesi
...
Bu nakil hakkında söylenenler şöyle özetlenebilir:
...
İkinci tavır, kötülüğün karşısında donup kalmaktır: dünya tehlikelerle dolu, yapacak bir şey yok.
...
**Üçüncüsü: "neffâsât"ın bugünkü karşılığı — ve iki yanlış.**
...
Bu bir tefsir değil, bir uygulamadır; ayetin lafzının bunu kastettiğini iddia etmiyorum.
...
**Dördüncüsü: haset ve karşılaştırma.**
...
- *Ğâsık*ın "ay tutulduğunda" anlamına geldiğini bildiren rivayet aktarıldı, ama kaynağı kesin olarak adlandırılmadı ve rivayetin senedi hakkında hüküm verilmedi.
...
- *en-Neffâsât*ın dişil çoğul gelmesi hakkındaki izahların hepsi klasik kaynaklarda geçer; hangisinin doğru olduğu konusunda tercih belirtilmedi.
