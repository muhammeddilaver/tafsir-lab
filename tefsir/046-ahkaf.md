...
|---|---|---|---|
| **I** | 1-14 | Delil isteme, itirazlar, doğru duruş | *Cezâen bimâ kânû ya'melûn* (14) |
| **II** | 15-20 | İki insan portresi: şükreden ve reddeden | *Bimâ küntüm tefsükūn* (20) |
| **III** | 21-28 | Âd kıssası — bulutu sevinerek karşılayanlar | *Ve zâlike ifkühüm ve mâ kânû yefterûn* (28) |
| **IV** | 29-35 | Cinlerin dinlemesi ve kapanış | *Fe-hel yühlekü ille'l-kavmü'l-fâsikūn* (35) |
...
**Cümle "biz kitabı indirdik" diye kurulmuyor.** Mübteda **mastar**dır: *tenzîl* — "indirilme". Yani fiil değil, **işin kendisi** öne alınmış.
...
**ٱلْعَزِيز** — kök **ع-ز-ز**: sağlam, ulaşılmaz, üstün olmak. Kelimenin somut anlam çekirdeği dilcilerce **"sert ve geçilmez toprak"** üzerinden açıklanır. **ٱلْحَكِيم** — kök **ح-ك-م**: engelleyip yerinde tutmak; kökün *hakeme* (gem) ile ilişkisi `002-bakara.md` 2/269 bölümünde işlendi.
...
***Müsemmâ* — ism-i mef'ûl: "adlandırılmış".** Süre yalnız belirli değil, **adı konmuş**tur — kimin bildiği söylenmiyor. Aynı kalıp Vâkıa 56/50'de *yevmin ma'lûm* (bilinen gün) için kullanılmıştı ve orada işlendi: **belirsiz değil, ama insana kapalı.**
...
1. **Gösterin** — *erûnî mâzâ halakū* (gözle görülür bir eser)
2. **Ortaklık iddiası** — *em lehüm şirkün fi's-semâvât*
3. **Yazılı ya da nakledilmiş dayanak** — *i'tûnî bi-kitâbin … ev esârein min ilm*
...
**أ-ث-ر** kökü: **iz, geride kalan işaret.** *Eser* — ayak izi, kalıntı, nakledilen haber. Kök dizinde birkaç yerde geçti (`087-ala.md`, `079-naziat.md`, `059-hasr.md`).
...
| Kim | Kelime | Neye |
|---|---|---|
| Metin | *beyyinât* | Âyetler için |
| Karşı taraf | *mübîn* | "Büyü" için |
...
**Aynı tavır Kamer 54/2'de de kaydedilmişti** (*ve in yerav âyeten yu'ridû ve yekūlû sihrun müstemirr*); `054-kamer.md`'de işlendi.
...
**Kökün anlamı: daha önce örneği olmayan bir şeyi ilk kez ortaya koymak.** *Bedî'*, *ibdâ'*, *bid'at* aynı kökten. Kök `057-hadid.md`'de geçti.
...
**Kendi okumam olarak kaydediyorum:** itiraz bir delil değil, bir **sıralama varsayımı**dır. Ve bu varsayım, dördüncü ayette istenen iki delil türünün (gözlem ve nakil) hiçbirine girmez.

**Bu tavrın dizinde başka örnekleri işlendi:** `080-abese.md`'de gelen âmâ ile ilgilenilmeyip ileri gelene yönelme, `104-humeze.md`'de mal biriktirmenin üstünlük sanılması. **Ortak nokta: değerin, taşıyanın konumundan okunması.**
...
**إِمَامًا** — kök **أ-م-م**: öne geçmek, kastedilen yön. *İmâm* — **önde giden, kendisine bakılarak yürünen.** Kelimenin yol ve yön anlamı bu kökten gelir.
...
**لِّسَانًا عَرَبِيًّا** — **ع-ر-ب kökünün "açıklık, meramı gizlememe" çekirdeği `056-vakia.md` 56/37'de (*urub*) çözümlendi; oraya dayanıyorum.** Dilin adı, kökündeki açıklık anlamıyla birlikte anılıyor.
...
Arapçada *sümme*, *fâ*dan farklı olarak **arada bir mesafe** bildirir. **Yani söz ile istikamet arasında bir zaman var: söylemek bir anda olur, doğru durmak sürer.**

**ٱسْتَقَٰمُوا۟** — X. bâb, kök **ق-و-م**: **dosdoğru durmak, eğrilmeden devam etmek.** Kökün *kayyûm* ile ilişkisi `002-bakara.md` 2/255 bölümünde işlendi: ayakta durmak ve ayakta tutmak.
...
**Kök dizinde `103-asr.md` ve `090-beled.md`'de geçti** (*tevâsav bi'l-hakk*, *tevâsav bi's-sabr*) — orada **karşılıklı** kalıptaydı (VI. bâb). **Burada ise II. bâb ve fâil Allah: *vassaynâ*.**
...
**ك-ر-ه** kökü: hoşlanmama, zorluk, ağırlık. Kök `002-bakara.md` 2/216'da (*ve hüve kürhün leküm*) ve 2/256'da (*lâ ikrâhe fi'd-dîn*) işlendi.
...
**أَوْزِعْنِىٓ** — kök **و-ز-ع**: dilcilerin verdiği anlam, **bir şeyi tutup yönlendirmek, dizginlemek, birine bir işi sevdirip ona yöneltmek**tir. Kelimenin "orduyu düzende tutmak" anlamıyla ilişkisi kaydedilir.
...
**Kelime bir *ism-i fiil*dir: bıkkınlık, tiksinti ve daralma bildiren bir ses.** Dilciler kökeni hakkında farklı açıklamalar verir; ortak nokta, kelimenin **anlam değil hâl** taşımasıdır.
...
**عَارِض** — kök **ع-ر-ض**: enine gelmek, ufukta boydan boya uzanmak. Kelime, **ufku kaplayan bulut** için kullanılır. Kök `002-bakara.md`, `057-hadid.md` ve `054-kamer.md`'de geçti.

**Sahnenin kuruluşu dikkat çekicidir ve üç adımda ilerliyor:**

| Adım | Ne oluyor |
|---|---|
| 1 | **Görüyorlar** — ufukta bir bulut |
| 2 | **Yorumluyorlar** — "bize yağmur getirecek" |
| 3 | **Düzeltiliyor** — *bel hüve me'sta'celtüm bih* — "hayır, acele istediğiniz şey" |
...
|---|---|---|
| 1 | *Sem'* — kulak | **Duymak** |
| 2 | *Ebsâr* — gözler | **Görmek** |
| 3 | *Ef'ide* — kalpler | **Kavramak** |
...
**أَفْـِٔدَة** — kök **ف-ء-د**: dilcilerin kaydettiği çekirdek **közün yakması**dır; *fuâd*, kalbin **tutuşan, hareketli** yönü için kullanılır. **Kökün *kalb* ile farkı `056-vakia.md`'de ve `053-necm.md`'de işlendi; tekrarlamıyorum.**

**فَمَآ أَغْنَىٰ عَنْهُمْ … مِّن شَىْءٍ** — "hiçbir şeyle yarar sağlamadı."
...
**Cin bahsinin ayrıntılı çözümlemesi `072-cin.md`'de yapıldı** — kelimenin kök anlamı (**ج-ن-ن**: örtmek, gizlemek), görünmezlik ve bu varlıklar hakkında kesin bilgi sınırı orada işlendi. **Tekrarlamıyorum ve aynı sınırı koruyorum: metnin bildirdiğinin ötesinde tasvir üretilmez.**
...
**Aynı fikir Kāf 50/38'de başka bir kelimeyle geçer** (*ve mâ messenâ min lüğûb*) ve `050-kaf.md`'de işlendi. **Bakara 2/255'te de aynı yerden geliyordu:** *ve lâ yeûdühû hıfzuhümâ* — koruması O'na ağır gelmez.
...
| **Süre** | *ecelin müsemmâ* (3) — *sâaten min nehâr* (35) | Sûrenin iki ucu |
