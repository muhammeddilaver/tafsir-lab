...
import { LANGS, ROUTES } from "@/lib/i18n";
import { abs, SITE_URL } from "@/lib/meta";

// The JSON fragments the citation modal fetches: 2,996 per language. Not
// pages, but the body of one section of a sura page — there is nothing to
// index, and crawling them only spends crawl budget.
const fragments = LANGS.map((l) => `${ROUTES[l].part}/`);
