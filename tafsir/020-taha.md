...
***Ebkā* (daha kalıcı) kelimesi sûrede dört kez geçiyor ve ilki Fir'avn'ın ağzındadır:**
...
**Hurûf-ı mukattaa bahsi dizinde defalarca kuruldu** (`002-bakara.md`, `050-kaf.md`, `038-sad.md`, `036-yasin.md`, `026-suara.md`, `019-meryem.md`) **ve tekrarlanmıyor.** Özeti: **bu harflerin anlamı hakkında kesin bir bilgi nakledilmemiştir; en dürüst tutum, bilinmediğini söylemektir.**

**Buraya ait olan şey, *tâhâ*ya özgü bir ihtilaftır ve gizlenmemelidir.** Bu iki harf, öteki mukattaa harflerinden farklı olarak **bir kelime gibi de okunabildiği için** üzerinde ayrıca durulmuştur.
...
**Kök dizinde `092-leyl.md`, `091-sems.md` ve `087-ala.md`'de *eşkā* kelimesi vesilesiyle işlendi** — orada kelimenin **ef'al** vezninde ism-i tafdîl olması ve *etkā* ile karşıtlığı tartışılmıştı. **Oraya dayanıyorum; kalıp tartışmasını tekrarlamıyorum.**
...
**Ve karşıtı *saâde* (mutluluk, işin kolay gelmesi) değil, doğrudan *şekāve*nin yokluğudur.** Kur'an ikisini bir arada anar: *fe-minhüm şakıyyün ve saîd* (Hûd 11/105).
...
**Tercih dayatmıyorum.** **Ancak bir karine kaydediyorum, tercih olarak değil:** üçüncü ayetin cevabı *tezkire*dir — yani **kitabın işi.** Cümle kitabın **niçin indiğini** konuşuyor; dolayısıyla nefyedilen şey de kitabın **muhataba yüklediği şey** olmaya daha yakın duruyor.
...
**Nefy edatı (*mâ*) fiile giriyor, ama nefyin asıl hedefi *lâm*lı gaye cümlesidir.** Arapçada bu yapı, **fiili değil, fiilin gerekçesini** olumsuzlar. Yani cümle "Kur'an'ı indirmedik" demiyor — **indirdi, ama bu gaye için değil** diyor.
...
***İllâ tezkiraten* istisnası, kendisinden önceki *li-teşkā*dan yapılmıyor** — çünkü "sıkıntı" ile "hatırlatma" aynı cinsten değil. **Dilciler bunu *istisnâ-i munkatı'* (kesik istisna) sayar:** anlamı **"bilakis, ancak"**dır.

**Yani cümle iki adımlıdır: bir gaye reddediliyor, yerine bir gaye konuyor.**

| Reddedilen | Konan |
|---|---|
| *Li-teşkā* — **senin sıkıntın** | *Tezkiraten li-men yahşâ* — **başkasının hatırlaması** |
...
**Bu cümle, dizinde birçok yerde işlenen bir sınırın en açık ifadesidir. `026-suara.md` 26/3'te ve `035-fatir.md` 35/7-9'da aynı hat işlendi ve oraya dayanıyorum:**
...
**Ve cümlenin bir sınır çizdiği kaydedilmelidir: kitap herkese iniyor ama *tezkire* olarak işlemesi bir şarta bağlanıyor.** **Bu ayrım `080-abese.md`'de (*emmâ meni'stağnâ* / *ve emmâ men câeke yes'â*) ve `050-kaf.md` 50/37'de (*li-men kâne lehû kalb*) işlendi;** oraya dayanıyorum.
...
**Ve dört tabaka sayılıyor:** gökler, yer, ikisi arası, **toprağın altı.** **`028-kasas.md` 28/1-6'da ve `019-meryem.md` 19/64'te aynı "her yönü kapsama" tekniği işlendi;** oraya dayanıyorum. **Buradaki fark, dördüncü tabakanın eklenmiş olmasıdır** — kapsam yalnız yukarı değil, **aşağı** da genişletiliyor.
...
**Buraya ait olan tek şey, öznenin seçimidir ve bu bir metin verisidir: cümlenin öznesi *er-Rahmân*.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı yukarıdaki dağılımdır:** hükümranlığı bildiren cümlenin öznesi, **merhameti bildiren isim** yapılmış. **Ve `019-meryem.md`'de bu ismin bir sûrenin omurgası oluşu işlenmişti;** Tâhâ'da ise isim **dört kez** geçer (5, 90, 108, 109) ve **dördü de bir güç sahnesindedir:** arş, buzağı karşısında Hârûn'un hatırlatması, seslerin kısıldığı gün, şefaatin izne bağlandığı an. **Bu dağılım metinden doğrulanabilir.**
...
**Terkip `059-hasr.md` 59/24'te işlendi ve orada kaydedilmişti: *lehû* öne alınmıştır ve Arapçada haberin öne geçmesi *hasr* (sınırlama) bildirir — "en güzel isimler yalnız O'nundur"; *hüsnâ*, *ahsen*'in müennes ism-i tafdîl hâlidir, yani "güzel isimler" değil "en güzel isimler".** **Oraya dayanıyorum ve tekrarlamıyorum.**
...
### Üç anlatım — sahnenin karşılaştırması

**Bu sahne dizinde iki kez işlendi: `028-kasas.md` 28/29-35 ve `027-neml.md` 27/7-8.** **أ-ن-س kökünün tahlili Kasas'ta yapıldı** (görüp fark etmek, ısınmak; aynı kökten *ins* ve *üns*; dilciler "uzaktan bir ışık sezmek" anlamını kaydeder) **ve Neml'de iki anlatım tablo hâlinde karşılaştırıldı.** **Kök tahlilini tekrarlamıyorum; oraya dayanıyorum.**

**Buraya ait olan, üçünün birden karşılaştırılmasıdır. Tablonun tamamı metinden doğrulanabilirdir:**
...
**Ve `028-kasas.md`'de kaydedilen gözlem burada da geçerlidir:** çağrı, aranmış bir yerde değil — **yolda, gündelik bir ihtiyaç için sapılan bir noktada** geliyor. **Tâhâ'ya özgü olan şudur ve bunu kendi okumam olarak veriyorum:** Mûsâ **yol soracak birini** arıyordu; **bulduğu şey, yolun kendisini veren oldu.** Kelime aynı: *hüdâ*.

### إِنِّىٓ أَنَا۠ رَبُّكَ — zamirin tekrarı

**Dizim nüktesi kaydedilmelidir: *innî* zaten "ben"i bildiriyor; ardından ayrıca *ene* (ben) geliyor.**
...
**Emrin gerekçesi ayette veriliyor: *inneke bi'l-vâdi'l-mukaddesi Tuvâ*.**

**Klasik tefsirlerde emrin sebebi üzerinde farklı izahlar nakledilir ve ihtilaf gizlenmemelidir:**
...
### فَٱسْتَمِعْ لِمَا يُوحَىٰ — seçim ve dinleme
...
**Ve fiil *isma'* değil *istemi'* — VIII. bâb.** Arapçada bu kalıp **kasıtlı, dikkat vererek dinlemeyi** bildirir. **`026-suara.md` 26/15'te aynı kökün aynı kalıbı bir güvence cümlesinde geçmişti:** *innâ meaküm **müstemiûn***. **Oraya dayanıyorum.**
...
**Bir karine kaydediyorum, tercih olarak değil ve dayanağı sûrenin kendi kelime örgüsüdür:** ذ-ك-ر kökü bu sûrenin omurgalarından biridir (yapı bölümünde tablolandı) **ve yüz yirmi dördüncü ayette yüz çevirmenin konusu tam olarak *zikrî*dir:** *ve men a'rada **an zikrî***.
...
### أَكَادُ أُخْفِيهَا — üzerinde durulan cümle
...
**فَتَرْدَىٰ** (16) — kök **ر-د-ي**: **yüksekten düşmek, uçuruma yuvarlanmak.** *Terdâ* — helâk olursun; kökün somut resmi **düşüştür.** **Aynı kök `092-leyl.md` 92/11'de (*izâ teraddâ*) işlendi;** oraya dayanıyorum.
...
**Bu okumayı destekleyen ikinci bir metin verisi var: yirmi birinci ayette asâ *sîratehe'l-ûlâ*ya (ilk hâline) döndürülüyor.** **Yani sahne, cismi kalıcı olarak dönüştürmüyor; bir kez ilk hâlini askıya alıp geri veriyor.** **Öğretilen şey nesne değil, nesne üzerindeki hükmün kime ait olduğu.**
...
**Bunu bir gözlem olarak kaydediyorum:** ayet, çobanın günlük işini **teknik adıyla** anıyor. **Ve `019-meryem.md` 19/25'te aynı fiil ailesi Meryem'e emredilmişti** (*ve hüzzî ileyki bi-cız'ı'n-nahle* — hurma gövdesini silkele). **İki sahne de bir ağacın silkelenmesini içeriyor; biri geçim, öteki yardım.**

**مَـَٔارِب** — kök **أ-ر-ب**: **ihtiyaç, hacet, iş.** *Me'rebe*nin çoğulu. Aynı kökten *erîb* (ihtiyacını bilen, becerikli) gelir. **Kelime Kur'an'da yalnız burada geçer.**
...
**`026-suara.md` ve `027-neml.md`'de bu sahneler işlendi; kelime tahlillerini tekrarlamıyorum.**
...
**جَنَاح** — *cenâh* kelimesi insan için kullanıldığında **"kol, yan taraf, koltuk altı"** anlamına gelir; **`028-kasas.md` 28/32'de (*vadmum ileyke cenâhake mine'r-rehb*) işlendi ve orada dilcilerin kuş resmine dayandırdığı izah aktarıldı.** **Oraya dayanıyorum.**

**Ve fark kaydedilmeye değer:** Kasas'ta *cenâh*ın toplanması **korkuya** karşıydı; **burada elin *cenâh*a sokulması bir işaretin üretilmesi içindir.** Aynı kelime, iki ayrı işte.

### إِنَّهُۥ طَغَىٰ — gerekçenin tek kelimesi

**ط-غ-ي** kökü dizinde birçok yerde işlendi (`079-naziat.md`, `050-kaf.md`, `089-fecr.md`, `068-kalem.md`) **ve tekrarlanmıyor.** Oradaki tarif: **suyun kabından taşması; ölçüyü aşıp dışına çıkmak.**

**Buraya ait olan, kökün bu sûredeki dağılımıdır ve bu bir metin verisidir:**
...
**ش-ر-ح kökü `094-insirah.md` 94/1'de ayrıntılı çözümlendi** ve orada kaydedilen tarif şudur: **kökün somut anlamı "eti yayıp açmak, ince dilimlere ayırarak genişletmek"tir** (*şerahtü'l-lahm*); buradan **bir şeyi açıp genişletmek** ve **bir sözü açmak** (Türkçedeki *şerh*) anlamları doğar. **ص-د-ر kökü de orada işlendi:** öne çıkan, çıkış yeri; aynı kökten *masdar*. **Oraya dayanıyorum ve kök tahlilini tekrarlamıyorum.**
...
**Ve `094-insirah.md`'de kaydedilen ikinci bir örtüşme buraya taşınabilir:** İnşirâh'ta *şerh*in ardından *yüsr* (kolaylık) geliyordu — *inne mea'l-usri yüsrâ*. **Tâhâ'da da aynı sıra var: *işrah* … *ve yessir*.** **İki sûre, aynı iki kelimeyi aynı sırada kullanıyor.** Bu, metinden doğrulanabilir bir örtüşmedir.
...
**Bu, `028-kasas.md` 28/56'da işlenen sınırla aynı çizgidedir** (*inneke lâ tehdî men ahbebte*) — orada altı sûreden altı ayrı sınır ifadesi tablolanmıştı. **Tâhâ'daki, o sınırın bir peygamberin kendi duasında görünmesidir.** Oraya dayanıyorum.
...
**ف-ق-ه** kökü **`048-fetih.md`, `059-hasr.md` ve `063-munafikun.md`'de işlendi** — **derinlemesine anlamak, sözün altındakini kavramak.** **Tekrarlamıyorum.** **Ve fiilin seçimi kaydedilmeye değer:** *yesmeû* (işitsinler) denmiyor; **anlamanın kendisi isteniyor.**
...
### وَزِير ve رِدْء — iki sûre, iki kelime

**Aynı talep `028-kasas.md` 28/34'te başka bir kelimeyle geçti ve orada işlendi:** ***رِدْء*** — kök **ر-د-أ**: **destek, arkadan tutan yardımcı**; dilciler kelimeyi **bir şeyin devrilmemesi için arkasına konan payanda** ile açıklar. **Oraya dayanıyorum ve tekrarlamıyorum.**

**Buraya ait olan, iki kelimenin karşılaştırılmasıdır.**

**وَزِير** — kökü üzerinde iki izah nakledilir ve ikisi de aynı resme çıkar:
...
**و-ز-ر kökü dizinde `094-insirah.md` 94/2 (*ve veda'nâ anke vizrak*), `035-fatir.md` 35/18 ve `039-zumer.md` 39/7'de işlendi** — orada kökün **ağırlık** çekirdeği kaydedilmişti. **Oraya dayanıyorum.**

**Şimdi iki talebi yan yana koyuyorum ve tablo metinden doğrulanabilirdir:**
...
**Ve `028-kasas.md`'de kaydedilen cevap buraya da bağlanır:** *se-neşüddü **adudeke** bi-ahîk* — "kolunu kardeşinle güçlendireceğiz". **Kasas cevabı *adud* (pazı) kelimesiyle veriyor; Tâhâ'da talep *ezr* (bel) kelimesiyle kuruluyor.** **İki yerde de destek bedensel bir resimle anlatılıyor** — biri kol, öteki bel.
...
### كَىْ نُسَبِّحَكَ كَثِيرًا — gerekçenin kendisi
...
**İki fiilin de öznesi çoğul: "biz".** **Ve ikisi de görev değil, kulluk fiilidir.**
...
**إِنَّكَ كُنتَ بِنَا بَصِيرًا** (35) — "**sen bizi görmektesin.**"
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı yukarıdaki üçüdür:** cevap, talebin muhasebesini yapmıyor. **Ve `019-meryem.md` 19/7-9'da Zekeriyyâ'nın duasına verilen cevap da aynı biçimdeydi:** itiraz tartışılmadan, doğrudan gerçekleşme bildiriliyordu. Oraya dayanıyorum.
...
**Bunu bir gözlem olarak kaydediyorum:** metin, emrin ne kadar zor olduğunu **kelimeyi yumuşatmayarak** kaydediyor. **`019-meryem.md` 19/23-25'te aynı dürüstlük kaydedilmişti** (Meryem'in *yâ leytenî mittü kable hâzâ* sözünün olduğu gibi verilmesi); oraya dayanıyorum.
...
**ٱلْيَمّ** — **deniz ya da büyük nehir.** Kelime bu sûrede dört kez geçer (39 iki kez, 78, 97) **ve dördüncüsü kaydedilmeye değer: doksan yedinci ayette buzağı *yemm*e savrulacak.** **Yani sûre, kıssayı başlatan suyu, kıssanın sonunda putu yutan su olarak geri getiriyor.** Bu, sûre içinde doğrulanabilir bir tekrardır.
...
**Ve `028-kasas.md` 28/9'da bunun sonucu anlatılıyordu:** *kurratü aynin lî ve leke lâ taktülûh* — Fir'avn'ın karısının sözü. **Yani Tâhâ sebebi, Kasas sonucu veriyor.** **İki sûre birlikte okunduğunda bir zincir çıkıyor ve bunu kendi okumam olarak kaydediyorum:** düşmanın evinde korunmanın sebebi bir güç değil, **bir duygu.**
...
**Aynı kök üç kez: iki kez yapılan iş kalıcı, bir kez yutuluyor.**
...
**ف-ت-ن** kökünün somut anlamı **madeni ateşe sokup saf olanı curuftan ayırmaktır.** **Kök dizinde birçok yerde işlendi** (`029-ankebut.md` 29/2-3, `085-buruc.md`, `037-saffat.md`) **ve tekrarlanmıyor.**

**Buraya ait olan, masdarın kalıbıdır: *fütûn*.** Bu, *fitne*nin çoğulu ya da mübalağalı masdarı olarak açıklanır; **her iki izahta da anlam "bir bir, tekrar tekrar sınama"ya çıkar.** **Türkçeye "seni bir bir sınadık" olarak veriyorum.**
...
**Terkibin anlamı üzerinde farklı izahlar nakledilir:**
...
**Kök ص-ن-ع, VIII. bâb: *istanaa* — "kendisi için özenle yapmak, seçip hazırlamak".**
...
| Ayet | Kalıp | Fâil |
|---|---|---|
| **39** | *Li-**tusnaa** alâ aynî* | **Söylenmiyor** — meçhul |
| **41** | *Ve'**stana'tüke** li-nefsî* | **Açık** — "ben" |
...
**ل-ي-ن** kökü: **yumuşaklık, esneklik; sertliğin karşıtı.** **Kök `034-sebe.md` 34/10'da (*ve elennâ lehü'l-hadîd* — demiri ona yumuşattık) ve `039-zumer.md` 39/23'te (*sümme telînü cülûdühüm* — sonra derileri yumuşar) ve `059-hasr.md`'de işlendi.** **Oraya dayanıyorum.**
...
**Gaye cümlesi *lealle* ile kuruluyor — yani umut kalıbı.** **`032-secde.md` 32/3'te kaydedilmişti: *lealle* ile biten gaye cümlesinde sonuç garanti edilmiyor.** Oraya dayanıyorum.
...
| Dal | Anlam |
|---|---|
| ***İfrât*** | **Ölçüyü aşıp öne geçmek** — aşırılık |
| ***Tefrît*** | **Geride bırakmak, ihmal etmek** |

**Ayette *yefruta* — "aşırı gitmek, hızla üzerimize gelmek".**

**Ve iki korku sayılıyor ve ikisi ayrıdır:**
...
**Cevabın yapısı kaydedilmelidir: bir yasak, bir bildirim, iki fiil.**
...
**Ve `026-suara.md` 26/15'te aynı güvence başka bir kalıpla verilmişti:** *innâ meaküm **müstemiûn***. **İki ayet yan yana konabilir:**
...
**Cümle *es-selâmü aleyke* (sana selâm) demiyor; *ale meni'ttebea'l-hüdâ* — "doğru yola uyana" diyor.**
...
**`028-kasas.md` 28/55, `025-furkan.md` 25/63 ve `043-zuhruf.md` 43/89'da işlenen çizgi buraya bağlanır** — orada da ayrışma bir selâmla mühürleniyordu. **Tâhâ'daki fark: selâm ayrışmayı değil, davetin sonunu mühürlüyor.**
...
**Aynı sahne `026-suara.md` 26/23-28'de işlendi ve orada soru edatı ayrıntılı tartışıldı.** Şuarâ'da soru şöyleydi: ***ve mâ rabbü'l-âlemîn*** — ve orada kaydedilmişti: **Arapçada *mâ* mahiyet (cins), *men* ise kimlik sorar; akıllı varlıklar *men* ile sorulur.** **Oraya dayanıyorum ve edat tartışmasını tekrarlamıyorum.**
...
| Terkip | *Rabbü**kümâ*** — "sizin Rabbiniz" | *Rabbü'l-**âlemîn*** — "âlemlerin Rabbi" |
...
| Ayet | İfade | Kim |
|---|---|---|
| **50** | *Sümme **hedâ*** | **Allah** — cevabın son kelimesi |
| **79** | *Ve mâ **hedâ*** | **Fir'avn** — bloğun son kelimesi |
...
### Cevabın devam etmesi

**Dizim nüktesi kaydedilmelidir: elli üçüncü ayet, ellinci ayetteki cevabın devamıdır.** *Ellezî* ism-i mevsûlü, *rabbüne'llezî a'tâ*ya bağlanıyor. **Yani Fir'avn'ın ikinci sorusu (51) araya girmiş, cevap yine de sürüyor.**
...
**Bunu bir dizim gözlemi olarak kaydediyorum ve dizinde bu kalıp birçok yerde işlendi** (`035-fatir.md` 35/9, `036-yasin.md`): **anlatım, en somut fiilde konuşana geçiyor.**
...
**Üç aşama, üç harf-i cerr ve dizim nüktesi buradadır:**
...
**Ortadaki harf değişiyor: giriş *fî* ile, çıkışlar *min* ile.**
...
**`035-fatir.md` 35/9'da ve `050-kaf.md` 50/11'de aynı delil işlendi** (*kezâlike'n-nüşûr* / *kezâlike'l-hurûc*): **görülen bir olaydan görülmeyen bir olaya geçiş.** **Oraya dayanıyorum.**
...
**Bu fiil, `002-bakara.md` 2/34'te İblîs için kullanılan fiildir** ve orada işlenmişti: *ebâ ve'stekbera* — **"*ebâ* eylemin kendisi, *istekbera* eylemin gerekçesi."** **Oraya dayanıyorum.**

**Ve aynı fiil bu sûrenin yüz on altıncı ayetinde İblîs için geri gelecek:** *fe-secedû illâ İblîse **ebâ***.

| Ayet | İfade | Kim |
|---|---|---|
| **56** | *Fe-kezzebe **ve ebâ*** | **Fir'avn** |
| **116** | *İllâ İblîse **ebâ*** | **İblîs** |
...
**سُوًى** — kök **س-و-ي**: denklik, eşitlik. ***Süvâ* — iki taraf için eşit olan.** **Kök `082-infitar.md` 82/7'de (*fe-sevvâk*) ve `091-sems.md`'de işlendi;** oraya dayanıyorum.
...
***Necvâ* kökü `058-mucadele.md`'de ayrıntılı işlendi;** **tekrarlamıyorum.**
...
**طَرِيقَتِكُمُ ٱلْمُثْلَىٰ** — "**örnek yolunuz**". ***Müslâ*, *emsel*in müennesidir: "en örnek, en üstün".** **Kaydedilmeye değer:** itiraz, dinî bir iddia olarak değil, **düzenin ve yaşam biçiminin korunması** olarak kuruluyor.

**`028-kasas.md` 28/57'de aynı mantık işlendi** (*in nettebiı'l-hüdâ meake nütehattaf min ardınâ*) ve orada kaydedilmişti: **itiraz, inanç üzerine değil güvenlik kaygısı üzerine kuruluyor.** **Oraya dayanıyorum.** **Tâhâ'daki fark: kaygının konusu toprak değil, *tarîka* — yani yaşama düzeni.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı bu üçüdür:** ayet korkuyu **en küçük hâliyle, içeride ve geçici** olarak kaydediyor. **Dışa vuran bir korku değil.** **Ve metin bunu gizlemiyor** — `019-meryem.md` 19/23'te ve `028-kasas.md` 28/15-16'da kaydedilen aynı dürüstlük. Oraya dayanıyorum.

**İki — Tâhâ, göze görünen şeyi ayrıca adlandırıyor: *yuhayyelü ileyhi*.**
...
**Güvencenin kelimesi kaydedilmelidir: *el-a'lâ* — "en üstün".** **Kök ع-ل-و.**

**Ve bu kelime, `028-kasas.md`'de kaydedildiği üzere Kasas sûresinin omurgasıydı** (*inne Fir'avne alâ fi'l-ard* / *lâ yürîdûne uluvven fi'l-ard*). **Ve Kur'an, Fir'avn'ın ağzından *ene rabbükümü'l-a'lâ* sözünü de kaydeder** (Nâziât 79/24 — `079-naziat.md`'de işlendi).

| Yer | *A'lâ* kime | Kim söylüyor |
|---|---|---|
| Nâziât 79/24 | **Fir'avn'a** | **Kendisi** — iddia |
| **Tâhâ 20/68** | **Mûsâ'ya** | **Allah** — güvence |
...
**`026-suara.md` 26/46'da bu çatı değişimi işlendi ve orada kaydedilen şu kayıt burada da aynen geçerlidir:** *"fe-sacede's-seharatü ('secde ettiler') denebilirdi; denmemiş. Edilgen çatı, secdenin planlanmış bir karar değil, karşı konulmaz bir tepki olduğunu bildiriyor."* **Oraya dayanıyorum.**

**Tâhâ'ya özgü olan tek fark hâl kelimesidir: *sücceden* (Tâhâ) / *sâcidîn* (Şuarâ).** ***Süccedan*, *sâcid*in kırık çoğuludur ve dilciler bu kalıbın yoğunluk bildirdiğini kaydeder.** **Bunu bir dil gözlemi olarak aktarıyorum.**
...
**`026-suara.md` 26/49'da bu cümle ayrıntılı işlendi ve orada kaydedilenler burada tekrarlanmıyor:**
...
**İki — ve asıl fark budur: tehdit bir yarışma cümlesiyle bitiyor.**
...
**أ-ث-ر** kökü: **iz, bir şeyin geride bıraktığı işaret.** IV. bâb *îsâr*: **birini ya da bir şeyi öne geçirmek, tercih etmek** — ve Arapçada *îsâr*, özellikle **kendi payından vazgeçip başkasına vermek** için kullanılır (`059-hasr.md` 59/9'da *ve yü'sirûne alâ enfüsihim* işlendi).
...
**ف-ط-ر** kökü: **bir şeyi yarıp açmak, ilk kez ortaya çıkarmak.** **Kök `035-fatir.md`'de sûre adı vesilesiyle ayrıntılı çözümlendi;** oraya dayanıyorum. **Kelimenin seçimi kaydedilmeye değer:** *halaka* değil *fatara* — **yani "ilk yaran, ilk var eden".**
...
**Ve `026-suara.md` 26/50'de aynı sahnenin Şuarâ anlatımı işlenmişti:** orada cevap *lâ dayra* (zarar yok) ile başlıyordu ve kaydedilmişti: **"cevap 'acıya katlanırız' demiyor; 'bu bir zarar değil' diyor — yani tehdidin dayandığı ölçü reddediliyor."**
...
| Ayet | İfade | Kim |
|---|---|---|
| **71** | *Eyyünâ **eşeddü azâben ve ebkā*** | **Fir'avn** — soru |
...
**Bunu kendi okumam olarak kaydediyorum:** cevabın gücü duygusundan değil, **karşılaştırmanın açık yapılmasından** geliyor. **Ve `026-suara.md`'de kaydedilen gözlem burada da geçerlidir:** bu sözü söyleyenler, gördükleri şeyin ne olmadığını meclisteki herkesten iyi bilen kişilerdi. **Bilgi, direncin değil teslimiyetin sebebi oluyor.**
...
| Okuma | Ne der |
|---|---|
| 1 | **Sihirbazların sözünün devamı** — yetmiş üçüncü ayetteki *ebkā*yı açıklıyorlar |
...
**`087-ala.md` 87/13'te aynı ifade işlendi** (*sümme lâ yemûtü fîhâ ve lâ yahyâ*). **Oraya dayanıyorum.** **Ve `019-meryem.md` 19/68-72'de kaydedilen bekleme hâliyle** (*cisiyyâ* — diz üstü) **aynı alandadır.**

### ٱلدَّرَجَٰتُ ٱلْعُلَىٰ — ve altmış sekizinci ayet

***El-ulâ* — *a'lâ*nın müennes çoğulu, kök ع-ل-و.**
...
**تَزَكَّىٰ** — kök **ز-ك-و**: **artmak, temizlenmek.** **Kök `091-sems.md` 91/9'da (*kad efleha men zekkâhâ*) ve `087-ala.md` 87/14'te (*kad efleha men tezekkâ*) işlendi.** **Oraya dayanıyorum.**
...
**Arap dilinde bu kalıba *ibhâm li't-tefhîm* denir: bir şeyin kasıtlı olarak belirsiz bırakılıp büyütülmesi.** Aynı kalıp Necm 53/16'da da vardır (*iz yağşe's-sidrate mâ yağşâ*) **ve `053-necm.md`'de işlendi.** **Oraya dayanıyorum.**
...
|---|---|---|---|
| **50** | *Sümme **hedâ*** | **Allah** | **Cevabın son kelimesi** |
| **79** | *Ve mâ **hedâ*** | **Fir'avn** | **Kıssanın son kelimesi** |
...
**Aynı terkip `019-meryem.md` 19/52'de geçmişti:** *ve nâdeynâhü min **cânibi't-Tûri'l-eymen** ve karrebnâhü neciyyâ.* **Oraya dayanıyorum.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı kökün bu üç ayetteki dağılımıdır:** kurtulan taraf, **kurtulduğu kişiyi niteleyen kökle uyarılıyor** — ve uyarının konusu artık zulüm değil, **nimet.** **Yani sûre, *tuğyân*ı bir karakter değil, bir eşik olarak veriyor: gücün de nimetin de aşılabilir bir sınırı var.**
...
**فَقَدْ هَوَىٰ** — kök **ه-و-ي**: **yukarıdan aşağı düşmek.** **Aynı kökten *hevâ* (nefsin eğilimi) gelir** ve kelimenin bu iki dalı arasındaki ilişki dilcilerce kaydedilir: **nefsin eğilimi de bir düşüştür.** **Kök `053-necm.md` 53/1'de (*ve'n-necmi izâ hevâ*) işlendi;** oraya dayanıyorum.
...
### غَضْبَٰنَ أَسِفًا — iki hâl

**İki kelime yan yana geliyor ve ikisi ayrı şeyi bildiriyor.**
...
**أَوْزَار** — *vizr*in çoğulu, kök **و-ز-ر**: **ağır yük.** **Yirmi dokuzuncu ayette *vezîr* kelimesi bahsinde aynı kök işlendi.** **Ve kelimenin seçimi kaydedilmeye değer:** süs eşyaları **"yük" olarak** adlandırılıyor.

### عِجْلًا جَسَدًا لَّهُۥ خُوَارٌ

**Üç kelime, üç ayrı bilgi:**
...
**Cümlenin kuruluşu kaydedilmelidir: iddia, Mûsâ'nın anlattığını reddetmiyor.**

**"Bu sizin ilâhınız" denip bırakılabilirdi; "ve Mûsâ'nın ilâhı" ekleniyor.**
...
**`021-enbiya.md`, `026-suara.md` 26/72-73 ve `037-saffat.md`'de aynı ölçü işlendi** (*hel yesmeûneküm iz ted'ûn · ev yenfeûneküm ev yedurrûn*). **Oraya dayanıyorum: ölçü, işitme ve fayda-zarardır.** **Tâhâ, bu ölçüye bir madde daha ekliyor: *ellâ yerciu ileyhim kavlen* — "söz döndürememek".**
...
### Hârûn'un uyarısının konumu

**Dizim nüktesi kaydedilmelidir: doksanıncı ayet *min kablü* (daha önce) diyor.**
...
### إِنَّمَا فُتِنتُم بِهِۦ — teşhisin kelimesi
...
**Ve teşhisin ardından gelen isim kaydedilmelidir: *ve inne rabbekümü'**r-rahmân***.**

**Bunu bir gözlem olarak kaydediyorum:** buzağı karşısında hatırlatılan isim, **azabı değil merhameti** bildiren isimdir. **Ve `019-meryem.md`'de kaydedildiği üzere, bu isim korku ve sığınma anlarında çağrılan addır.**
...
### عَٰكِفِين — kelimenin sûredeki dönüşü

**ع-ك-ف** kökü: **bir şeyin başında sürekli durmak, ayrılmamak.** Aynı kökten *itikâf* gelir. **Kök `026-suara.md` 26/71'de (*fe-nezallü lehâ âkifîn*) işlendi;** oraya dayanıyorum.
...
### يَبْنَؤُمَّ — hitabın seçimi

**Cevabın ilk kelimesi kaydedilmelidir: *yebneümme* — "ey anamın oğlu".**
...
**ل-ح-ي** kökü: **çene, çene kemiği;** *lihye* — **sakal.**

**Bunu bir gözlem olarak kaydediyorum:** metin, bir peygamberin öfke anındaki fiilî davranışını **örtmüyor.** **`028-kasas.md` 28/14-21'de ve `019-meryem.md` 19/23'te kaydedilen aynı dürüstlük;** oraya dayanıyorum.
...
### إِنِّى خَشِيتُ — savunmanın gerekçesi

**Hârûn'un cevabı bir mazeret değil, bir tercih açıklamasıdır ve yapısı kaydedilmelidir.**
...
**Sahnenin kaydettiği şey bir aile tartışması değil, bir sorumluluk çatışmasıdır.**
...
|---|---|---|---|
| 1 | **Elçinin ayak izinden alınan toprak** | *Eser* kelimesinin ilk anlamı **ayak izi**dir | Metin ne olduğunu söylemiyor; ayrıntılar rivayetlerden geliyor |
...
**Bu tefsirde hiçbiri tercih edilmiyor. Kayıt şudur: kesin bilgi yoktur.**
...
### لَا مِسَاسَ — cezanın biçimi

***Misâs* — kök م-س-س: dokunmak.** *Lâ misâs* — **"dokunma yok".**

**Cezanın ne olduğu üzerinde farklı izahlar nakledilir:**
...
**İki fiil ve ikisi de sûrenin başka yerleriyle bağlantılı.**
...
|---|---|---|
| **97** | **Buzağı** | *Le-nensifennehû fi'l-yemmi **nesfâ*** |
| **105** | **Dağlar** | *Yensifühâ rabbî **nesfâ*** |
...
**Bloğun kapanış cümlesi kaydedilmelidir ve seçilen sıfat dikkat çekicidir: *ılm*.**

**Bir put kıssasının sonunda beklenen kapanış bir güç bildirimi olabilirdi.** **Cümle, ilim bildiriyor.**
...
**وِزْر** — kök **و-ز-ر**: **ağır yük.** **Kök `094-insirah.md` 94/2 (*ve veda'nâ anke vizrak*) ve `035-fatir.md` 35/18'de işlendi;** oraya dayanıyorum. **Ve yirmi dokuzuncu ayetteki *vezîr* kelimesi de bu köktendi** — 20/29-35 bahsinde tablolandı.

**Bunu bir gözlem olarak kaydediyorum:** sûre, aynı kökü iki ayrı yerde kullanıyor — **biri paylaşılan yük** (*vezîr* — yardımcı), **öteki taşınamayan yük** (*vizr*). **Ve `019-meryem.md` 19/95'te kaydedildiği üzere, ikincisi tek başına taşınır:** *ve küllühüm âtîhi yevme'l-kıyâmeti ferdâ.*
...
**ز-ر-ق** kökü: **maviye çalan renk.** ***Zurk*, *ezrak*ın çoğuludur.**
...
| **103** | *Ye**tehâfetûne** beynehüm* | **Kısık sesle konuşma** |
...
**ن-س-ف kökü doksan yedinci ayet bahsinde işlendi ve `077-murselat.md` 77/10'a dayanıldı.** **Ve iki ayet arasındaki örtüşme orada tablolandı:** aynı fiil, aynı mefûl-i mutlak (*nesfâ*), biri buzağı biri dağlar için.

**Buraya ait olan, sorunun kendisidir.** *Ve **yes'elûneke** ani'l-cibâl* — **soru soruluyor.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı kelimelerin inceliğidir:** ayet, düzlüğü **iki kez olumlu, iki kez olumsuz** tarif ediyor. **Ve olumsuz tarifte seçilen iki şey, gözle güçlükle ayırt edilen şeylerdir: görünmeyen eğrilik ve küçük bir tümsek.** **Yani düzlük, en küçük ölçüden tarif ediliyor** — tıpkı `019-meryem.md` 19/98'de yokluğun **en küçük ses izinden** ölçülmesi gibi.
...
**Ve `019-meryem.md` 19/98'de *rikz* kelimesi işlendi** — orada kaydedilen tarif: **çok hafif, güçlükle duyulan ses; fısıltı.** **O da Kur'an'da yalnız bir kez geçer.** **Oraya dayanıyorum ve iki kelimeyi karşılaştırıyorum:**
...
**خ-ش-ع** kökü: **alçalmak, boyun eğip sinmek.** **Kök `023-muminun.md` 23/2'de (*ellezîne hüm fî salâtihim hâşiûn*) ve `068-kalem.md`'de işlendi;** oraya dayanıyorum.

**Dizim nüktesi kaydedilmelidir: fiilin öznesi *el-asvât* (sesler).** **Yani alçalan şey insan değil, sesin kendisi.**

**Bunu bir dizim gözlemi olarak kaydediyorum ve dizinde aynı teknik başka yerlerde de görülmüştü:** `028-kasas.md` 28/66'da (*fe-amiyet aleyhimü'l-enbâ*) **körlüğün öznesi haberler yapılmıştı.** **Aynı yöntem: fiil, insandan alınıp insana ait olan şeye veriliyor.**
...
| Şart | İfade | Ne |
|---|---|---|
| 1 | *Ezine lehü'r-rahmân* | **İzin** — şefaat edilmesine |
| 2 | *Ve **radıye** lehû kavlâ* | **Rıza** — söylenen sözden |

**Bunu bir gözlem olarak kaydediyorum:** izin verilmiş olmak yetmiyor; **söylenen sözün de kabul edilmesi ayrıca anılıyor.**

**`002-bakara.md` 2/255 ve `019-meryem.md` 19/87'de şefaatin izne bağlanması işlendi;** oraya dayanıyorum. **Meryem'de şart *ahd* idi** (*illâ meni'ttehaze inde'r-rahmâni ahdâ*); **Tâhâ'da izin ve rıza.**
...
**Terkip `041-fussilet.md` 41/25 ve 41/42'de işlendi ve `019-meryem.md` 19/64'te tekrar anıldı; orada kaydedilmişti: ikili, bir şeyin bütün yönlerini kapsamak için kullanılır.** **Oraya dayanıyorum.**
...
**ٱلْحَىِّ ٱلْقَيُّوم** — **iki isim birlikte.** **`002-bakara.md` 2/255'te (Âyetü'l-kürsî) bu ikili işlendi;** oraya dayanıyorum.
...
| Kelime | Kök | Ne |
|---|---|---|
| ***Zulm*** | ظ-ل-م | **Hak etmediği bir şeyin yüklenmesi** |
| ***Hadm*** | ه-ض-م | **Hak ettiği bir şeyin eksiltilmesi** |
...
**İki gaye sayılıyor ve ikincisi kaydedilmeye değer.**

**ح-د-ث** kökü: **yeni olmak, sonradan meydana gelmek.** IV. bâb *ihdâs*: **yeni bir şey meydana getirmek.**
...
**Aynı hat Kıyâme 75/16-19'da da geçer** (*lâ tuharrik bihî lisâneke li-ta'cele bih*) **ve `075-kiyame.md`'de işlendi.** **Oraya dayanıyorum.** **İki ayet arasındaki fark kaydedilmeye değer:** Kıyâme'de yasağın konusu **dilin hareketi**, Tâhâ'da **acelenin kendisi.**

### وَقُل رَّبِّ زِدْنِى عِلْمًا

**Sûrenin en çok anılan cümlelerinden biridir ve bulunduğu yer kaydedilmelidir.**

**Dizim nüktesi: dua, bir yasağın hemen ardından geliyor.** *Acele etme* — **ve şöyle de: ilmimi artır.**
...
**Kıssa `002-bakara.md` 2/30-38'de ayrıntılı işlendi ve `038-sad.md` 38/71-85'te ikinci kez ele alındı.** **İkisine de dayanıyorum ve tekrarlamıyorum.**
...
**ع-ز-م kökü `046-ahkaf.md` 46/35'te (*ülü'l-azmi mine'r-rusül*) işlendi** ve orada kaydedilmişti: **bir işe kesin olarak karar vermek, kararlılık; kökte "kesip atmak" anlamı da kaydedilir.** **Oraya dayanıyorum.**

**Ve iki ayet yan yana konabilir; bu, sayılabilir bir örtüşmedir:**

| Yer | İfade | Kim |
|---|---|---|
| Ahkāf 46/35 | *Ülü'l-**azm**i mine'r-rusül* | **Bazı elçiler** — azim sahipleri |
...
**Bunu sûrenin en güçlü metin verisi olarak kaydediyorum ve kendi okumam şudur:**

**Sûre, ikinci ayetinde kitabın muhataba *şekā* yüklemediğini söylemişti.** **Yüz on yedinci ayette *şekā*nın asıl kaynağını adlandırıyor: cennetten çıkarılmak, yani bulunulan yerin dışına düşmek.** **Ve yüz yirmi üçüncü ayette ikisini birleştiriyor: hidayete uyan *şakī* olmaz.**
...
**Bunun izahı üzerinde farklı görüşler nakledilir:**
...
**ض-ح-و** kökü: **güneşin yükselmesi, gölgesiz kalmak.** *Duhâ* — kuşluk vakti; **ve *tadhâ* — güneşin altında gölgesiz kalmak.** **Kök `093-duha.md`'de sûre adı vesilesiyle işlendi;** oraya dayanıyorum. **Ve aynı kelime bu sûrenin elli dokuzuncu ayetinde vakit olarak geçmişti:** *ve en yuhşera'n-nâsü **duhâ***.
...
| Vaat | Kelime | Ne |
|---|---|---|
| 1 | *Şecerati'l-**huld*** | **Sonsuzluk** — ölmemek |
| 2 | *Mülkin **lâ yeblâ*** | **Eskimeyen mülk** — kaybetmemek |

**ب-ل-ي** kökü: **eskimek, yıpranıp çürümek.** *Belâ*, elbisenin eskimesi için kullanılır.
...
### فَبَدَتْ لَهُمَا سَوْءَٰتُهُمَا — ikil kip
...
**`002-bakara.md` 2/35-36'da bu kayıt düşülmüştü ve tam olarak bu ayet delil olarak anılmıştı:** *"Kur'an'da Havvâ'yı ayrıca suçlayan, onu baştan çıkarıcı olarak konumlandıran, sorumluluğu ona yükleyen hiçbir ifade yoktur… Tâhâ sûresinde vesvesenin muhatabı doğrudan Âdem'dir (20/120), ardından 'ikisi de ondan yediler' (20/121). Kadın aracı olarak gösterilmiyor."* **Oraya dayanıyorum ve tekrarlamıyorum.**
...
**Cümle kaydedilmelidir çünkü açıktır ve yumuşatılmamıştır.**
...
**Ve `002-bakara.md` 2/37'de kaydedilen ilke burada da geçerlidir:** *"dönüş imkânı, dönmek isteyene sonradan verilmiş bir ikramdır."* **Tâhâ'da bu, üç fiille veriliyor:**
...
### فَلَا يَضِلُّ وَلَا يَشْقَىٰ — sûrenin iki kökü burada birleşiyor

**Yüz yirmi üçüncü ayet, sûrenin iki omurga kökünü tek cümlede topluyor:**
...
**Ve cümlenin yapısı kaydedilmelidir: şart ve iki sonuç.**

*Fe-meni'ttebea hüdâye* — **şart**; *fe-lâ yadıllü* — **birinci sonuç**; *ve lâ yeşkā* — **ikinci sonuç.**
...
**`002-bakara.md` 2/38'de aynı iniş ve vaat işlendi** ve orada kaydedilmişti: *"İnsan yeryüzüne bırakılmıyor; yeryüzüne gönderiliyor ve arkasından rehber gönderileceği söyleniyor."* **Oraya dayanıyorum.**

**Ve iki ayetin farkı kaydedilmeye değer:**
...
| Ayet | Yüz çevrilen | Karşılık | Resim |
|---|---|---|---|
| **100** | *Anhü* — Kur'an | *Yahmilü … **vizrâ*** | **Ağırlık** |
| **124** | *An **zikrî*** | *Maîşeten **danken*** | **Darlık** |
...
**Ve `094-insirah.md` 94/1-2'de bunun tam karşıtı işlenmişti:** *elem neşrah leke **sadrak** · ve veda'nâ anke **vizrak*** — **göğsün açılması ve yükün indirilmesi.**
...
**Dizim nüktesi kaydedilmelidir: cevap "körsün çünkü görmüyordun" demiyor.** **Kullanılan fiil *nisyân*dır** — görme değil, **unutma.**
...
| Taraf | Fiil | Çatı |
|---|---|---|
| **Dünyada** | *Fe-**nesîtehâ*** | **Etken** — o unuttu |
| **O gün** | *El-yevme **tünsâ*** | **Edilgen** — o unutuluyor |
...
**`019-meryem.md` 19/98'de aynı hat işlendi** (*ve kem ehleknâ kablehüm min karnin hel tuhıssü minhüm min ehad*) **ve `028-kasas.md` 28/43-51'de bilgi kaynağı meselesi ayrıntılı ele alındı.** **Oraya dayanıyorum.**
...
**Ve iki şey sayılıyor: *kelimetün sebekat* ve *ecelün müsemmâ*.**

**`035-fatir.md` 35/45'te (*yüahhıruhüm ilâ ecelin müsemmâ*) aynı erteleme işlendi;** oraya dayanıyorum.

### فَٱصْبِرْ — ve sûrenin ikinci ayeti

**Bloğun emri kaydedilmelidir: *fasbir alâ mâ yekūlûn*.**
...
### Beş vakit gibi bir tarif

**Tesbih için sayılan zamanlar kaydedilmelidir ve dizim ilginçtir:**
...
**آنَاء** — *iney*in çoğulu: **gecenin bölümleri, saatleri.**
...
**Dizim nüktesi kaydedilmelidir: *terdâ* — "hoşnut olursun".** **Fiilin öznesi muhatap.**

**Ve seksen dördüncü ayette Mûsâ *li-**terdâ*** demişti — orada öznesi Allah'tı ("hoşnut olasın diye").**
...
**`028-kasas.md` 28/60 ve `025-furkan.md` 25/23'te aynı hat işlendi ve oraya dayanıyorum:**
...
**`025-furkan.md` 25/23'te kaydedilen okuma buraya bağlanabilir:** orada *hebâ'* kelimesi için şu kaydedilmişti — **"görünürlüğünü kaybetmemiş ama tutulamaz hâle gelmiş şeyi anlatıyor; yani yok olma değil, elde kalmama."** **Tâhâ'nın *zehra* kelimesi de aynı alandadır:** çiçek yok değildir, **kalıcı değildir.** **Bunu kendi okumam olarak kaydediyorum.**
...
***İstabera* — VIII. bâbdan, *sabera*ya göre daha yoğun: kendini zorlayarak sabretmek.**

**Ve `019-meryem.md` 19/55'te İsmâil için aynı vasıf kaydedilmişti:** *ve kâne **ye'müru ehlehû** bi's-salâti ve'z-zekât.* **Orada kaydedilen gözlem buraya taşınabilir:** vasıf, geniş bir topluluğa değil **kendi evine** yönelik bir sorumlulukla veriliyor.
...
**Ve `028-kasas.md` 28/83'te aynı cümlenin bir benzeri işlendi** (*ve'l-âkıbetü li'l-müttekīn* — "sonuç korunanlarındır"). **İki ayet yan yana konabilir:**
...
| Ayet | İfade | Kim |
|---|---|---|
| **10** | *Ev ecidü ale'n-nâri **hüdâ*** | **Mûsâ** — arıyor |
| **135** | *Ve meni'**htedâ*** | **Kapanış** — kimin bulduğu |
...
### Sûrenin iki kıssası — nasıl bağlanıyor
...
| Ayet | İhtilaf |
|---|---|
| 1 | *Tâhâ*nın mukattaa mı, hitap mı, isim mi olduğu |
...
| 124 | *Maîşeten danken*ın hangi hayatta olduğu |
