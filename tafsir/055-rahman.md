...
Sûrenin bütün meselesi bu üç şeyin bir arada durmasıdır.
...
*"Rahmân da ne?"* sorusuna verilebilecek en uzun cevap budur.
...
Burada Mürselât'takinden farklı bir durum var: **görüş birliği yok.**
...
## Nakarat — فَبِأَىِّ ءَالَآءِ رَبِّكُمَا تُكَذِّبَانِ
...
**Bir — bölümler kısalmıyor, bir kerede düşüyor.**
...
Bunun okuma üzerindeki etkisi Mürselât'ınkinden farklıdır ve fark önemlidir:
...
Bunu kendi okumam olarak kaydediyorum. Sayılar tablodan çıkarılmıştır ve doğrulanabilir.

**İki — nakaratın metindeki payı.**

| | **Mürselât** | **Rahmân** |
|---|---|---|
| Toplam ayet | 50 | 78 |
| Nakarat sayısı | 10 | 31 |
| Nakaratın payı | %20 | **%40** |
| Nakarat dışı ayet | 40 | 47 |
...
**Üç — ilk on iki ayetin ayrıcalığı.**
...
Bunu da kendi okumam olarak kaydediyorum.
...
> *"Allah'ın **âlâ**sını hatırlayın ki kurtuluşa eresiniz."* (A'râf 7/69)
> *"Allah'ın **âlâ**sını hatırlayın ve yeryüzünde bozgunculuk yaparak taşkınlık etmeyin."* (A'râf 7/74)
...
**Burada dürüst olmak gerekiyor ve iki şeyi ayırmak zorundayım:**
...
## تُكَذِّبَانِ — ikil kip

Sûrenin en çok tartışılan gramer meselesi. Fiil **ikil**dir: *tükezzibân*, "siz ikiniz yalanlıyorsunuz". Ve zamir de ikil: *Rabbikümâ*, "ikinizin Rabbi".

**Soru şu: kim bu iki muhatap?**
...
Dolayısıyla klasik cevap açıktır ve metne dayanır: **iki muhatap ins ve cindir.**
...
Zorluk gerçektir ve gizlenmemeli: **ikil zamir, ikinin adı konmadan önce kullanılıyor.**

Klasik kaynaklarda buna verilen cevaplar şunlardır:
...
**İki.** Onuncu ayetteki *el-enâm* mercî sayılırsa zorluk kalmaz.
...
### İkil kipin yaptığı iş

Tercihi kaydettikten sonra asıl soru şu: **bu ikil ne işe yarıyor?**

İki şey yapıyor ve ikisi de sûrenin bütününe bakıyor.
...
**İkincisi: sûrenin biçimini kuruyor.** Aşağıda ses yapısı bölümünde göstereceğim gibi, *tükezzibân*ın sonundaki **ـانِ** sûrenin kafiyesinin ta kendisidir. Yani ikil kip, yalnız bir gramer tercihi değil; **sûrenin sesini belirleyen şeydir.**

## Nakarat neden azap bölümlerinden sonra da geliyor?

Bu, sûrenin en çok üzerinde durulması gereken yeridir ve nakaratın anlamını belirler.

Tabloya bakın. Nakarat şunların ardından geliyor:
...
Bu okumada nakarat şunu soruyor: *size ne olacağını önceden söylemem hangi tür bir muameledir?*

### İkinci: adalet bir nimettir
...
### Üçüncü: âlâ' yalnız "hoş olan" demek değil
...
### Dördüncü — ve bence en önemlisi: nakaratın değişmemesi
...
**Ve bunun en keskin örneği yirmi altıncı ayettir.**
...
Bunu bir okuma olarak kaydediyorum; nakaratın değişmediği ise metnin doğrulanabilir bir verisidir.

## İki nakaratın karşılaştırılması — Mürselât ve Rahmân

İki sûre aynı tekniği kullanıyor ve tam da bu yüzden farkları öğreticidir.
...
Tablodaki son üç satır üzerinde ayrı ayrı durmak gerekiyor.
...
**Kapanışlar — ve bir lafız ortaklığı.**

Şimdi iki sûrenin son ayetlerine bakın:

> Mürselât 77/50 — **فَبِأَىِّ حَدِيثٍۭ بَعْدَهُۥ يُؤْمِنُونَ** — *"Bundan sonra hangi söze inanacaklar?"*
>
> Rahmân'ın nakaratı — **فَبِأَىِّ ءَالَآءِ رَبِّكُمَا تُكَذِّبَانِ**

**İki cümle de aynı iki kelimeyle başlıyor: فَبِأَىِّ.**
...
Dahası, iki sûrenin cümle türleri tam olarak yer değiştirmiş:
...
## Bir soru olarak nakarat — cevabın boş bırakılması

Son bir nokta, ve sûrenin biçimine dair en dikkat çekici olanı.

Nakarat bir sorudur. **Ve sûre otuz bir kez soruyor, bir kez bile cevap vermiyor.**
...
Bunun anlamı şudur: **cevabın yeri metinde boş bırakılmıştır.**
...
## Sûrenin ses yapısı — ikilin sesi
...
## Fasıla: tek ses, yetmiş sekiz ayet

Sûrenin fasılaları **uzun â + tek ünsüz** düzeninde gidiyor. Ünsüz üç harften biridir: **ن، م، ر.**
...
Yani sûre neredeyse tek kafiyelidir. Ve bu tekliğin sebebi basittir: **kafiye, nakaratın kendisinden gelir.** *Tükezzibân* otuz bir kez tekrarlandığına göre, sûrenin kulağa gelen baskın sesi zaten *-ân*dır; geri kalan ayetler bu sese uyum sağlamıştır.
...
## Ve asıl mesele: bu ses, ikilin ekidir
...
**Ve dikkat çekici olan şu:** 62-66 arasında üç ayet üst üste tamamen ikil kelimelerden kuruludur. Altmış dördüncü ayet **tek kelimelik**tir ve o tek kelime ikildir: *müdhâmmetân*.

## Muhtevadaki çiftler

İkil yalnız gramerde değil. Sûrenin saydığı şeyler de çift çift geliyor:
...
## 55/52 ve 51/49 — "her şeyden çift"

Sûrenin elli ikinci ayeti şöyle:

> **فِيهِمَا مِن كُلِّ فَٰكِهَةٍ زَوْجَانِ**
> *"İkisinde her meyveden iki çift vardır."*

Ve Kur'an'da bir başka ayet, aynı kalıbı **bütün varlığa** genişletiyor:

> **وَمِن كُلِّ شَىْءٍ خَلَقْنَا زَوْجَيْنِ لَعَلَّكُمْ تَذَكَّرُونَ**
> *"Her şeyden iki çift yarattık — belki düşünüp öğüt alırsınız."* (Zâriyât 51/49)
...
**Kur'an aynı fikri bir yerde daha, daha geniş kurar:**
...
### Birinci: sûre bir isimle açılıyor

Birinci ayet tek kelimeliktir ve o kelime bir **isim**dir. Fiil yok, cümle yok, bağlaç yok.
...
> Fiil cümlesi **hudûs** (oluş, yenilenme) bildirir; isim cümlesi **sübût** (sabitlik, süreklilik) bildirir.
...
**Gramerde nedir?** Klasik nahivciler bu kelimenin cümledeki yeri konusunda ayrılırlar:
...
### İkinci: bağlaçsız dizi

Şimdi 2, 3 ve 4. ayetlerin başlarına bakın.

**Hiçbirinde bağlaç yok.**
...
Bu, aşağıdaki sıralama meselesinin cevabının yarısıdır ve şimdi oraya geliyorum.

### Üçüncü — ve asıl mesele: yaratmadan önce öğretmenin anılması

Sıra şudur:

1. **عَلَّمَ ٱلْقُرْءَانَ** — Kur'an'ı öğretti
2. **خَلَقَ ٱلْإِنسَٰنَ** — insanı yarattı
3. **عَلَّمَهُ ٱلْبَيَانَ** — ona beyanı öğretti

**Öğretme, yaratmadan önce anılıyor.** Oysa öğretilecek bir varlık olmadan öğretme olmaz.
...
| 4 | **3. ayetteki "insan" belirli bir kişidir** | Bir azınlık görüşü *el-insân*ı Peygamber'e yorar; o zaman sıra zaman bakımından da düzelir | 
...
**Bu tefsirde tercih birinci görüştür ve bağlayıcı değildir.**

### Ama sıralamanın bir işi daha var: yapının kendisi
...
**Aynı fiil, iki uçta. Yaratma ortada.**
...
Ve iki öğretmenin **nesneleri farklı**, ve fark belirleyicidir:
...
### عَلَّمَ — fiilin kalıbı ve eksik bırakılan nesne
...
**Ve ikinci ayette bir eksik var:** *alleme'l-Kur'ân* — kime öğretti?
...
Yani insana verilen şey "ses çıkarma yetisi" değil; **ayırma ve ayırdığını görünür kılma yetisi**dir.

### 2/31 ile bağ — bu sûrenin merkezî bağlantısı
...
>
> Ve adlandırma sıradan bir beceri değildir. Bir şeye ad vermek şunları gerektirir: **o şeyi çevresinden ayırt etmek**; benzerlerini bir kategoride toplamak; kategoriyi bir sese bağlamak; ve o sesi, nesne ortada yokken kullanabilmek.
...
Rahmân'da insana verilen şeyin adı **beyân**dır — ve bu kelimenin kökü tam olarak **ayırmak**tır.

**İki sûre, aynı yetiyi iki ayrı kelimeyle adlandırıyor. Ve iki kelimenin altında aynı işlem var.**
...
*Tekzîb* bir konuşma fiilidir. Yalanlamak için konuşmak gerekir; konuşmak için beyan gerekir.
...
Dört ayetin toplamı şudur: insanın eline bir **ayırt etme aleti** verilmiş.
...
Bunun somut karşılığı bulmakta zorlanılmaz: dilin en yaygın kötüye kullanımı yalan değil, **yanlış ayrım**dır. Aynı şeye iki ayrı ad vermek, iki ayrı şeye tek ad vermek, kategoriyi çıkara göre çizmek. Mürselât bölümünde *fark* kökü için kaydedilen ölçü burada da işliyor: ayırma işlemi tek başına ne iyidir ne kötü; değeri, **neyin neden ayrıldığına** bağlıdır.
...
> Güneş, Kur'an'ın tabiat tasvirinde bir sıcaklık ya da güzellik unsuru değil; öncelikle bir **saat**tir.
...
Aynı kelime, bir yerde göğün düzenini, başka bir yerde gökten inen bir cezayı adlandırıyor. Bu bir çelişki değil; **kökün altındaki fikrin doğrudan sonucudur.** *Husbân*ın altında "hesaplanmış olmak" vardır. Hesaplanmış bir yörünge de hesaplanmıştır, hesaplanmış bir darbe de.

Bunu bir dil gözlemi olarak kaydediyorum; iki ayetin lafızları metindedir.

**Bâ harfi.** *Bi-husbân*taki *bâ*, musâhabe (beraberlik) ya da zarfiyye olarak okunur: "bir hesapla birlikte" ya da "bir hesap içinde". İkisi de aynı sonucu verir. Cümle isim cümlesidir ve fiil yoktur — yine **sübût**: güneş ile ay "hesaplı hareket eder" değil, **"hesaplıdır."** Nitelik, davranışın değil varlığın parçası.
...
Yani **kökün kendisi iki alanı da karşılıyor**: gökte beliren de, yerden beliren de *necm*dir. İhtilaf buradan doğuyor.

| | **"Yıldız" okuması** | **"Gövdesiz bitki" okuması** |
|---|---|---|
| Anlam | Gökteki yıldız | Sapı olmayan, yerde yayılan bitki (ot, sarmaşık) |
| **Siyak delili** | Bir önceki ayet **güneş ve ay**dan söz ediyor; dizi gökte devam ediyor | Yanındaki kelime **ٱلشَّجَر** (gövdeli ağaç). İkisi bir çift kuruyor: **gövdesiz bitki / gövdeli bitki** |
| **Kur'an içi delil** | *"Güneş, ay, **yıldızlar**, dağlar, ağaçlar ve canlılar O'na secde eder"* (Hac 22/18) — orada *nücûm* ve *şecer* birlikte sayılıyor | Kur'an *necm*i yıldız için genellikle **çoğul** (*nücûm*) kullanır; burada tekil ve belirli |
...
**Klasik tefsirlerin çoğunluğu ikinci okumayı benimsemiştir** ve Târık bölümünde de bu kaydedilmişti. Gerekçe, kelimenin yanındaki *şecer*dir: Arapçada *necm* ile *şecer*, bitki dünyasını ikiye bölen yerleşik bir çifttir — **sapsız olan ve saplı olan.**
...
**Bu tefsirde eğilim ikinci okumadan yanadır ve bağlayıcı değildir.** Hac 22/18 birinci okumanın ciddi bir dayanağıdır ve elenemez; ama o ayette *nücûm* çoğul ve *şecer*den ayrı bir kalem olarak sayılmaktadır, burada ise tekil ve *şecer* ile aynı fiile bağlıdır.
...
- **مِيزَان** — Kâria bölümünde kaydedildiği gibi **mif'âl** vezninde **alet ismi**dir (aslı *miwzân*, *vâv* *yâ*ya dönüşmüştür). **Terazi**, yani aletin kendisi.
- **وَزْن** — **masdar**dır. **Tartma**, yani işin kendisi.
...
Ve o bölümde tam bu ayet, *kıst*ın Kur'an'daki yerleşik kullanımına örnek olarak veriliyordu.

**Buraya eklenecek olan:** *kıst*ın asıl anlamı **pay**dır. Yani "adaletle tartın" demek, "herkesin payını payı kadar verin" demektir. Adalet burada soyut bir erdem değil, **bir bölüştürme işlemi.**

Ve Mutaffifîn bölümünde *adl* kelimesi için kaydedilen tespit burada yankılanıyor: *adl*ın asıl anlamı **denklik**tir, *ıdl* devenin bir yanına yüklenen dengi adlandırır — yani adalet kavramının kendisi bir tartı görüntüsünden doğmuştur. Aynı sonuç *kıst* için de geçerli: kelime bir bölüşme görüntüsünden geliyor.
...
>
> **Tuğyan, bir varlığın kendi sınırını aşmasıdır.** Su, yatağını aştığında taşkın olur; taşkın su artık besleyen değil, yıkan sudur. Aynı su, aynı miktarda ama yatağının içinde kaldığında hayattır.
>
> Ve kökün Kur'an'daki simgesi Firavun'dur: *"Firavun'a git; o azdı"* (Nâziât 79/17). Tuğyanın en uç noktası, kendini rab konumuna koymaktır.
...
>
> Ve fiil **إفعال (if'âl)** babındadır: *ahsera* — başkasını zarara sokmak. Asr'da insan zararın **içindedir** (*fî husr*); Mutaffifîn'de insan başkasını zarara **sokar** (*yuhsirûn*).
...
Sekizinci ayetin başındaki **أَلَّا**, *en* + *lâ* birleşimidir ve iki türlü okunur:
...
Yukarıda kaydedildi: bu, yedinci ayetteki *vada'a*nın tekrarıdır. Terazi de yer de aynı fiille konuluyor. Ve gök **yükseltiliyor**, ikisi **konuluyor.**
...
Bakara bölümünde *cennet* kelimesi için kaydedilen tespit — kökün (*c-n-n*) **örtmek** olduğu ve *cennet*in "ağaçlarıyla toprağı örten bahçe" demek olduğu — burada yankılanıyor. Sûrede örtü fikri birden fazla yerde çıkacak.
...
"İnsanı, çömlek gibi çınlayan kuru bir çamurdan yarattı · cânnı da dumansız bir alevden yarattı."

Sûrenin ikinci bölümü ve iki ayetlik. İki tür, iki madde, iki cümle — ve cümleler birebir aynı kalıpta:

**خَلَقَ + ٱلْـ[tür] + مِنْ + [madde]**
...
**Kelimenin anlamı konusunda dilciler iki kol kaydeder:**
...
### كَٱلْفَخَّار — çömlek gibi

**Kök: ف-خ-ر.** *Fahhâr* — ateşte pişirilmiş kil, çömlek.
...
### مَّارِجٍ مِّن نَّار — karışık alev
...
Bu ayet o sınırın içinde kalıyor: bir madde adı veriyor, başka hiçbir şey söylemiyor.

### İki maddeyi karşılaştırmak
...
**İki ayrıntı üzerinde durmaya değer:**
...
**Bunları dizim gözlemleri olarak kaydediyorum.**

### Bir dizim notu: insan neden önce?

Ayet insanı önce anıyor. Oysa Kur'an başka bir yerde cinin **daha önce** yaratıldığını söyler:
...
*Rabbü'l-meşrikayni ve Rabbü'l-mağribeyn*

"İki doğunun Rabbi, iki batının Rabbi."

Tek ayetlik bir bölüm — sûrenin bu uzunlukta ilk bölümü.
...
Ve orada klasik müfessirlerin izahı kaydedilmişti:

> - **Tekil:** yön olarak doğu ve batı; iki temel istikamet.
> - **İkil:** güneşin **yaz ve kış aylarındaki iki uç doğuş ve batış noktası.** Bu, gözle görülebilir bir olgudur.
...
### Fark: burada ikil, orada çoğul

İki ayeti yan yana koymak, sayının neyi değiştirdiğini gösteriyor:
...
**Ve buradaki en dikkat çekici dizim farkı: رَبُّ kelimesinin tekrarlanması.**

Ayet *"iki doğunun ve iki batının Rabbi"* demiyor. **"İki doğunun Rabbi ve iki batının Rabbi"** diyor. Kelime iki kez geçiyor.

Meâric'te ise tek bir *Rabb* iki tamlananı birden taşıyor.

**Bu tekrarın iki izahı verilir:**
...
### Fasıladaki tek istisna

Ve burada bir ses notu düşmek gerekiyor.

Yukarıda ses yapısı bölümünde kaydedildiği gibi, sûrenin bütün fasılaları **uzun â + tek ünsüz** düzenindedir: *-ân*, *-âm*, *-âr*.

**Bu ayet bu düzenin dışındadır.** *el-mağribeyn* — uzun â yok; ikil ekinin *-ayn* biçimi var.

Ve dikkat çekici olan şu: bu istisnanın bulunduğu ayet, **konusu ikilik olan ayettir.**
...
> Kökün altındaki fikir **karıştırmak ve salıvermek**tir; ikisi bir aradadır, çünkü salıverilen şeyler karışır. *Merac* — otlak, hayvanın salıverildiği yer. *Merîc* — karışık (Kāf 50/5).

**Ve burada sûrenin en sıkı iç halkalarından biri var:**

| Ayet | Kelime | Neye ait |
|---|---|---|
| **15** | **مَارِج** — karışık/salıverilmiş | **Ateş** |
| **19** | **مَرَجَ** — salıverdi | **Su** |
...
> *"İki denizi salıveren O'dur: **şu tatlı ve susuzluk gideren, şu tuzlu ve acı.** İkisinin arasına bir berzah ve aşılmaz bir engel koydu."* (Furkān 25/53)
...
Ve fiil **muzâri**dir: *yeltekıyân* — "kavuşuyorlar", sürüp giden bir durum. Tek seferlik bir buluşma değil; kesintisiz bir temas.
...
## Modern oşinografi iddiası — gerekçeli bir ret
...
### Bir — Kur'an, iki denizin ne olduğunu kendisi söylüyor
...
### Üç — *lâ yebğıyân* fizik değil, ahlâk kelimesidir
...
### Dört — iddianın anlattığı bilim de tam doğru değil

İddiada sıkça şu söylenir: "modern bilim, denizlerin karışmadığını keşfetti."
...
**Ayetin söylediği ile iddianın söylediği aynı şey değil.**

### Beş — usul meselesi

Alak bölümünde kaydedilen ilke burada aynen geçerlidir ve tekrar edilmesi gerekiyor:
...
### Altı — ayetin kendi işi başka

Ve son gerekçe, en önemlisi.
...
Ayet bir coğrafya dersi vermiyor. **Bir sınırın tutuyor olmasını bir nimet olarak sayıyor.**
...
| Görüş | Anlam |
|---|---|
| **Mercan** | Denizde biten kırmızı, dallı yapı |
| **Küçük inci** | *Lü'lü'* büyük inci, *mercân* küçük inci |
...
**ٱلْجَوَارِ**, *câriye*nin çoğuludur: "akıp gidenler". Ve dikkat: gemi için seçilen ad, geminin yapısını değil **hareketini** anlatıyor.
...
| **ٱلْمُنشِـَٔات** (*münşiât*) | **İsm-i fâil** | **Yükselten**ler — yelkenlerini açıp yükselen gemiler |
...
| 2 | **عَلَّمَ** | Öğretti |
| 4 | **عَلَّمَ** | Öğretti |
| 24 | **ٱلْأَعْلَٰم** | Dağlar / yol işaretleri |
...
"Onun üzerinde bulunan herkes fânîdir · celâl ve ikram sahibi Rabbinin vechi ise bâkî kalır."

**Sûrenin ekseni burasıdır.**
...
### Dizim: bir isim cümlesi ve bir fiil cümlesi

İki ayetin gramer kuruluşu farklıdır ve fark anlamı taşıyor:
...
**Ve bu tercih dikkatle yapılmış gibi duruyor.**
...
Mürselât bölümünde *le-vâkı'* için kaydedilen ölçü burada da işliyor:
...
### فَانٍ / يَبْقَىٰ — iki kök

**فَنَاء — kök ف-ن-ي.** Tükenmek, sona ermek, yok olmak. Kelimenin somut kullanımı bir şeyin **bitmesi**dir — suyun tükenmesi, ömrün tamamlanması.

**بَقَاء — kök ب-ق-ي.** Kalmak, artakalmak, sürmek. Aynı kökten *bakiyye* (kalan, artan), *ebkā* (daha kalıcı) gelir.

**İkisi Kur'an'da düzenli olarak karşıt kullanılır:**

> *"Sizin yanınızdaki tükenir; Allah katındaki ise **bâkî**dir."* (Nahl 16/96) — *mâ ındeküm yenfedü ve mâ ındallâhi **bâk***
...
### مَنْ عَلَيْهَا — "onun üzerindeki"

**Zamir kime ait?** Ayette bir dişil zamir var (*aleyhâ*) ama mercîi bu ayette yok.
...
> **فَثَمَّ وَجْهُ ٱللَّهِ** — "orada Allah'ın vechi vardır". *Vech* kelimesi, "yüz" demek olsa da bütünü ve yönelişi karşılayabilir. Burada yaygın anlayış **"Allah'ın rızasının yöneldiği yön"** ya da **"O'na yönelme ciheti"**dir.
>
> **Ayet ne söylüyor:** Allah bir mekâna hapsedilemez. **Ayet ne söylemiyor:** yönün hiç önemi olmadığını.

**Şimdi bu iki kaydı bu ayete uygulayalım.**
...
**Bu ayette de aynı kelime Allah için kullanılıyor ve klasik anlayışlar şunlardır:**
...
**Tamlamanın anlamı konusunda iki okuma vardır:**
...
**Birinci okuma daha yaygındır** ve sûrenin bütünüyle uyumludur: sûre baştan sona ikramları sayıyor.

**Ve tamlamanın asıl gücü, iki kelimenin zıt yönlerde çekmesindedir:**
...
**İki kelime tek tamlamada birleştiriliyor.** Ve Fâtiha bölümünde *er-Rahmân er-Rahîm* ile *Mâliki yevmi'd-dîn*in sıralanışı için kaydedilen denge burada tek bir tamlamanın içine sıkıştırılmış:
...
Rahmân'da bu denge arka arkaya değil, **yan yana** kuruluyor: *zü'l-celâli ve'l-ikrâm.*

### İki ayetin sûredeki yeri

Ve şimdi asıl soruya geliyorum: **bu iki ayet niçin burada?**
...
**Hepsi sayıldıktan sonra ayet geliyor: "onun üzerinde bulunan herkes fânîdir."**

Sayılan nimetlerin sahibi de, sayılan nimetlerin çoğu da bu hükmün içinde.

**Ve ardından nakarat: "Rabbinizin hangi nimetlerini yalanlıyorsunuz?"**

Yukarıda nakarat bölümünde bu, sûrenin en zor cümlesi olarak kaydedilmişti. Burada tamamlıyorum.

**İki okuma mümkün ve ikisi de metne aykırı değil:**
...
**İkinci okuma: nakarat ikisini birden kapsıyor.** Ve bu okumada fânîliğin kendisi de listeye giriyor.
...
**Bir liste düşünün ki bütün kalemleri geçici, ve listenin başlığı "nimetler" olsun.**
...
**Ve bunun gündelik karşılığı şudur: bir şeyin değeri, süresiyle ölçülmüyor.**
...
**İki.** Cümle **isim cümlesi**dir: *hüve fî şe'n* — "O bir iştedir". Fiil yok. Yine sübût: bu, O'nun yaptığı bir şey değil, **bulunduğu bir durum.**
...
**Ayet ne söylemiyor:** Allah'ın kendisinin değiştiğini. Klasik kelâm geleneğinde bu ayrım titizlikle korunmuştur: değişen O'nun **işleri**dir, zâtı değil. Ayet zaten "her gün başka biri olur" demiyor; **"her gün bir iştedir"** diyor. Cümlenin öznesi O, yüklemi bir konumdur.
...
**Birinci cümle:** herkes O'ndan istiyor.
**İkinci cümle:** O her gün bir işte.
...
>
> Boşalmak, aynı zamanda **bir şeye tamamen yönelebilecek hale gelmek**tir. Boşluk, kendi başına bir hâl değil; bir sonraki yönelişin ön şartı.
...
Ve Kâria bölümünde *mevâzîn* için kaydedilen tespit bu bağı tamamlıyor: orada tartılan **ameller**di, terazi ise âhirettedir. Rahmân'da terazi dünyaya konmuş, tartılacak olan da adlandırılmış.
...
### يَٰمَعْشَرَ — "ey topluluk"

**Kök: ع-ش-ر.** Bu kökün çekirdeği **on** sayısıdır (*aşere*), ve buradan **bir arada bulunma** anlamına geçilir:
...
**Kök: ق-ط-ر.** *Kutr* — bir şeyin yanı, kenarı, tarafı, bölgesi. Çoğulu **أَقْطَار.**
...
### تَنفُذُوا۟ — delip geçmek

**Kök: ن-ف-ذ.** Bir şeyin içinden geçip öbür tarafa çıkmak, delip geçmek.
...
**Ayette fiil üç kez geçiyor** ve üç ayrı kipte:
...
**Bu, Kur'an'ın yerleşik meydan okuma kalıbıdır.** Mürselât bölümünde aynı yapı işlenmişti:
...
### إِلَّا بِسُلْطَٰنٍ — "ancak bir sultân ile"

**Kök: س-ل-ط.** Üstün gelmek, hâkim olmak. *Sultân*, *selîta*, *taslît* aynı kökten.

**Kelimenin anlamı konusunda iki görüş vardır ve ikisi de Kur'an'ın kendi kullanımına dayanır:**

| Görüş | Anlam | Kur'an'daki dayanağı |
|---|---|---|
| **Güç, kudret** | Ancak bir güçle geçebilirsiniz — ki yok | Kelimenin sözlükteki asıl anlamı |
| **Delil, hüccet, yetki** | Ancak bir delil/izinle geçebilirsiniz — ki verilmemiş | Kur'an *sultân*ı sık sık **delil** anlamında kullanır: *sultânin mübîn* — "apaçık delil" |
...
**Ve iki görüş birbirini dışlamıyor**, çünkü Arapçada *sultân*ın altındaki fikir tektir: **üstün gelme yetkisi.** Bir delil de üstün gelir, bir güç de.
...
### Ne zaman? — bir ihtilaf

**Ayetin hangi zamana ait olduğu tartışılmıştır:**
...
**Bu tefsirde eğilim birinci görüşten yanadır ve bağlayıcı değildir.**
...
Yani Kur'an bir sûrede meydan okuyor, başka bir sûrede meydan okunan taraf cevabı veriyor.

### Fennî yorum hakkında

**Bu ayete uzay yolculuğu anlamı verilmesi yaygın bir okumadır ve bu tefsirde benimsenmiyor.** Gerekçeler kısaca:

**Bir.** Ayetin fiili *seyahat* değil, *nüfûz*tur — bir sınırı **delip geçmek.** Uzaya çıkan bir araç, göklerin "sınırlarını" delip geçmiş olmuyor; onların içinde hareket ediyor.
...
**Bu tefsirde bu ayette kelimelerin anlamıyla yetiniliyor.**
...
Fiil **meçhul**dür: gönderilir, kim gönderir söylenmiyor. Mürselât bölümünde bu tercih ayrıntılı işlenmişti ve orada kaydedilen ölçü burada da geçerli: **sahne failsiz kuruluyor; olan bitene bakılıyor, yapana değil.**
...
*İftiâl* babının burada işlevi **dönüşlülük**tür: yardım dışarıdan gelmiyor; kişinin kendisine yardım etmesi söz konusu.
...
İki kelime de **nekre**dir: *insün*, *cânnün* — "bir insan", "bir cin". Belirlilik takısı yok.
...
> Bakara 2/273: **تَعْرِفُهُم بِسِيمَٰهُمْ** — "onları simalarından tanırsın" (yoksullar için)
> Rahmân 55/41: **يُعْرَفُ ٱلْمُجْرِمُونَ بِسِيمَٰهُمْ** — "suçlular simalarından tanınır"
...
>
> - *Hûd 11/56*: *"Hiçbir canlı yoktur ki O, onun perçeminden tutmuş olmasın."* — Bu ayet meseleyi kökten kuruyor: **hâkimiyet zaten fiilen O'nun elindedir.**
...
"İşte bu, suçluların yalanladığı cehennemdir · onunla kaynar su arasında dolaşıp dururlar."

Sûrenin azap bölümünün son parçası, ve iki ayet.

### هَٰذِهِۦ — "işte bu"

**Yakın işaret ismi.** Ve bu, dizimde bir iş görüyor.
...
### يُكَذِّبُ بِهَا — "yalanladıkları"

**Ve burada sûrenin en sıkı iç halkalarından biri var.**

Fiil **ك-ذ-ب** kökünden — **nakaratın kökü.**
...
**Otuz bir kez sorulan sorunun fiili, burada bir haber cümlesinin içinde geri geliyor.**

Ve fiil **muzâri**dir: *yükezzibü* — "yalanlıyorlar", "yalanlayıp durdukları". Yani cehennemin karşısında dururken bile, yalanlama fiili şimdiki zamanda anlatılıyor.
...
**Bunu kendi okumam olarak kaydediyorum.** İki ayetteki *beyne* yapısı metnin verisidir.

### حَمِيمٍ ءَانٍ — kaynar su
...
>
> Bu, dilin ilginç bir işleyişidir: kelime kendinde olumsuz değil, hatta olumlu bir çekirdek taşıyor — **kıvamına gelmek.** Kötülük kelimede değil, kıvamına gelen şeyde. **Suyun "olgunlaşması" onun içilemez hale gelmesidir.**
...
**Buraya eklenecek olan bir dizim notu:** iki kelime de **nekre**dir — *hamîmin ânin*, "kaynar bir su". Belirlilik yok. Ve nekre burada, Abese'deki *şe'n* için kaydedildiği gibi, **büyütme** işini görebiliyor.
...
Yapı şudur: **iki ayrı bahçe çifti anlatılıyor.**
...
Yani toplam **dört bahçe**, iki çift halinde.

## Önce yapı: birebir simetri

İki bölümün ayet dağılımına bakın:
...
**İki bölüm birebir eşit.** Aynı sayıda ayet, aynı sayıda nakarat, aynı sayıda tasvir.
...
Bunu bir yapı gözlemi olarak kaydediyorum; sayılar tablodan çıkarılmıştır ve doğrulanabilir.
...
## وَمِن دُونِهِمَا — "onların ötesinde" mi, "onlardan aşağıda" mı?

**İki bölüm arasındaki ilişkinin ne olduğu, tek bir kelimeye bağlıdır: دُون.**

Ve bu kelime Arapçada **iki ayrı şey** ifade eder:

| Okuma | Anlam | Sonuç |
|---|---|---|
| **Aşağı, alt derece** | "Onlardan daha aşağıda olan iki bahçe" | İki çift arasında bir **derece farkı** vardır |
| **Başka, öte, beride** | "Onlardan başka iki bahçe" ya da "onların berisinde" | İki çift **eşit**tir; yalnızca iki ayrı yerdir |
...
**Bu tefsirde eğilim birinci okumadan yanadır ve bağlayıcı değildir.** İki gerekçeyle:

**Bir.** Kelimenin yaygın kullanımı budur.
...
**Ama burada dürüst olmak gerekiyor ve klasik yorumun bir zayıflığını kaydetmem lazım.**

## Farkların hepsi "derece farkı" değil

Klasik tefsirlerin çoğu, *dûn*u "aşağı" okuduktan sonra **bütün ayrıntıları o okumaya göre yorumlamıştır.** Yani her fark, ikinci çiftin daha aşağı olduğunun delili sayılmıştır.

**Bu yöntem her ayrıntıda aynı derecede işlemiyor. Tek tek bakalım:**

### Derece okumasını destekleyen farklar
...
**Kök: ن-ض-خ.** Fışkırmak, kaynayıp taşmak. Dilciler *nadh* ile *nadh* arasında bir derece farkı kaydeder ve *nadh*ı daha güçlü sayarlar.
...
İkinci çiftte ise dış görünüş anlatılıyor: yeşil, güzel.

**Bu fark da savunulabilir**, ama yine tasvirden değil, tasvirin **hangi tarafını** anlattığından çıkıyor.

### Derece okumasına uymayan bir fark
...
**Şunu kaydediyorum ve kendi değerlendirmem olarak sunuyorum:**
...
## Ve asıl mesele: karşılaştırmanın kendisi

Şimdi bu bölümün en önemli noktasına geliyorum ve **kendi okumam olarak** kaydediyorum.

**Sûre, iki bahçe çiftini yan yana koymakla bir şey yapıyor ve yaptığı şey ayrıntılardan bağımsızdır.**
...
**Yani derece farkını kuran şey, ayrıntılardan önce yapının kendisidir.**

Kıyâme bölümünde *mukābele* için kaydedilen tespit burada da işliyor:

> Aynı özne, aynı zaman zarfı, aynı yerde tek kelime farklı — Arapçada buna *mukābele* denir, ve etkisi şudur: iki grup arasındaki fark dışarıdan gelen bir muamele farkı gibi değil, **aynı cümlenin iki farklı doldurulması** gibi sunuluyor.

**Rahmân'da mukābele iki tarafı zıt yapmak için değil, iki tarafı derecelendirmek için kullanılıyor.** Abese ve Kıyâme'de iki tablo **karşıt**tı: cennet ve cehennem, parlayan yüz ve toz basmış yüz. Burada iki tablo **aynı taraftan**: ikisi de bahçe.
...
**Buraya eklenecek olan bir fark var ve kaydedilmeli.**
...
**Nâziât'ta iki şart ve tek cennet; Rahmân'da tek şart ve iki cennet.**
...
**خَافَ — kök خ-و-ف.** Korku. Ve Kur'an bu kökü *haşyet*ten ayırır: *havf* daha genel bir çekinme, *haşyet* bilgiye dayanan bir saygılı korku bildirir. Burada *havf* kullanılıyor.
...
**جَنَّتَان** — ikil. Ve klasik tefsirlerde bunun sebebi tartışılmıştır:
...
**ذَوَاتَآ** — *zât*ın ikili: "sahibi olan ikisi".

**أَفْنَان** kelimesinin anlamı konusunda **iki görüş** vardır ve ikisi de iki ayrı kökten çıkar:
...
Mürselât bölümünde *uyûn* (pınarlar) bahsinde bu işlenmişti; tekrarlamıyorum.

**تَجْرِيَانِ** — yine **ج-ر-ي** kökü, yirmi dördüncü ayetteki *el-cevâr* (gemiler) ile aynı. Hâkka bölümünde kaydedildiği gibi kökün taşıdığı tek fikir **hareketin sürekliliği**dir.
...
"İkisinde her meyveden iki çift var."

Bu ayet yukarıda ses yapısı bölümünde Zâriyât 51/49 ile birlikte ele alındı; tekrarlamıyorum.

**زَوْج — kök ز-و-ج.** Ve kelimenin Arapçadaki işleyişi üzerinde durmaya değer: *zevc*, Arapçada **çiftin bir yarısı** demektir, çiftin kendisi değil. Yani bir adam da *zevc*tir, karısı da *zevc*tir. Türkçedeki "zevce" (kadın eş) kelimesi Arapçada da vardır ama asıl kullanım her iki taraf için *zevc*tir.

**Buradan çıkan sonuç:** *zevcân* — "iki *zevc*", yani **bir çiftin iki yarısı.** Ayet "iki çeşit" demiyor; **bir bütünün iki parçası** diyor.

Bu ayrımı bir dil notu olarak kaydediyorum.

### 55/54 — مُتَّكِـِٔينَ عَلَىٰ فُرُشٍۭ بَطَآئِنُهَا مِنْ إِسْتَبْرَقٍ وَجَنَى ٱلْجَنَّتَيْنِ دَانٍ

*Müttekiîne alâ furuşin batāinuhâ min istebrak, ve cene'l-cenneteyni dânin*
"Astarları kalın ipekten döşeklere yaslanmış olarak; ve iki bahçenin devşirilecek meyvesi yakındır."
...
**بَطَآئِن — tekili بِطَانَة.** **Astar**, iç yüz. Karşıtı **ظِهَارَة** (*zıhâre*) — dış yüz.
...
**وَجَنَى ٱلْجَنَّتَيْنِ دَانٍ** — "iki bahçenin devşirilecek meyvesi yakındır."

**جَنَى — kök ج-ن-ي.** Toplamak, devşirmek. *Cenâ*, devşirilmeye hazır meyve.
...
Bunu bir ses gözlemi olarak kaydediyorum, etimolojik bir bağ olarak değil.
...
**Üçü de nakledilir ve tercih dayatmıyorum.**

**قَٰصِرَٰتُ ٱلطَّرْف — "bakışlarını kısanlar"**

**Kök: ق-ص-ر.** Kısaltmak, sınırlamak, bir yerde tutmak.
...
**Ve burada sûrenin en zarif kelime örgülerinden biri var:**
...
**Aynı kök, iki bahçe çiftinde, biri etken biri edilgen.**
...
**طَرْف — kök ط-ر-ف.** Göz kapağının kenarı; ve buradan **bakış.** Aynı kökten *taraf* (kenar, uç) gelir.

**Yani *kāsırâtü't-tarf* harfiyen "bakışı kısanlar" demektir** — bakışın menzilini sınırlayanlar.

**Klasik izahlarda iki anlam verilir:**
...
**لَمْ يَطْمِثْهُنَّ — "el değmemiş"**
...
**Ayetteki anlam açıktır: daha önce hiçbir temas olmamıştır.**

**Ve dikkat çekici olan, temasın reddedildiği iki taraftır: إِنسٌ وَلَا جَآنّ** — ne insan ne cin.
...
*Ke-ennehünne'l-yâkūtü ve'l-mercân*
"Sanki onlar yakut ve mercandır."

**Bir benzetme ayeti, ve iki taşla kuruluyor.**
...
**ٱلْمَرْجَان** — yirmi ikinci ayette geçmişti ve orada ele alındı.

**Ve işte sûrenin iç halkası:**
...
**Denizden çıkarılan şey, bahçede benzetme olarak geri dönüyor.**
...
**Bunu kendi okumam olarak kaydediyorum.** İki kelimenin sûredeki yerleri metnin verisidir.
...
*Hel cezâü'l-ihsâni ille'l-ihsân*
"İhsanın karşılığı ihsandan başka bir şey midir?"

**Sûrenin iki kural cümlesinden biri.** Diğeri 26-27. ayetlerdi.

### Sorunun türü

**هَلْ** ile başlayan bu cümle bilgi soran bir soru değil, **istifhâm-ı inkârî**dir — cevabı içinde olan, olumsuzlama bildiren bir soru. Türkçesi: "olamaz."

Ve **إِلَّا** ile birlikte kurulan bu yapı Arapçada **hasr** (sınırlama) bildirir: *"…başka bir şey midir?"* = *"…ancak odur."*

Yani cümle şunu söylüyor: **ihsanın karşılığı yalnızca ihsandır.**
...
**Ayetteki asıl nükte, kelimenin iki kez geçmesidir — ve iki geçiş aynı kelimedir.**

Cümle *"iyiliğin karşılığı mükâfattır"* demiyor. **"İhsanın karşılığı ihsandır"** diyor. Yani karşılık, verilenle **aynı adı taşıyor.**

**Ve iki *ihsân*ın kime ait olduğu konusunda iki okuma vardır:**
...
**İkisi çelişmiyor:** genel kural, özel duruma da uygulanır.
...
## Ayet ayet: ikinci çift

### 55/62 — وَمِن دُونِهِمَا جَنَّتَانِ

*Ve min dûnihimâ cennetân*
"Ve onların ötesinde iki bahçe daha."

*Dûn* kelimesinin iki okuması yukarıda ele alındı; tekrarlamıyorum.

**Bir dizim notu:** ayet, birinci çiftin açılış ayetiyle (46) karşılaştırıldığında bir şey eksik veriyor.

| | **46** | **62** |
|---|---|---|
| Kime | **وَلِمَنْ خَافَ مَقَامَ رَبِّهِۦ** — Rabbinin makamından korkana | **Söylenmiyor** |
| Ne | *cennetân* | *cennetân* |
...
**Bunu kaydediyorum ama metinde açıkça söylenmediğini de kaydediyorum.**

### 55/64 — مُدْهَآمَّتَانِ

*Müdhâmmetân*
"Kapkara yeşil olan ikisi."

**Sûrenin en kısa ayeti: tek kelime.** Ve o tek kelime **ikil**.

**Kök: د-ه-م.** Kararmak, siyaha çalmak. *Edhem* — siyah at. *Dühme* — karanlık.
...
**Yani kelime "yeşil" demiyor, "koyulaşmış" diyor.** Yeşilliğin, siyaha çalacak kadar koyulaşmış hali.
...
*Fîhimâ aynâni naddâhatân*
"İkisinde fışkıran iki pınar var."

**Kök: ن-ض-خ.** Fışkırmak, kuvvetle püskürmek.
...
**Ve karşılık gelen ayetle (50) farkı:**
...
Bunu bir dizim gözlemi olarak kaydediyorum ve buradan bir derece sonucu çıkarmıyorum.

### 55/68 — فِيهِمَا فَٰكِهَةٌ وَنَخْلٌ وَرُمَّانٌ

*Fîhimâ fâkihetün ve nahlün ve rummân*
"İkisinde meyve, hurma ve nar var."

**Ve burada bir gramer sorusu var, klasik dönemden beri tartışılmıştır:**

Ayet önce **فَٰكِهَة** (meyve) diyor, sonra **نَخْل** (hurma) ve **رُمَّان** (nar) sayıyor.

**Hurma ve nar zaten meyve değil mi? Öyleyse neden ayrıca sayılıyorlar?**
...
| **Hurma ve nar meyve sayılmıyor** | Bazı dilciler *fâkihe*yi "yenmesi zorunlu olmayan tatlı meyve" diye dar tanımlar; hurma gıda, nar ise ilaç sayılırsa ayrı bir kalem olurlar |
...
"İçlerinde iyi huylu, güzel olanlar var."

**İki kelime, iki ayrı alan.**

**خَيْرَات — kök خ-ي-ر.** İyilik, hayır. *Hayrât*, *hayre*nin çoğuludur: "iyi olanlar".
...
**Bu okuma yaygındır ve anlamı belirler:** *hayrât*, ahlâkî bir vasıftır — huy güzelliği.

**حِسَان — kök ح-س-ن.** *Hasen*in çoğulu: güzel olanlar. Ve bu kök on ayet önce, altmışıncı ayette **ihsan** olarak geçmişti.

**Ve iki kelimenin sırası anlamlıdır ve kaydedilmeli:**

| Sıra | Kelime | Alan |
|---|---|---|
| **1** | **خَيْرَات** | **Huy** — ahlâkî |
| **2** | **حِسَان** | **Görünüş** — estetik |

**Huy önce, görünüş sonra.**
...
*Hûrun maksûrâtün fi'l-hıyâm*
"Çadırlarda ikamet eden hûriler."

### حُور — hûr

**Kök: ح-و-ر.** Ve bu kökün altında birbirinden uzak görünen bir aile var:
...
**Ayetteki anlam ise tartışmasızdır: göz güzelliğiyle nitelenen eşler.**
...
### مَّقْصُورَٰت — ikamet edenler

Yukarıda 56. ayette kaydedildi: bu kelime **ق-ص-ر** kökünden **ism-i mef'ûl**dür ve elli altıncı ayetteki *kāsırât* (ism-i fâil) ile bir çift kurar.

**Anlamı konusunda iki görüş vardır:**
...
**İkisi de nakledilir ve çelişmezler.**

### فِى ٱلْخِيَام — çadırlarda

**خِيَام — tekili خَيْمَة.** Çadır.

**Ve kelimenin seçimi bir tarihî arka plan taşıyor.** Muhataplar çadırı biliyorlardı; çöl toplumunda çadır bir yoksulluk işareti değil, **yerleşim biçimi**dir. Ve büyük çadırlar bir statü göstergesiydi.
...
Elli altıncı ayetin **birebir tekrarı.** Yukarıda ele alındı; tekrarlamıyorum.
...
*Müttekiîne alâ rafrafin hudrin ve abkariyyin hisân*
"Yeşil yastıklara ve güzel döşemelere yaslanmış olarak."

**رَفْرَف.** Anlamı konusunda dilciler ayrılır:

| Görüş | Anlam |
|---|---|
| **Yastık / minder** | Yaslanılan şey |
| **İnce yeşil kumaş** | Örtü, döşeme |
| **Bahçe / çimenlik** | Yeşillik |
...
**عَبْقَرِىّ.** Ve bu kelimenin bir hikâyesi var.
...
**Ayetteki anlamı: değerli, ince işlenmiş döşeme.**

### İki oturuş tasvirini karşılaştırmak
...
**Ve iki ayetin ortak açılışı dikkat çekicidir: مُتَّكِـِٔينَ عَلَىٰ.**

İki bahçe çiftinin **son tasvir ayeti** aynı kelimeyle başlıyor. Yani iki bölüm, aynı duruşla kapanıyor.

**Bu simetriyi bir yapı gözlemi olarak kaydediyorum.**
...
*Tebârake'smü Rabbike zi'l-celâli ve'l-ikrâm*
...
**Bunu kendi okumam olarak kaydediyorum.** *Rahmân*ın yalnız Allah için kullanıldığı Fâtiha bölümünde belgelendi; *tebârake*nin kullanımı hakkındaki tespiti ise Kur'an metninden çıkarılmış bir gözlem olarak sunuyorum.
...
Besmelede kul, Zât'a değil isme tutunuyordu. Rahmân'ın son ayetinde ise mübarek kılınan şey yine **isim**dir.
...
**Ve isim kökünün "alâmet" koluna dikkat.** Fâtiha'da kaydedildiği gibi *isim*, bir görüşe göre **و-س-م** kökünden gelir — damga, alâmet. Ve sûrenin kırk birinci ayetinde suçlular **سِيمَا**larından tanınıyordu — aynı kökten sayılan bir kelime.
...
Bu, i'râbdan doğrudan okunabilen bir farktır: *zû* merfûdur ve merfû olan *vech*i niteler; *zî* mecrûrdur ve mecrûr olan *Rabbike*yi niteler.
...
**İki. Muhatap değişiyor.** Birinci ayette hiçbir muhatap yok. Nakaratlarda muhatap **ikil**dir (*Rabbikümâ*). Son ayette muhatap **tekil**dir: *Rabbike* — "senin Rabbin".
...
Fâtiha bölümünde bu iki ismin farkı işlenmişti: *er-Rahmân* kapsayıcıdır — mümin, kâfir, hayvan, bitki, hepsini kapsar. *Rabb* ise Fâtiha'da kaydedildiği gibi **terbiye eden**dir ve bir **ilişki** bildirir: "senin Rabbin".
...
## Yapı: bir nakaratın böldüğü otuz bir bölüm
...
**Bir — sûre üç büyük parçadan oluşuyor ve parçalar eşit değil:**
...
| **ذُو ٱلْجَلَٰلِ وَٱلْإِكْرَام** | (27) — *zû*, **vech**e bağlı | (78) — *zî*, **Rabb**e bağlı | **Sûrenin dış çerçevesi** |
...
Bu tefsirde birkaç bölümde uygulanan bir ölçü: metnin **söylemediklerini** de kaydetmek.
...
**Üç — bir tarihî olay anlatılmıyor.** Kur'an'ın kıssa anlatımı bu sûrede hiç yok. Sûre bir anlatı değil, bir **sayım**dır.
...
Sûre bir delil sunmuyor, bir **envanter** çıkarıyor. Ve envanterin mantığı şudur:

1. **Bir isim söyleniyor:** er-Rahmân (1).
2. **O ismin fiilleri sayılıyor:** öğretti, yarattı, öğretti (2-4).
3. **Düzen gösteriliyor:** hesap, secde, terazi, sınır (5-9).
4. **Rızık gösteriliyor:** yer, meyve, tane, koku (10-12).
5. **Soru soruluyor** — ve otuz kez daha sorulacak (13).
6. **Muhatap adlandırılıyor:** insan ve cin (14-15).
7. **Sınırın işlediği gösteriliyor:** iki ufuk, iki deniz, berzah (17-25).
8. **Kimin kalıcı olduğu söyleniyor:** her şey fânî, O bâkî (26-27).
9. **Hesap ilan ediliyor:** sıra size gelecek (31).
10. **Kaçış imkânı kapatılıyor:** sınırdan geçemezsiniz (33).
11. **Sonuç gösteriliyor:** ateş, yarılan gök, yakalanan suçlular, cehennem (35-44).
12. **Karşı taraf gösteriliyor:** iki bahçe, sonra iki bahçe daha (46-77).
...
Ve reddedilecek bir kalem gösterilemediği sürece soru cevapsız kalır.

---

## Bugüne bakan yönü

**Birincisi: ölçünün tek olması.**
...
**İkincisi: sınırın kendisinin bir nimet olması.**
...
**Ve sûre bunları nimet olarak sayıyor.**
...
Ve ayet bunu bir öğüt olarak değil, **bir tarif olarak** söylüyor: denizler zaten böyle davranıyor.

**Üçüncüsü: nimetin ne olduğunun tanımı.**

Yukarıda nakarat bölümünde ayrıntılı işlendi ve burada tekrarlamıyorum; sonucu toparlıyorum.
...
Yukarıda kaydedildiği gibi *tekzîb* bir konuşma fiilidir. Yalanlamak için beyan gerekir.

**Yani sûre, insanın ayırt edici yetisinin aynı zamanda onun ayırt edici tehlikesi olduğunu söylüyor.**
...
**Ve sûre bu ikisi arasında bir ölçü koymuyor — bir soru koyuyor.** Otuz bir kez.

**Beşincisi: bir soruyla yaşamak.**

Sûrenin biçimi de bir şey söylüyor ve bu, Mürselât'ta kaydedilenden farklı bir şey.
...
Ve sûrenin cevabı metne yazmaması bunun içindir: **cevabın yeri okuyucudadır.**

**Altıncısı: karşılaştırmanın kendisi.**
...
**Yedincisi: ismin mübarek kılınması.**
...
**Metin hiçbir yerde muhataptan ulaşamayacağı bir şeye ulaşmasını istemiyor.**

---

## Komşu sûreler

Mushaf tertibinde bu sûrenin öncesinde Kamer, sonrasında Vâkıa vardır. İki bağ kaydedilmeye değer.
...
Ve Rahmân şöyle açılır: **ٱلرَّحْمَٰنُ.**
...
Rahmân iki bahçe çiftiyle bitiyor; Vâkıa üç sınıfla başlıyor.
...
- **55/4'teki *beyân* ile Bakara 2/31'deki adlandırma yetisi arasında kurduğum bağ**, iki kökün anlamına dayanır ve kökler tartışmasızdır; ama **bağın kendisi benim okumamdır.** Aynı şekilde *beyân* (4) ile *tükezzibân* (13) arasında kurduğum ahlâkî bağ da bana aittir.

- **55/6'daki النجم kelimesinin** "yıldız" mı "gövdesiz bitki" mi olduğu tablolandı. İkinci okumadan yana **eğilim** belirtildi ve **bağlayıcı olmadığı**, Hac 22/18'in birinci okumaya ciddi bir dayanak verdiği kaydedildi. Sûrenin çift örgüsünden çıkardığım ek gerekçe **kendi okumamdır.**

- **55/7-9'daki üç *mîzân*ın üç ayrı gramer konumunda bulunması** doğrulanabilir bir i'râb verisidir; **üç konumun "kozmikten ticarîye bir iniş" oluşturduğu yorumu bana aittir.**
...
- **55/27'deki وجه kelimesinin** üç anlayışı tablolandı ve **tercih dayatılmadı**; Bakara 2/112 ve 2/115'teki tespitlere dayanıldı.
...
- **55/39'un Hicr 15/92-93 ile görünen gerilimi** gizlenmedi; üç izah tablolandı, üçüncüsünden yana **eğilim** belirtildi ve **bağlayıcı olmadığı** yazıldı.
...
- **Mürselât ile kurulan bütün karşılaştırmalar** (nakarat türü, bölüm eğrisi, *fe-bi-eyyi* ortaklığı, soru/hüküm terslemesi) iki metnin doğrulanabilir verilerine dayanır; ama **iki sûre arasında bilinçli bir gönderme olduğu iddia edilmedi** ve bu her seferinde ayrıca yazıldı.
