...
**Aynı kökün "yöneltme" anlamı `048-fetih.md`'de *hedy* (kurbanlık — yerine gönderilen hayvan) kelimesi işlenirken kaydedilmişti.** Oraya dayanıyorum. **Ve bu kök bu sûrede bir kez daha dönecek** (22/37 bölümünde ele alınacak) — aynı kök, aynı sûrede iki ayrı yerde.
...
**`040-gafir.md` 40/67'de aynı aşamalı oluşum altı basamakla işlendi ve orada bir STYLE sınırı çizildi. `039-zumer.md` 39/6'da (*halkan min ba'di halkın fî zulümâtin selâs*) aynı sınır tekrarlandı. Aynı sınırı burada da koruyorum ve gerekçesiyle tekrar ediyorum:**
...
**Ve dördüncü maddedeki *lâ raybe fîhâ* kaydı, beşinci ayetin ilk kelimesine cevaptır:** ayet *in küntüm fî **raybin*** diye açılmıştı. **Aynı kök, iki ayet sonra reddedilerek geri geliyor.** Bu, metinden doğrulanabilir bir halkadır.
...
| Sıra | Kelime | Kim |
|---|---|---|
| 1 | **رِجَالًا** | **Yaya** — *ricl* (ayak) kökünden; yürüyerek gelen |
...
**ق-ن-ع kökü hakkında bir kayıt gerekiyor:** kök hem "kanaat etmek" hem "istemek" anlamına gelebilir (*kania* — razı oldu; *kanaa* — istedi). **Dilciler bu ayrımı kaydeder ve buradaki kullanımın hangisi olduğu tartışılmıştır.**
...
**Üç grubun üçünde de kalp geçiyor.** Bu, iki ayette üç kez tekrarlanan bir kelimedir.
...
**Ve fiil, yetmiş beşinci ayetteki *yastafî* (seçer) ile aynı işi görüyor.** **İki fiil aynı bölüm içinde iki ayette: biri elçiler için, öteki muhataplar için.**
...
| Aşamalı oluşum ve STYLE sınırı | `040-gafir.md` 40/67, `039-zumer.md` 39/6 |
