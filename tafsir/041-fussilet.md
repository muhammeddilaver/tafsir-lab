...
*Hâ-mîm* ile açılan yedi sûrenin ikincisidir.
...
**Kökün somut anlamı: iki şeyi birbirinden ayırmak, aralarına mesafe koymak.** Kök dizinde birkaç yerde çözümlendi — `077-murselat.md` ve `078-nebe.md`'de *yevmü'l-fasl* (ayırma günü) bağlamında. **Tekrarlamıyorum.**
...
**Diğer *hâ-mîm* sûrelerinde bu cümle *minallâhi'l-azîzi'l-hakîm* (üstün ve hikmet sahibi Allah'tan) biçimindedir** — `045-casiye.md` 45/2 ve `046-ahkaf.md` 46/2'de böyle geçti ve orada işlendi.
...
**`045-casiye.md` 45/8'de bunun tersi bir sahne işlendi:** orada tip **işitiyor**, sonra direniyordu. **İki sûre, aynı meselenin iki ayrı aşamasını anlatıyor: biri işitip direnmeyi, öteki direnmenin işitmeyi kapatmasını.**
...
### Üç engel, üç ayrı yer

**Karşı taraf kendi durumunu tarif ediyor ve üç kelime kullanıyor:**
...
**ك-ن-ن kökü `056-vakia.md`'de çözümlendi** (*el-lü'lüi'l-meknûn* — sedefinde saklı inci; *kinân* — kılıf). **Tekrarlamıyorum.** **Buradaki kullanım tersine dönmüş: orada korumaydı, burada kapanmışlık.**

**و-ق-ر kökü ağırlık bildirir** (`071-nuh.md` ve `051-zariyat.md`'de geçti); *vakār* (ağırbaşlılık) da bu köktendir. **Kulaktaki ağırlık, sesin girmesini engelleyen yüktür.**
...
**فَٱسْتَقِيمُوٓا۟ إِلَيْهِ** — *istikāmet* kökü **ق-و-م**; kelimenin tahlili `002-bakara.md` 2/255'te ve bu dizinde `046-ahkaf.md` 46/13'te yapıldı.
...
**أَجْرٌ غَيْرُ مَمْنُونٍ** — "kesintisiz bir karşılık". **م-ن-ن** kökü: kesmek; ve iyiliği başa kakmak. **`095-tin.md`'de aynı terkip işlendi** ve `002-bakara.md` 2/262-264'te *menn* (başa kakma) çözümlendi. **İki anlam da burada işler: ne kesilen ne başa kakılan bir karşılık.**
...
| Kavim | Kusur | İfade |
|---|---|---|
| **Âd** | **Güç ölçüsü** | *Men eşeddü minnâ kuvveten* |
| **Semûd** | **Tercih** | *Festehabbü'l-amâ ale'l-hüdâ* |
...
**`045-casiye.md` 45/23'te ve `046-ahkaf.md` 46/26'da kulak-göz-kalp üçlüsü işlenmişti.** **Burada üçüncü sırada *kalp* değil *cild* (deri) var.**

| Yer | Üçlü |
|---|---|
| Ahkāf 46/26 · Câsiye 45/23 | Kulak · göz · **kalp** |
...
**`045-casiye.md` 45/29'da kitabın *yentıku* (konuşuyor) fiiliyle anıldığını işlemiştim** — orada **belge** konuşuyordu, burada **beden.** **Aynı kök (ن-ط-ق), iki sûrede iki ayrı şahit.**
...
**Sebep açıkça adlandırılıyor ve kelime *zann*dır.**

**`045-casiye.md`'nin bütün ekseninin bu kelime olduğunu orada tablolamıştım** (45/24 *in hüm illâ yezunnûn*, 45/32 *in nezunnü illâ zannâ*). **Burada aynı kelime bir adım öteye götürülüyor: zan yalnız bilgi eksikliği değil, *helâk sebebi* olarak anılıyor.**
...
### Taktik olarak gürültü

**Bu ayet, sûrenin en somut sahnesidir ve beşinci ayetle birlikte okunmalıdır.**
...
**وَٱلْغَوْا۟ فِيهِ** — fiil **ل-غ-و** kökünden: *lağv* — **hesaba katılmayan, boşa giden söz.** Kök `056-vakia.md` 56/25'te ayrıntılı çözümlendi (dilcilerin kaydettiği "kuşun ötmesi" kullanımı ve *lüğa* ile ilişkisi dahil). **Tekrarlamıyorum.**
...
**قُرَنَآء** — kök **ق-ر-ن**: iki şeyi yan yana bağlamak. *Karîn* — **sürekli yanında olan, eşlik eden.**
...
**مِنَ ٱلْجِنِّ وَٱلْإِنسِ** — iki cins birlikte anılıyor. **`046-ahkaf.md` 46/18'de de aynı ikili geçmişti** ve orada işlendi.
...
**Ayetin ilk yarısı, `046-ahkaf.md` 46/13 ile kelime kelime aynıdır:** *inne'llezîne kālû rabbüne'llâhü sümme'stekāmû.*
...
**ٱدْفَعْ بِٱلَّتِى هِىَ أَحْسَنُ** — *def'* — kök **د-ف-ع**: itmek, geri püskürtmek. **`002-bakara.md` 2/251'de aynı kök işlendi** (*ve levlâ def'ullâhi'n-nâse ba'dahüm bi-ba'd*): **dengenin, güçlerin birbirini sınırlamasıyla kurulması.**
...
**وَلِىٌّ حَمِيمٌ** — *hamîm* kelimesi **ح-م-م** kökündendir ve kökün iki dalı (**kaynar su** / **yakın dost**) `069-hakka.md`'de ayrıntılı işlendi; `056-vakia.md`'de de kaynar su dalı üç kez geçmişti. **Burada dostluk dalı kullanılıyor.**
...
**اِهْتَزَّتْ وَرَبَتْ** — *ihtizâz* (titremek, kımıldamak) ve *rabve* (kabarmak, yükselmek — **ر-ب-و** kökü; `002-bakara.md` 2/275'te *ribâ* bahsinde işlendi).
...
**Kırk ayet arayla aynı kelime, biri iddia biri hüküm olarak.** **Sûre, karşı tarafın kendi hakkında söylediğini sonunda tasdik ediyor** — ama bir farkla: beşinci ayette bu bir **mazeret**ti, burada bir **durum tespiti.**
...
**Bu, dizinde birkaç yerde işlenen bir hattır:** `002-bakara.md` 2/213 ve 2/253, `045-casiye.md` 45/17. **Hepsinde aynı şey söyleniyor: ihtilaf, kitap geldikten sonra çıkıyor.** Oralara dayanıyorum.
...
**بِظَلَّٰمٍ لِّلْعَبِيدِ** — *zallâm*, mübalağa kalıbıdır (*fa''âl*).
...
**Kelime `055-rahman.md` 55/11'de geçti** (*ve'n-nahlü zâtü'l-ekmâm*) ve orada işlendi. **Tekrarlamıyorum.**
...
| Ayet | Kim | Neyden usanmıyor |
|---|---|---|
| 38 | *Ellezîne inde rabbik* | **Tesbihten** — gece gündüz |
| **49** | *el-İnsân* | **Hayır istemekten** |
...
**يَـُٔوس** ve **قَنُوط** — ikisi de mübalağa kalıbındadır. **ي-أ-س**: umudu kesmek. **ق-ن-ط** — **kök dizinde ilk kez burada geçiyor**: dilcilerin verdiği anlam **umudun tamamen kesilmesi, karamsarlığın yerleşmesi**dir.
...
**Ayet bir iddia kurmuyor — bir ihtimal kuruyor.** *İn kâne min indillâh* — "ya öyleyse?"
...
**شِقَاق** — kök **ش-ق-ق**: yarmak, ikiye ayırmak. **Kök `054-kamer.md` 54/1'de (*ve'nşakka'l-kamer*) ve `084-insikak.md`'de işlendi.** *Şikāk*, iki tarafın **ayrı yarılara** düşmesidir.

**Ve sıfat *baîd* (uzak):** ayrılık yalnız var değil, **mesafesi de büyük.** **`050-kaf.md` 50/3'te aynı sıfat (*rec'un baîd*) işlenmişti** — orada inkâr edenler dirilişi "uzak" saymıştı. **Burada uzak olan, kendi durumlarıdır.**
...
**Klasik tefsirlerde de birden fazla okuma nakledilir:**
...
**مِرْيَة** — kök **م-ر-ي**: dilcilerin kaydettiği somut anlam, **hayvanın memesini sağmak için sıkmak, çekiştirmek**tir; buradan "bir meselenin üzerinde çekişmek, şüphe içinde bocalamak" anlamı doğar.

**مُّحِيط** — kök **ح-و-ط**: kuşatmak, etrafını çevirmek. **Kök `002-bakara.md` 2/255'te işlendi** (*ve lâ yuhîtûne bi-şey'in min ilmih* — insanın kuşatamaması). **Burada aynı kök, tersinden: O her şeyi kuşatandır.**
