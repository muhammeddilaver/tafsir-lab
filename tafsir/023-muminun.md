...
Ve **birinci liste, Furkān sûresinin sonundaki *ıbâdü'r-rahmân* listesiyle** (25/63-77) birlikte okunmalıdır. `025-furkan.md`'de o liste ayrıntılı olarak işlendi. **İki liste bu dosyada tablo hâlinde karşılaştırılacak:** ortak maddeler, yalnız birinde bulunanlar, ve iki listenin sûre içindeki konumu.
...
**Kök `002-bakara.md`'de çözümlendi ve `091-sems.md` 91/9 (*kad efleha men zekkâhâ*) ile `087-ala.md` 87/14 (*kad efleha men tezekkâ*) bahislerinde genişletildi.** **Tekrarlamıyorum.** Bakara'da kurulan görüntünün özeti şudur ve `058-mucadele.md`, `059-hasr.md`, `048-fetih.md`, `064-tegabun.md` bölümlerinde de aynen kullanılmıştır:

> Kök **yarmak, çatlatmak**tır. *Fellâh* — çiftçi; toprağı yardığı için bu adı alır. *Felâh* — bir engeli yarıp çıkmak, kabuğu kırmak, ürün verecek hâle gelmek.

**`113-felak.md`'de kökün türevleri sıralanırken tam bu ayet örnek olarak verilmişti.** Oraya dayanıyorum.
...
**Ve ikinci bir düzenlilik var:** altı maddenin **beşi isim (ism-i fâil), yalnız sonuncusu fiil**dir — *yuhâfizûn*. Bu fark dokuzuncu ayette ayrıca işlenecek.
...
**`041-fussilet.md` 41/39'da kökün toprak için kullanılışı işlendi** (yağmurdan önce çökmüş, sonra kabaran toprak) ve `079-naziat.md`'de *hâşia* (79/9 — *ebsârun yevmeizin hâşia*) geçti.
...
**Bir. Edat *fî*dir — "içinde".** Huşû namazın **yanında** değil, **içinde** aranıyor. Zarf, namazı bir kap gibi kuruyor.
...
**Kök `056-vakia.md` 56/25'te (*lâ yesmeûne fîhâ lağven ve lâ te'sîmâ*) ayrıntılı çözümlendi.** **Tekrarlamıyorum.** Orada verilen tarif şudur:

> Dilcilerin verdiği tarif: **hesaba katılmayan, boşa giden söz ya da fiil.** *Lağve'ş-şey'ü* — değersiz oldu, sayılmadı.

**Ve `056-vakia.md`'de tam bu ayet, kelimenin Kur'an içindeki yerini göstermek için anılmıştı.** Oraya dayanıyorum. Kelimenin dizindeki halkaları şunlardır ve beşincisi buradadır:

| Yer | Kullanım | Ne yapıyor |
|---|---|---|
| `056-vakia.md` 56/25 | *Lâ yesmeûne fîhâ lağven* | **Cennette yok** — kaldırılmış |
| `041-fussilet.md` 41/26 | *Ve'lğav fîhi* | **Bir taktik** — karşı taraf gürültü yapıyor |
| `028-kasas.md` 28/55 | *Ve izâ semiû'l-lağve a'radû anh* | **Bir tepki** — duyunca yüz çevirme |
| `025-furkan.md` 25/72 | *İzâ merrû bi'l-lağvi merrû kirâmâ* | **Bir vasıf** — yanından onurla geçme |
...
**Kökün somut anlamı: bir şeyin *arz*ını, yani enini/yan tarafını göstermek.** *A'rada anhü* — ondan yüz çevirdi; kelimenin resmi, **yüzünü değil yanını dönmektir.**
...
**Bu, sûre içinde doğrulanabilir bir tekrardır.** Ve bunu kendi okumam olarak kaydediyorum: **fiil kendiliğinden iyi ya da kötü değil; hükmü, yüz çevrilen şeyin ne olduğu belirliyor.** Aynı ayrımın bir benzeri `040-gafir.md` 40/75'te *ferah* fiili için kaydedilmişti.
...
**Kök `091-sems.md` 91/9'da (*kad efleha men zekkâhâ*) tafsilatlı işlendi** ve `080-abese.md`'de (*leallehû yezzekkâ*) tekrar ele alındı. **Tekrarlamıyorum.** Orada kaydedilen özet şudur:
...
**Kelime bu bağlamda örtme yeri için kullanılan bir kinâyedir** ve dilciler bunu kaydeder. **Ve kaydedilmeye değer bir nokta var:** aynı kök Kur'an'da gökyüzü için de kullanılır — *mâ lehâ min **fürûc*** (Kāf 50/6, "onda hiçbir çatlak yoktur"). **`050-kaf.md`'de o ayet işlendi.** **Aynı kök, biri kapalılığın delili biri korunması istenen alan için.** Bunu bir dil gözlemi olarak veriyorum ve iki kullanım arasında bir hüküm bağı kurmuyorum.

### حَافِظُون — ve maddenin genişliği

***Hâfiz*: koruyan, gözeten. Kök ح-ف-ظ `085-buruc.md` 85/22'de (*fî levhın mahfûz*) ve `086-tarik.md` 86/4'te (*leyse aleyhâ hâfiz*) işlendi.**

**Bir dizim ayrıntısı kaydedilmelidir ve dilciler üzerinde durur:** beşinci ayette edat **لِ**dir (*li-fürûcihim*), altıncı ayetteki istisnada edat **عَلَىٰ**ya döner (*illâ alâ ezvâcihim*).
...
**İki.** Kur'an'ın aynı alandaki başka ayetleri, kölelikten çıkışı **defalarca bir iyilik, bir kefaret ve bir hedef** olarak koyar: *fekku rakabe* (Beled 90/13 — `090-beled.md`'de işlendi), *fe-tahrîru rakabe* (Nisâ 4/92, Mâide 5/89, Mücâdele 58/3 — `058-mucadele.md`'de işlendi), *fe-kâtibûhüm* (Nûr 24/33).
...
| 2 | *Ahd* burada **cins ismi**dir; tekil gelmesi çoğulluğu dışlamaz |
...
| 3 | 4 | Mal — *zekât* |
| 4 | 5-7 | Beden — *fürûc* |
| 5 | 8 | İlişki — *emânet ve ahd* |
| **6** | **9** | **Namaz** |

**Bunu kendi okumam olarak kaydediyorum ve dayanağı listenin kendi düzenidir:** aradaki dört madde **söz, mal, beden ve ilişki**dir — yani insanın başkalarıyla temas ettiği dört alan. **Liste bu dört alanı iki namaz maddesinin arasına alıyor.** Çerçeve dıştadır, hayat içeridedir.
...
**Dört. III. bâb.** *Hâfaza* kalıbı, I. bâbdaki *hafiza*dan farklı olarak **süreklilik ve karşılıklı çaba** bildirir. Aynı kalıp beşinci ayette *hâfizûn* (ism-i fâil, I. bâbdan) idi.
...
**Aynı kök `044-duhan.md` 44/28'de (*ve evrasnâhâ kavmen âharîn*) ve `026-suara.md`'de işlendi** — orada miras, helâk olan bir kavmin geride bıraktığı şeydi. **Aynı kelime, iki ayrı yönde.**
...
**Ve bir yapı kaydı:** liste bir **mekân** ile kapanıyor. **Bu, `025-furkan.md`'de işlenen *ıbâdü'r-rahmân* listesinin kapanışıyla örtüşür** — orada da liste bir mekânla kapanmıştı: *ülâike yüczevne'l-**gurfete** bimâ saberû* (25/75). **İki liste, iki ayrı sûrede, ikisi de bir konut adıyla bitiyor.** Bu, iki metinden doğrulanabilir bir örtüşmedir.

---

## İki vasıf listesi — Mü'minûn 23/1-11 ile Furkān 25/63-77

**Bu karşılaştırma bu tefsirin bir gereğidir, çünkü iki liste Kur'an'ın iki ayrı sûresinde aynı işi yapıyor: kurtuluşa erecek kimseyi bir ad ile değil, bir vasıflar dizisiyle tarif etmek.** `025-furkan.md`'de o liste madde madde işlendi; burada **karşılaştırma** yapılıyor, çözümleme tekrarlanmıyor.
...
**Konum farkı kaydedilmeye değer ve bunu kendi okumam olarak veriyorum:** Mü'minûn listesi **hiçbir şeye cevap değildir** — sûre onunla başlıyor, ortada bir itiraz yok. Furkān listesi ise `025-furkan.md`'de gösterildiği gibi **sûrenin yedinci ayetindeki itiraza dolaylı bir cevaptır** ve ilk maddesi (yürüyüş) tam o itirazın konusudur. **Yani biri tarif olarak kuruluyor, öteki cevap olarak.**
...
**Ve bir kayıt daha, `077-murselat.md`'de yazıldığı gibi:** ayetin argümanı **muhatabın bildiği bir şeyden** yola çıkıyor. Doğum, düşük, kemik ve et herkesin gördüğü şeylerdi. **Muhatabın bilmediği bir şeyle bir delil kurulamaz;** bu sebeple ayete modern bilgi giydirmek argümanı güçlendirmez, zayıflatır.

### سُلَالَة — kök: س-ل-ل

**Kök `032-secde.md` 32/8'de çözümlendi** (*sümme ceale neslehû min sülâletin min mâin mehîn*). **Tekrarlamıyorum.** Orada verilen özet:
...
**طِين** — **çamur: toprakla suyun karışımı.** Kelime `032-secde.md` 32/7'de ve `037-saffat.md` 37/11'de (*min tînin lâzib* — yapışkan çamur) işlendi.
...
**Bunu bir dizim gözlemi olarak veriyorum ve dayanağı ikinci *min*dir:** malzeme ile ürün arasına bir **işlem** yerleştiriliyor.
...
**قَرَار — kök ق-ر-ر:** **bir yerde durmak, sabitlenmek, karar kılmak.** Aynı kökten *karâr* (durulan yer), *müstekarr* (yerleşme yeri), *kurra* (göz aydınlığı — gözün bir yerde durması; `025-furkan.md` 25/74'te işlendi).
...
**Ve burada bloğun asıl meselesi başlıyor.** On ikinci ayette fiil *halaknâ* idi; on üçüncüde *cealnâ*ya dönüyor.

**Ayrım `043-zuhruf.md` 43/3'te kaydedilmişti ve burada geçerlidir:**

> ***Ceale*, Arapçada bir şeyi bir hâlden bir hâle koymayı bildirir — *halaka*dan (yoktan var etmek) farkı budur.**
...
"**Sonra o damlayı bir *alaka* yaptık, *alaka*yı bir çiğnem yaptık, çiğnemi kemikler yaptık, kemiklere et giydirdik. Sonra onu başka bir yaratılışla inşa ettik. Yaratanların en güzeli olan Allah ne yücedir!**"
...
|---|---|---|---|
| **عَلَقَة** | ع-ل-ق | **Asılan, tutunan, yapışan şey**; ve pıhtı; ve sülük (*alak*) | `096-alak.md` 96/2 — beş gerekçeli sınır bölümüyle |
| **مُضْغَة** | م-ض-غ | **Bir çiğnemlik parça** — *madğ*, çiğnemek | Dizinde ilk kez burada |
| **عِظَام** | ع-ظ-م | **Kemikler** — *azm*; kökten *azîm* (büyük, sert) | `036-yasin.md` 36/78, `075-kiyame.md` 75/3 |

**`096-alak.md`'de *alak* kelimesi için yazılan bölüm burada da geçerlidir ve tekrarlamıyorum.** Oradaki sonuç şuydu: **kelimenin "asılan, tutunan, yapışan" anlamı verilir ve eksiltilmez; ama bu, ayetin iddiası olarak sunulamaz ve bir mucize delili hâline getirilemez.**
...
**Bunu kendi okumam olarak veriyorum, dayanağı iki edatın bu ayrımıdır:** *sümme*ler üç yerde duruyor — insan→damla, damla→*alaka*, ve et giydirildikten sonra→**başka bir yaratılış.** **Yani metin üç yere aralık koyuyor; aradaki basamaklar ise *fe* ile birbirine bitişik veriliyor.** Üç eşik, dört bitişik adım.

**İki. Fiil dört kez *halaknâ*dır, sonra bir kez *kesevnâ*, sonra bir kez *enşe'nâ*.** Yani **son iki basamakta fiil değişiyor.**
...
**Ve bir kelime bağı kaydedilmeye değer:** aynı fikir Kur'an'da elbise için de kullanılır — *ve cealnâ'l-leyle **libâsâ*** (Nebe' 78/10; `078-nebe.md` ve `025-furkan.md` 25/47'de işlendi). **Kök farklıdır (ل-ب-س / ك-س-و) ve aralarında iştikak bağı kurmuyorum;** ortak olan, **örtmenin altındakini ortadan kaldırmaması** fikridir.
...
**Kök `056-vakia.md` 56/35'te (*innâ enşe'nâhünne inşââ*) ve 56/62'de (*ve lekad alimtümü'n-neş'ete'l-ûlâ*) çözümlendi.** **Tekrarlamıyorum.** Orada kaydedilenlerin özeti şudur:

> **Fiil *enşe'nâ*dır — "yarattık" değil, "inşa ettik".** Ayet bir **yeniden kurma** bildiriyor. Ve aynı kök 56/62'de dünyadaki doğum için kullanılır: *en-neş'ete'l-ûlâ* — "ilk inşa".

**Ve `056-vakia.md`'de kaydedilen şu husus buraya doğrudan bağlanır:** Vâkıa, cennet için kullandığı fiili yirmi yedi ayet sonra dünyadaki oluşum için kullanmıştı. **Mü'minûn ise aynı fiili, dünyadaki oluşumun *son basamağı* için kullanıyor.**

**Kökün dizindeki öteki halkaları:** `067-mulk.md` 67/23 (*ellezî enşe'eküm*), `056-vakia.md` 56/72 (*em nahnü'l-münşiûn*).
...
**تَبَارَكَ** — **kök ب-ر-ك `067-mulk.md` 67/1'de çözümlendi** ve `025-furkan.md` 25/1'de tekrar işlendi. **Tekrarlamıyorum.** Özet: kökün çekirdeği **bereke** — devenin çökmesi, bir yere yerleşip sabit kalmak; buradan **kalıcı ve artan hayır.**
...
|---|---|---|
| **15** | *İnneküm … **le**-meyyitûn* — **ism-i fâil**, *lâm*la pekiştirilmiş | **Yerleşik, kaçınılmaz hâl** |
...
**Bunu kendi okumam olarak veriyorum, dayanağı üç *sümme*nin aynı dizide olmasıdır:** metin diriliş için ayrı bir delil kurmuyor — **onu zaten işlemekte olan dizinin bir halkası olarak sunuyor.** Aynı yöntem `036-yasin.md` 36/77-79'da ve `075-kiyame.md` 75/36-40'ta işlendi. **Oraya dayanıyorum.**
...
**Kök `086-tarik.md`'de çözümlendi.** Orada verilen tarif: **kökün asıl anlamı vurmak, dövmek, sert bir şeyle çarpmaktır.** **Tekrarlamıyorum.**
...
| **طَرَائِق** | *Tarîka*nın çoğulu | Buradaki kelime |

**Kelimenin bu ayette ne bildirdiği üzerinde dilciler ayrılır:**

| Okuma | *Tarâik* ne | Dayanağı |
|---|---|---|
| 1 | **Yedi gök** — *semâvât*ın yerine geçen bir adlandırma | *Fevkaküm* (üstünüzde) ve "yedi" sayısı; sûrenin 86. ayetinde *es-semâvâti's-seb'* açıkça geçiyor |
...
**Aynı fikir `001-fatiha.md`'de *Rabb* isminin çözümlenmesinde kaydedilmişti:** *"Rabb, çalışan bir düzenin adıdır; kurulup terk edilmiş bir saatin değil."* **Oraya dayanıyorum.**
...
**ق-د-ر kökü `097-kadr.md`'de tafsilatlı, `054-kamer.md` 54/49'da (*innâ külle şey'in halaknâhü bi-kader*) ayrıca çözümlendi** ve `039-zumer.md` 39/67 ile `025-furkan.md` 25/2'de tekrar işlendi. **Tekrarlamıyorum.** Özet: **kökün en temel anlamı ölçmek, biçmek, miktarını belirlemektir.**

**`097-kadr.md`'de tam bu bağlantı kurulmuştu:** *"Biz her şeyi bir ölçüye göre (bi-kader) yarattık (Kamer 54/49)"* ayeti, *kadr* kelimesinin "ölçü" anlamının delili olarak gösterilmişti. **Oraya dayanıyorum.**
...
| Yer | Kapsam |
|---|---|
| `054-kamer.md` 54/49 | *Külle şey'in* — **her şey** |
| **Mü'minûn 23/18** | *Mâen* — **su** |
...
**Kök `025-furkan.md` 25/45'te işlendi** (*ve lev şâe le-cealehû sâkinâ* — gölge için) ve `030-rum.md` 30/21'de (*li-teskünû ileyhâ*).

**Ve aynı olgu — inen suyun yere geçmesi — `039-zumer.md` 39/21'de başka bir fiille anlatılmıştı. İki ayet yan yana konmalıdır:**
...
**Beş geçişin beşi de "sıfırdan var etmek" değil, *kurmak, ayağa dikmek* bildiriyor** — kökün `056-vakia.md`'de çözümlenen anlamı budur. **Ve beşi de sûrenin ayrı bloklarında duruyor.** Bunu bir yapı gözlemi olarak kaydediyorum: **sûre, insanı, bitkiyi, kuşakları ve organları aynı fiille anıyor.**
...
**`036-yasin.md` 36/34'te bu ikili işlendi.** Oraya dayanıyorum.
...
**ف-ك-ه** kökü: **hoşlanmak, keyif almak.** *Fâkihe* — meyve; *fükâhe* — tatlı söz, şakalaşma. **Kök `056-vakia.md` 56/20 ve 56/32'de, `080-abese.md` 80/31'de işlendi.**
...
**Bunu bir gözlem olarak veriyorum:** ayet iki ihtiyacı ayrı ayrı sayıyor — **doyuran ve hoşa giden.** Aynı ayrım `056-vakia.md`'de cennet tablosu için de kaydedilmişti.
...
**`095-tin.md`'de bu yemin işlendi** ve orada Sînâ'nın Mûsâ'nın vahiy aldığı dağ olduğu, incir ve zeytinin de bir coğrafyayı temsil edebileceği kaydedilmişti. **Oraya dayanıyorum.**
...
**طُور** — **dağ.** Kelime `052-tur.md`'de sûre adı vesilesiyle işlendi. **Tekrarlamıyorum.**
...
### تَنۢبُتُ بِٱلدُّهْنِ — kıraat ve *bâ*'nın işi
...
***Bâ*** harfinin işi üzerinde de dilciler ayrılır:
...
**Kök `079-naziat.md` 79/26'da ve `059-hasr.md` 59/2'de (*fe'tebirû yâ üli'l-ebsâr*) çözümlendi.** **Tekrarlamıyorum.** Orada verilen özet:
...
**Buraya ait olan şudur ve kendi okumam olarak veriyorum:** kelimenin resmi **bir yerden başka bir yere geçmek**tir. **Yani "ibret", görüneni seyretmek değil — görülenden görülmeyene geçmektir.** Ve ayet bu geçişin nereden nereye olduğunu hemen gösteriyor: **hayvanın karnından çıkan içecekten, onu çıkaran düzene.**
...
**فُلْك** — **kök ف-ل-ك `043-zuhruf.md` 43/12'de çözümlendi.** **Tekrarlamıyorum.** Orada verilen özet: **dilcilerin verdiği çekirdek yuvarlaklık ve dönmedir;** *felek* — yörünge; *felke* — iğ başındaki yuvarlak ağırlık. **Gemi için kullanılması, geminin gövdesi ya da suda salınarak gitmesi üzerinden açıklanır.**
...
**Aynı ikili `043-zuhruf.md` 43/12'de (*ve ceale leküm mine'l-fülki ve'l-en'âmi mâ terkebûn*) işlendi.** **Buradaki fark kaydedilmelidir:** Zuhruf'ta fiil ***terkebûn*** (binersiniz) — etken; **burada *tuhmelûn* (taşınırsınız) — edilgen.**

| Yer | Fiil | Çatı |
|---|---|---|
| `043-zuhruf.md` 43/12 | *Terkebûn* — **binersiniz** | **Etken** — insan yapıyor |
...
**Dizinin yönü kaydedilmelidir ve bunu kendi okumam olarak veriyorum:** en içeriden (insanın kendi bedeni) en dışarıya (gökler) çıkıp tekrar içeriye (yediği, içtiği, bindiği) dönülüyor. **Ve bütün dizide fiillerin faili tektir.** `056-vakia.md` 56/58-72'de aynı yöntem işlenmişti — orada da tohum, su ve ateş sırayla sayılıp her birinde "siz mi yaptınız?" sorusu sorulmuştu. **Oraya dayanıyorum.** **Farkı kaydediyorum: Vâkıa soru soruyor, Mü'minûn haber veriyor.**
...
**`037-saffat.md`'de bir peygamber dizisinin nasıl kurulduğu ayrıntılı işlendi:** orada her kıssa aynı üç-dört cümlelik **mühürle** bitiyordu (*ve tereknâ aleyhi fi'l-âhirîn*, *selâmün alâ…*, *innâ kezâlike neczi'l-muhsinîn*). **Oraya dayanıyorum.**

**Mü'minûn'un dizisi başka bir kalıp kullanıyor ve farkı kaydedilmelidir:**

| | `037-saffat.md` 37/75-148 | **Mü'minûn 23/23-44** |
|---|---|---|
...
| İzah | Gerekçe |
|---|---|
| 1 | **Meclisi doldururlar** — toplantıda bulunanlar |
| 2 | **Gözü doldururlar** — heybetleriyle |
...
**Bu itiraz, `025-furkan.md` 25/7'de ayrıntılı olarak işlendi.** Oradaki cümle şuydu: *mâ li-hâze'r-rasûli ye'külü't-taâme ve yemşî fi'l-esvâk.* **Ve orada kaydedilmişti:**
...
| | `025-furkan.md` 25/7 | **Mü'minûn 23/24** |
|---|---|---|
...
**Ve `025-furkan.md` 25/20'de bu itiraza verilen cevap işlenmişti:** *ve mâ erselnâ kableke mine'l-mürselîne illâ innehüm le-ye'külûne't-taâme ve yemşûne fi'l-esvâk* — **itiraz reddedilmiyor, genelleştiriliyor.**
...
**Bunu kendi okumam olarak veriyorum, dayanağı fiilin bu olmasıdır:** karşı taraf davetin içeriğini tartışmıyor; **davetin arkasındaki maksadı tarif ediyor.** `025-furkan.md` 25/4-8'de aynı husus kaydedilmişti: *"itirazların hiçbiri metnin ne söylediğine bakmıyor."* **Oraya dayanıyorum.**
...
**ج-ن-ن** kökü: **örtmek, gizlemek.** *Cenne* — bahçe (ağaçlar toprağı örter); *cinn* — görünmeyen; *cenîn* — karında örtülü; *cünne* — kalkan; *cünûn* — aklın örtülmesi. **Kök `054-kamer.md`'de ve `072-cin.md`'de işlendi.** **Tekrarlamıyorum.**

**Ve bu suçlama sûrede bir kez daha, yetmişinci ayette geçecek:**

| Ayet | Kime | Cümle |
|---|---|---|
| **25** | **Nûh** | *İn hüve illâ racülün **bihî cinnetün*** |
| **70** | **Muhatap Peygamber** | *Em yekūlûne **bihî cinnetün*** |

**Birebir aynı terkip (*bihî cinne*), iki ayrı çağda.** Bu, sûre içinde doğrulanabilir bir tekrardır ve bunu bir gözlem olarak kaydediyorum: **sûre, kendi muhataplarına yöneltilen suçlamanın Nûh'a da yöneltildiğini göstererek karşılık veriyor.** Aynı yöntem `025-furkan.md` 25/31'de ve `035-fatir.md` 35/4'te kaydedilmişti: **durum kaldırılmıyor, sıraya oturtuluyor.**
...
**Ve şikâyetin muhatabı kaydedilmelidir: dua Rabbe yöneltiliyor, kavme değil.** **`025-furkan.md` 25/30'da aynı husus işlenmişti** (*inne kavmi'ttehazû hâze'l-kur'âne mehcûrâ*) ve orada kaydedilmişti: **itirazlar açıkça dile getirilirken, cevap bir şikâyet olarak yukarı yöneltiliyor.** **Oraya dayanıyorum.**
...
**Terkip `054-kamer.md` 54/14'te (*tecrî bi-a'yüninâ*) işlendi** ve `052-tur.md` 52/48'de (*fe-inneke bi-a'yüninâ*) geçti. **Oraya dayanıyorum.**

**Buraya ait olan, iki ayetin farkıdır ve kaydedilmelidir:**

| Yer | Cümle | *Bi-a'yüninâ* neye bağlı |
|---|---|---|
| `054-kamer.md` 54/14 | *Tecrî bi-a'yüninâ* | **Geminin yürümesine** — sudayken |
...
**تَنُّور** — **fırın, tandır.** **Kelime `067-mulk.md`'de bu bağlamda anıldı** (Hûd 11/40 — *ve fâre't-tennûr*). **Kelime Kur'an'da yalnız iki yerde geçer: Hûd 11/40 ve bu ayet.**
...
**زَوْج** kelimesi kaydedilmelidir: Arapçada *zevc*, **çiftin bir teki**dir — Türkçedeki "çift" gibi ikisi birden değil. **Bu sebeple *zevceyni'snuyn* terkibi "iki eş, yani iki tane" demektir.** Dilciler bu inceliği düzenli olarak kaydeder.

### وَأَهْلَكَ إِلَّا مَن سَبَقَ عَلَيْهِ ٱلْقَوْلُ مِنْهُمْ

**İstisna kaydedilmelidir:** aileden bir kısmı dışarıda bırakılıyor. **Ve dışarıda bırakılma gerekçesi bir akrabalık değil, *önceden geçmiş bir hüküm*tür:** *sebeka aleyhi'l-kavl.*
...
**مُّبَارَكًا** — **kök ب-ر-ك on dördüncü ayette anıldı;** `067-mulk.md` 67/1'de çözümlendi. **Tekrarlamıyorum.**

**Ve terkip kaydedilmeye değer:** istenen şey **büyük**, **geniş** ya da **güvenli** bir yer değil — **bereketli** bir yer. Kökün çekirdeği **kalıcılık ve artış**tır. **Yani dua, yerin niteliğini değil, orada olacak şeyin sürekliliğini istiyor.** Bunu kendi okumam olarak veriyorum.
...
**Dizim üzerinde dilciler durur:** *in* burada **muhaffefe mine's-sakīle**dir (aslı *inne*), ve *lâm* onu ayırt eden **fârika lâmı**dır. **Yani cümle olumsuz değil, pekiştirmelidir:** "biz elbette sınayanlarız."

**ب-ل-و / ب-ل-ي** kökü: **denemek, sınamak; ve eskitmek, yıpratmak.** *İbtilâ* — sınama. **Kök `067-mulk.md` 67/2'de (*li-yeblüveküm eyyüküm ahsenü amelâ*) ve `029-ankebut.md` 29/2-3'te işlendi.** **Tekrarlamıyorum.**
...
**Bunu kendi okumam olarak veriyorum, dayanağı cümlenin bu konumudur.** **Ve `025-furkan.md` 25/20'de (*ve cealnâ ba'daküm li-ba'dın fitneten e-tasbirûn*) aynı çerçeve işlenmişti** — orada sınamanın **insanlar eliyle** geldiği kaydedilmişti. **Oraya dayanıyorum.**
...
**Dizim ayrıntısı kaydedilmelidir:** *karnen* tekil, sıfatı *âharîn* çoğuldur. **Dilciler bunu kaydeder ve *karn*ın mânen çoğul (topluluk) oluşuyla açıklar.**
...
**Yani metin, itirazın konusu olan hususu bir kayıt olarak kendisi koyuyor.** Bunu bir gözlem olarak veriyorum. **Aynı çizgi `046-ahkaf.md` 46/9'da (*mâ küntü bid'an mine'r-rusül*) işlenmişti.**
...
**ت-ر-ف** kökü: **bolluk içinde yaşamak, nimetle şımarmak.** *Terafe* — bollukta yaşadı; *mütref* — refahla şımartılmış. **Kök `034-sebe.md` 34/34'te ve `056-vakia.md` 56/45'te (*innehüm kânû kable zâlike mütrafîn*) işlendi.** **Tekrarlamıyorum.**

**Ve kök sûrede bir kez daha dönecek:** altmış dördüncü ayette *hattâ izâ ahaznâ **mütrafîhim** bi'l-azâb.*

| Ayet | Cümle | Yön |
|---|---|---|
| **33** | *Ve **etrafnâhüm** fi'l-hayâti'd-dünyâ* | **Veriliyor** |
| **64** | *Ahaznâ **mütrafîhim** bi'l-azâb* | **Alınıyor** |
...
**Ve otuz üçüncü ayetteki iki fiil — yemek ve içmek — `025-furkan.md` 25/7'deki itirazla birebir aynı alandadır** (*ye'külü't-taâm*). **Oraya dayanıyorum.**
...
**خ-س-ر** kökü: **eksilmek, kaybetmek; ölçüde eksik vermek.** **Kök `103-asr.md` 103/2'de (*inne'l-insâne le-fî husr*) ve `083-mutaffifin.md`'de işlendi.** **Tekrarlamıyorum.**
...
**Kelime bir isim değil, bir *ism-i fiil*dir** — yani fiil anlamı taşıyan, ama fiil gibi çekimlenmeyen bir kelime. **Anlamı: "ne kadar uzak!"**
...
| 3 | "**Yaşarız ve ölürüz**" — *vâv* sıra bildirmez | Arapçada *vâv*ın mutlak birleştirme bildirmesi |
...
**ف-ر-ي** kökü: **deriyi yarmak, kesmek; ve uydurmak.** *İftirâ* — VIII. bâb: **uydurmak, yakıştırmak.** **Kök `025-furkan.md` 25/4'te (*in hâzâ illâ ifkün'fterâh*) işlendi.**

**Ve suçlamanın Furkān'daki karşılığıyla farkı kaydedilmelidir:**

| Yer | Suçlama | Nereye bakıyor |
|---|---|---|
| `025-furkan.md` 25/4 | *İfkün'fterâhü ve **eânehû aleyhi kavmün âharûn*** | **Yardım aldı** — kaynağa |
...
**ص-ي-ح** kökü: **yüksek sesle bağırmak.** *Sayha* — çığlık, gürültü. **Kök `036-yasin.md` 36/29, 36/49, 36/53'te ve `054-kamer.md`'de işlendi.**
...
**Kelime `087-ala.md` 87/5'te (*fe-cealehû ğusâen ahvâ*) çözümlendi** — **ve orada tam bu ayet, kelimenin öteki geçişi olarak anıldı.** **Oraya dayanıyorum ve tekrarlamıyorum.**

**Buraya ait olan, iki ayetin farkıdır:**

| Yer | *Ğusâ'* ne | Süreç |
|---|---|---|
| `087-ala.md` 87/5 | **Otlak** — yeşerip sonra kuruyan | **Doğal döngü** — sıfatı *ahvâ* (kararmış) |
| **Mü'minûn 23/41** | **Bir kavim** | **Ceza** — sıfatsız |

**Aynı kelime, biri bitki için biri topluluk için.** Ve `039-zumer.md` 39/21 ile `056-vakia.md` 56/65'te aynı fikir başka bir kelimeyle (*hutâm* — kırıntı) veriliyordu.

**Bunu kendi okumam olarak kaydediyorum, dayanağı kelimenin resmidir:** *ğusâ'* **yok olmuş** şey değildir — **su üstünde duran, ama tutulmayan** şeydir. `025-furkan.md` 25/23'te *hebâ'* (toz) için kaydedilen tespitin aynısı burada da geçerlidir: **yok olma değil, elde kalmama.**
...
**Ve zamir uyumu kaydedilmelidir:** *ümmeten* tekil, *kezzebûhü* çoğul. **Dilciler bunu *ümmet*in mânen çoğul (topluluk) oluşuyla açıklar.**

### وَجَعَلْنَٰهُمْ أَحَادِيثَ

**Bu terkip `034-sebe.md` 34/19'da çözümlendi.** **Tekrarlamıyorum.** Orada kaydedilenlerin özeti:
...
**Ve `034-sebe.md`'de kaydedilen şu tespit buraya doğrudan bağlanır:** *"bir topluluğun ölçüsü, sonunda hakkında ne anlatıldığıdır. Ayet bunu bir ceza olarak anıyor."*

**Buraya ait olan, iki ayetin bağlam farkıdır:**

| | `034-sebe.md` 34/19 | **Mü'minûn 23/44** |
|---|---|---|
...
**Dizim kaydedilmelidir: Hârûn, adıyla değil önce *kardeş* sıfatıyla anılıyor** — *ehâhü hârûn*.
...
| **116** | *Fe-**teâlâ**llâhu'l-melikü'l-hakk* | **Allah** |
...
**İzahları aktarıyorum; tercih dayatmıyorum.** **Birinci izah metne en yakın olanıdır ve bunu gözlem olarak kaydediyorum, dayanağı zamirin ikil oluşudur:** cümlenin devamında *âveynâ**hümâ*** (ikisini) geliyor. **Yani cümle sayı bakımından ikilliyi koruyor, sıfat bakımından tekilde birleştiriyor.**

### وَجَعَلْنَا — *ceale* fiilinin seçimi

***Ceale* ile *halaka* ayrımı `043-zuhruf.md` 43/3'te kaydedildi ve on üçüncü ayette anıldı:** *ceale* bir şeyi **bir hâlden bir hâle koymayı** bildirir.
...
**Kökün somut anlamı: bir yere sığınmak, barınmak.** *Me'vâ* — barınak; *îvâ'* — barındırma. **Kök `053-necm.md` 53/15'te (*cennetü'l-me'vâ*) ve `079-naziat.md` 79/39'da işlendi.** Ve *ivâ'* fiili Kur'an'da düzenli olarak **korunmaya alma** bağlamında geçer (Duhâ 93/6 — *e-lem yecidke yetîmen fe-âvâ*; `093-duha.md`'de işlendi).

**Bunu bir gözlem olarak kaydediyorum:** fiil bir **taşınma** değil, bir **barındırma** bildiriyor.

### رَبْوَة

**ر-ب-و** kökü: **artmak, yükselmek, kabarmak.** **Kök `002-bakara.md` 2/275'te (*ribâ*) çözümlendi** ve `030-rum.md` 30/39 ile `041-fussilet.md` 41/39'da (*ihtezzet ve rabet*) tekrar işlendi. **Tekrarlamıyorum.**
...
**Bunu kendi okumam olarak kaydediyorum, dayanağı kelimenin çekirdek anlamıdır:** *karâr* **durulan, karar kılınan yer**dir. **İki ayet de bir korunma yeri anlatıyor** — biri görünmeyen, öteki coğrafî.

**مَعِين** — kelimenin kökeni üzerinde dilciler ayrılır:

| Görüş | Kök | Anlam |
|---|---|---|
| 1 | **ع-ي-ن** | **Gözle görülen, yüzeyde akan su** — *ayn* (pınar, göz) |
| 2 | **م-ع-ن** | **Bol akan** — *ma'n*, akmak |

**İki görüş de nakledilir; tercih dayatmıyorum.** **İkisinde de sonuç aynıdır:** akan, ulaşılabilir su. **Kelime `056-vakia.md` 56/18'de (*ke'sin min maîn*) ve `067-mulk.md` 67/30'da (*bi-mâin maîn*) geçti.**
...
**Ve aynı yöntem `025-furkan.md` 25/7 ile 25/20 arasında işlenmişti.** Orada kaydedilenler burada da geçerlidir:
...
| | `025-furkan.md` 25/7 → 25/20 | **Mü'minûn 23/33 → 23/51** |
|---|---|---|
...
**ط-ي-ب** kökü: **hoş olmak, temiz olmak, iyi olmak.** *Tayyib* — hoş, temiz, helâl. **Kök `002-bakara.md` 2/168 ve 2/172'de (*külû min tayyibâti mâ razaknâküm*) işlendi.**
...
| Yer | Muhatap | Emir |
|---|---|---|
| `002-bakara.md` 2/172 | *Yâ eyyühe'llezîne âmenû* | *Külû min tayyibâti mâ razaknâküm* |
...
**Kelime `042-sura.md` 42/13'te ve `002-bakara.md` 2/213'te işlendi.**

**Ve kelimenin buradaki i'râbı kaydedilmelidir:** *ümmeten vâhideten* **mansûb**dur — dilciler bunu **hâl** sayar. **Yani cümle "ümmetiniz tek ümmettir" demekten çok, "ümmetiniz — tek bir ümmet olarak — sizin ümmetinizdir" demeye yakındır.** İzahı nakledildiği şekliyle aktarıyorum.

### فَٱتَّقُونِ — ve aynı cümlenin Enbiyâ'daki hâli

**Bu cümle Kur'an'da bir kez daha, neredeyse birebir geçer: `021-enbiya.md` 21/92.** **İki ayet arasındaki tek fark son kelimededir:**

| Yer | Cümle | Son kelime |
|---|---|---|
| `021-enbiya.md` **21/92** | *İnne hâzihî ümmetüküm ümmeten vâhideten ve ene rabbüküm* | ***fa'büdûn*** — **"bana kulluk edin"** |
| **Mü'minûn 23/52** | *Ve inne hâzihî ümmetüküm ümmeten vâhideten ve ene rabbüküm* | ***fe'ttekūn*** — **"benden sakının"** |

**`021-enbiya.md` 21/92-93'te bu ayet işlendi; oraya dayanıyorum.** **Ve iki sûrenin *sonraki* ayeti de örtüşüyor** — Enbiyâ 21/93: *ve **tekattaû emrahüm beynehüm** küllün ileynâ râciûn*; Mü'minûn 23/53: *fe-**tekattaû emrahüm beynehüm** zübürâ.* **Yani iki sûrede birlik cümlesini aynı parçalanma cümlesi izliyor.** Bu, iki metnin lafzından doğrulanabilir bir örtüşmedir.
...
**Elli ikinci ayet birliği bildiriyor; elli üçüncü ayet parçalanmayı.** **İkisi arasındaki geçiş, `002-bakara.md` 2/213 ve `042-sura.md` 42/13-14'te işlenen meselenin ta kendisidir.**

**`002-bakara.md` 2/213'te kaydedilmişti:**
...
**`042-sura.md` 42/14'te aynı hüküm neredeyse aynı kelimelerle tekrarlanıyordu:** *ve mâ teferrakū illâ min ba'di mâ câehümü'l-ilmü bağyen beynehüm.*

**Oraya dayanıyorum ve tekrarlamıyorum.** **Üç sûre aynı sırayı kuruyor:**

| Yer | Birlik | Gelen | Sonuç |
|---|---|---|---|
| `002-bakara.md` 2/213 | *Kâne'n-nâsü ümmeten vâhide* | **Peygamberler ve kitap** | *İhtelefe fîhi* — *bağyen beynehüm* |
| `042-sura.md` 42/13-14 | *Ekīmü'd-dîne ve lâ teteferrakū fîh* | **el-İlm** | *Mâ teferrakū illâ min ba'di…* |
...
**Kök `054-kamer.md` 54/43 ve 54/52'de çözümlendi.** **Tekrarlamıyorum.** Orada kaydedilenlerin özeti:

> **ز-ب-ر** kökü: **sert bir yüzeye kazımak; ve demir kütlesi, taşla örülmüş kuyu.** *Zübür* — *zebûr*un ya da *zibr*in çoğulu: **yazılı sahifeler, kitaplar.** **Ve `054-kamer.md`'de ز-ب-ر ile س-ط-ر farkı tablolanmıştı:** ز-ب-ر kazımadır ve **kalıcılık — silinmezlik** bildirir.

**Ve `054-kamer.md`'de kökün sûre içinde bir soru-cevap halkası kurduğu gösterilmişti** (54/43'te soru, 54/52'de cevap). **Oraya dayanıyorum.**
...
| 2 | **Parçalar** — *zübre*nin çoğulu; *zübretü'l-hadîd*, demir kütlesi/parçası (Kehf 18/96'da geçer) | Fiilin (*tekattaû*) parçalama bildirmesi |
| 3 | **Gruplar, hizipler** | Cümlenin devamındaki *küllü hızbin* |

**İhtilafı aktarıyorum; tercih dayatmıyorum.**

**Kıraat farkı da vardır:** ***zübüran*** (زُبُرًا — *bâ* ötreli, *zebûr/zibr*in çoğulu) ve ***zübera*** (زُبَرًا — *bâ* fethalı, *zübre*nin çoğulu) okuyuşları nakledilir. **Bu kıraat farkı, yukarıdaki ihtilafla doğrudan ilgilidir:** fethalı okuyuş ikinci anlamı, ötreli okuyuş birinci anlamı destekler.

**Ve i'râbı üzerinde de dilciler ayrılır:** *zübüran* **hâl** mi (parçalar hâlinde), yoksa *emr*den **bedel** mi? **İki i'râb da nakledilir.**

**Kendi okumam olarak şu kadarını kaydediyorum, dayanağı `054-kamer.md`'deki kök çözümlemesidir:** kökün çekirdeğinde **sert bir yüzeye kazıma** vardır. **Hangi anlam alınırsa alınsın, kelime kolayca geri alınamayan bir şeyi bildiriyor** — ister kazınmış bir metin, ister kopmuş bir demir parçası. **Ve fiilin (*tekattaû*) yanına konduğunda, yapılan işin kalıcılığı öne çıkıyor.** Bu bir okumadır, bağlayıcı değildir.

### كُلُّ حِزْبٍۭ بِمَا لَدَيْهِمْ فَرِحُونَ

**Cümle Kur'an'da bir kez daha, birebir aynı lafızla geçer: Rûm 30/32.** **`030-rum.md` 30/32'de işlendi** (*mine'llezîne ferrakū dînehüm ve kânû şiyeâ, küllü hızbin bimâ ledeyhim ferihûn*). **Oraya dayanıyorum.**

**İki ayet karşılaştırılabilir:**

| | `030-rum.md` 30/32 | **Mü'minûn 23/53** |
|---|---|---|
...
**Kök ayrımı `040-gafir.md` 40/75'te çözümlendi.** **Tekrarlamıyorum.** Orada verilenler:

| Kelime | Kök | Anlam |
|---|---|---|
| *Tefrahûn* | **ف-ر-ح** | **Sevinmek, ferahlamak** |
| *Temrahûn* | **م-ر-ح** | **Şımarmak, çalım satarak yürümek** |

**Ve `040-gafir.md`'de kaydedilen tespit şuydu:**
...
**Oraya dayanıyorum.** **Ve buraya ait olan şudur:** bu ayette *merah* değil ***ferih*** kullanılmış — **yani kınanan şey sevincin kendisi değil.** Nitekim `030-rum.md` 30/1-5'te aynı kök **mü'minler** için kullanılmıştı: *ve yevmeizin **yefrahu**'l-mü'minûn.*

**`030-rum.md`'de bu ayrım tablolanmıştı** ve orada kökün üç geçişi (30/4, 30/32, 30/36) **"sevincin bağlandığı yere göre değişmesi"** başlığı altında toplanmıştı. **Oraya dayanıyorum.**
...
**Aynı çizgi `025-furkan.md` 25/43'te (*e-fe-ente tekûnü aleyhi vekîlâ*) ve `028-kasas.md` 28/56'da tablolanan sorumluluk sınırında işlendi.** **Bu ayet o hattın bir halkasıdır.**
...
**Ve fiilin muzâri gelmesi kaydedilmelidir:** *nümiddühüm* — **süregiden bir verme.**

### مَالٍ وَبَنِين

**İki kelime Kur'an'da düzenli olarak birlikte geçer:** Kehf 18/46 (*el-mâlü ve'l-benûne zînetü'l-hayâti'd-dünyâ*), Sebe' 34/35 (*nahnü ekserü emvâlen ve evlâden*; `034-sebe.md`'de işlendi), Nûh 71/12 (`071-nuh.md`'de işlendi), Kalem 68/14 (`068-kalem.md`'de işlendi).

**Ve `034-sebe.md` 34/35-37'de bu meselenin tamamı işlenmişti:** malın ve evlâdın **yakınlık ölçüsü sayılmasına** verilen cevap. **Oraya dayanıyorum ve tekrarlamıyorum.**
...
**Bunu bir dizim gözlemi olarak veriyorum, dayanağı *enne*nin haberinin ikinci ayette olmasıdır.** Ve i'râb üzerinde dilciler ayrılır: *ennemâ* bitişik mi (kâffe) ayrı mı (*enne* + *mâ* mevsûle); iki i'râb da nakledilir. **İki durumda da cümlenin hükmü aynı yere çıkar.**
...
***Bel* edatı `025-furkan.md` 25/11'de işlendi:** **önceki söylenenden vazgeçip asıl sebebi getiriyor.** **Oraya dayanıyorum.**
...
**خَشْيَة — kök خ-ش-ي:** dilcilerin verdiği tarif, **bilerek duyulan çekinme**dir. *Haşyet*, korkulan şeyin büyüklüğünü bilmekle ilgilidir; nitekim Fâtır 35/28'de *innemâ yahşallâhe min ıbâdihi'l-ulemâ'* denir. **Kök `035-fatir.md` 35/28'de ve `067-mulk.md` 67/12'de (*yahşevne rabbehüm bi'l-ğayb*) işlendi.**
...
**`080-abese.md`'de ve `083-mutaffifin.md`'de aynı ihtiyat kaydı, birbirine yakın sesli kökler için düşülmüştü:** *"ses yakınlığı kök birliği değildir."* **Oraya dayanıyorum.**

**مُشْفِقُون — kök ش-ف-ق:** dilcilerin verdiği çekirdek anlam **incelme**dir. *Şafak* — gündüzle gecenin arasındaki ince ışık; *şefeka* — bir şeyin inceliği. **Ve *işfâk*, dilcilerce şöyle tarif edilir: içinde sevgi bulunan korku, ya da içinde korku bulunan sevgi.** **Kök `084-insikak.md` 84/16'da (*fe-lâ uksimü bi'ş-şafak*) işlendi.**
...
**Kelime Kur'an'da düzenli olarak kalple birlikte geçer:** Enfâl 8/2 (*vecilet kulûbühüm*), Hicr 15/52 ve 15/53, Hac 22/35, Zümer 39/23 (`039-zumer.md`'de işlendi).
...
| Okuma | *Enne*nin başında ne var (takdîr) | Anlam |
|---|---|---|
...
**Ve `035-fatir.md` 35/28 ile `067-mulk.md` 67/12'de kaydedilen çizgi burada da geçerlidir:** Kur'an'da *haşyet* bilgiyle, *vecel* ise karşılaşma beklentisiyle birlikte anılır.
...
**س-ب-ق** kökü: **öne geçmek, yarışta önde olmak.** **Kök `056-vakia.md` 56/10'da (*ve's-sâbikūne's-sâbikūn*) ayrıntılı işlendi** — orada kelimenin **bir fiili bildirmekten çıkıp bir sınıf adına dönüştüğü** kaydedilmişti. **Oraya dayanıyorum.**
...
**Bu cümle `002-bakara.md` 2/286'da (*lâ yükellifullâhu nefsen illâ vüs'ahâ*) işlendi.** **Tekrarlamıyorum.** Orada kaydedilenler:
...
| | `002-bakara.md` 2/286 | **Mü'minûn 23/62** |
|---|---|---|
| Fiilin öznesi | *Yükellifu**llâhu*** — **isim açık** | *Nükellifü* — **birinci çoğul** |
...
**Bu terkip `045-casiye.md` 45/29'da (*hâzâ kitâbünâ yentıku aleyküm bi'l-hakk*) işlendi.** Orada kaydedilenler:
...
| | `045-casiye.md` 45/29 | **Mü'minûn 23/62** |
|---|---|---|
...
**Fark tek kelimedir ve anlam yönünü değiştiriyor.** **Arapçada *alâ* burada aleyhte olmayı bildirir;** `045-casiye.md`'de bu kaydedilmişti.

**Bunu kendi okumam olarak kaydediyorum, dayanağı iki ayetin sahne farkıdır:** Câsiye'de kitap **açılmış ve muhataba karşı** konuşuyor — orada iş bitmiştir. **Mü'minûn'da kitap henüz *katta*dır ve yalnız "hakkı söylediği" bildiriliyor** — kime karşı olduğu söylenmiyor.
...
**Ve *bi'l-hakk* terkibinin kendisi kaydedilmelidir:** kitap **hakkı** söylüyor. **Yani kayıt ile gerçek arasında bir fark bulunmadığı bildiriliyor.** `045-casiye.md`'de *nestensih* (nüshasını çıkarma) kelimesi için kaydedilen tespit buna denk düşer: **asıl, yaşanan hayattır; kitap onun nüshasıdır.**
...
**Bunu bir gözlem olarak veriyorum, dayanağı kelimenin izafetli oluşudur:** *mütrafî**him*** — "onların refah içindekileri". **Yani ayet bir grubun içinden bir kesimi ayırıyor.** Aynı ayrım yirmi dördüncü, otuz üçüncü ve kırk altıncı ayetlerde *el-mele'* için de yapılmıştı.
...
**Ve altmış beşinci ayet bu sesi yasaklıyor: *lâ tec'erû'l-yevm*.** **Yasağın biçimi `025-furkan.md` 25/14'te işlenen kalıba benzer** — orada da feryat (*sübûr*) yasaklanmamış, çoğaltılması söylenmişti. **Buradaki fark kaydedilmelidir:** Furkān feryadı çoğaltıyor, **Mü'minûn onu kesiyor** ve gerekçe veriyor: *inneküm minnâ lâ tunsarûn.*
...
**أَعْقَاب** — *akıb*ın çoğulu: **topuklar.** Kök **ع-ق-ب**: bir şeyin arkası, sonu. *Âkıbet* — sonuç; *ta'kīb* — ardından gelme; *ukbâ* — son.
...
**ه-ج-ر** kökü: **ayrılmak, terk etmek; ve hezeyan söylemek (*hücr*).** **Kök `025-furkan.md` 25/30'da (*ittehazû hâze'l-kur'âne mehcûrâ*), `073-muzzemmil.md` 73/10'da ve `074-muddessir.md` 74/5'te işlendi.** **Tekrarlamıyorum.**
...
**Ve `025-furkan.md` 25/30'da bu kökün iki dalı tablolanmıştı:**

| Okuma | Anlam |
|---|---|
| 1 | **Terk edilmiş** — okunmayan, uygulanmayan |
| 2 | **Hakkında saçma söz söylenen** — kökün *hücr* dalından |

**Oraya dayanıyorum.** **Ve buraya ait olan, iki ayetin karşılaştırılmasıdır:**

| | `025-furkan.md` 25/30 | **Mü'minûn 23/67** |
|---|---|---|
...
**Bunu kendi okumam olarak kaydediyorum, dayanağı dört sorunun sırasıdır:** dört olası gerekçe teker teker sayılıyor ve **hiçbiri onaylanmıyor.** Ardından *bel* geliyor — **öncekileri iptal edip asıl sebebi koyan edat** (`025-furkan.md` 25/11'de işlendi).

**Ve konan asıl sebep bir bilgi eksikliği değil:** *ve ekseruhüm li'l-hakkı **kârihûn*** — **"çoğu haktan hoşlanmıyor."**

**Bu, `002-bakara.md` 2/213 ve `042-sura.md` 42/14'te işlenen çizginin aynısıdır:** ayrılığın sebebi bilgi değil, tutumdur. **Oraya dayanıyorum.**
...
**Kelime Kur'an'da tam olarak bu bağlamda birkaç yerde geçer:** Nisâ 4/82 (*e-fe-lâ yetedebberûne'l-Kur'ân*), Muhammed 47/24 (`047-muhammed.md`'de işlendi), Sâd 38/29 (*li-yeddebberû âyâtih*; `038-sad.md`'de işlendi).
...
**Kalıp kaydedilmelidir:** *yeddebberû*, aslı *yetedebberû*dur; *tâ* *dâl*a idgam olmuştur. **Kıraatlerde *yetedebberû* okuyuşu da nakledilir.** Anlamı değiştirmiyor.
...
**ع-ر-ف** kökü: **tanımak.** Dilciler *ma'rife* ile *ilm* arasında bir ayrım kaydeder: *ma'rife* **daha önce bilinen bir şeyin yeniden tanınması**dır; *ilm* geneldir.
...
**ك-ر-ه** kökü: **hoşlanmamak, istememek; ve zorlama (*ikrâh*).** Dilciler kökün altında **içten gelen isteksizlik** ile **dıştan gelen zorlama**yı birlikte kaydeder.
...
**Cümlenin öznesi olan *el-hakk*ın ne olduğu üzerinde müfessirler ayrılır ve fark, delilin çalışma biçimini değiştirir:**
...
**ف-س-د** kökü: **bozulmak, düzeni gitmek.** *Fesâd* — düzenin dağılması; *ifsâd* — bozma. **Kelime `002-bakara.md` 2/11-12'de ve `038-sad.md` 38/28'de işlendi.**

**Aynı fiille kurulmuş bir başka delil `021-enbiya.md` 21/22'de işlendi:** *lev kâne fîhimâ âlihetün illa'llâhu **le-fesedetâ***, "eğer o ikisinde Allah'tan başka ilâhlar olsaydı, ikisi de bozulup giderdi." **Oraya dayanıyorum.**

**İki delil karşılaştırılabilir:**

| | `021-enbiya.md` **21/22** | **Mü'minûn 23/71** |
|---|---|---|
...
**Fark kaydedilmelidir: Enbiyâ'nın delili *şirke*, Mü'minûn'unki *hevâ*ya karşı kuruluyor.** Ve Enbiyâ'daki cümle *sübhânallâhi rabbi'l-arşi ammâ yasıfûn* ile bitiyor; **Mü'minûn'da aynı tenzih cümlesi yirmi ayet sonra, doksan birinci ayette gelecek.**
...
**Kök `045-casiye.md` 45/23'te (*e-fe-raeyte meni'ttehaze ilâhehû hevâhü*) ayrıntılı işlendi** — orada *ilâhehû hevâhü* terkibindeki iki okuma tablolanmıştı. **Ve `025-furkan.md` 25/43'te aynı cümle tekrar ele alındı** ve orada Câsiye'deki çözümlemeye dayanılmıştı. **Tekrarlamıyorum.**
...
|---|---|---|---|
| `045-casiye.md` 45/23 | *Hevâhü* | **Tekil** | **Bireysel** — mühürlenme |
| `025-furkan.md` 25/43 | *Hevâhü* | **Tekil** | **Bireysel** — sorumluluk sınırı |
...
| 2 | **Kendilerinin şerefi/anılması** — *zikr*in "ün, itibar" anlamı (Zuhruf 43/44'te *ve innehû le-zikrun leke ve li-kavmik*) |
...
| Yer | Cümle |
|---|---|
| `025-furkan.md` 25/57 | *Mâ es'elüküm aleyhi min ecrin illâ men şâe en yettehıze ilâ rabbihî sebîlâ* |
| `042-sura.md` 42/23 | *Lâ es'elüküm aleyhi ecran illâ'l-mevveddete fi'l-kurbâ* |
| `068-kalem.md` 68/46 | *Em tes'elühüm ecran fe-hüm min mağramin müskalûn* |
| `052-tur.md` 52/40 | *Em tes'elühüm ecran fe-hüm min mağramin müskalûn* |
| **Mü'minûn 23/72** | *Em tes'elühüm harcen fe-harâcü rabbike hayr* |

**Beş yerde de aynı iş yapılıyor:** elçinin bir çıkar sahibi olmadığı kaydediliyor. **`025-furkan.md` 25/57'de bu kalıp işlendi** ve orada istisnanın biçimi kaydedilmişti: **istenen şey verenin elinden çıkan bir şey değildi.** **Oraya dayanıyorum.**
...
**Terkip `001-fatiha.md`'de ayrıntılı işlendi.** **Tekrarlamıyorum.**

**Buraya ait olan, iki ayetteki belirlilik farkıdır ve kaydedilmelidir:**

| Ayet | Terkip | Belirlilik |
|---|---|---|
...
**İki kökün ayrı olduğu kesindir ve aralarında iştikak bağı kurmuyorum.** **`080-abese.md` ve `083-mutaffifin.md`'de yakın sesli kökler için düşülen ihtiyat kaydı burada da geçerlidir.**
...
**Bu, `025-furkan.md` 25/11'de kaydedilen tespitle aynı hattadır:** *bel kezzebû bi's-sâa* — **"asıl mesele bu değil: onlar kıyameti yalanladılar."** **Oraya dayanıyorum.**
...
|---|---|---|
| **33** | *Kezzebû bi-likāi'l-âhıra* | **Adsız kavim** |
| **74** | *Lâ yü'minûne bi'l-âhıra* | **Muhataplar** |
...
**ط-غ-ي / ط-غ-و** kökü: **haddi aşmak, taşmak.** *Tuğyân* — suyun taşması (Hâkka 69/11 — *lemmâ tağa'l-mâ'*; `069-hakka.md`'de işlendi). **Kök `079-naziat.md` 79/17 ve 79/37'de, `096-alak.md` 96/6'da işlendi.**
...
**Ve Bakara 2/15 ile bu ayet arasındaki bağ kaydedilmeye değer:** orada fiil *yemüddühüm* (uzatırız), burada *le-leccû* (inat ederlerdi). **`002-bakara.md`'de o ayet işlendi.**
...
**Ve aynı hat En'âm 6/43'te işlenir** (*fe-levlâ iz câehüm be'sünâ tedarraû*). **Bu tefsirde `067-mulk.md` 67/21'de (*bel leccû fî utüvvin ve nüfûr*) benzer bir dizim işlenmişti** — orada da inat, bir imkânın ardından geliyordu. **Oraya dayanıyorum.**
...
**ف-ت-ح** kökü: **açmak.** **Kök `048-fetih.md`'de sûre adı vesilesiyle ayrıntılı işlendi.** **Tekrarlamıyorum.**
...
**Kelime Kur'an'da birkaç yerde geçer:** En'âm 6/44 (*fe-izâ hüm **müblisûn***), Rûm 30/12 ve 30/49 (`030-rum.md`'de işlendi), Zuhruf 43/75 (`043-zuhruf.md`'de işlendi).
...
**`032-secde.md` 32/9'da bu üçlü dördüncü kez işlenmiş ve dört halkalı bir tablo kurulmuştu.** **Beşinci halka burasıdır ve tabloyu genişletiyorum:**

| Yer | Cümle | Fiil | Üçlünün işi |
|---|---|---|---|
| `046-ahkaf.md` 46/26 | *Ve **cealnâ lehüm** sem'an ve ebsâran ve ef'ideten fe-mâ ağnâ anhüm…* | *Ceale* | **Verildi — işe yaramadı** |
| `045-casiye.md` 45/23 | *Ve **hateme** alâ sem'ihî ve kalbihî ve **ceale** alâ basarihî ğışâveten* | *Hateme* / *ceale* | **Kapatıldı** — mühür ve perde |
| `041-fussilet.md` 41/20 | *Şehide aleyhim sem'uhüm ve ebsâruhüm ve **cülûdühüm*** | *Şehide* | **Şahitlik etti** — üçüncüsü *deri* |
| `032-secde.md` 32/9 | *Ve **ceale leküm** … kalîlen mâ teşkürûn* | *Ceale* | **Verildi — şükredilmedi** |
...
**Sıralamanın anlamı `046-ahkaf.md` 46/26'da kaydedilmişti ve burada da geçerlidir:** dıştan içe doğru gidiliyor — **işitilen → görülen → içeride değerlendirilen.** **أَفْـِٔدَة** kelimesinin kökü (**ف-ء-د**, közün yakması; *fuâd*, kalbin tutuşan yönü) orada çözümlendi; **tekrarlamıyorum.**
...
| | `032-secde.md` 32/9 | **Mü'minûn 23/78** |
|---|---|---|
...
**Fiil farkı kaydedilmeye değer ve bunu kendi okumam olarak veriyorum:** *ceale* **var olanı bir hâle koymayı** bildirir; *enşee* **kurmayı, ayağa dikmeyi.** **`056-vakia.md`'de kökün bu anlamı çözümlenmişti** ve orada kaydedilmişti: **fiil bir *yeniden kurma* bildiriyor.**
...
**Dizim `032-secde.md` 32/9'da işlendi ve burada da geçerlidir:** *kalîlen* **öne alınmış** (takdîm); **ve *mâ* burada ya olumsuzluk pekiştiricisi ya da masdar edatıdır; iki i'râb da nakledilir.** **Tekrarlamıyorum.**
...
**Kök dizinde ilk kez burada çözümleniyor.** Kelime Kur'an'da birkaç yerde geçer: A'râf 7/179 (*ve lekad zere'nâ li-cehenneme*), Nahl 16/13, Şûrâ 42/11 (*yezraüküm fîh*; `042-sura.md`'de geçti), Mülk 67/24 (*ellezî zeraeküm fi'l-ard*; `067-mulk.md`'de işlendi).

**Ve Mülk 67/24 ile bu ayetin örtüşmesi kaydedilmelidir:** iki cümle **neredeyse birebir aynıdır.**

| Yer | Cümle |
|---|---|
| `067-mulk.md` 67/24 | *Kul hüve'llezî **zeraeküm fi'l-ardı ve ileyhi tuhşerûn*** |
...
**ح-ش-ر** kökü: **dağınık olanı bir araya toplamak.** **Kök `059-hasr.md`'de sûre adı vesilesiyle çözümlendi.** **Tekrarlamıyorum.**
...
**Aynı olgu `025-furkan.md` 25/62'de başka bir kelimeyle anlatılmıştı:** *ve hüve'llezî ceale'l-leyle ve'n-nehâra **hılfeten** li-men erâde en yezzekkera ev erâde şükûrâ.* **Ve orada işlendi.**

**İki ayet karşılaştırılabilir:**

| | `025-furkan.md` 25/62 | **Mü'minûn 23/80** |
|---|---|---|
...
**ع-ق-ل** kökü: **bağlamak.** *İkāl* — devenin dizini bağlayan ip; *akl* — kişiyi savrulmaktan tutan bağ. **Kök `036-yasin.md` 36/62 ve `002-bakara.md` 2/44'te işlendi.**
...
| Kalıp | *E-yaıdü**küm*** — **üçüncü şahsa itiraz** ("size vaat mi ediyor") | *E-izâ **mitnâ*** — **birinci şahıs** ("biz ölünce") |
...
**س-ط-ر** kökü: **satır satır yazmak, dizmek.** *Satr* — satır, dizi; *estâr* — satırlar. ***Esâtîr*** — *ustûre*nin çoğulu sayılır: **düzülüp anlatılan hikâyeler.**

**Kök `054-kamer.md` 54/53'te (*ve küllü sağîrin ve kebîrin müstetar*) ز-ب-ر ile karşılaştırılarak işlendi** ve `068-kalem.md` 68/1'de (*ve'l-kalemi ve mâ yesturûn*) çözümlendi. **Tekrarlamıyorum.**

**Ve terkip `025-furkan.md` 25/5'te birebir geçmişti:** *ve kālû **esâtîru'l-evvelîne**'ktetebehâ fe-hiye tümlâ aleyhi bükraten ve asîlâ.* **Ve orada, dört itirazın ikincisi olarak tablolandı.**

**İki ayet karşılaştırılabilir:**

| | `025-furkan.md` 25/5 | **Mü'minûn 23/83** |
|---|---|---|
...
**Bunu bir gözlem olarak kaydediyorum:** karşı taraf *evvelîn*i **delil** olarak kullanıyor (24, 83); sûre onu **teşhis** olarak kullanıyor (68, 81). **Aynı kelime, iki ayrı işte.**
...
**İki gerekçe birbirinin zıddıdır ve ikisi de sûrenin içindedir.** Bu, metinden doğrulanabilir bir karşıtlıktır ve bunu kendi okumam olarak yorumluyorum: **red, gerekçesini durumdan alıyor** — gerekçe değişiyor, red değişmiyor. **`025-furkan.md` 25/4-8'de kaydedilen tespitin aynısı budur.**
...
|---|---|---|---|
| **1** (84-85) | *Li-**men**i'l-ardu ve men fîhâ* — **mülkiyet** | *Lillâh* | *E-fe-lâ tezekkerûn* |
...
**Kelime Kur'an'da dört yerde geçer:** En'âm 6/75, A'râf 7/185, Yâsîn 36/83 (`036-yasin.md`'de işlendi), ve bu ayet.

**Ve `036-yasin.md` 36/83'te (*fe-sübhâne'llezî bi-yedihî melekûtü külli şey'*) neredeyse birebir aynı terkip geçer:**

| Yer | Cümle |
|---|---|
| `036-yasin.md` 36/83 | *Fe-sübhâne'llezî **bi-yedihî melekûtü külli şey'in** ve ileyhi türceûn* |
...
**Ve `036-yasin.md`'de o ayetin sûrenin son ayeti olduğu kaydedilmişti.** Oraya dayanıyorum.
...
**Aynı kelime Cin 72/22'de de geçer** (*lâ yücîrunî mine'llâhi ehad*; `072-cin.md`'de işlendi) **ve Ahkāf 46/31-32'de** (`046-ahkaf.md`'de işlendi).
...
**Kök `054-kamer.md` 54/2'de (*sihrun müstemirr*) ve `074-muddessir.md` 74/24'te (*in hâzâ illâ sihrun yü'ser*) işlendi.**
...
**`037-saffat.md`'de bu iki cümlenin bir benzeri işlendi** (37/159 — *sübhânallâhi ammâ yasıfûn*; 37/180 — *sübhâne rabbike rabbi'l-izzeti ammâ yasıfûn*) **ve orada ikincisinin birincinin genişletilmişi olduğu kaydedilmişti.** **Oraya dayanıyorum.**

**Buradaki fark kaydedilmelidir:** Sâffât'ta iki cümle de *yasıfûn* ile bitiyordu; **Mü'minûn'da ikincisi *yüşrikûn*a dönüyor.** **Yani sözden fiile geçiliyor.**

### عَٰلِمِ ٱلْغَيْبِ وَٱلشَّهَٰدَة

**Terkip Kur'an'da düzenli olarak geçer:** En'âm 6/73, Tevbe 9/94 ve 9/105, Ra'd 13/9, Secde 32/6 (`032-secde.md`'de geçti), Zümer 39/46 (`039-zumer.md`'de geçti), Haşr 59/22 (`059-hasr.md`'de işlendi), Teğābün 64/18 (`064-tegabun.md`'de işlendi), Cuma 62/8 (`062-cuma.md`'de geçti).
...
**Kök `104-humeze.md`'de çözümlendi.** **Tekrarlamıyorum.** Orada verilen tarif:

> **همز — kök ه-م-ز.** Sözlükteki asıl anlamı **basmak, sıkıştırmak, kırmak, dürtmek**tir. Bir şeye bastırıp ezmek. **Arap alfabesindeki *hemze* harfinin adı da buradan gelir:** boğazda bir sıkışma ve kesilmeyle çıkan ses.

**Oraya dayanıyorum.** **Buraya ait olan, kelimenin çoğul ve masdar oluşudur.**

***Hemezât* — *hemze*nin çoğulu; masdar-ı merre (bir defalık iş) çoğulu.** **Yani kelime tek tek dürtmeleri bildiriyor**, sürekli bir hâli değil.

**Bunu kendi okumam olarak veriyorum, dayanağı kalıbın bu oluşudur:** sığınılan şey bir kuşatma değil, **tek tek gelen dürtüler.** **Ve `104-humeze.md`'de kaydedilen "bastırıp ezmek" anlamı, dürtünün bedende bir yeri olduğu görüntüsünü veriyor** — hafif ama fiziksel bir temas.

### أَن يَحْضُرُون — meçhulün olmayışı

**ح-ض-ر** kökü: **hazır bulunmak, yanında olmak.** *Hâdır* — orada bulunan; *muhdar* — getirilen.

**Kök `037-saffat.md`'de üç yerde (37/57, 127, 158) işlendi** ve orada kalıbın ters yönlerde kullanıldığı tablolanmıştı. **Oraya dayanıyorum.**

**Ve fiilin sonundaki *nûn* kaydedilmelidir:** *en yahdurûn* — aslı *en yahdurûni*dir; sondaki *yâ* (mütekellim zamiri) fâsılaya uyum için düşürülmüştür. **Aynı işlem doksan dokuzuncu ayette (*irciûn*) ve yüz sekizinci ayette (*lâ tükellimûn*) de görülecek.**
...
**Ve fiilin sonundaki *nûn* doksan sekizinci ayette kaydedildiği gibi mütekellim *yâ*sının düşmesiyle oluşuyor:** aslı *irciûnî.*
...
**كَلَّا** — ret ve azarlama edatı. **Dilciler kelimeyi "hayır, öyle değil" olarak açıklar** ve Kur'an'da çoğunlukla bir talebin ya da iddianın reddinde geçtiğini kaydeder. **Kelime `075-kiyame.md`, `080-abese.md` ve `102-tekasur.md`'de işlendi.**
...
**Kelime `025-furkan.md` 25/53'te çözümlendi.** Orada verilen tarif:
...
**Ve `055-rahman.md` 55/20'de (*beynehümâ berzahun lâ yebğıyân*) de geçmişti.** **Oraya dayanıyorum.**

**Kelime Kur'an'da üç yerde geçer ve üçü karşılaştırılmalıdır:**

| Yer | Cümle | Neyin arasında | Cinsi |
|---|---|---|---|
| `055-rahman.md` 55/20 | *Beynehümâ berzahun lâ yebğıyân* | **İki su** — tatlı ve tuzlu | **Mekân engeli** |
| `025-furkan.md` 25/53 | *Ve ceale beynehümâ berzahan ve hicran mahcûrâ* | **İki su** | **Mekân engeli** |
...
**Aynı talep dizide iki yerde daha işlendi ve `032-secde.md` 32/12'de ikisi tablolanmıştı.** **Üçüncüsü burasıdır ve tabloyu genişletiyorum:**

| | `035-fatir.md` 35/37 | `032-secde.md` 32/12 | **Mü'minûn 23/99-100** |
|---|---|---|---|
...
**Ve `032-secde.md`'de kaydedilen tespit burada bir adım daha ilerliyor.** Orada şu yazılmıştı:
...
**Kelime ve olgu `079-naziat.md` 79/6-7, `069-hakka.md` 69/13 ve `036-yasin.md` 36/51'de işlendi.** **Tekrarlamıyorum.**

**Ve fiilin meçhul oluşu kaydedilmelidir: *nüfiha* — üfleyen söylenmiyor.** **`079-naziat.md`'de aynı husus kaydedilmişti.**
...
**Kelime `025-furkan.md` 25/54'te işlendi** (*fe-cealehû neseben ve sıhrâ*). Orada kaydedilenler:
...
| | `025-furkan.md` 25/54 | **Mü'minûn 23/101** |
|---|---|---|
...
| Yer | Cümle | Ne diyor |
|---|---|---|
| `037-saffat.md` 37/27 | *Ve akbele ba'duhüm alâ ba'dın **yetesâelûn*** | **Soruyorlar** — cehennemde |
| `037-saffat.md` 37/50 | *Fe-akbele ba'duhüm alâ ba'dın **yetesâelûn*** | **Soruyorlar** — cennette |
| `052-tur.md` 52/25 | *Ve akbele ba'duhüm alâ ba'dın **yetesâelûn*** | **Soruyorlar** |
| `074-muddessir.md` 74/40 | *Fî cennâtin **yetesâelûn*** | **Soruyorlar** |
...
**İhtilafı aktarıyorum; tercih dayatmıyorum.** **Ve `037-saffat.md`'de aynı fiilin iki tabloda (cehennem ve cennet) tekrarlandığı kaydedilmişti;** oraya dayanıyorum.
...
**Kelime `101-karia.md` 101/6-9'da (*fe-emmâ men sekulet mevâzînüh · ve emmâ men haffet mevâzînüh*) ayrıntılı işlendi** ve orada Zilzâl'in *zerre*siyle birleştirildiği kaydedilmişti. **Tekrarlamıyorum.**

**Ve bu ayet, Kâria'daki iki ayetin neredeyse birebir tekrarıdır:**

| Yer | Ağır | Hafif |
|---|---|---|
| `101-karia.md` 101/6-9 | *Fe-emmâ men **sekulet mevâzînüh** fe-hüve fî îşetin râdıye* | *Ve emmâ men **haffet mevâzînüh** fe-ümmühû hâviye* |
...
**Ve `059-hasr.md`'de *felâh* ile *fevz* arasında bir ayrım kaydedilmişti:**
...
**Oraya dayanıyorum.** **Ve bu sûrede iki kelime de bulunuyor:** *felâh* (1, 102, 117) ve *fevz* (111 — *ennehüm hümü'l-fâizûn*). **Yani `059-hasr.md`'de kurulan ayrım bu sûrede de sınanabilir hâlde:** *felâh* sûrenin iki ucunda ve tartı sahnesinde, *fevz* ise sabredenlerin karşılığında.
...
| Ayet | Kim söylüyor | Kim zarar edecek |
|---|---|---|
| **34** | **İtiraz edenler** | **Elçiye uyanlar** |
| **103** | **Metin** | **Tartısı hafif gelenler** |
...
| Kelime | Kök | Derece |
|---|---|---|
| **نَفْح** | ن-ف-ح | **Hafif esinti, az dokunma** |
| **لَفْح** | ل-ف-ح | **Şiddetli çarpma, yakma** |

**Bu ayrımı nakledildiği şekliyle aktarıyorum.**

**Kök dizinde ilk kez burada çözümleniyor.** Kelime Kur'an'da yalnız burada geçer.

**Ve fiilin nesnesi kaydedilmelidir: *vücûhehüm* — yüzler.** **Yüz, Kur'an'ın azap ve nimet tablolarında düzenli olarak öne çıkan uzuvdur** — `080-abese.md` 80/38-41'de (*vücûhün yevmeizin müsfira* / *aleyhâ ğaberah*) ve `088-gasiye.md` 88/2 ve 88/8'de işlendi.
...
**Bunu bir dil kaydı olarak veriyorum ve ötesine gitmiyorum.** **Ve `025-furkan.md` 25/12'de kaydedilen tespit burada da geçerlidir:** Kur'an bu sahnelerde soyut sıfat yerine **görülebilen ayrıntı** kullanıyor.
...
**Cümle bir mazerettir ve kuruluşu kaydedilmelidir:** *şikvetünâ* — **öznedir**, *aleynâ* — **onlar mef'ûldür.**
...
**ش-ق-و** kökü: **zorluk, sıkıntı, mutsuzluk.** Kelime *saâdet*in (mutluluk) karşıtıdır. **Kök `087-ala.md` 87/11'de (*ve yetecennebühe'l-eşkā*) ve `092-leyl.md` 92/15'te (*lâ yaslâhâ ille'l-eşkā*) işlendi.**
...
| `067-mulk.md` 67/4 | *Hâsien* — ism-i fâil | **Göz** — bakışın dönüşü |
...
**Ve fiilin sonundaki *nûn*, doksan sekizinci ayette kaydedildiği gibi mütekellim *yâ*sının düşmesiyle oluşuyor:** aslı *tükellimûnî.*
...
**ف-ر-ق** kökü: **ayırmak.** *Ferîk* — ayrılmış bölük. **Kök `025-furkan.md` 25/1'de (*el-Furkān*) ve `044-duhan.md` 44/4'te işlendi.**
...
**ص-ب-ر** kökü: **bir şeyi tutmak, hapsetmek, dayanmak.** **Kök `103-asr.md`'de ve `090-beled.md` 90/17'de işlendi.**

**Ve *sabr*ın burada neyin karşısında olduğu kaydedilmelidir:** ayet açlık, hastalık ya da savaştan söz etmiyor — **alay edilmeye** karşı sabırdan söz ediyor.
...
**Ve `025-furkan.md` 25/75'te aynı gerekçe kaydedilmişti:** *ülâike yüczevne'l-gurfete **bimâ saberû***. **Aynı terkip, iki sûrede.** **Oraya dayanıyorum.**

| Yer | Cümle | Karşılık |
|---|---|---|
| `025-furkan.md` 25/75 | *Yüczevne'l-gurfete **bimâ saberû*** | **El-Gurfe** — mekân |
...
**Kök `059-hasr.md` 59/20'de (*ashâbü'l-cenneti hümü'l-fâizûn*) işlendi** ve orada *felâh* ile ayrımı yapılmıştı:
...
**Ve dizim kaydedilmelidir:** *ennehüm **hüm**ü'l-fâizûn* — fasıl zamiriyle pekiştirilmiş. **Yani "onlar da kurtulanlardandır" değil, "kurtulanlar işte onlardır."**
...
| Okuyuş | Kalıp | Kim söylüyor |
|---|---|---|
| ***kāle*** | **Mâzî** — "buyurdu/dedi" | **Üçüncü şahıs** |
| ***kul*** | **Emir** — "de ki" | **Muhataba emir** |
...
| Yer | İfade | Ölçü |
|---|---|---|
| `046-ahkaf.md` 46/35 | *Ke-ennehüm yevme yeravne mâ yûadûne lem yelbesû illâ **sâaten min nehâr*** | **Gündüzün bir saati** |
| `079-naziat.md` 79/46 | *Ke-ennehüm yevme yeravnehâ lem yelbesû illâ **aşiyyeten ev duhâhâ*** | **Bir akşam ya da bir kuşluk** |
| `030-rum.md` 30/55 | *Yuksimü'l-mücrimûne mâ lebisû **ğayra sâa*** | **Bir saatten az** |
| **Mü'minûn 23/113** | *Lebisnâ **yevmen ev ba'da yevm*** | **Bir gün ya da bir kısmı** |

**Dört ifade de aynı işi görüyor.** **Ve `046-ahkaf.md` 46/35'te bu ölçü işlendi ve orada kaydedilmişti:**
...
**Ve `044-duhan.md`'de aynı cümlenin Enbiyâ 21/16'da da geçtiği bir lafız kaydı olarak verilmişti; o ayet `021-enbiya.md` 21/16-18'de işlendi.** **İkisine de dayanıyorum.**
...
|---|---|---|---|
| `044-duhan.md` 44/38 | ***Lâibîn*** — oyun oynayanlar olarak | **Gökler ve yer** | **Yaratan** — *mâ halaknâ* |
| `021-enbiya.md` **21/16** | ***Lâibîn*** | **Gök, yer ve arası** | **Yaratan** |
...
**Bir. Nesne farkı.** Duhân ve Enbiyâ **kâinatı** anıyor; **Mü'minûn doğrudan muhatabı** — *halaknâ**küm***.

**İki. Kip farkı.** Ötekiler **haberdir** (yaratmadık); **Mü'minûn sorudur** (sandınız mı).

**Üç. Kelime farkı.** Ötekilerde *laib* (oyun), burada *abes* (boş iş). **Ve dilcilerin kaydettiği ayrıma göre *abes* daha ağırdır:** oyunda bir maksat vardır, *abes*te hiç yoktur.
...
| Ayet | Terkip | Sıfat |
|---|---|---|
| **86** | *Ve rabbü'l-arşi'**l-azîm*** | ***Azîm*** — büyük |
| **116** | *Rabbü'l-arşi'**l-kerîm*** | ***Kerîm*** — şerefli, değerli |

**İki sıfat, aynı terkipte, otuz ayet arayla.** Bu, sûre içinde doğrulanabilir bir tekrardır.

**ك-ر-م** kökü: **değerli olmak, cömert olmak.** **Kök `096-alak.md` 96/3'te (*ve rabbüke'l-ekrem*) ve `044-duhan.md` 44/49'da işlendi.**
...
**Ve cümlenin i'râbı kaydedilmelidir: *lâ burhâne lehû bihî*, *ilâhen âhar*ın sıfatıdır.** Dilciler bu sıfatı ***sıfat-ı kâşife*** sayar — yani **ayırt etmek için değil, durumu açığa çıkarmak için** getirilmiş sıfat.
...
**Bu, `025-furkan.md` 25/43 ve `028-kasas.md` 28/56'da tablolanan sorumluluk sınırının bir halkasıdır:** hüküm veren taraf ile tebliğ eden taraf ayrılıyor. **Ve bu sûrede aynı sınır elli dördüncü ayette de çizilmişti** (*fe-zerhüm fî ğamratihim*).
...
**Bunu kendi okumam olarak kaydediyorum, dayanağı bu üçlü dağılımdır:** sûre hükmü başta veriyor, ortada ölçüyü koyuyor, sonda olumsuzunu bildiriyor. **Ve `002-bakara.md`'de çözümlenen kök anlamı bu çerçeveye uyuyor:** *felâh* **bir engeli yarıp çıkmak**tır. **Sûrenin açılışındaki liste, o yarmanın nasıl olacağını anlatıyor.** Bu bir okumadır ve bağlayıcı değildir.
...
**Ve yüz dokuzuncu ayette aynı dua mef'ûllüydü:** *fe'ğfir **lenâ** ve'rham**nâ***.

| Ayet | Fiiller | Mef'ûl |
|---|---|---|
| **109** | *İğfir lenâ ve'rhamnâ* | ***Lenâ / -nâ*** — "bize" |
| **118** | *İğfir verham* | **Yok** |
...
**Aynı yapı `002-bakara.md`'de kaydedilmişti:** *"sûre, 286 ayetlik uzun bir hüküm, tarih ve tartışma metninden sonra bir istekle bitiyor."* **Ve `025-furkan.md` 25/77'de de sûre bir *duâ* kelimesiyle kapanıyordu.** **Oraya dayanıyorum.**
...
**Ve bu iki liste, `025-furkan.md` 25/63-77'deki *ıbâdü'r-rahmân* listesiyle dosyanın başında ayrıntılı olarak karşılaştırıldı.** Oradaki tabloyu tekrarlamıyorum; özeti şudur: **dört ortak alan** (namaz, boş söz, mal, iffet), **Mü'minûn'a mahsus bir madde** (emanet ve ahit), **Furkān'a mahsus yedi madde**, ve **iki listenin de bir konutla bitmesi.**
...
| **8** | *Li-emânâtihim* / *li-emânetihim*; ve *ahd*in tekil gelmesi |
| **11** | *Firdevs* kelimesinin kökeni |
| **14** | *Halkan âhar*ın i'râbı; "başka bir yaratılış"ın ne olduğu; *ahsenü'l-hâlikīn* terkibi |
| **17** | *Tarâik* ne — yedi gök, katlar, yollar |
| **20** | *Tenbütü* / *tünbitü*; *bâ*'nın işi; *Seynâ'* / *Sînâ'*; ağacın adı |
| **27** | *Tennûr*un ne olduğu; *min küllin* / *min külli* |
| **29** | *Münzelen* / *menzilen* |
| **31** | Kavmin kim olduğu — Âd, Semûd, belirsiz |
| **44** | *Tetrâ* / *tetran* |
| **45** | *Âyât* ile *sultân* arasındaki ilişki |
| **49** | *Leallehüm yehtedûn*daki zamirin mercii |
| **50** | *Âyeten*in tekil gelmesi; *maîn*in kökü; *rabve*nin harekesi; yerin neresi olduğu |
...
| **55-56** | *Ennemâ*nın bitişik mi ayrı mı olduğu |
| **60** | *Yü'tûne mâ âtev* / *ye'tûne mâ etev*; *ennehüm*ün i'râbı |
| **61** | *Lehâ*'nın işi |
| **63** | *Hâzâ* zamirinin mercii; *min dûni zâlike*nin anlamı |
| **67** | *Bihî* zamirinin mercii; *tehcürûn* / *tühcirûn* |
| **71** | *El-Hakk* ne — Allah, vahiy, gerçek, düzen; *zikruhüm*ün anlamı |
...
| **92** | *Âlimi*nin i'râbı — mecrûr mu merfû mu |
| **99** | *İrciûn*un çoğul gelmesi |
| **100** | *İnnehâ kelimetün hüve kāilühâ*nın anlamı; *fîmâ terektü*nün kapsamı; *min verâihim*in yönü |
...
- **12-16. ayetlerde aşamalı oluşum, modern embriyoloji terimleriyle eşitlenmedi.** `040-gafir.md` 40/67, `039-zumer.md` 39/6, `032-secde.md` 32/7-9 ve `096-alak.md`'de çizilen sınır aynen korundu ve gerekçeleri tekrarlanmadı.
- **17. ayetteki *seb'a tarâik* üzerinden hiçbir modern tasnifle eşleştirme yapılmadı.** `086-tarik.md`'de astronomi iddiaları için düşülen kayıt burada da geçerli sayıldı.
- **18. ayetteki *fe-eskennâhü fi'l-ard* üzerinden hidrolojik döngü ya da yeraltı suyu hakkında bir "önceden haber verme" iddiası kurulmadı.** `077-murselat.md` 77/20-23'teki kayıt korundu.
...
- **27. ayette *tennûr*un yeri, 50. ayette *rabve*nin yeri, 31. ayette kavmin adı** — üçünde de Kur'an'ın vermediği ayrıntı eklenmedi; nakledilen yer ve kavim adları, kaynaklarından emin olmadığım için aktarılmadı.
...
- **52, 71 ve 115. ayetlerde Enbiyâ ile kurulan karşılaştırmalar `021-enbiya.md`'ye dayandırıldı; o dosyada yapılan çözümlemeler tekrarlanmadı.**
...
- 12-14. ayetlerdeki **üç *sümme*nin üç eşik** olarak okunması; *kesevnâ* fiilinin **dönüşüm değil örtme** bildirdiği tespiti; ve *enşe'nâ*nın koyduğu eşiğin **adlandırılmamış** oluşuna dair okuma.
...
- 22. ayetteki *tuhmelûn*un **edilgen çatısı** üzerinden II. bloğun bütününe dair kurulan okuma.
- 51. ayetteki *külû* emrinin, 33. ayetteki itirazın **cevabı** olarak okunması; ve Furkān'ın yöntemiyle karşılaştırılması.
- 53. ayette *zübür*ün **kalıcılık** yönünün öne çıkarılması.
...
- 89. ayetteki *tüsharûn*un **meçhul çatısı** üzerinden kurulan yorum.
- 96. ayette Fussilet 41/34 ile fark: **sonuç vaadinin bulunmaması.**
- 100. ayette *berzah*ın Furkān'daki kullanımdan **edat farkıyla** (*beyne* / *ilâ*) ayrılması.
