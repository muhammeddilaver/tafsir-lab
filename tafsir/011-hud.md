...
**Deve, Kur'an'da birkaç sûrede anılır** (`026-suara.md` 26/155, `007-araf.md` — dizide henüz yok, `054-kamer.md` 54/27, `091-sems.md` 91/13). **`026-suara.md` ve `091-sems.md`'de işlendi; oraya dayanıyorum.**
...
**Ve fiil çoğuldur: "onu kestiler".** **Kur'an başka bir yerde işi tek bir kişinin yaptığını bildirir** (*fe-nâdev sâhıbehüm fe-teâtâ fe-akar* — Kamer 54/29; *izi'nbease eşkāhâ* — Şems 91/12). **Bu iki ayet `054-kamer.md` ve `091-sems.md`'de işlendi.**
...
**Kelime Kur'an'da birçok yerde helâk aracı olarak geçer ve dizinde işlendi** (`036-yasin.md` 36/29 ve 36/49, `015-hicr.md` — dizide yok, `054-kamer.md` 54/31 — orada *sayhaten vâhıdeh*). **`036-yasin.md`'ye dayanıyorum.**
...
**Ve aynı kelime `003-al-i-imran.md` — dizide henüz yok — dışında `051-zariyat.md` 51/34'te de geçer** (*müsevvemeten inde rabbike li'l-müsrifîn*) **ve orada aynı sahne anlatılır.** **İki sûrede birebir aynı terkip: *müsevvemeten inde rabbik*.** Bu, metinden doğrulanabilir bir tekrardır.
