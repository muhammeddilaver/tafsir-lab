...
Sûrenin asıl konusu şairler değildir. Sûrenin asıl konusu **tekrardır.**
...
Sûre üç şeyi arka arkaya söylüyor:

1. **Sen üzülme** (3) — muhatabın inanmaması elçinin başarısızlığı değildir.
2. **Senden önce de böyleydi** (10-191) — yedi kıssa, yedi kez aynı sonuç.
3. **Bu söz senin uydurman değil** (192-227) — kaynağı, dili, indiği yer ve **kimin sözü olmadığı.**
...
**Bunu bir olgu olarak kaydediyorum; harf ya da sayı hesabına girmiyorum** — bu tefsirde o yol kapalıdır (`002-bakara.md`). Kaydedilen şey, Kalem ve Sâffât bölümlerinde de kaydedilen türden bir ses gözlemidir (`068-kalem.md`, `037-saffat.md`).
...
Sûrenin bütünü Mekke'deki temel tartışmanın içine oturur ve o tartışmanın üç iddiasına cevap verir:
...
## Sûrenin omurgası — yedi kıssa, dört kalıp
...
1. **Yalanlama bildirimi:** *Kezzebet … el-mürselîn*
2. **Açılış:** *İz kāle lehüm ehûhüm … elâ tettekūn*
3. **Üçlü giriş:** *innî leküm rasûlün emîn · fettekullâhe ve etîûn · ve mâ es'elüküm aleyhi min ecrin…*
4. **Kapanış mührü:** *inne fî zâlike le-âyeten… · ve inne rabbeke le-hüve'l-azîzü'r-rahîm*
...
### Tablo 1 — Kapanış mührü: sekiz geçiş
...
### Tablo 2 — Açılış kalıbı: beş kıssa, iki eksik
...
**Bu tabloda üç ayrı olgu var ve üçü de metinden okunuyor:**
...
**Ve aynı fark fiile de yansımıştır:** *kavm*, *Âd*, *Semûd* kelimeleri Arapçada müennes muamelesi görebildiği için fiil *kezzebet*tir; *ashâb* müzekker çoğul olduğu için fiil *kezzebe*dir. **Yani 176. ayetteki iki fark — düşen *ehûhüm* ve değişen fiil — aynı sebebe bağlanabiliyor. Bunu bir dizim gözlemi olarak kaydediyorum.**

### Tablo 3 — Üçlü giriş: beş kıssada birebir aynı
...
### Tablo 4 — *Fettekullâhe ve etîûn*: sekiz geçiş

Cümle beş kıssada birer kez giriş kalıbının içinde geçiyor; **üç kıssada bir kez daha tekrarlanıyor.**
...
**Toplam sekiz geçiş: 108, 110, 126, 131, 144, 150, 163, 179.**
...
### Tablo 5 — *Ve mâ es'elüküm aleyhi min ecrin*: beş geçiş

> *وَمَآ أَسْـَٔلُكُمْ عَلَيْهِ مِنْ أَجْرٍ إِنْ أَجْرِىَ إِلَّا عَلَىٰ رَبِّ ٱلْعَٰلَمِينَ*
>
> "Buna karşılık sizden bir ücret istemiyorum; benim ücretim ancak âlemlerin Rabbine aittir."
...
### Şuarâ ile Sâffât — iki peygamber dizisi

**`037-saffat.md`'de aynı yapı işlendi ve orada kurulan çerçeve burada tekrarlanmıyor.** İki sûrenin karşılaştırması şudur:
...
*Tâ-sîn-mîm · Tilke âyâtü'l-kitâbi'l-mübîn*

"Tâ-sîn-mîm. · **Bunlar, apaçık kitabın ayetleridir.**"

### Hurûf-ı mukattaa

**Bahis dizinde defalarca kuruldu** (`002-bakara.md`, `036-yasin.md`, `038-sad.md`, `050-kaf.md`, `068-kalem.md`) **ve tekrarlanmıyor.** Özeti: bu harflerin anlamı hakkında kesin bir bilgi nakledilmemiştir; en dürüst tutum, bilinmediğini söylemektir.
...
**Kasas'ın açılışı bu tefsirde işlendi** (`028-kasas.md` 28/1-6) ve orada da aynı kayıt düşüldü.

### تِلْكَ — uzağı gösteren işaret

**تِلْكَ** — müennes, **uzak** için kullanılan işaret zamiri ("şu", "işte o"). Yakın için *hâzihî* denirdi.
...
**Aynı açılış Kur'an'da birkaç sûrede tekrarlanır:** *tilke âyâtü'l-kitâbi'l-hakîm* (Yûnus 10/1), *tilke âyâtü'l-kitâbi'l-mübîn* (Yûsuf 12/1), *tilke âyâtü'l-kitâbi'l-hakîm* (Lokmân 31/2 — `031-lokman.md`'de işlendi). **Şuarâ, Yûsuf ile aynı sıfatı kullanıyor: *el-mübîn*.**

### ٱلْمُبِين — kök ب-ي-ن

**Kök dizinde birçok yerde çözümlendi** (`043-zuhruf.md` 43/2, `044-duhan.md` 44/2, `036-yasin.md`) **ve tekrarlanmıyor.** Oradaki tarif: kökün çekirdeğinde **ayrılık, iki şeyin arasının açılması** vardır; *beyn* — ara. Bir şey **ayrıştığında** görünür olur.
...
**Bu ayet, Kur'an'da elçiye çizilen sınırın en keskin ifadelerinden biridir ve dizinde altı kez işlendi.** `028-kasas.md` 28/56'da bu ayetler bir tabloda toplanmıştı. **Şuarâ 26/3, o tabloya eklenen yedinci satırdır:**
...
*A'nâk* (boyunlar) **akılsız çoğuldur**; kuralca haberi de müennes tekil ya da kırık çoğul gelmeliydi: *hâdıaten* ya da *hâdıatün*. **Ama gelen kelime *hâdıîn*dir — akıllı varlıklar için kullanılan müzekker sâlim çoğul.**
...
**Kur'an bu ayrımı başka yerlerde de kurar:** *ve lev şâe rabbüke le-âmene men fi'l-ardı küllühüm cemîâ* (Yûnus 10/99), *ve lev şi'nâ le-âteynâ külle nefsin hüdâhâ* (Secde 32/13 — `032-secde.md`'de işlendi). **Üç ayet de aynı yapıdadır: dilemek + zorlamak + gerçekleşmemek.**
...
**Kelime *zikr*in sıfatıdır ve nüzul anına bakar:** her yeni inen bölüm. Yani ayet tek bir olayı değil, **tekrarlanan bir tepkiyi** anlatıyor: **her yeni geldiğinde aynı şey oluyor.**
...
### ٱلرَّحْمَٰن — ismin seçimi

**İsim `055-rahman.md`'de ayrıntılı çözümlendi ve tekrarlanmıyor.**

**Buraya eklenecek olan bir dizim gözlemidir:** yüz çevirme fiilinin karşısına konan isim *el-Kahhâr* ya da *el-Cebbâr* değil, **er-Rahmân**dır. **Yani yüz çevrilen şey bir tehdit değil, bir rahmet olarak takdim ediliyor.** Aynı teknik `036-yasin.md` 36/11 ve `043-zuhruf.md` 43/36'da da kaydedildi.

### فَقَدْ كَذَّبُوا۟ — geçmişten geleceğe

**İki fiil arasındaki zaman geçişi kaydedilmeye değer:**

| Fiil | Kip | Zaman |
|---|---|---|
| *Kezzebû* | Mâzî | **Oldu** |
| *Se-ye'tîhim* | Muzâri + *sîn* | **Olacak** |

**سَ** (*sîn*) Arapçada yakın geleceği bildirir. Uzak gelecek için *sevfe* kullanılır. **Yani "bir gün" değil, "yakında".**

**أَنۢبَآء** — *nebe*'in çoğulu; kök **ن-ب-أ**: **büyük ve önemli haber.** Kök `078-nebe.md`'de çözümlendi. Sıradan habere *haber*, ağırlıklı habere *nebe* denir.

**Ve dizim nüktesi şudur: gelecek olan şey azap değil, *haber*dir.** *Enbâü mâ kânû bihî yestehziûn* — "alay ettikleri şeyin haberleri". **Yani alay edilen şey gerçekleştiğinde, artık haber olarak değil, olay olarak gelir.** Bu ifade Kur'an'da tekrarlanır: *ve hâka bihim mâ kânû bihî yestehziûn* (En'âm 6/10; Hûd 11/8).
...
**Kök `078-nebe.md` 78/8'de (*ve halaknâküm ezvâcâ*) ve `043-zuhruf.md` 43/12'de (*halaka'l-ezvâce küllehâ*) çözümlendi.**
...
**Bitkiler için kullanılması kaydedilmeye değer:** ayet bitkileri *zevc* diye anıyor. Kur'an bunu birkaç yerde tekrarlar (*min külli's-semerâti ceale fîhâ zevceyni'sneyn* — Ra'd 13/3; *ve enbetnâ fîhâ min külli zevcin behîc* — Kāf 50/7, `050-kaf.md`'de işlendi).
...
**İki isim de dizinde çözümlendi ve tekrarlanmıyor:** *azîz* için `035-fatir.md` ve `059-hasr.md`; *rahîm* için `055-rahman.md` ve `001-fatiha.md`.

Özetle: **ع-ز-ز** kökünün çekirdeği **sertlik, aşınmazlık**tır — *arzun azâz*, sert toprak. *Azîz*, kendisine erişilemeyen, yenilmeyen, kırılmayandır. **ر-ح-م** kökünün çekirdeği ise **rahim**dir — koruyup büyüten yakınlık.
...
## Mûsâ kıssası — 26/10-68 (giriş)

**Sûrenin en uzun bölümü: elli dokuz ayet.** Yedi kıssanın toplam uzunluğunun yaklaşık üçte biri.
...
**Kur'an'da Mûsâ kıssası birçok sûrede anlatılır ve her sûre başka bir parçayı öne çıkarır.** Bu tefsirde `028-kasas.md` bölümü kıssanın **doğumdan Medyen'e ve vadideki çağrıya** kadar olan kısmını işledi; `079-naziat.md` 79/15-26 ise **en kısa anlatımı** (on iki ayet) işledi. **Şuarâ'nın payına düşen kısım, çağrının sonrasıdır: Fir'avn'ın huzuru, sihirbazlar ve deniz.**

| Sûre | Neyi öne çıkarıyor | Nerede işlendi |
|---|---|---|
| **Kasas 28** | Doğum, anne, Medyen, çağrı | `028-kasas.md` |
| **Şuarâ 26** | **Fir'avn'la yüzleşme, sihirbazlar, deniz** | burası |
| **Nâziât 79** | En kısa özet — *ezheb ilâ fir'avne innehû tağâ* | `079-naziat.md` |
| **Sâffât 37** | Yalnız kurtuluş ve zafer — dört ayet | `037-saffat.md` |
| **Duhân 44** | Kavmin terk edilişi, mirasın devri | `044-duhan.md` |
...
**Aynı sahne Kasas 28/29-35'te ayrıntılı anlatılmıştı ve `028-kasas.md`'de işlendi;** Tâhâ 20/9-24'te ise en uzun biçimiyle geçer. **Şuarâ'nın atladığı şey, ötekilerin anlattığı şeydir.**
...
**أَن** burada *tefsîriyye*dir: kendinden önceki *nâdâ* (seslendi) fiilinin **içeriğini açıyor.** "Şöyle seslendi:" demek gibidir.
...
| Sıra | İfade | Ne veriyor |
|---|---|---|
| 1 | *el-kavme'z-**zâlimîn*** | **Vasıf** — ne yaptıkları |
| 2 | *kavme **Fir'avn*** | **Kimlik** — kim oldukları |
...
**`094-insirah.md`'de bu kelime çözümlendi ve orada kaydedilen tarif burada da geçerlidir.** Buraya eklenecek olan bir örtüşmedir: **Kur'an, iki elçinin de göğsünün daraldığını kaydeder; birine "genişlettik" der, öteki "genişlet" diye ister.**
...
**ط-ل-ق** kökü: **bağın çözülmesi, serbest kalmak.** *Talâk* (nikâh bağının çözülmesi) aynı köktendir — `065-talak.md`'de işlendi. *İntilâk* (VII. bâb) — **kendiliğinden çözülüp gitmek, serbest kalmak.**
...
**Ve Kasas 28/34'te Mûsâ'nın kendi ifadesi bunu doğrular:** *ve ahî Hârûnu hüve efsahu minnî lisânâ* — "kardeşim Hârûn'un dili benimkinden daha düzgündür". **Orası `028-kasas.md`'de işlendi ve oraya dayanıyorum.**
...
**Kasas 28/34'teki talep ise farklıdır:** *fe-ersilhü meıye rid'en yusaddikunî* — "onu benimle **destek** olarak gönder, beni doğrulasın". **`028-kasas.md`'de kaydedildiği gibi orada talep doğrulanmaktır.** İki sûrede aynı olayın iki ayrı yüzü veriliyor: Şuarâ'da **elçilik**, Kasas'ta **destek**. Bunu bir gözlem olarak kaydediyorum; bir çelişki değil, iki ayrı vurgudur.
...
**Olay `028-kasas.md` 28/14-21'de ayrıntılı işlendi ve oraya dayanıyorum.** Oradaki kayıtlar özetle şunlardı: fiil kasıtlı bir öldürme değildir (*vekeze* — yumrukla vurmak; *fe-kadâ aleyh* — işini bitirdi); Mûsâ olayı kendisi değerlendirir (*hâzâ min ameli'ş-şeytân*, *innî zalemtü nefsî*); ve metin bunu örtmez.
...
**Ve *zenb* kelimesi:** kök **ذ-ن-ب**, somut anlamı **kuyruk**tur (*zeneb*). Dilcilerin verdiği bağ: suç, kişinin **peşinden sürüklediği** şeydir — arkasından gelir, bırakmaz. Kelime bu resimden "vebal, sonucu peşine takılan fiil" anlamına genişler.
...
**كَلَّا** Arapçada **kesin ret ve caydırma** bildirir. Kur'an'da genellikle bir iddiayı reddetmek için gelir (`075-kiyame.md`, `080-abese.md`, `102-tekasur.md`'de işlendi).
...
**مُّسْتَمِعُون** — kök **س-م-ع**, X. bâb ism-i fâili. *Semi'a* işitmek, *istemea* **kulak vermek, dinlemek**tir. **Fark önemlidir: işitmek edilgen, dinlemek yönelmiş bir iştir.**
...
**Fiil *rabbâ* (II. bâb): büyütmek, yetiştirmek.** Ve dilciler bu fiilin **رَبّ** (Rab) kelimesiyle aynı anlam alanından geldiğini kaydeder: **ر-ب-ب** kökünün çekirdeği **bir şeyi yetiştirip kemale erdirmek, sahip olup gözetmek**tir. Kök `001-fatiha.md`'de çözümlendi.

**Ve dizim nüktesi burada duruyor:** Mûsâ, *rabbü'l-âlemîn*in elçisi olduğunu söylemişti (16). **Fir'avn ona kendi *terbiye*sini hatırlatıyor.** İki kelime aynı köktendir.
...
**Ve bu, Kasas 28/8-9'daki sahneye gönderme yapıyor:** çocuk suyla Fir'avn'ın sarayına ulaşmış, hanımı onu almıştı. **O olay `028-kasas.md`'de işlendi.** Fir'avn olayın **sonucunu** anıyor, **sebebini** anmıyor: çocuğun neden suya bırakıldığını söylemiyor.
...
|---|---|---|
| Fiil | *fealte* | Yaptın |
| Mef'ûl-i mutlak | *fa'lete-ke* | O yapışını |
| Sıfat cümlesi | *elletî fealte* | Yaptığın |
...
**فَعْلَة** — *fa'le* vezni **tek seferlik iş** bildirir (Arapçada *masdaru'l-merre*). Yani "senin bir kerelik o işin". **Bu tefsirde aynı vezin `054-kamer.md` 54/36'da *batşe* için de kaydedilmişti** (*batşetenâ* — "bir tek yakalayış").
...
**Kelime hem "nankör" hem "inkârcı" anlamına gelir; kök ك-ف-ر'in çekirdeği örtmektir** ve dizinde çözümlendi (`109-kafirun.md`, `074-muddessir.md`).
...
**ض-ل-ل** kökü: **yolu kaybetmek, doğru istikameti bulamamak.** Kök `001-fatiha.md`'de ve `053-necm.md`'de çözümlendi. **Kelime bu bağlamda "inkârcı" değil, "ne yaptığını tam bilmeyen, isabet edememiş" anlamındadır** — nitekim Duhâ 93/7'de aynı kök bir elçi için kullanılır (*ve vecedeke dâllen fe-hedâ*) ve `093-duha.md`'de bu ayrım işlendi.
...
**Üçü de aynı yönü gösteriyor: fiilin kastî bir cinayet olarak sahiplenilmediği ama örtülmediği.** `028-kasas.md`'de kaydedildiği gibi, metin bir peygamberin hayatındaki ağır bir olayı gizlemiyor.
...
**حُكْم** — kök **ح-ك-م**: **bir şeyi sağlamlaştırmak, bozulmasını engellemek.** Kökün somut kullanımı hayvancılıktandır: *hakeme* — atın ağzına gem vurmak; *hakeme* aynı zamanda gemin adıdır. **Yani hüküm, dizginleyen şeydir.** Kök `031-lokman.md` 31/12'de (*hikmet*) çözümlendi.
...
**تَمُنُّهَا** — kök **م-ن-ن**: **kesmek, koparmak** (somut anlam); oradan **bağışta bulunmak** ve **bağışı başa kakmak.** Kök `047-muhammed.md`'de ve `049-hucurat.md` 49/17'de (*yemünnûne aleyke en eslemû*) işlendi.
...
**عَبَّدْتَّ** — kök **ع-ب-د**, II. bâb (*fa''ale*): **köleleştirmek, kul hâline getirmek.** Kökün çekirdeği **boyun eğme, itaat**tir; *abd* — kul. II. bâb geçişlilik ve **zorlama** katıyor: "onları kul yaptın".
...
**Bu cümlenin anlaşılması için gereken arka plan `028-kasas.md` 28/1-6'da işlendi ve oraya dayanıyorum.** Oradaki kayıtlar özetle şunlardı:
...
**Kök dizinde çözümlendi** (`072-cin.md`, `068-kalem.md` 68/2, `052-tur.md`) **ve tekrarlanmıyor.**
...
**İki — ithamın dizimi.** Fir'avn *"sen delisin"* demiyor. **Dinleyicilere dönüp üçüncü şahısla konuşuyor:** *inne **rasûleküm**ellezî ürsile **ileyküm*** — "**size** gönderilen **elçiniz**".
...
**Ve *e-ve lev* kalıbı kaydedilmelidir:** hemze (soru) + vâv + *lev* (şart). **Türkçesi: "…olsa da mı?"** Bu kalıp Kur'an'da bir başka yerde de aynı işi görür: *e-ve lev ci'tüküm bi-ehdâ mimmâ vecedtüm aleyhi âbâeküm* (Zuhruf 43/24 — `043-zuhruf.md`'de işlendi). **İki ayette de kalıp, kapalı bir tutumun karşısına konuyor.**
...
**Ve `028-kasas.md` 28/29-35'te bu sahne işlendi;** orada kaydedilen şey Mûsâ'nın tepkisiydi: *vellâ müdbiran ve lem yuakkib* — arkasına bakmadan kaçtı. **Şuarâ o tepkiyi anlatmıyor.** Sûre, sahneyi Fir'avn'ın huzurunda kurduğu için, Mûsâ'nın ilk karşılaşmasındaki korkusuna yer vermiyor.

### وَنَزَعَ يَدَهُۥ — ikinci ayet

**ن-ز-ع** kökü: **çekip çıkarmak, sökmek.** Kök `079-naziat.md` 79/1'de çözümlendi ve tekrarlanmıyor.
...
**Aynı teknik Kur'an'da tekrarlanır:** *hâzâ sihrun mübîn* (Ahkāf 46/7 — `046-ahkaf.md`'de işlendi), *hâzâ sihrun ve innâ bihî kâfirûn* (Zuhruf 43/30). **Ve sûrenin sonunda aynı teknik Muhammed'e uygulanacak: "şair", "mecnûn".**
...
**حَٰشِرِين** — kök **ح-ش-ر**: **dağınık olanı bir yere toplamak.** Kök `081-tekvir.md` 81/5'te ve `050-kaf.md`'de çözümlendi. **Kelime kıyamet bağlamında da kullanılır (*haşr*) ve buradaki kullanımı somuttur: şehir şehir dolaşıp adam toplayan görevliler.**
...
| Ayet | Kelime | Vezin | Kim için |
|---|---|---|---|
| **34** | *sâhir* | İsm-i fâil | **Mûsâ** |
| **37** | *sehhâr* | *Fa''âl* — mübalağa | **Getirilecek sihirbazlar** |
...
### فَجُمِعَ — edilgen çatı

**Beş ayetin ilk üçünde fiiller edilgendir: *cümia* (toplandı), *kīle* (denildi).** Fâil söylenmiyor.
...
**Ve bir gözlem: metin bir devletin seferber edilişini iki fiille anlatıyor.**

### لِمِيقَٰتِ يَوْمٍ مَّعْلُوم — vaktin tayini
...
### هَلْ أَنتُم مُّجْتَمِعُونَ — halkın çağrılması
...
### لَعَلَّنَا نَتَّبِعُ ٱلسَّحَرَةَ — halkın ağzına konan cümle

**Dizim nüktesi kaydedilmeye değer ve tartışılmıştır: bu cümleyi kim söylüyor?**
...
**İki okuma da metinden desteklenebilir. Tercih dayatmıyorum.**
...
### أَئِنَّ لَنَا لَأَجْرًا — ücret sorusu

**Ve sûrenin en güçlü karşıtlıklarından biri buradadır.**

**Sihirbazların Fir'avn'a sorduğu ilk soru ücrettir:** *e-inne lenâ le-ecrâ.*
...
### ٱلْمُقَرَّبِين — yakınlık vaadi

**ق-ر-ب** kökü: **yakın olmak.** *Mukarreb* — II. bâbın ism-i mef'ûlü: **yakınlaştırılmış, yakına alınmış.**

**Kelime Kur'an'da iki ayrı alanda kullanılır ve fark kaydedilmelidir:**
...
**`056-vakia.md`'de ve `083-mutaffifin.md`'de bu kelime çözümlendi ve tekrarlamıyorum.**
...
**Ve son satır kaydedilmelidir: altıncı geçişte çatı değişiyor.**
...
### بِعِزَّةِ فِرْعَوْنَ — yemin

**Sihirbazlar yemin ediyor ve yemin ettikleri şey kaydedilmelidir: *ızzetü Fir'avn* — Fir'avn'ın izzeti.**

**ع-ز-ز** kökü, sûrenin mühründeki *el-Azîz* isminin köküdür (9, 68, 104, 122, 140, 159, 175, 191) ve `035-fatir.md`'de çözümlendi. **Çekirdeği: sertlik, aşınmazlık, yenilmezlik.**

**Yani sûre, aynı kelimeyi sekiz kez Allah için, bir kez de Fir'avn için kullanıyor.** Bu, metinden doğrulanabilir bir veridir.

**Ve bu, `085-buruc.md`'de kaydedilen tekniğin bir başka örneğidir:** Kur'an, karşı tarafın kendine yakıştırdığı sıfatı alıp asıl sahibine iade eder. **Sihirbazlar Fir'avn'ın *ızze*sine yemin ediyor; sûre her kıssanın sonunda "asıl *azîz* Rabbindir" diye mühür vuruyor.** Bu bağı bir Kur'an içi okuma olarak kaydediyorum.
...
**Ve dört ayet sonra aynı ağızlar *âmennâ bi-rabbi'l-âlemîn* diyecek.**

### مَا يَأْفِكُونَ — kelimenin seçimi

**أ-ف-ك** kökü: **bir şeyi yönünden çevirmek, ters yüz etmek.** *İfk* — çevrilmiş söz, iftira. Kök `045-casiye.md` 45/7'de ve `046-ahkaf.md` 46/11, 46/28'de işlendi.

**Ve bu kelime sûrede iki kez geçecek:**

| Ayet | Kelime | Kim için |
|---|---|---|
| **45** | *mâ **ye'fikûn*** | **Sihirbazlar** — uydurdukları |
| **222** | ***effâkin*** esîm | **Şeytanların indiği kişi** |

**Bunu kendi okumam olarak kaydediyorum ve dayanağı aynı köktür:** sûre, sihirbazın işini ve *effâk*ın işini aynı kökle adlandırıyor — **ikisi de bir şeyi asıl yönünden çeviriyor.** Ve sûrenin sonunda, Kur'an'ın kaynağının bu alandan gelmediği söylenecektir (210-212). **Yani sûre, kendi savunmasını burada, bir asâ ile ipler arasında kuruyor.**

**Ve dizim nüktesi:** ayet *"iplerini yuttu"* demiyor. *Telkafü **mâ ye'fikûn*** — "**uydurduklarını** yutuyor". **Yutulan şey nesne değil, fiil.**

### ءَامَنَّا بِرَبِّ ٱلْعَٰلَمِينَ · رَبِّ مُوسَىٰ وَهَٰرُونَ — iki ayet, bir tashih

**Kırk yedinci ayet iman ilanıdır; kırk sekizinci ayet ona bir açıklama ekliyor: *rabbi Mûsâ ve Hârûn*.**

**Bunun neden eklendiği tartışılmıştır ve metin içinden bir izah vardır. Kendi okumam olarak kaydediyorum:** *rabbü'l-âlemîn* ifadesi, Fir'avn tarafından **kendine mal edilebilecek** bir ifadedir — nitekim Fir'avn kendisi için *ilâhen ğayrî* (29) demişti ve Kur'an başka bir sûrede onun *ene rabbükümü'l-a'lâ* (Nâziât 79/24 — `079-naziat.md`'de işlendi) dediğini kaydeder. **Kırk sekizinci ayetteki ek, ihtimali kapatıyor:** hangi Rab olduğu, adla belirtiliyor.

**Bu izah, metnin kendi içindeki bir gerilime dayanıyor ve zorunlu değildir.**

### ءَامَنتُمْ لَهُۥ قَبْلَ أَنْ ءَاذَنَ لَكُمْ — iznin yeri

**Fir'avn'ın tepkisinde iki cümle var ve ikisi de sûrenin bütününü ilgilendiriyor.**

**Bir — *kable en âzene leküm* ("ben size izin vermeden").** İman, izne bağlı bir iş olarak konuşuluyor.
...
**Kök `084-insikak.md`'de çözümlendi ve tekrarlamıyorum.** Oradaki tarif: **ق-ل-ب** — bir şeyi ters çevirmek, altını üstüne getirmek; aynı kökten **قَلْب** (kalb) — hâlden hâle en çok dönen şey. **إِنقَلَبَ** (*infi'âl* bâbı) — döndü, geri döndü.
...
**Üç — Kur'an'daki akrabası.** *Ve innâ ilâ rabbinâ le-münkalibûn* (Zuhruf 43/14) — **binek üzerinde söylenen dua.** Orası `043-zuhruf.md` 43/13-14'te işlendi. **Aynı cümle, iki sûrede iki ayrı sahnede:** biri yolculuğa çıkarken, öteki idam tehdidi altında. **Bu, metinden doğrulanabilir bir örtüşmedir ve kelimenin ne bildirdiğini gösteriyor: her hareketin bir varış noktası vardır.**
...
| Ayet | Kelime | Kök | Kime nispet |
|---|---|---|---|
| **22** | *abbedte* | ع-ب-د | **Fir'avn'a** — zorla |
| **52** | *ıbâdî* | ع-ب-د | **Allah'a** |
...
**Yani çıkış emri, tehlikeyi gizlemiyor.** Bu, `028-kasas.md` 28/7-13'te anneye verilen bildirimde kaydedilen kalıba benziyor: **emir çıplak bırakılmıyor, ne olacağı söyleniyor.**
...
**غَآئِظُون** — kök **غ-ي-ظ**: **içten içe kaynayan öfke.** Dilciler *ğayz*ı, dışa vurulmayan, göğüste biriken öfke olarak tarif eder; *ğadab*tan bu yönüyle ayrılır.
...
**Ve `044-duhan.md` 44/25-28'de aynı olay aynı kelimelerle anlatılır** (*kem terakû min cennâtin ve uyûn*) **ve orada işlendi.** Buradaki fark fiildir: Duhân "**bıraktılar**" der, Şuarâ "**çıkardık**" der. **Biri terk edilişi, öteki çıkarılışı anlatıyor.**
...
**Ve bu, `028-kasas.md` 28/1-6'da işlenen vaadin gerçekleşmesidir.** Orada kaydedilen cümle şuydu: *ve nec'alehümü'l-**vârisîn*** (Kasas 28/5) — "onları **vârisler** kılalım". **Aynı kök, aynı topluluk, aynı vaat.**
...
**Bu, metinden doğrulanabilir bir örtüşmedir ve `028-kasas.md`'de kaydedilen "konumun tersine çevrilmesi" vaadinin karşılığıdır.**
...
### كَلَّآ إِنَّ مَعِىَ رَبِّى سَيَهْدِينِ — sûrenin ikinci *kellâ*'sı
...
**ف-ل-ق** kökü: **bir şeyi ikiye ayırmak, yarmak.** Aynı kökten *felak* (tan yerinin yarılması — `113-felak.md`'de çözümlendi) ve *fâlıku'l-habbi ve'n-nevâ* (En'âm 6/95 — tohumu yaran).
...
| Ayet | Fiil | Anlamı |
|---|---|---|
| **64** | *Ezlefnâ … el-âharîn* | **Yaklaştırdık** |
| **66** | *Ağraknâ'l-âharîn* | **Boğduk** |
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı sıradır.** Ve aynı sıra `037-saffat.md`'de kaydedilen Nûh bölümünde de vardır: önce kurtuluş, sonra karşı tarafın âkıbeti.
...
## İbrâhim kıssası — 26/69-104 (giriş)
...
**ت-ل-و** kökü `037-saffat.md` 37/3'te çözümlendi ve tekrarlamıyorum. **Oradaki temel kayıt: kökün asıl anlamı "okumak" değil, "arkasından gitmek"tir;** okuma anlamı, harfleri birbirinin ardından dizmekten doğar.

**نَبَأ** — kök **ن-ب-أ**: **büyük ve önemli haber.** Kök `078-nebe.md`'de çözümlendi. **Sıradan habere *haber*, ağırlıklı habere *nebe* denir.** Ve kelime sûrenin altıncı ayetinde de geçmişti (*enbâü mâ kânû bihî yestehziûn*).

### مَا تَعْبُدُونَ — sorunun edatı, ikinci kez

**Ve sûrenin ikinci büyük sorusu, birincisiyle aynı edatla soruluyor.**

| Ayet | Kim soruyor | Kime | Soru |
|---|---|---|---|
| **23** | **Fir'avn** | Mûsâ'ya | *Ve **mâ** rabbü'l-âlemîn* |
| **70** | **İbrâhim** | Kavmine | ***Mâ** ta'büdûn* |
...
### أَصْنَامًا فَنَظَلُّ لَهَا عَٰكِفِين — cevabın kendisi

**Ve cevap kaydedilmeye değer, çünkü savunma içermiyor.**

**أَصْنَام** — *sanem*in çoğulu: **yontulmuş, biçim verilmiş put.** Dilciler *sanem* ile *vesen* arasında bir ayrım nakleder: *sanem* biçimlendirilmiş (insan ya da hayvan sûretinde), *vesen* biçimsiz taş. **Bu ayrım her kaynakta aynı değildir; kesin bir tercih yapmıyorum.**

**Ve kelimenin nekre (belirsiz) gelmesi kaydedilmelidir: *asnâmen*.** Ad verilmiyor, sayı verilmiyor. **Yani cevap, tapılanı tanıtmıyor.**

**نَظَلُّ لَهَا عَٰكِفِين** — kelimesi kelimesine: "onlara **kapanıp kalıyoruz**".
...
**Bu delil dizinde iki yerde işlendi ve oralara dayanıyorum:**

**`035-fatir.md` 35/13-14:** *in ted'ûhüm lâ yesmeû duâeküm ve lev semiû me'stecâbû leküm* — "onları çağırsanız çağrınızı işitmezler; işitseler bile size cevap veremezler". **Orada kaydedilen yapı iki kademeliydi: işitmezler; işitseler de cevap veremezler.**

**`046-ahkaf.md` 46/5-6:** *ve men edallü mimmen yed'û min dûni'llâhi men lâ yestecîbü lehû ilâ yevmi'l-kıyâmeti ve hüm an duâihim ğâfilûn* — "kıyamete kadar cevap veremeyecek olanları çağırandan daha sapkın kim var? Onlar bunların çağrısından habersizdir."

**Şuarâ'nın farkı kaydedilmelidir: burada delil bir hüküm olarak değil, bir soru olarak veriliyor.**
...
**Yani Şuarâ'da delil, cevabı karşı tarafa bıraktırıyor.** İbrâhim hüküm vermiyor; **soruyor.**
...
### Üç fiil — işitmek, fayda, zarar

**Soru üç fiil içeriyor ve sırası kaydedilmeye değer:**
...
**Nakledilen izah: fâsıla (ayet sonu) uyumu için hazfedilmiştir; nesne cümleden anlaşılır.** Bu, Arapçada olağan bir hazif türüdür ve `055-rahman.md`'de benzer örnekler kaydedildi.
...
### بَلْ وَجَدْنَآ ءَابَآءَنَا كَذَٰلِكَ يَفْعَلُونَ — atalar delili

**Ve cevap, soruya cevap değil.**
...
**Atalar delili dizinde iki yerde ayrıntılı işlendi ve oralara dayanıyorum:**

**`043-zuhruf.md` 43/22-23:** *bel kālû innâ vecednâ âbâenâ alâ ümmetin ve innâ alâ âsârihim mühtedûn* (22) ve *ve kezâlike mâ erselnâ min kablike fî karyetin min nezîrin illâ kāle mütrafûhâ innâ vecednâ âbâenâ alâ ümmetin ve innâ alâ âsârihim muktedûn* (23). **Orada kaydedilen şey şuydu: aynı cümle iki ayette tekrarlanıyor ve ikincisinde bunun her devirde tekrarlanan bir cevap olduğu söyleniyor.**

**`031-lokman.md` 31/20-21:** *ve izâ kīle lehümü'ttebiû mâ enzelallâhu kālû bel nettebiu mâ vecednâ aleyhi âbâenâ.* **Orada da aynı *bel* edatı vardır.**

**Şuarâ'nın kendine özgü tarafı kaydedilmelidir:**
...
**Kalıp Kur'an'da sık geçer ve bu tefsirde `053-necm.md` ve `056-vakia.md`'de işlendi.** *E-raeyte* — kelimesi kelimesine "gördün mü?", ama işlevi **"söyle bakalım, ne dersin?"**tir. **Gözle görmeyi değil, düşünmeyi istiyor.**
...
**Ve `043-zuhruf.md` 43/23'te kaydedilen şey bu okumayı destekliyor:** orada aynı cevabın **her devirde** verildiği söyleniyordu. **Yani atalar delili, kendi kendini üreten bir zincirdir; her nesil bir öncekini gerekçe gösterir ve zincirin başı hiç sorulmaz.**
...
| Kuruluş | Anlamı |
|---|---|
| *Ene adüvvün lehüm* | **Ben** düşmanım — özne ben |
| ***İnnehüm adüvvün lî*** | **Onlar** düşman — özne onlar |
...
| **Mahşerde düşman olacaklardır** | Kur'an bunu açıkça söyler: *ve kânû bi-ıbâdetihim kâfirîn* (Ahkāf 46/6, `046-ahkaf.md`'de işlendi) |
...
### Dizinin yapısı — sayılabilir veriler
...
**Dört olgu doğrudan tablodan okunuyor:**

**Bir — birinci cümlede *vâv* yoktur.** Dizi *ellezî halakanî* diye başlıyor; sonraki dördü *ve'llezî* ile bağlanıyor. **Yani birinci cümle dizinin bir üyesi değil, dizinin başıdır.** Yetmiş yedinci ayetteki *rabbe'l-âlemîn*in doğrudan sıfatı olarak duruyor.
...
**Üç — ayırma zamiri (*hüve*) ilk üç cümlede var, son ikisinde yok.**
...
**Cümleler bir hayatın sırasına göre dizilmiş ve bu, metinden doğrulanabilir:**
...
### Birinci cümle — ٱلَّذِى خَلَقَنِى فَهُوَ يَهْدِينِ
...
**Ve `043-zuhruf.md` 43/26-27'de İbrâhim'in ağzından benzer bir cümle geçer:** *illâ'llezî fetaranî fe-innehû **se-yehdîn*** — "beni yaratan başka; O bana yol gösterecek". **İki ayet arasındaki fark bir harftir:**
...
### İkinci cümle — وَٱلَّذِى هُوَ يُطْعِمُنِى وَيَسْقِينِ

**İki fiil: *yut'ımu* (yedirir) ve *yeskī* (içirir).**
...
### Üçüncü cümle — وَإِذَا مَرِضْتُ فَهُوَ يَشْفِينِ

**Dizinin ortası, dizinin tek kırılması ve bu tefsirin bu bölümdeki asıl konusu.**

**Cümle üç bakımdan öteki dörtten ayrılıyor:**
...
**Dört cümlede fiiller şöyle kuruluyor:**
...
- ***maridtü*** — **ben** hastalandım
- *yeşfî-**n*** — **O** bana şifa verir

**Yani dizinin bütününde Allah fâil, İbrâhim mef'ûldür. Yalnız bir fiilde İbrâhim fâil olur — ve o fiil hastalıktır.**

**Bu farkı kendi okumam olarak işliyorum. Dayanaklarını sırayla veriyorum.**
...
**Ve bu okumanın sınırlarını açıkça belirtiyorum:**
...
**ش-ف-ي** kökü: dilcilerin verdiği çekirdek **bir şeyin kenarına, uç noktasına gelmek**tir (*şefâ* — kenar; *şefe* — dudak). **Şifâ**, hastalığın **kenarına** gelmek, ondan çıkmaktır. **Yani şifa, hastalığın yok olması değil, sınırına varılmasıdır.**
...
### Dördüncü cümle — وَٱلَّذِى يُمِيتُنِى ثُمَّ يُحْيِينِ

**İki fiil, arada *sümme*.**
...
### Beşinci cümle — وَٱلَّذِىٓ أَطْمَعُ أَن يَغْفِرَ لِى خَطِيٓـَٔتِى يَوْمَ ٱلدِّينِ

**Dizinin sonu ve tonu değişiyor: kesinlikten umuda geçiliyor.**
...
**Nakledilen izah: tekil, cinsi bildirir — "her ne hatam varsa".** Kesin bir tercih yapmıyorum.

**يَوْمَ ٱلدِّين** — "din günü", yani **hesap günü**. **د-ي-ن** kökü `001-fatiha.md`'de çözümlendi (*mâliki yevmi'd-dîn*) ve tekrarlamıyorum. Oradaki kayıt: kökün çekirdeğinde **borç, karşılık ve boyun eğme** vardır; *deyn* (borç) ve *dîn* (din) aynı köktendir.

### Dizinin bütünü — bir gözlem
...
**Yani karşılaştırma baştan sona aynı ölçü üzerinden yürüyor: ne yapıyor?**
...
**Beş cümlelik tanıtım dizisinden sonra altı dilek geliyor ve bunlar da bir sıra izliyor:**
...
### هَبْ لِى حُكْمًا — Mûsâ ile bağ

**Aynı kelime, aynı sûrede, iki peygamber:**
...
**Aynı fiil (و-ه-ب), aynı nesne (*hukm*), iki ayrı kip.** Bu, metinden doğrulanabilir bir örtüşmedir.

**Kelimenin kök tahlili 26/20-22 bölümünde verildi (ح-ك-م — sağlamlaştırmak, gem vurmak); tekrarlamıyorum.**

### لِسَانَ صِدْقٍ فِى ٱلْءَاخِرِين — "doğruluk dili"

**Terkip Arapçada bir deyimdir ve kelimesi kelimesine çevrilemez.**
...
**Yani dilek şudur: "arkamdan doğru bir söz kalsın."** Ünlü olmak değil, **doğrulukla anılmak.**

**Ve `037-saffat.md`'de kaydedilen kalıpla bağ kurulabilir:** orada peygamber dizisinin mührü *ve tereknâ aleyhi fi'l-âhirîn* ("arkadan gelenler arasında ona [bir hatıra] bıraktık") idi ve **İbrâhim o mührü almıştı** (Sâffât 37/108).
...
### وَٱغْفِرْ لِأَبِىٓ — en tartışmalı dilek

**Ve bu dilek, Kur'an'ın kendi içinde ayrıca ele aldığı bir konudur.**
...
**Ve Mümtehine 60/4'te aynı olay bir istisna olarak anılır** (*illâ kavle İbrâhîme li-ebîhi le-estağfiranne lek*) **ve `060-mumtehine.md`'de işlendi.** Oradaki kayda dayanıyorum.
...
### وَلَا تُخْزِنِى — utandırılmamak

**خ-ز-ي** kökü: **rezil olmak, aşağılanmak, yüzü yere düşmek.** *Hizy* — rezillik.
...
### يَوْمَ لَا يَنفَعُ مَالٌ وَلَا بَنُون — iki dayanak

**İki şey sayılıyor ve ikisi de nekre (belirsiz): *mâlün* ve *benûn*.**

**Arapçada olumsuzluk edatından sonra gelen nekre, cinsi topluca olumsuzlar: "hiçbir mal, hiçbir oğul".**

**Ve seçilen iki şey kaydedilmelidir:** *mâl* (servet) ve *benûn* (oğullar). **Kur'an bu ikisini birçok yerde bir arada anar** — *el-mâlü ve'l-benûne zînetü'l-hayâti'd-dünyâ* (Kehf 18/46), *ennemâ emvâlüküm ve evlâdüküm fitne* (Tegābün 64/15 — `064-tegabun.md`'de işlendi).
...
### إِلَّا مَنْ أَتَى ٱللَّهَ بِقَلْبٍ سَلِيمٍ — istisnanın kendisi

**Ve sûrenin en çok anılan cümlelerinden biri.**

**Dizim nüktesi kaydedilmelidir: istisna, neyden yapılıyor?**
...
**Ve `037-saffat.md` 37/84'te aynı terkip aynı kişi için geçer:** *iz **câe** rabbehû **bi-kalbin selîm***. **Orada işlendi ve oradaki kayıt burada da geçerlidir:**
...
**Aynı terkip, aynı yapı, iki ayrı fiil (*câe* ve *etâ*) ve ters yönler:** Sâffât'ta İbrâhim'in kendisi tarif ediliyor, Şuarâ'da İbrâhim bir ölçü koyuyor. **`037-saffat.md`'de bu örtüşme zaten kaydedilmişti ve oraya dayanıyorum.**

**سَلِيم** — kök **س-ل-م**: **sağlam olmak, kusursuz olmak, esenlikte olmak.** Kök `050-kaf.md`'de, `072-cin.md`'de ve `002-bakara.md`'de çözümlendi. Aynı kökten *selâm* (esenlik), *silm* (barış), *islâm* (teslim olmak).

***Fa'îl* vezni Arapçada hem etken hem edilgen anlam taşıyabilir** ve `037-saffat.md`'de bu kelime için nakledilen anlamlar tablo hâlinde verilmişti. **Tekrarlamıyorum;** özeti şudur: **kusursuz, hastalıksız, sağlam** (asıl anlam) ya da **teslim olmuş** (ikinci anlam).

**Buraya eklenecek olan bir siyak gözlemidir ve kendi okumam olarak kaydediyorum:** *selîm* kelimesinin asıl anlamı **hastalıksızlık**tır. **Ve dokuz ayet önce hastalık geçmişti:** *ve izâ **maridtü** fe-hüve yeşfîn* (80). **Yani sûre, bedenin hastalığını ve şifasını anlattıktan sonra, kalbin sağlamlığını ölçü olarak koyuyor.** Bu bağın kastedildiği metinde söylenmiyor; iki kelimenin aynı anlam alanından geldiği ve dokuz ayet arayla durduğu ise metin verisidir.
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı iki fiilin farkıdır:** ayetler, iki tarafın karşılaştığı şeyi **algı diliyle** anlatıyor. Sakınan için değişen şey **mesafe**, azgın için değişen şey **görüş**tür.

### ٱلْغَاوِين — kök غ-و-ي

**Kök `053-necm.md`'de çözümlendi ve tekrarlamıyorum.** Oradaki tarif: **غ-و-ي** — doğru istikameti kaybetmek, azmak; *ğayy* — azgınlık. **Ve orada kaydedilen bir şey vardı:** kelimenin çoğulu ***ğâvûn***, Kur'an'da **şairlerin ardından gidenler** için kullanılır (Şuarâ 26/224).
...
**Ve `053-necm.md`'de kaydedilen bir karşılaştırma buraya bağlanıyor:** aynı sûrede *mâ dalle sâhıbüküm ve mâ **ğavâ*** (53/2) — "arkadaşınız ne saptı ne azdı" denir. **Yani Necm elçiyi *ğayy*den tenzih ediyor, Şuarâ ise *ğâvûn*u tarif ediyor.** İki sûre aynı kökün iki yakasında duruyor.
...
**Aynı fiil (*ta'büdûn*), iki ayrı soru edatı: *mâ* ve *eyne*.** Biri cinsi, öteki yeri soruyor.
...
**Aynı iki kademeli yapı `035-fatir.md` 35/14'te de vardı** (*lâ yesmeû … ve lev semiû me'stecâbû*) **ve orada işlendi.** İki ayette de delil, ikinci kademede tamamlanıyor.
...
**جُنُود** — *cünd*ün çoğulu: **ordu, toplanmış birlik.** Kelime `048-fetih.md` ve `085-buruc.md`'de geçti.
...
### يَخْتَصِمُون — çekişme

**خ-ص-م** kökü: **çekişmek, davalaşmak.** VIII. bâb (*ihtisâm*) karşılıklılık bildirir: **birbirleriyle çekişmek.**

**Ve `037-saffat.md` 37/27'de aynı sahne kaydedilmişti:** *fe-akbele ba'duhüm alâ ba'dın yetesâelûn* — "birbirlerine dönüp sorarlar". **Orada işlendi ve orada kaydedilen şey şuydu: aynı cümle cehennemde ve cennette iki ayrı biçimde geçiyor.**

**Şuarâ'nın farkı: fiil *tesâül* (soruşma) değil, *ihtisâm* (çekişme).** Bu, metinden doğrulanabilir bir farktır.

### تَٱللَّهِ — nadir bir yemin harfi
...
### إِن كُنَّا لَفِى ضَلَٰلٍ مُّبِين — muhaffefe *in*

**Gramer notu:** buradaki *in*, olumsuzluk edatı değil; ***in*'in muhaffefesi**dir (aslı *inne*). Bunun işareti, haberin başındaki **lâm**dır (*le-fî*). **Yani anlam "değildik" değil, "idik"tir.**

**Bu, Arapçada karışması kolay bir yapıdır ve `102-tekasur.md`'de benzeri kaydedilmişti.**

### إِذْ نُسَوِّيكُم بِرَبِّ ٱلْعَٰلَمِين — itirafın kelimesi

**س-و-ي** kökü: **denk olmak, eşitlemek, düzgün hâle getirmek.** II. bâb (*sevvâ*) geçişlidir: **denk tutmak.**

**Ve dizim nüktesi kaydedilmelidir: itiraf "size taptık" değil, "sizi denk tuttuk".**
...
### وَمَآ أَضَلَّنَآ إِلَّا ٱلْمُجْرِمُون — suçun devri

**Ve itiraftan hemen sonra sorumluluk devri geliyor.**
...
**İki ayet arasında bir ayet yok; itiraf ile devir bitişik.**

**Bunu bir gözlem olarak kaydediyorum:** aynı ağız, iki cümlede iki ayrı şey söylüyor. **Ve Kur'an bu sahneyi başka sûrelerde de kaydeder** — Sebe 34/31-33, Sâffât 37/27-33 (`037-saffat.md`'de işlendi), Ahzâb 33/67. **Hepsinde ortak olan şey, suçun karşı tarafa aktarılmasıdır.**

**ٱلْمُجْرِمُون** — kök **ج-ر-م**: dilcilerin verdiği somut anlam **meyveyi dalından koparmak**tır (*ceramü'n-nahl* — hurma devşirmek). **Oradan "kazanmak" ve "kötü bir şey kazanmak, suç işlemek" anlamına geçer.** *Mücrim* — suç kazanan.
...
### فَمَا لَنَا مِن شَٰفِعِينَ وَلَا صَدِيقٍ حَمِيمٍ — iki yokluk

**İki şey aranıyor ve ikisi de yok:**
...
**ش-ف-ع** kökü: **çift yapmak, tek olanı ikilemek.** *Şef'* — çift (Fecr 89/3'teki *eş-şef'i ve'l-vetr* — `089-fecr.md`'de işlendi). **Şefaat, kişiyi yalnız bırakmayıp yanına bir başkasının katılmasıdır.** Yani kelime, "aracılık"tan önce **"yalnız olmamak"** demektir.
...
**İki anlam aynı kelimede ve dilcilerin kurduğu bağ şudur: dostluk da bir "hararet"tir** — ilgi ve yakınlığın sıcaklığı. **Kelime `069-hakka.md`'de ve `070-mearic.md` 70/10'da (*ve lâ yes'elü hamîmun hamîmâ*) işlendi.**

**Ve `078-nebe.md`'de bu ayet zaten anılmıştı;** oradaki kayda dayanıyorum.
...
### فَلَوْ أَنَّ لَنَا كَرَّةً — geri dönüş dileği

**ك-ر-ر** kökü: **dönmek, tekrar etmek, hücumda geri dönüp yeniden saldırmak.** *Kerre* — bir dönüş, bir tekrar.

**لَوْ** burada **temennî** (gerçekleşmesi mümkün olmayan dilek) bildiriyor. **Cümlenin cevabı söylenmemiş — Arapçada buna *cevâbü lev*in hazfi denir ve dileğin karşılıksızlığını bildirir.**

**Ve aynı dilek Kur'an'da birçok yerde tekrarlanır:** *ve lev terâ iz vukıfû ale'n-nâri fe-kālû yâ leytenâ nüraddü* (En'âm 6/27), *rabbenâ ahricnâ na'mel sâlihan ğayre'llezî künnâ na'mel* (Fâtır 35/37 — `035-fatir.md`'de işlendi). **Hepsinde ortak olan şey, dileğin cevapsız kalmasıdır.**
...
## Beş kıssanın ortak çerçevesi — 26/105-191 (giriş)
...
**Ortak kalıbın kelime tahlilleri bir kez burada yapılıyor ve sonraki dört kıssada tekrarlanmayacak.**

### كَذَّبَتْ … ٱلْمُرْسَلِينَ — çoğulun nüktesi
...
### إِنِّى لَكُمْ رَسُولٌ أَمِينٌ — güvenilirlik iddiası
...
**Yani elçi, kendini muhataba nispetle tanıtıyor:** "ben **size** gönderilmiş güvenilir bir elçiyim."
...
### فَٱتَّقُوا۟ ٱللَّهَ وَأَطِيعُونِ — iki emir

**ت-ق-ي** kökü (asıl kök **و-ق-ي**): **korumak, siper almak.** *Takvâ*, "korkmak" değil **"kendini korumaya almak"**tır. Kök `002-bakara.md`'de, `049-hucurat.md`'de ve `092-leyl.md`'de çözümlendi.

**ط-و-ع** kökü: **isteyerek uymak.** *Tav'* — gönüllülük; karşıtı *kerh* (zorlama). Kök `041-fussilet.md` 41/11'de (*eteynâ tâiîn*) işlendi.
...
**Ve *etîûn*'daki hazif:** aslı *etîûnî*dir; sondaki *yâ* fâsıla (ayet sonu) uyumu için düşmüştür. **Bu, sûrede sık tekrarlanan bir hazif türüdür** — *yükezzibûn(i)*, *yaktülûn(i)*, *yehdîn(i)*, *yeskīn(i)*, *yeşfîn(i)*, *yuhyîn(i)*. **Yani sûrenin fâsıla düzeni, fiillerin sonundaki zamirleri düşürüyor.** Bu, metinden doğrulanabilir bir olgudur ve sûrenin tek sesli yapısıyla doğrudan ilgilidir.

### وَمَآ أَسْـَٔلُكُمْ عَلَيْهِ مِنْ أَجْرٍ — ücret reddi

**Cümlenin beş geçişi ve sûre içindeki işlevi "Sûrenin omurgası" bölümünde tablolandı; tekrarlamıyorum.**

**Buraya eklenecek olan iki gramer notudur.**
...
**Nûh kıssası Kur'an'da birçok sûrede geçer ve bu tefsirde `071-nuh.md` bölümü tamamen ona ayrıldı.** Oradaki tespitleri tekrarlamıyorum.
...
| Sûre | Neyi öne çıkarıyor | Nerede işlendi |
|---|---|---|
| **Nûh 71** | Davet yöntemi, süre, dua | `071-nuh.md` |
...
### ٱلْأَرْذَلُون — kelimenin ağırlığı
...
**Bunu bir gözlem olarak kaydediyorum ve `043-zuhruf.md` 43/31'de kaydedilen itirazla aynı ailedendir:** *lev lâ nüzzile hâzâ'l-kur'ânü alâ racülin mine'l-karyeteyni azîm* — "bu Kur'an iki şehrin büyük bir adamına indirilseydi ya". **İki itiraz da mesajı taşıyanların ya da alanların konumunu ölçü yapıyor.**
...
| Ayet | Kim | İfade |
|---|---|---|
| **49** | **Fir'avn** | *Âmentüm **lehû** kable en âzene leküm* |
| **111** | **Nûh'un kavmi** | *E-nü'minü **leke*** |

**İki yerde de *âmene li-* kullanılıyor: "sana güvenmek, seni tasdik etmek".** Bu, metinden doğrulanabilir bir örtüşmedir. **Ve ikisinde de konu, inanılacak şey değil, inanılacak *kişi*dir.**

### وَمَا عِلْمِى بِمَا كَانُوا۟ يَعْمَلُونَ — cevabın sınırı

**Nûh, iman edenleri savunmuyor.** "Onlar iyi insanlardır" demiyor. **"Ne yaptıklarını bilmiyorum" diyor.**
...
### وَمَآ أَنَا۠ بِطَارِدِ ٱلْمُؤْمِنِين — kovmayı reddetmek
...
| Kim | Adlandırma | Ölçü |
|---|---|---|
| **Kavim** | *El-erzelûn* | **Toplumsal konum** |
| **Nûh** | *El-mü'minîn* | **İman** |

**Aynı insanlar, iki ad.** Bu, metinden doğrulanabilir bir örtüşmedir.

**Ve Kur'an bu meseleyi başka yerlerde de ele alır:** *ve lâ tatrudi'llezîne yed'ûne rabbehüm bi'l-ğadâti ve'l-aşiyy* (En'âm 6/52) — aynı kök (*tatrud*), aynı yasak. **Ve Abese sûresi bu meselenin bir başka yüzünü işler; `080-abese.md`'de işlendi.**

### إِنْ أَنَا۠ إِلَّا نَذِيرٌ مُّبِين — görevin tarifi

**Kasr (sınırlama) kalıbı: *in … illâ*.** "Ben ancak apaçık bir uyarıcıyım."
...
**ر-ج-م** kökü: **taşlamak, taş atmak.** Kelime Kur'an'da hem fiilî taşlama hem de sözle taşlama (lânetleme, kovma) için kullanılır. **`067-mulk.md` 67/5 ve `081-tekvir.md`'de kökün bir başka kullanımı (şeytanların taşlanması) işlendi.**
...
**`071-nuh.md`'de Nûh'un bu sûredeki duasından farklı bir duası işlendi** (*rabbi lâ tezer ale'l-ardı mine'l-kâfirîne deyyârâ* — Nûh 71/26). **İki dua arasındaki fark kaydedilmeye değer:**
...
**Ve aynı sıfat Kur'an'da bir kez daha geçer:** *ve âyetün lehüm ennâ hamelnâ zürriyyetehüm fi'l-fülki'l-**meşhûn*** (Yâsîn 36/41 — `036-yasin.md`'de işlendi). **Aynı terkip, iki sûrede.**
...
**Nûh kıssasıyla tek fark, muhatabın adıdır: *kavmü Nûh* yerine *Âd*, *Nûh* yerine *Hûd*.**

### عَاد ve Hûd kavminin yeri

**Âd, Kur'an'ın Arap yarımadasına ait olarak andığı iki kavimden biridir (öteki Semûd).** Kur'an onları **Ahkāf** bölgesiyle ilişkilendirir (Ahkāf 46/21 — `046-ahkaf.md`'de işlendi) ve **İrem** adını anar (Fecr 89/6-8 — `089-fecr.md`'de işlendi).

**`089-fecr.md`'de kaydedilen şey burada da geçerlidir ve tekrarlamıyorum:** Fecr sûresi Âd'ı *irame zâti'l-imâd* ("sütunlar sahibi İrem") diye anar ve *elletî lem yuhlak mislühâ fi'l-bilâd* ("beldelerde bir benzeri yaratılmamış") der.
...
**Ve `054-kamer.md` 54/18-21 ile `069-hakka.md` 69/6-8'de Âd'ın helâk biçimi (rüzgâr) işlendi.** **Şuarâ helâk biçimini söylemiyor** — yalnız *fe-ehleknâhüm* (139) diyor. Bu, metinden doğrulanabilir bir farktır.
...
**ر-ي-ع** kökü: dilcilerin verdiği anlamlar **yükselmek, artmak, çoğalmak**tır. *Rî'* için nakledilen karşılıklar:
...
**Ve bu, sûrenin en dikkat çekici kelime tekrarlarından biridir. Kendi okumam olarak kaydediyorum:** sûre, her kıssanın sonunda *"bunda bir **âyet** var"* diyor. **Âd kavmi ise kendi *âyet*lerini kendisi dikiyor** — her tepeye bir tane. **Bir taraf işaret koyuyor, öteki taraf işaret bırakılmış olanı görmüyor.** Bu bağın kastedildiği metinde söylenmiyor; kelimenin iki kullanımı ise metin verisidir.
...
**`085-buruc.md` 85/12** (*inne batşe rabbike le-şedîd*) — kökün ayrıntılı tahlili orada yapıldı. **Oradaki tarif: *batş*, bir şeyi şiddetle ve sertçe kavramak, güçle yakalamak.** Ve orada kaydedilen önemli bir şey vardı: **Kur'an bu kökü hem Allah için hem zalimler için kullanır.** Nitekim `085-buruc.md`'de bu ayet (Şuarâ 26/130) zaten anılmıştı — *"Bu cümleyi Hûd, kendi kavmine söylüyor."*

**`054-kamer.md` 54/36** (*ve lekad enzerahüm batşetenâ*) — orada ***batşe*** (*fa'le* vezni, tek seferlik) ile *batş* (masdar) farkı tablolandı. **Tekrarlamıyorum.**

**Buraya eklenecek olan, ayetin kendi dizimidir ve bu sûreye özgüdür.**

**Cümle şu yapıda: şart + cevap, ve ikisi de aynı fiil.**

*Ve izâ **betaştüm** — **betaştüm** cebbârîn*
...
**Ve şart edatı *izâ*dır, *in* değil.** Otuz birinci ayette kaydedildiği gibi, **Arapçada *in* şüpheli, *izâ* kesin ve tekrarlanan durum için kullanılır.** Yani ayet "yakalarsanız" demiyor; **"her yakaladığınızda"** diyor. Bu, davranışın istisna değil, **kural** olduğunu bildiriyor.

**جَبَّارِين** — kök **ج-ب-ر**: dilcilerin verdiği çekirdek **kırığı zorla yerine oturtmak, düzeltmek**tir (*cebîre* — kırık sargısı; matematikteki *cebir* de buradan gelir). **Ve oradan "zorla yaptırmak, boyun eğdirmek" anlamına geçer.**
...
|---|---|---|
| **Allah için** | *El-Azîzü'l-**Cebbâr**ü'l-Mütekebbir* (Haşr 59/23) | **Düzelten, iradesini yürüten** |
| **İnsan için** | **Şuarâ 26/130**; *cebbâren şakıyyâ* (Meryem 19/32) | **Zorba** |

**`059-hasr.md`'de bu ayrım işlendi ve tekrarlamıyorum.** Oradaki kayıt: aynı sıfat, kudreti sınırsız olan için "düzelten", kudreti sınırlı olan için "zorba" anlamına gelir. **Fark, sıfatın kimde bulunduğundadır.**

**Ve `050-kaf.md` 50/45'te kaydedilen ayet buraya bağlanıyor:** *ve mâ ente aleyhim bi-**cebbâr*** — "sen onların üzerinde bir zorba değilsin". **Yani Kur'an, elçiye yasakladığı sıfatı, Âd kavminin fiili olarak sayıyor.** Bu, metinden doğrulanabilir bir örtüşmedir.
...
**Aynı kalıp Kur'an'da birkaç yerde geçer:** *sevâün aleyhim e-enzertehüm em lem tünzirhüm lâ yü'minûn* (Bakara 2/6; Yâsîn 36/10 — `036-yasin.md`'de işlendi). **Fark kaydedilmelidir: orada cümleyi anlatıcı kuruyor; burada kavmin kendisi söylüyor.**
...
**Tercih dayatmıyorum.** İkinci yön, yetmiş dördüncü ayetteki atalar deliliyle aynı ailedendir — **`043-zuhruf.md` ve `031-lokman.md`'de işlendi ve oraya dayanıyorum.**
...
**Buraya eklenecek olan bir dizim notudur: ek iki fiilden ibaret ve ikisi de *fâ* ile bağlı.**
...
**Ve `037-saffat.md`'de kaydedildiği gibi, *fâ* ile *sümme* arasındaki fark tam da budur:** *sümme* araya zaman koyar, *fâ* koymaz. **Nûh kıssasında helâk *sümme* ile gelmişti** (*sümme ağraknâ*, 120) — **orada gemi yapılacak kadar zaman vardı.** Burada *fâ* var.
...
### ثَمُود ve Sâlih kavminin yeri

**Semûd, Kur'an'ın en çok andığı kavimlerden biridir ve bu tefsirde birçok yerde geçti:** `054-kamer.md` 54/23-31 (deve ve *sayha*), `089-fecr.md` 89/9 (*ellezîne câbû's-sahra bi'l-vâd* — "vadide kayaları oyanlar"), `091-sems.md` 91/11-15 (deveyi kesenler), `069-hakka.md` 69/5 (*fe-ühlikû bi't-tâğıye*), `051-zariyat.md` 51/43-45.
...
| Ayet | Kelime | Kim / ne için |
|---|---|---|
| **143** | *emîn* | **Elçi** — güvenilir |
| **146** | *âminîn* | **Kavim** — güvende |
...
**طَلْع** — hurma ağacının çıkardığı ilk tomurcuk, salkımın kılıf içindeki hâli. Kelime Kur'an'da birkaç yerde geçer (En'âm 6/99; Kāf 50/10 — `050-kaf.md`'de işlendi).
...
**Ve `089-fecr.md` 89/9'da kaydedilen ayet buraya bağlanıyor:** *ve Semûde'llezîne **câbû's-sahra** bi'l-vâd* — "vadide **kayaları oyan** Semûd". **Aynı kavim, aynı iş, iki ayrı fiil (*nehate* ve *câbe*).** Bu, metinden doğrulanabilir bir örtüşmedir.
...
**Ve `085-buruc.md` ile `089-fecr.md`'de kaydedildiği gibi, Kur'an bu iki kavmi sık sık yan yana anar.** Şuarâ da aynı sırayı koruyor: **Âd (123-140), sonra Semûd (141-159).**
...
| Ayet | İfade | Kime |
|---|---|---|
| **150** | *Ve **etîûn*** | **Elçiye** — emir |
| **151** | *Ve lâ **tutîû** emre'l-müsrifîn* | **Ölçüyü aşanlara** — yasak |
...
**س-ر-ف** kökü: **haddi aşmak, ölçüyü kaçırmak.** *İsrâf*, yalnız harcamada değil, **her alanda sınırı geçmek** demektir. **Kök `040-gafir.md`'de ve `043-zuhruf.md` 43/5'te işlendi** (*en küntüm kavmen müsrifîn*).
...
### ٱلْمُسَحَّرِين — kelimenin iki okuması

**Cümle sûrede iki kez geçiyor ve iki kavmin ağzında birebir aynıdır:**

| Ayet | Kim söylüyor | Kime |
|---|---|---|
| **153** | **Semûd** | Sâlih'e |
| **185** | **Eyke halkı** | Şuayb'e |

**Bu, metinden doğrulanabilir bir tekrardır.**

**مُسَحَّر** — kök **س-ح-ر**, II. bâbın ism-i mef'ûlü. **Ve kelime iki ayrı yönde okunmuştur:**
...
**Tercih dayatmıyorum; ama bu siyak bağını bir metin verisi olarak kaydediyorum.**
...
**Bu, sûrede tekrarlanan bir tekniktir ve tabloya alınmayı hak ediyor:**
...
### فَأْتِ بِـَٔايَةٍ — mucize talebi

**Ve bu talep, sûrenin dördüncü ayetiyle karşılaşıyor.**
...
**Üç kavim, üç kez aynı talep.** Ve 31 ile 154 neredeyse birebir aynıdır (*in künte mine's-sâdıkīn*).
...
**ن-و-ق** kökü: dişi deve. **Kur'an bu deveden birçok yerde söz eder** (A'râf 7/73; Hûd 11/64; İsrâ 17/59; Kamer 54/27; Şems 91/13) **ve `054-kamer.md` ile `091-sems.md`'de işlendi.**
...
**ش-ر-ب** kökü: içmek. *Şirb* — **su içme payı, sıra.**

**Ve düzenin kendisi kaydedilmelidir: su, gün gün paylaştırılıyor.** Deve bir gün, kavim bir gün. **Ve `054-kamer.md` 54/28'de aynı düzen daha açık ifade edilir:** *ve nebbi'hüm enne'l-mâe kısmetün beynehüm* — "suyun aralarında paylaştırıldığını onlara haber ver".
...
### وَلَا تَمَسُّوهَا بِسُوٓءٍ — yasağın dizimi

**Yasak, "onu öldürmeyin" değil:** *lâ temessûhâ bi-sûin* — "**ona kötülükle dokunmayın**".

**م-س-س** kökü: **dokunmak, değmek.** Fiil, en hafif temas için kullanılır.
...
### فَأَصْبَحُوا۟ نَٰدِمِين — pişmanlığın yeri

**Ve ayet, kıssanın en dikkat çekici cümlesini içeriyor: kavim pişman oluyor.**

**ن-د-م** kökü: **yapılan bir işten dolayı içten pişmanlık duymak.**

**Ve dizim nüktesi kaydedilmelidir: pişmanlık, azaptan *önce* geliyor.**

| Ayet | Olay |
|---|---|
| **157** | *Fe-akarûhâ* → *fe-asbahû **nâdimîn*** |
| **158** | *Fe-ehazehümü'l-azâb* |

**Yani sıra şudur: fiil → pişmanlık → azap.**
...
**Tercih dayatmıyorum.** Kaydedilecek olan şudur: **Kur'an, pişmanlığın her türünün aynı sonucu vermediğini başka yerlerde de kaydeder** — *fe-lem yekü yenfeuhüm îmânühüm lemmâ raev be'senâ* (Mü'min 40/85 — `040-gafir.md`'de işlendi).

### Mührün başındaki ek — 158
...
**Buraya eklenecek olan bir kelime notudur:** ek, *fe-**ehazehüm**ü'l-azâb* biçimindedir ve fiil, yüz elli altıncı ayette Sâlih'in kullandığı fiille aynıdır: *fe-**ye'huzeküm** azâbü yevmin azîm.*

**Yani uyarıda kullanılan fiil, gerçekleşmede aynen tekrarlanıyor.** Bu, metinden doğrulanabilir bir örtüşmedir. **Ve `085-buruc.md`'de kaydedilen ilkeyle aynı hattadır: sonuç, uyarının diliyle bildiriliyor.**
...
| Ayet | Fiil | Ne |
|---|---|---|
| **165** | *Te'tûne* — gidiyorsunuz | **Yapılan** |
| **166** | *Tezerûne* — bırakıyorsunuz | **Bırakılan** |
...
**ذُكْرَان** — *zeker*in çoğullarından: **erkekler.**
...
| Öğe | İfade | İşi |
|---|---|---|
| 1 | *Mâ **halaka*** | **Yaratılmış olan** |
| 2 | ***Leküm*** | **Sizin için** |
| 3 | ***Rabbüküm*** | **Rabbiniz tarafından** |
...
**Ve *muhrecîn* kelimesi sûrede geçen ç-ı-k-a-r-m-a fiillerinin bir halkasıdır:**
...
### مِّنَ ٱلْقَالِين — nadir bir kelime
...
**Kelime bu kalıpta Kur'an'da yalnızca burada geçer.** Kökün bir başka türevi Duhâ 93/3'te geçer: *mâ vaddeake rabbüke ve mâ **kalâ*** — "Rabbin seni ne bıraktı ne de darıldı" (`093-duha.md`'de işlendi).
...
**İki ayette de aynı kök (ع-م-ل) ve aynı ayrım.** Bu, metinden doğrulanabilir bir örtüşmedir.

### إِلَّا عَجُوزًا فِى ٱلْغَٰبِرِين — istisna

**عَجُوز** — yaşlı kadın. **Kur'an burada bir isim vermiyor;** Lût'un eşi olduğu Kur'an'ın başka yerlerinden anlaşılır (Hûd 11/81; Tahrîm 66/10 — `066-tahrim.md`'de işlendi).
...
**Ve `066-tahrim.md`'de kaydedilen ilke buraya bağlanıyor:** orada Nûh'un ve Lût'un eşleri örnek verilerek, **yakınlığın kurtarıcı olmadığı** işlenmişti. **Oradaki kayda dayanıyorum.**
...
### دَمَّرْنَا ve أَمْطَرْنَا — iki fiil

**د-م-ر** kökü: **helâk etmek, yerle bir etmek.** II. bâb (*demmera*) pekiştirir. **Ve `037-saffat.md` 37/136'da aynı fiil aynı kavim için geçer:** *sümme **demmerne**'l-âharîn* — **birebir aynı cümle.**

**Bu, metinden doğrulanabilir bir örtüşmedir ve iki sûrenin Lût bölümlerini birbirine bağlıyor.** `037-saffat.md`'de kaydedildiği gibi, orada Lût bölümü kapanış mührünü almamıştı; **Şuarâ'da alıyor.**

**م-ط-ر** kökü: yağmur. **Ve dizim nüktesi kaydedilmelidir: mef'ûl-i mutlak var.**
...
### ٱلْأَيْكَة — kelimenin anlamı

**أ-ي-ك** kökü: **sık ağaçlık, birbirine girmiş çalılık.** *Eyke* — ağaçları sık bir koru.

**Kelime Kur'an'da dört yerde geçer** (Hicr 15/78; Şuarâ 26/176; Sâd 38/13; Kāf 50/14) **ve `038-sad.md` ile `050-kaf.md`'de anıldı.**

**Ve Şuayb'in kavmi Kur'an'da iki ayrı adla anılır ve bu kaydedilmelidir:**
...
**Kur'an'ın vermediği coğrafî ayrıntıya girmiyorum.**

**Ve `038-sad.md` 38/13'te kaydedildiği gibi, orada *ashâbü'l-Eyke* helâk edilen topluluklar dizisinde anılır ve *ülâike'l-ahzâb* denir.** Oradaki kayda dayanıyorum.
...
**Ve `083-mutaffifin.md`'de bu alan ayrıntılı işlendi ve oraya dayanıyorum.** Oradaki kayıtlar özetle şunlardı:
...
**Yani Şuarâ 26/181 ile Mutaffifîn 83/3 aynı kökü kullanıyor.** Bu, metinden doğrulanabilir bir örtüşmedir. **Ve `083-mutaffifin.md`'de bu ayet (Şuarâ 26/183) zaten anılmıştı.**
...
**ٱلْمُسْتَقِيم** — kök **ق-و-م**, X. bâbın ism-i fâili: **dosdoğru, sapmasız.** Aynı kelime *sırâta'l-müstakīm* terkibinde geçer (`001-fatiha.md`'de çözümlendi).

**Ve `057-hadid.md` 57/25'te *mîzân* işlendi ve oraya dayanıyorum.** Oradaki kayıtlar özetle şunlardı:
...
**Kök `083-mutaffifin.md`'de çözümlendi ve oraya dayanıyorum.** Oradaki tarif: **ب-خ-س** — **bir şeyin değerini düşürerek almak, hakkını eksik vermek.**
...
**Ve `085-buruc.md`'de kaydedilen ilke burada da işliyor: sonuç, isteğin diliyle bildiriliyor.**

### كِسَفًا مِّنَ ٱلسَّمَآء — gökten parçalar

**ك-س-ف** kökü: **parçalamak, kesmek.** *Kisef* — *kisfe*nin çoğulu: **parçalar, kesitler.**

**Kelime Kur'an'da birkaç yerde geçer ve hep gökle birlikte** (İsrâ 17/92; Rûm 30/48; Sebe 34/9; Tûr 52/44 — `052-tur.md`'de işlendi).

**Ve `052-tur.md` 52/44'te kaydedilen ayet buraya bağlanıyor:** *ve in yerav kisfen mine's-semâi sâkıtan yekūlû sehâbün merkûm* — "gökten bir parçanın düştüğünü görseler, 'üst üste yığılmış bulut' derler". **Yani Kur'an, istenen şeyin verildiğinde bile başka türlü yorumlanacağını bir başka sûrede kaydediyor.**
...
**Bu bağı kendi okumam olarak kaydediyorum ve bağlayıcı değildir:** kavim gölgeli bir yerin halkı diye anılıyor ve azabı bir gölgeyle geliyor. **Bunun kastedildiği metinde söylenmiyor;** iki kelimenin aynı sûrede on beş ayet arayla durması ise metin verisidir. **Ve `085-buruc.md`'de kaydedilen "hüküm, suçun ya da hâlin diliyle bildirilir" ilkesiyle uyumludur.**
...
| Ayet | Kim söylüyor | Kip |
|---|---|---|
| **135** | **Hûd** | **Korku** — henüz olmadı |
| **156** | **Sâlih** | **Şart** — olursa |
| **189** | **Anlatıcı** | **Haber** — oldu |
...
**Aynı kalıp Kur'an'da birkaç sûrenin açılışıdır:** *tenzîlü'l-kitâbi mine'llâhi'l-azîzi'l-hakîm* (Zümer 39/1; Câsiye 45/2; Ahkāf 46/2 — `046-ahkaf.md`'de işlendi), *tenzîlen mimmen halaka'l-arda* (Tâhâ 20/4), *tenzîlü'l-azîzi'r-rahîm* (Yâsîn 36/5 — `036-yasin.md`'de işlendi).

**Ve Yâsîn 36/5 kaydedilmeye değer: orada *tenzîl*in nispet edildiği iki isim, Şuarâ'nın mühründeki iki isimle aynıdır — *el-Azîzü'r-Rahîm*.** Bu, metinden doğrulanabilir bir örtüşmedir.
...
**Kimin kastedildiği ayette söylenmiyor; ama Kur'an içi delil güçlüdür ve `097-kadr.md` ile `078-nebe.md`'de bu tablolandı. Oradaki kayda dayanıyorum:**
...
**Üç ayet birlikte okunduğunda aynı işi yapan üç ad çıkıyor ve üçüncüsünde ad açıkça veriliyor: Cibrîl.** Bu, metinden doğrulanabilir bir zincirdir; **`097-kadr.md`'de "Kur'an içi delili en güçlü olan" görüş olarak kaydedildi.**

**Ve *emîn* sıfatı kaydedilmelidir.** Sûrede beş elçi kendini bu sıfatla tanıtmıştı: *innî leküm rasûlün **emîn*** (107, 125, 143, 162, 178).

| Kim | Sıfat | Ayetler |
|---|---|---|
| **Beş elçi** | *emîn* | 107, 125, 143, 162, 178 |
| **Vahyi getiren** | *el-emîn* | **193** |
...
**ع-ر-ب** kökü `056-vakia.md` 56/37'de çözümlendi ve oraya dayanıyorum. Oradaki tarif: **kökün çekirdek anlamı "açık ve düzgün ifade etmek, meramı gizlemeden ortaya koymak"tır.** *A'rabe ani'ş-şey'* — bir şeyi açıkça bildirdi. *İ'râb* — açığa vurma; **gramerdeki *i'râb* terimi de buradan gelir: kelimenin cümledeki işini sonundaki harekeyle açığa vurması.**
...
| Anlam | Nerede |
|---|---|
| **Mucize, gökten inen işaret** | 4, 154 |
| **Dikili nişan, anıt** | 128 |
| **İbret, delil** | Sekiz mühürde; **197** |
...
**Ve `046-ahkaf.md` 46/10'da aynı delil geçer:** *ve şehide şâhidün min benî İsrâîle alâ mislihî fe-âmene ve'stekbertüm* — "İsrâiloğullarından bir şahit onun benzerine şahitlik etti de iman etti; siz ise büyüklendiniz." **Orada işlendi ve oraya dayanıyorum.**

**Ve `046-ahkaf.md` 46/4'te kaydedilen çerçeve buraya bağlanıyor:** orada iki delil türü isteniyordu — **gözlem** (*erûnî mâzâ halakū*) ve **nakil** (*i'tûnî bi-kitâbin min kabli hâzâ ev esâratin min ılm*). **Şuarâ 26/196-197 ikinci türden bir delil sunuyor.**
...
**Aynı varsayım Kur'an'da bir kez daha kurulur ve `041-fussilet.md` 41/44'te işlendi. Oraya dayanıyorum.**
...
**Ve `041-fussilet.md`'de kaydedilen şeye burada bir şey eklenebilir:** Şuarâ'daki varsayımda değişen taraf **kitap değil, kişidir.** *Alâ ba'dı'l-a'cemîn* — "yabancılardan **birine**". Ve fiil de eklenmiş: *fe-**karaehû** aleyhim* — "onlara **okusaydı**". **Yani varsayımda okuma fiili de var: metin gelseydi, okunsaydı, yine inanmazlardı.**
...
### سَلَكْنَٰهُ فِى قُلُوبِ ٱلْمُجْرِمِين — zamir tartışması
...
**Ve tartışılan yer şudur: *seleknâhü* zamiri neye dönüyor?**
...
### حَتَّىٰ يَرَوُا۟ ٱلْعَذَابَ ٱلْأَلِيم — sınırın konması

**Ve cümle, imanın zamanına bir sınır koyuyor: *hattâ yerevü'l-azâb*.**
...
**Ve Kur'an bunu başka yerde açıkça söyler:** *fe-lem yekü yenfeuhüm îmânühüm lemmâ raev be'senâ* (Mü'min 40/85 — `040-gafir.md`'de işlendi).

### بَغْتَةً وَهُمْ لَا يَشْعُرُون — ansızınlık

**ب-غ-ت** kökü: **ansızın, hazırlıksız yakalamak.**
...
### هَلْ نَحْنُ مُنظَرُون — mühlet isteği
...
**Ve dizim nüktesi kaydedilmelidir: istenen şey iman etmek için fırsat değil, *süre*.**

### أَفَبِعَذَابِنَا يَسْتَعْجِلُون — acele isteği

**Ve iki ayet arasında bir karşıtlık kuruluyor:**
...
**Aynı kişiler, iki ayrı zamanda, iki zıt istek.** Bu, metinden doğrulanabilir bir örtüşmedir.
...
**ع-ج-ل** kökü: **acele etmek.** X. bâb (*ista'cele*) — **acele istemek, çabuklaştırılmasını talep etmek.**
...
### وَمَآ أَهْلَكْنَا مِن قَرْيَةٍ إِلَّا لَهَا مُنذِرُون — kuralın konması

**Ve sûre, yedi kıssadan çıkan kuralı tek cümlede söylüyor.**
...
**Ve `035-fatir.md` 35/24'te aynı kural bir başka kelimeyle konur:** *ve in min ümmetin illâ halâ fîhâ nezîr* — "hiçbir ümmet yoktur ki içinde bir uyarıcı gelip geçmiş olmasın". **Orada işlendi ve oraya dayanıyorum.**

### ذِكْرَىٰ وَمَا كُنَّا ظَٰلِمِين — iki kelimelik gerekçe

**ذِكْرَىٰ** — kök **ذ-ك-ر**: hatırlamak, anmak. *Zikrâ* — **hatırlatma.**
...
**وَمَا كُنَّا ظَٰلِمِين** — "ve biz zalimler değiliz."
...
**Ve `050-kaf.md` 50/29'da benzer bir kayıt geçer:** *ve mâ ene bi-zallâmin li'l-abîd.* **Orada işlendi.**
...
**Ve `072-cin.md` 72/8-9 ile `081-tekvir.md` 81/25 ve `037-saffat.md` 37/6-10'da bu konu işlendi ve oralara dayanıyorum.** Oradaki kayıtlar özetle şunlardı: Kur'an, göğün "korunduğunu" ve dinlemeye kalkışanların kovulduğunu birkaç sûrede kaydeder; **bu ayet o kaydın Şuarâ'daki karşılığıdır.**

**Ve `072-cin.md`'de Şuarâ 26/210-212 zaten anılmıştı;** oradaki kayda dayanıyorum.
...
**Ve `070-mearic.md` 70/13'te kaydedilen karşılaştırma buraya bağlanıyor:** orada *fasîle* kelimesi işlenmişti (*ve fasîletihi'lletî tü'vîh*) ve **"Meâric'in *fasîle*si daha dar bir halkayı bildirir"** diye kaydedilmişti. **Oraya dayanıyorum.**

**Ve `074-muddessir.md`'de kaydedilen kademelenme buraya bağlanıyor.** Oradaki kayıt şuydu: **inzârın muhatabı Kur'an'da kademeli olarak belirlenir.** Tablo hâlinde tekrarlıyorum, çünkü bu ayet o tablonun bir halkasıdır:
...
**Ve `071-nuh.md` 71/8-9'da kaydedilen tartışma buraya bağlanıyor:** orada Nûh'un davetindeki sıra (gizli/açık) tartışılmış ve **bu ayet, "dar daireden geniş daireye" okumasının dayanağı olarak anılmıştı.** Oradaki kayda dayanıyorum; **orada da kesin bir tercih yapılmamıştı.**
...
**خ-ف-ض** kökü: **alçaltmak, indirmek, yumuşatmak.** Karşıtı *ref'* (yükseltmek). Kur'an aynı kökü sesi alçaltmak için de kullanır (*va'ğdud min savtike* değil ama benzer alanda, Lokmân 31/19 — `031-lokman.md`'de işlendi).

**جَنَاح** — **kanat.** İnsan için kullanıldığında **"kol, yan taraf"** anlamına gelir.
...
**Ve `028-kasas.md` 28/29-35'te aynı kelimenin bir başka deyimi işlendi ve oraya dayanıyorum.**
...
**Kök `039-zumer.md`'de ve `065-talak.md` 65/3'te işlendi ve tekrarlamıyorum.**
...
**هَلْ أُنَبِّئُكُمْ** — "size haber vereyim mi?" **Kalıp Kur'an'da dikkat çekme için kullanılır** (*hel ünebbiüküm bi-şerrin min zâlike* — Mâide 5/60; *hel edüllüküm alâ ticâratin* — Saff 61/10, `061-saff.md`'de işlendi).
...
**Kök `045-casiye.md` 45/7'de çözümlendi ve oraya dayanıyorum.** Oradaki tarif: **أ-ف-ك — bir şeyi yönünden çevirmek, ters yüz etmek.** Ve orada kaydedildiği gibi kök `046-ahkaf.md` 46/11 ve 46/28'de de işlendi (*ifkün kadîm*, *ifkühüm*).
...
**Ve `045-casiye.md`'deki kaydın devamı buraya bağlanıyor:** orada *effâk*ın ardından ne yaptığı anlatılıyordu (*yesmeu âyâtillâhi tütlâ aleyhi sümme yusırru müstekbiran ke-en lem yesma'hâ*). **Şuarâ'da ise ne aldığı anlatılıyor.**
...
| ***Effâk*larla anlaşanlara** | Kâhinler / haber alanlar | "Onlar [şeytanlara] kulak verir; çoğu yalancıdır" |
...
**Nakledilen izah: kulak vermek (*ilkāü's-sem'*) bir *çaba*dır; uzaklaştırılmak ise sonuçtur.** Yani "dinlemeye çalışırlar ama erişemezler". **Bu izah iki ayeti uzlaştırır ve iki yüz on ikinci ayetin kalıbıyla uyumludur — orada edilgen kalıp kullanılmıştı.**

**ألقى السمع** — Arapçada bir deyimdir: **kulağını vermek, dikkat kesilmek.** Kur'an aynı deyimi bir kez daha kullanır: *ev elka's-sem'a ve hüve şehîd* (Kāf 50/37 — `050-kaf.md`'de işlendi). **Aynı deyim, iki ayrı bağlamda.**
...
| Yer | İfade | Kim |
|---|---|---|
| **Sekiz mühür** | *Ve mâ kâne **ekseruhüm** mü'minîn* | **Kavimler** |
| **223** | *Ve **ekseruhüm** kâzibûn* | **Kulak verenler** |
...
**Yani *şâir*, kökün anlamına göre "kafiye söyleyen" değil, *ince olanı sezip söyleyen*dir.** Bu, kelimenin sözlük değeridir ve olumsuz bir anlam taşımaz.
...
| Öğe | Kelime | İşi |
|---|---|---|
| **Mübtedâ** | *Eş-şuarâü* | **Şairler** |
| **Haber (fiil cümlesi)** | *Yettebiuhümü'l-ğâvûn* | **Onlara azgınlar uyar** |
...
**Kök `053-necm.md`'de çözümlendi ve sûredeki üç geçişi (91, 94, 224) 26/90-95 bölümünde tablolandı; tekrarlamıyorum.**
...
**ه-ي-م** kökü `056-vakia.md` 56/55'te çözümlendi ve oraya dayanıyorum. Oradaki tarif: ***hîm*, *ehyem*/*heymâ*'nın çoğuludur ve suya kanmayan bir hastalığa tutulmuş deve demektir. *Hüyâm* — develerde görülen, hayvanın sürekli su içmesine yol açan ve içtikçe susuzluğunun geçmediği bir hâl.**
...
**Ve aynı ölçü Kur'an'da bir kez daha, bu kez doğrudan mü'minlere kurulur. `061-saff.md` 61/2-3'te işlendi ve oraya dayanıyorum.**
...
**Ve bu ölçü sûrenin kendi içinde de kuruludur:** beş elçi beş kez *"sizden ücret istemiyorum"* dedi (109, 127, 145, 164, 180) — **ve sûre bunu bir iddia olarak değil, bir davranış kaydı olarak veriyor.** Ve elçilerin sıfatı *emîn*di (107, 125, 143, 162, 178): **güvenilir, yani sözü ile hâli tutan.**
...
**Bir — savunma *sonradan*dır.** *Min ba'di mâ zulimû* — "**zulme uğradıktan sonra**". **Yani cümle, önce saldırmayı değil, karşılık vermeyi tarif ediyor.**

**İki — fiil edilgen: *zulimû* — "zulme uğradılar".** Kim zulmettiği söylenmiyor; **konu, zulmün yapıldığı taraftır.**

**Ve `042-sura.md`'de bu alan işlendi ve oraya dayanıyorum.** Orada aynı kök geçer: *ve'llezîne izâ esâbehümü'l-bağyü hüm **yentesırûn*** (Şûrâ 42/39) ve hemen ardından sınır konur: *ve cezâü seyyietin seyyietün mislühâ* (42/40) — **karşılığın misli kadar olması.** Oradaki kayda dayanıyorum ve burada tekrarlamıyorum.
...
| Ayet | İfade | Konum |
|---|---|---|
| **6** | *Fe-**se**-ye'tîhim enbâü…* | **Sûrenin başında** |
| **227** | *Ve **se**-ya'lemü'llezîne zalemû…* | **Sûrenin sonunda** |
...
**Kök `084-insikak.md`'de çözümlendi ve orada bu ayet zaten anıldı; oraya dayanıyorum.** Oradaki kayıt: **ق-ل-ب — ters çevirmek; *inkalebe* hem "geri dönmek" hem "âkıbete varmak" anlamındadır ve Kur'an bu ayeti ikinci anlam için kullanır.**
...
**Ve mührün iki ayeti iki ayrı iş yapıyor:**
...
**Ve iki yüz on yedinci ayette bu iki isim bir emre bağlanıyor: *ve tevekkel ale'l-azîzi'r-rahîm*.**
...
### Sûrenin iki ucu — açılış ve kapanış
...
**Son satır kaydedilmelidir: sûre, sekiz kez kullandığı mührü sonunda kullanmıyor.**
...
### Sûrede çözümlenen kökler ve nerede işlendiler
...
|---|---|---|---|
| **ب-خ-ع** | *bâhı'* (3) | **Evet** | — |
| **ب-خ-س** | *tebhasû* (183) | Hayır | `083-mutaffifin.md` |
| **ب-ط-ش** | *betaştüm* (130) | Hayır | `085-buruc.md`, `054-kamer.md` |
| **ه-ي-م** | *yehîmûn* (225) | Hayır | `056-vakia.md` |
| **أ-ف-ك** | *ye'fikûn* (45), *effâk* (222) | Hayır | `045-casiye.md`, `046-ahkaf.md` |
| **ع-ر-ب** | *arabiyy* (195) | Hayır | `056-vakia.md`, `043-zuhruf.md` |
...
| **ق-ل-ي** | *kālîn* (168) | **Evet** | `093-duha.md` (başka türev) |
| **ج-ب-ل** | *cibille* (184) | **Evet** | — |
| **ف-ر-ه** | *fârihîn* (149) | **Evet** | — |
| **ه-ض-م** | *hedîm* (148) | **Evet** | — |
| **ع-ث-و** | *ta'sev* (183) | **Evet** | — |
| **ع-ج-م** | *a'cemîn* (198) | Hayır | `041-fussilet.md` |
| **ق-ل-ب** | *münkalibûn* (50, 227) | Hayır | `084-insikak.md` |
| **ج-ن-ح** | *cenâh* (215) | Hayır | `028-kasas.md` |

### Bu bölümde dayanılan başlıca bölümler

| Bölüm | Ne için |
|---|---|
| `037-saffat.md` | **Peygamber dizisi ve kapanış mührü tekniği**; *kalb-i selîm*; *demmernâ'l-âharîn* |
| `028-kasas.md` | **Mûsâ kıssasının arka planı**; *istid'âf*; *cenâh* deyimi; elçiye çizilen sınır tablosu |
| `041-fussilet.md` | **41/44 — "yabancı dilde bir Kur'an" varsayımı** |
| `061-saff.md` | **61/2-3 — söylediğini yapmamak** |
| `056-vakia.md` | ع-ر-ب ve ه-ي-م kökleri |
| `083-mutaffifin.md` | Ölçü-tartı alanı; ب-خ-س kökü |
| `085-buruc.md` | ب-ط-ش kökü; "hüküm suçun diliyle bildirilir" ilkesi |
| `043-zuhruf.md`, `031-lokman.md` | **Atalar delili** |
| `046-ahkaf.md`, `035-fatir.md` | **"İşitiyorlar mı?" delili**; iki kademeli çürütme |
| `045-casiye.md` | *effâk esîm* |
| `057-hadid.md` | *Mîzân* — kitap, ölçü, demir |
| `089-fecr.md`, `054-kamer.md`, `069-hakka.md` | Âd ve Semûd'un Kur'an içindeki yeri |
| `071-nuh.md` | Nûh'un daveti ve duası |
| `097-kadr.md`, `078-nebe.md` | *er-Rûhu'l-emîn*'in kim olduğu |
| `053-necm.md` | غ-و-ي kökü ve *ğâvûn* |
| `042-sura.md` | Zulme karşı savunmanın ölçüsü |
| `066-tahrim.md` | Lût'un eşi — yakınlığın kurtarıcı olmayışı |
...
Aradaki her şey — yedi peygamber, sekiz mühür, beş kez tekrarlanan üç cümle, sihirbazların iki dakikada değişen tarafı, dağlardan yontulan evler, ölçek ve terazi, ve son üç ayetteki söz-fiil ölçüsü — **bu iki bildirimin arasına yerleştirilmiştir.**

Ve sûrenin elçiye söylediği tek şey, üçüncü ayetten iki yüz on yedinci ayete kadar değişmiyor: **taşıdığın yük ulaştırmaktır; sonucu taşıyan sen değilsin.**
