...
**Ve adlandırmanın kendisi kaydedilmeye değer.** Sûre, Yûnus peygamberin kıssasını anlatmaz. Balık, gemi, kura, kabak bitkisi — hiçbiri burada yoktur; onlar `037-saffat.md` 37/139-148, `021-enbiya.md` 21/87-88 ve `068-kalem.md` 68/48-50'de işlendi. **Bu sûrede anılan şey, peygamberin başına gelenler değil, kavminin âkıbetidir.** Sûre bir peygamberin adını taşıyor, ama o adı bir **topluluğun kararından** alıyor.
...
**Hurûf-ı mukattaa kaydı dizinde defalarca düşüldü** (`002-bakara.md`, `050-kaf.md`, `045-casiye.md`): **anlamı hakkında kesin bilgi yoktur, harf-sayı hesabına girilmez.** **Tekrarlamıyorum.**

**Buraya ait olan, sayılabilir bir mushaf verisidir ve `042-sura.md` 42/1'de tablolanmıştı:** bazı sûrelerde harfler tek başına bir ayet sayılır (*elif-lâm-mîm* — Bakara 2/1), bazılarında sonraki cümleyle **tek ayeti** oluşturur. **Yûnus ikinci gruptandır:** *elif-lâm-râ* ile *tilke âyâtü'l-kitâbi'l-hakîm* birlikte birinci ayettir.

**تِلْكَ ءَايَٰتُ ٱلْكِتَٰبِ ٱلْحَكِيمِ** — **açılış cümlesi `026-suara.md` 26/2 ve `012-yusuf.md` 12/1'de tablolandı.** Oraya dayanıyorum: aynı kalıp birkaç sûrede tekrarlanır, değişen yalnız son sıfattır (*el-hakîm* / *el-mübîn*).
...
**ع-ج-ب kökü `050-kaf.md` 50/2'de (*bel acibû en câehüm münzirun minhüm*) ve `013-rad.md` 13/5'te (*ve in ta'ceb fe-acebün kavlühüm*) işlendi.** **Oraya dayanıyorum ve orada kaydedilen çekirdek burada da geçerlidir: itiraz bir delille değil, *aşinalık ölçüsüyle* başlıyor.**
...
**Üçünde de ortak olan kelime *minhüm* / *minküm*tür: içlerinden biri.** **İtirazın dayanağı, elçinin insan ve tanıdık olmasıdır.** **`025-furkan.md` 25/20 ve `021-enbiya.md` 21/7-8'de bu itiraz ve cevabı ayrıntılı işlendi; oraya dayanıyorum.**

### قَدَمَ صِدْقٍ — "doğruluk ayağı"

**Terkip dikkat çekicidir ve Kur'an'da yalnız burada geçer.**

**ق-د-م kökü:** öne geçmek, ilerlemek. *Kadem* — **ayak**; ve buradan **basamak, sabit yer, öncelik.**
...
**Ve *sıdk* kelimesinin sıfat olarak kullanılması sûre içinde bir kez daha dönecek:** doksan üçüncü ayette İsrâiloğulları için *mübevvae **sıdk***in (doğruluk yurdu) denecek. **İki terkip de aynı kalıptadır: isim + *sıdk*.**
...
|---|---|---|---|
| **2** | *el-Kâfirûn* | **Peygamber** | *İnne hâzâ le-**sâhırun** mübîn* — "bu bir **büyücü**dür" |
| **76** | Fir'avn ve çevresi | **Mûsâ'nın getirdiği** | *İnne hâzâ le-**sihrun** mübîn* — "bu bir **büyü**dür" |
...
**Terkip `032-secde.md` 32/5'te ayrıntılı çözümlendi ve oraya dayanıyorum; tekrarlamıyorum.** Orada kaydedilenlerin çekirdeği şuydu: **د-ب-ر kökünün somut anlamı "arka"dır** (*dübür*); *tedbîr*, bir işin **arkasına — yani sonuna — bakarak** onu düzenlemektir. **Ve orada II. bâb (*tedbîr*, Allah'a nispet) ile V. bâb (*tedebbür*, insana emredilen) arasındaki kalıp farkı tablolanmıştı.**
...
**`002-bakara.md` 2/255'te (*men ze'llezî yeşfeu indehû illâ bi-iznih*)** kaydedilen şuydu: **kendiliğinden, hak olarak, kişinin garanti sayabileceği bir şefaat yoktur; izne bağlı olan ise ayrı bir meseledir.** Ve orada Bakara 2/48 ile bu ayet yan yana konmuş, taraf belirtilmemişti.

**`039-zumer.md` 39/43-44'te (*kul lillâhi'ş-şefâatü cemîâ*)** kaydedilen şuydu: **şefaat inkâr edilmiyor — sahibi belirtiliyor.**
...
**Ve `079-naziat.md` 79/5 bölümünde bu ayet *tedbîr* vesilesiyle anılmıştı** — orada tedbirin Allah'a, uygulamanın meleklere nispet edilişi tartışılmıştı. **Oraya dayanıyorum.**
...
**`050-kaf.md` 50/38'de kaydedilen ve Hadîd 57/4 bahsine dayandırılan özet şuydu:** *yevm* kelimesi Arapçada yalnız "yirmi dört saatlik gün" demek değildir; kökün asıl anlamı **bir zaman dilimi, bir devre**dir. **Altı "gün"ün ne kadar sürdüğü bildirilmemiştir ve bilinmemektedir.**

**`041-fussilet.md` 41/9-12'de aynı sınır bir kez daha çizilmişti:** "gün"ler jeolojik çağlarla eşitlenmez, *duhân* kelimesinden bir evren modeli çıkarılmaz. **Metnin söylediği şudur: yaratma sıralı ve ölçülü anlatılıyor.**

**Aynı sınırı koruyorum. Fennî mucize avcılığı yapmıyorum ve burada modern kozmolojiye dair hiçbir sonuç çıkarmıyorum.**

**ثُمَّ ٱسْتَوَىٰ عَلَى ٱلْعَرْشِ** — **terkip `032-secde.md` 32/4'te işlendi ve iki klasik tavır (tefvîz / te'vîl) tablolanıp tercih dayatılmamıştı. Aynı kaydı düşüyorum ve tartışmayı açmıyorum.** Ortak ilke Şûrâ 42/11'dir: *"O'nun benzeri hiçbir şey yoktur."*

**`020-taha.md` 20/5'te bu terkibin Kur'an'daki yedi geçişi sayılmıştı** (A'râf 7/54, **Yûnus 10/3**, Ra'd 13/2, Tâhâ 20/5, Furkān 25/59, Secde 32/4, Hadîd 57/4). **Oraya dayanıyorum.**
...
| Ayet | İfade |
|---|---|
| **4** | *İleyhi **merciuküm** cemîâ* |
| **23** | *Sümme ileynâ **merciuküm*** |
| **46, 70** | *Fe-ileynâ **merciuhüm*** |
...
**وَٱلَّذِينَ كَفَرُوا۟ لَهُمْ شَرَابٌ مِّنْ حَمِيمٍ** — *hamîm*: kaynar su. **Kök `056-vakia.md` ve `044-duhan.md`'de işlendi; tekrarlamıyorum.**
...
**Bu ayrım dizinde birçok yerde anıldı** (`071-nuh.md` 71/16, `064-tegabun.md`, `091-sems.md`, `078-nebe.md`, `021-enbiya.md` 21/33) **ve hep bu ayete gönderme yapıldı. Burası kelimenin kendi yeridir; bu yüzden ayrımı burada topluca kaydediyorum.**
...
**Ve `091-sems.md`'de kaydedilen şu tespit buraya aittir:** Kur'an ayı hiçbir yerde *sirâc* (kandil) diye anmaz; *sirâc* güneş içindir (`071-nuh.md` 71/16, Furkān 25/61). **Kelime tercihi tutarlıdır ve bu, sayılabilir bir veridir.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı bu cümledir:** ayet, gök cisimlerini bir **takvim** olarak anıyor. **`091-sems.md`'de kaydedildiği gibi: güneş, Kur'an'ın tabiat tasvirinde öncelikle bir saattir.** **Yani ayetin verdiği fayda, ışığın fiziği değil, zamanın ölçülebilir olmasıdır.**
...
**إِنَّ فِى ٱخْتِلَٰفِ ٱلَّيْلِ وَٱلنَّهَارِ** (6) — **خ-ل-ف kökü:** ardından gelmek. *İhtilâf* burada "anlaşmazlık" değil, **birbirini izleme, nöbetleşme**dir.
...
### وَٱطْمَأَنُّوا۟ بِهَا — *itmi'nân*ın olumsuz kullanımı

**Bu, sûrenin en güçlü dil verilerinden biridir ve mutlaka karşılaştırılmalıdır.**

**ط-م-ن kökü `002-bakara.md` 2/260'ta çözümlendi** (*li-yatmeinne kalbî*): **yatışmak, sakinleşmek, yerine oturmak;** ve orada dilcilerin kaydettiği somut resim verilmişti: **bir şeyin çukura oturup sabitlenmesi.** **Ve orada iman ile itmi'nân arasındaki fark kaydedilmişti: biri kabul, öteki içe yerleşme.**

**`013-rad.md` 13/28'de aynı kök olumlu bağlamda işlendi:** *ellezîne âmenû ve **tatmeinnü** kulûbühüm bi-zikrillâh, elâ bi-zikrillâhi **tatmeinnü**'l-kulûb.* **Ve orada cümlenin iki kez söylenmesi ve *bi-zikrillâhi*nin takdimle tahsis bildirmesi tablolanmıştı.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı iki ayetin dizimidir:** *itmi'nân* Kur'an'da tek başına ne övülüyor ne yeriliyor. **Kelime bir *durum*u anlatıyor: içe yerleşme, yerine oturma, arayışın durması.** **Değerini belirleyen şey, neyin üzerine oturulduğudur.**

**Ve bu okumayı destekleyen bir sûre içi veri var:** yedinci ayette *itmi'nân*dan hemen önce ***radû*** (razı oldular) geliyor. **Yani sıra şudur: razı olmak → yatışmak → gaflet.** **Arayışın durması, önce bir *yeterli bulma* kararıyla başlıyor.**

**Ve `029-ankebut.md` 29/64'te kaydedilen tanım burada işliyor:** dünya hayatı *hayat* kelimesiyle anılıyor, ama asıl hayat (*el-hayevân*) başka bir kelimeye veriliyor. **Yûnus'un yaptığı, o kelimenin üzerine oturulabileceğini söylemek.**
...
**Üç ayette aynı grup, üç ayrı fiille anılıyor: razı oldular, bırakıldılar, istediler.** **Bunu bir gözlem olarak kaydediyorum: sûre grubu bir inanç maddesiyle değil, bir *beklenti yokluğu*yla tanımlıyor.**
...
**`039-zumer.md` 39/73'te cennet bekçilerinin *selâmün aleyküm tıbtüm* dediği işlendi;** **`056-vakia.md` 56/25-26'da selâmın karşılık olarak verilmesi tablolandı.** **Oraya dayanıyorum.**

### وَءَاخِرُ دَعْوَىٰهُمْ أَنِ ٱلْحَمْدُ لِلَّهِ رَبِّ ٱلْعَٰلَمِينَ

**Cümle, Fâtiha'nın birinci ayetiyle kelime kelime aynıdır.**

**`001-fatiha.md` 1/1'de bu cümle ayrıntılı çözümlendi:** isim cümlesi tercihi (fiil değil), yani hamdın kulun fiiline bağlanmaması; *Rabb* isminin süregiden bir terbiyeyi bildirmesi. **Tekrarlamıyorum.**
...
**`039-zumer.md` 39/75'te de aynı cümle sûrenin kapanışıydı** ve orada kaydedilmişti: **fiil meçhuldür (*ve kīle* — "denildi"), söyleyeni adlandırılmamıştır.**
...
**`035-fatir.md` 35/45'te** (*ve lev yüâhızullâhu'n-nâse bimâ kesebû mâ tereke alâ zahrihâ min dâbbe*): kapsam **bütün canlılar**dı ve orada kaydedilmişti — *"ayet, insanın hesabının başka canlıları da ilgilendirdiğini söylemiş oluyor."*

**`018-kehf.md` 18/58'de** (*lev yüâhızühüm bimâ kesebû le-accele lehümü'l-azâb*): orada *lehüm mev'ıd* — **belirlenmiş bir vakit** bildiriliyordu.
...
**Ve Yûnus'un eklediği kaydedilmelidir:** öteki iki ayette şart **kazanılan amel**di (*bimâ kesebû*); **burada şart, insanın kendi acele isteme hızı.** **Yani ölçü dışarıdan değil, muhatabın kendi davranışından alınıyor.**

**Ve `013-rad.md` 13/6'da azabın acele istenmesi (*ve yesta'cilûneke bi's-seyyieti kable'l-haseneh*) işlendi;** **`034-sebe.md` 34/29 ve `029-ankebut.md` 29/53'te de aynı talep geçmişti.** **Yûnus, o talebe verilen cevabın en kuruluşlu hâlidir.**

**فِى طُغْيَٰنِهِمْ يَعْمَهُونَ** — **terkip `023-muminun.md` 23. bölümünde tablolandı** ve orada Kur'an'daki düzenli geçişleri sayılmıştı (Bakara 2/15, En'âm 6/110, A'râf 7/186, **Yûnus 10/11**). **Oraya dayanıyorum.**
...
**`039-zumer.md` 39/8 ve 39/49'da** aynı kalıp iki kez geçiyordu ve orada kaydedilmişti: **birincisinde *unutma*, ikincisinde *sahiplenme*** — "önce kaynağı unutmak, sonra kaynağın kendisi olduğunu iddia etmek."

**`041-fussilet.md` 41/49-51'de** portre bir kez daha geçiyordu: *nee bi-cânibih* (yan çizme) ve *duâin arîd* (enine boyuna dua). **Ve orada *tûl* ile *arz* farkı kaydedilmişti: dua derinleşmiyor, yayılıyor.**
...
**Ve `032-secde.md` 32/16'da mü'minlerin vasfı olarak *tetecâfâ cünûbühüm ani'l-medâcı'* (yanları yataklardan uzaklaşır) geçiyordu.** **İki ayette de *cenb* (yan) kelimesi var; biri sıkıntıda dua eden, öteki rahatta kalkan.** **Bunu bir lafız gözlemi olarak kaydediyorum; iki ayetin birbirine gönderme yaptığı iddiasında değilim.**
...
**زُيِّنَ لِلْمُسْرِفِينَ** — *tezyîn* (süslü gösterilme) `041-fussilet.md` 41/25'te ve `043-zuhruf.md`'de işlendi. **Tekrarlamıyorum.**
...
**خَلَٰٓئِف** — **خ-ل-ف kökü:** ardından gelmek. *Halîfe*nin çoğulu. **Kelime altıncı ayetteki *ihtilâfü'l-leyli ve'n-nehâr* ile aynı köktendir** — gece ile gündüzün birbirini izlemesi ile nesillerin birbirini izlemesi aynı kelimeyle anlatılıyor.
...
**Cümle bir amaç bildiriyor ve amaç *bakmak*tır.** **Bunu kendi okumam olarak kaydediyorum:** halifelik, bir imtiyaz olarak değil **bir gözlem konusu** olarak veriliyor. **Yani yerini almak, sınavın kendisi.**
...
**Bu cümle `046-ahkaf.md` 46/9'da kelime kelime aynı geçmişti ve orada işlendi.** Oraya dayanıyorum. **Orada kaydedilen çerçeve şuydu:** *mâ küntü bid'an mine'r-rusül* (türedi biri değilim) cümlesinden sonra geliyor ve **bilginin kendinden olmadığını** bildiriyor.
...
| Ayet | Şefaat hakkında |
|---|---|
| **3** | *Mâ min şefîın illâ min ba'di iznih* — **kayıt** |
| **18** | *Hâülâi şüfeâünâ indallâh* — **iddia** |

**Ve iddianın kelimeleri kaydedilmelidir: *indallâh* — "Allah katında".** Yani iddia sahipleri Allah'ı reddetmiyorlar; **O'nun katında bir konum tarif ediyorlar.** **`039-zumer.md` 39/3'te (*mâ na'büdühüm illâ li-yukarribûnâ ilallâhi zülfâ*) aynı gerekçe işlendi ve orada kaydedilmişti: itiraz Allah'a değil, aracısızlığa.** **Oraya dayanıyorum.**
...
**أُمَّةً وَٰحِدَةً** — **terkip Kur'an'da birden çok yerde geçer** ve `043-zuhruf.md` 43/33'te (*ve levlâ en yekûne'n-nâsü ümmeten vâhideten*) başka bir yönüyle işlendi. **Oraya dayanıyorum.**
...
| **64** | *Lâ tebdîle li-**kelimâti**llâh* | **Değişmezlik** |
...
**Bu talep dizinde birçok yerde işlendi:** **`013-rad.md` 13/7'de aynı cümle** (*lev lâ ünzile aleyhi âyetün min rabbih*) **geçiyordu ve orada iki kez daha dönmüştü;** **`025-furkan.md` 25/21'de** (*lev lâ ünzile aleyne'l-melâike*) **ve `018-kehf.md` 18/57'de** aynı hat işlendi. **Oraya dayanıyorum.**
...
> **20. ayet:** *fe'ntezirû innî meaküm mine'l-müntazirîn*
> **102. ayet:** *kul fe'ntezirû innî meaküm mine'l-müntazirîn*
...
**وَٱللَّهُ أَسْرَعُ مَكْرًا** — **ve kelimenin Allah'a nispet edilmesi kaydedilmelidir.**
...
**إِنَّ رُسُلَنَا يَكْتُبُونَ مَا تَمْكُرُونَ** — *rusül* burada **melekler** anlamındadır; dilciler kelimenin "gönderilenler" anlamının bunu mümkün kıldığını kaydeder. **`013-rad.md` 13/11'de *muakkıbât* vesilesiyle aynı alan işlendi; oraya dayanıyorum.**
...
| Sıra | İfade | Şahıs |
|---|---|---|
| 1 | *Yüseyyiru**küm*** — sizi yürütür | **II. şahıs** |
...
| 5 | *Câe**hüm**ü'l-mevc* — **onlara** dalga geldi | **III. şahıs** |
...
**رِيحٌ عَاصِفٌ** — **ع-ص-ف kökü `077-murselat.md`'de (*el-âsıfât*) ve `105-fil.md`'de işlendi;** ve orada kaydedilmişti: ***âsıf* Arapçada neredeyse yalnız rüzgâr için kullanılır.** **Oraya dayanıyorum.**
...
**`018-kehf.md` 18/45'te** (*ke-mâin enzelnâhu mine's-semâi fe'htelata bihî nebâtü'l-ardı fe-asbaha heşîmen tezrûhü'r-riyâh*) **ve `039-zumer.md` 39/21'de** (beş aşamalı tek cümle: indirdi → yürüttü → çıkardı → sarardı → çer çöp yaptı). **Ve orada `056-vakia.md` 56/65 ile birlikte üç kelimenin (*heşîm*, *hutâm*, *hasîd*) aynı sonu anlattığı kaydedilmişti.**
...
**ز-خ-ر-ف kökü `043-zuhruf.md`'de sûre adı vesilesiyle çözümlendi** ve orada kaydedilmişti: ***zuhruf* — altın; ve buradan süs, bezek, yaldız.** **Ayrıca orada dilcilerin kelimeyi *zehare* (kabarmak, taşmak) fiiliyle ilişkilendirdiği nakledilmişti: süs, bir şeyin *kabarması*, olduğundan daha dolu görünmesidir.** **Bu türetme ilişkisi orada "dilcilerin kaydettiği şekliyle" verilmişti; aynı kaydı koruyorum.**
...
**`018-kehf.md` 18/35-36'da bahçe sahibinin cümlesi işlenmişti:** *mâ ezunnü en tebîde hâzihî ebedâ · ve mâ ezunnu's-sâate kāimeh* — **"bunun yok olacağını hiç sanmıyorum; kıyametin kopacağını da sanmıyorum."** **Ve orada kaydedilmişti: iki *zan* arka arkaya, birincisi elde olan hakkında, ikincisi gelecek hakkında; ve ikincisi birincinin doğal uzantısı olarak veriliyor.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı iki cümlenin nesneleridir:** Kehf'te yanılgı **bahçe hakkında**dır — "o yok olmaz". **Yûnus'ta yanılgı *kendileri* hakkındadır** — "biz ona gücümüz yetiyor". **Yani biri şeyin ömrü, öteki sahibin yetkisi konusunda yanılıyor.**
...
**Yani ayetin işaret ettiği şey mülkiyet değil, *kontrol duygusu*dur.** **`067-mulk.md`'de kaydedilen kayıt burada da geçerlidir:** ayet tedbiri değil, **tedbirin ürettiği yanılsamayı** konu ediyor.
...
| Ayet | İfade |
|---|---|
| **10** | *Ve tehıyyetühüm fîhâ **selâm*** |
| **25** | *Yed'û ilâ **dâri's-selâm*** |
...
| Fiil | Kime |
|---|---|
| *Yed'û* — **çağırır** | **Belirtilmiyor** — genel |
| *Yehdî* — **iletir** | *Men yeşâ'* — **dilediğini** |
...
**Bu terkip dizinde birçok yerde anıldı: `075-kiyame.md`, `080-abese.md`, `092-leyl.md`, `072-cin.md`, `074-muddessir.md`.**

***el-Hüsnâ* — `092-leyl.md`'de işlendi:** Kur'an kelimeyi mükâfat için kullanır.
...
**`075-kiyame.md`'de birinci okuma "nakledildiği şekliyle" aktarılmış, hüküm olarak sunulmamıştı. Aynı kaydı koruyorum ve tercih dayatmıyorum.**
...
**قَتَر** — kök **ق-ت-ر**: **duman, is; ve buradan yüze çöken karartı.** **`080-abese.md` 80/40-41'de kelime işlendi ve orada kaydedilmişti:** *"Aynı kelime (katar), aynı fiil ailesi (yerheku), ters hükümle. Abese'nin son iki ayeti, Yûnus 10/26'nın negatifidir."* **Oraya dayanıyorum.**
...
**مَكَانَكُمْ** — **isim fiil olarak emir: "yerinizde kalın, durun."** **Bunu bir dizim gözlemi olarak kaydediyorum:** sahne bir mahkeme salonu gibi kuruluyor ve ilk emir **durdurma**dır.
...
**مَّا كُنتُمْ إِيَّانَا تَعْبُدُونَ** — **dizim kaydedilmelidir: *iyyânâ* öne alınmış.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı bu takdimdir:** ortakların savunması, kulluğun **hiç olmadığı** değil, **kendilerine yönelmediği** yönündedir. **Ve `034-sebe.md`'de ve `019-meryem.md` 19/81-82'de aynı sahne işlendi:** yöneldiği sanılan taraf, yönelmeyi tanımıyor.

**تَبْلُوا۟ كُلُّ نَفْسٍ مَّآ أَسْلَفَتْ** — **ب-ل-و kökü:** denemek, sınayarak yıpratmak. **Kök `002-bakara.md` 2/49'da çözümlendi** (*belâün min rabbiküm azîm*) ve orada kaydedilmişti: **kelime iyiyle sınamayı da kapsar.** **Oraya dayanıyorum.**

Ve fiilin öznesi kaydedilmelidir: *tebl**û** küllü nefsin* — sınayan, **canın kendisi.** Sınanan da kendi önden gönderdiği.
...
**Ve dördüncüsü, üçüncü ayetin fiilidir.** **`035-fatir.md` 35/3'te aynı soru kalıbı (*hel min hâlikın ğayrullâhi yerzükuküm*) işlendi ve orada kaydedilmişti: soru soyut bir yaratıcılık tartışması açmıyor — sürüp giden bir işin kim tarafından yürütüldüğünü soruyor.** **Oraya dayanıyorum.**
...
**ض-ل-ل kökü:** **yolu kaybetmek, kaybolmak.** **`013-rad.md` 13/14'te kaydedilmişti:** *dalâl*, dua için kullanıldığında "dua kaybolmuyor — yolunu kaybediyor" demekti. **Kökün çekirdeği yok olmak değil, *yerini bulamamak*tır.**
...
| Ayet | Sorulan yetki |
|---|---|
| **34** | *Yebdeü'l-halka sümme yuîdüh* — **varlık** |
| **35** | *Yehdî ile'l-hakk* — **yol gösterme** |
...
**Ve bu, sûrenin ح-ك-م hattının orta halkasıdır:** birinci ayette *el-kitâbi'l-**hakîm***, burada *keyfe **tahkümûn***, yüz dokuzuncu ayette *yah**küm**allâhu ve hüve hayru'l-**hâkimîn***. **Üç geçiş, tek kök.**

### إِنَّ ٱلظَّنَّ لَا يُغْنِى مِنَ ٱلْحَقِّ شَيْـًٔا

**Bu cümle Kur'an'da bir kez daha, kelime kelime aynı biçimde geçer: `053-necm.md` 53/28.**
...
**Ve `045-casiye.md`'nin bütün ekseninin bu kelime olduğu orada tablolanmıştı** (45/24 *in hüm illâ yezunnûn*, 45/32 *in nezunnü illâ zannâ*); **`041-fussilet.md` 41/23'te zannın helâk sebebi olarak adlandırılması işlendi;** **`051-zariyat.md` 51/10'da *harrâsûn* (tahminciler) çözümlendi ve orada Yûnus 10/66 anılmıştı.**
...
**Bu meydan okuma dizinde `002-bakara.md` 2/23 ve `052-tur.md` 52/34'te işlendi ve orada Kur'an'daki üç ölçeği tablolanmıştı:** bir söz (Tûr 52/34), on sûre (Hûd 11/13), bir sûre (Bakara 2/23; **Yûnus 10/38**).
...
**`024-nur.md` 24/1'de *sûre* kelimesinin Kur'an'daki kullanımı işlendi;** oraya dayanıyorum.
...
**Ve `002-bakara.md` 2/255'te *ve lâ yuhîtûne bi-şey'in min ilmihî* işlenmişti** — orada da aynı kök, ilmin sınırı için kullanılıyordu. **Oraya dayanıyorum.**
...
**Ve *lemmâ* edatı kaydedilmelidir: *lem*den farklı olarak "henüz olmadı, ama beklenir" bildirir.** **Yani cümle, te'vilin geleceğini ima ediyor.**
...
**Ayrışma cümlesi. Dizinde birçok yerde geçti** (`109-kafirun.md`, `039-zumer.md` 39/15 ve 39/39'da *i'melû … innî âmil*, `028-kasas.md` 28/55). **Oraya dayanıyorum.**
...
**Ve iki ayet arasındaki fark kaydedilmelidir:** dinleme ve bakma **gerçekleşiyor** (*yestemiûne*, *yenzuru*). **Eksik olan sonuç.** Yani sorun ulaşmama değil, ulaştığı yerde karşılık bulmama. **`002-bakara.md` 2/74'te kaydedilen ölçü burada işliyor:** *"mesele bilginin ulaşıp ulaşmadığı değil, ulaştığı yerin onu alıp almadığıdır."*
...
| Ayet | Duyu | Eklenen |
|---|---|---|
| **42** | **Sağırlık** — işitme | *Lâ **ya'kılûn*** — akletmemek |
| **43** | **Körlük** — görme | *Lâ **yubsırûn*** — görmemek |

**Bunu bir dizim gözlemi olarak kaydediyorum:** sağırlığa eklenen şey **akıl**, körlüğe eklenen şey yine **görme**dir. **Yani işitme kaybının telafisi akıl olabilirdi; ayet o kapıyı da kapatıyor.** Bu izahı dilcilerin kaydettiği yönde veriyorum, kesin bir hüküm olarak değil.
...
**`041-fussilet.md` 41/46'da (*ve mâ rabbüke bi-zallâmin li'l-abîd*) aynı ilke işlendi; oraya dayanıyorum.**
...
**وَإِمَّا نُرِيَنَّكَ بَعْضَ ٱلَّذِى نَعِدُهُمْ أَوْ نَتَوَفَّيَنَّكَ** (46) — **cümle `013-rad.md` 13/40 ile neredeyse aynıdır ve orada ayrıntılı işlendi.**
...
**Ve `028-kasas.md` 28/56'da bu sınırın yedi sûrelik tablosu kurulmuştu.** **Yûnus'un o tabloya kattığı ayet doksan dokuzuncu ayettir ve orada ele alacağım.**
...
**وَلِكُلِّ أُمَّةٍ رَّسُولٌ** — **ilke `035-fatir.md` 35/24 (*ve in min ümmetin illâ halâ fîhâ nezîr*) ve `028-kasas.md` 28/59'da işlendi.** **Oraya dayanıyorum.**

**Ve `013-rad.md` 13/7'de (*ve li-külli kavmin hâd*) iki okuma tablolanmıştı.** **Yûnus'taki cümle, orada tercih dayatılmayan birinci okumaya lafzen en yakın olandır: her ümmete gönderilmiş bir elçi.**

**مَتَىٰ هَٰذَا ٱلْوَعْدُ** — **soru `078-nebe.md`'de tablolandı ve orada kaydedilmişti: bu sorular bilgi talebi değildir.** **Oraya dayanıyorum** (Yûnus 10/48 orada anılmıştı).
...
**لِكُلِّ أُمَّةٍ أَجَلٌ** — ***ecel* dizinde birçok yerde işlendi** (`046-ahkaf.md` 46/3, `039-zumer.md` 39/42, `035-fatir.md` 35/45, `031-lokman.md` 31/29, `029-ankebut.md` 29/53, `013-rad.md` 13/2). **Tekrarlamıyorum.**

**Buraya ait olan fark: öteki yerlerde ecel *kâinat* ya da *kişi* içindi; burada *ümmet* için.** **Yani süre, topluluklara da yazılıyor.**

**فَلَا يَسْتَـْٔخِرُونَ سَاعَةً وَلَا يَسْتَقْدِمُونَ** — **iki yön de kapatılıyor: ne geri ne ileri.**
...
**Ve iki ayet arasındaki fark da kaydedilmelidir:** elli birinci ayette suçlama **acele istemek**tir (*küntüm bihî testa'cilûn*); doksan birinci ayette **isyan** (*asayte kablü*). **İki ayrı geçmiş, tek sonuç.**

**بَيَٰتًا أَوْ نَهَارًا** — **ve bu ikili yirmi dördüncü ayetteki *leylen ev nehârâ* ile aynı yapıdadır.**

***Beyât* — ب-ي-ت kökü: geceyi geçirmek. *Beyâten* — gece vakti, uykudayken.** **Kelime, yirmi dördüncü ayetteki *leylen*den daha dardır: yalnız gece değil, *gece uykuda* olma hâli.**
...
**Bu ayet, `034-sebe.md` 34/3'te kurulan tabloda yerini almıştı. Tabloyu oradan alıyorum, çünkü ayetlerden biri burasıdır:**
...
**Fidye sahnesi dizinde işlendi:** **`039-zumer.md` 39/47** (*mâ fi'l-ardı cemîan ve mislehû meah*) **ve `013-rad.md` 13/18.** **Oraya dayanıyorum.**
...
**Ve kaydedilmesi gereken şudur: pişmanlık *var*.** **Sahnenin gösterdiği şey pişmanlığın yokluğu değil, işe yaramaması.** **`039-zumer.md` 39/56-58'de üç mazeret tablolanmıştı** (pişmanlık → sorumluluğu devretme → geri dönme isteği) **ve orada kaydedilmişti: sıra önce pişmanlıktır.** **Yûnus, o sıranın ilk basamağını tek başına veriyor.**
...
**Ve bu, `041-fussilet.md` 41/44'te tam olarak işlenmişti:** *hüve li'llezîne âmenû **hüden ve şifâ'*** — ve orada kaydedilmişti: **"aynı metin, birine yol ve şifa, ötekine ağırlık ve körlük. Metin değişmiyor; aldığı yer değişiyor."** **Oraya dayanıyorum.**
...
**`100-adiyat.md`'de bu ayet *mâ fi's-sudûr* vesilesiyle anılmıştı; oraya dayanıyorum.**

### فَبِذَٰلِكَ فَلْيَفْرَحُوا۟

**ف-ر-ح kökü `040-gafir.md` 40/75'te işlendi** (*ferah* ile *merah* farkı) **ve `013-rad.md` 13/26'da tekrar anıldı.** **Oraya dayanıyorum.**
...
**هُوَ خَيْرٌ مِّمَّا يَجْمَعُونَ** — **karşılaştırma *topladıkları* ile yapılıyor.** **ج-م-ع kökü, biriktirme fiili.** **`104-humeze.md` ve `102-tekasur.md`'de biriktirme meselesi işlendi; oraya dayanıyorum.**
...
**Bunu bir dizim gözlemi olarak kaydediyorum:** otuz altıncı ayette zan **uyulan şey**ti; burada **hesaba dair bir beklenti** olarak soruluyor. **Aynı kelime, iki ayrı işte: biri delil yerine konuyor, öteki sonucu tahmin ediyor.**
...
**Ve `099-zilzal.md` 99/7-8'de terkip amelin ölçüsü olarak işlenmişti; orada bu ayet de anılmıştı. Tablo tamamlanabilir:**
...
**لَا يَعْزُبُ** — **ع-ز-ب kökü `034-sebe.md` 34/3'te çözümlendi:** **uzaklaşmak, ayrı düşmek, gözden kaybolmak.** **Ve orada kaydedilmişti: ayet "bilmez" demiyor, "O'ndan uzak kalmaz" diyor — bilgi bir arama fiili olarak değil, bir *mesafe yokluğu* olarak tarif ediliyor.** **Tekrarlamıyorum.**
...
***Ellezîne âmenû ve kânû yettekūn*** — **iman ettiler ve sakınıyorlardı.**
...
**Terkip dizinde işlendi: `046-ahkaf.md` 46/13 ve `041-fussilet.md` 41/30.**
...
**Ve bu, `041-fussilet.md` 41/31 ile birebir örtüşüyor:** *nahnu evliyâüküm **fi'l-hayâti'd-dünyâ** ve fi'l-âhıra* — "dünya hayatında da âhirette de sizin dostlarınızız." **Ve orada kaydedilmişti: "vaat edilen şey yalnız sonraya ait değil."**

**İki ayet arasındaki lafız ortaklığı kaydedilmelidir ve tamamen metin verisidir:**

| | **Fussilet 41/31** | **Yûnus 10/62-64** |
|---|---|---|
| Kelime | *Evliyâü**küm*** — melekler konuşuyor | *Evliyâ**allâh*** — metin bildiriyor |
...
**لَا تَبْدِيلَ لِكَلِمَٰتِ ٱللَّهِ** — **ve on beşinci ayetteki talep burada kapanıyor.**

**Cümlenin kuruluşu kaydedilmelidir: *lâ* burada cinsi olumsuzlayan *lâ*dır** (`002-bakara.md` 2/256'da aynı yapı işlendi). **Yani "az değişir" değil: *değiştirmenin cinsi* kaldırılıyor.**
...
| Ayet | Kim | Biçim |
|---|---|---|
| **62** | *Evliyâullâh* | *Ve lâ hüm **yahzenûn*** — **haber** |
| **65** | **Peygamber** | *Ve lâ **yahzünke** kavlühüm* — **emir** |

**Aynı kök, üç ayet arayla: biri hüküm biri teselli.** **Bunu bir lafız gözlemi olarak kaydediyorum.**

**Ve terkip `028-kasas.md` 28/56'daki sorumluluk tablosunda yer alıyordu** (`031-lokman.md` 31/23 *fe-lâ yahzünke küfruh*, `035-fatir.md` 35/8 *fe-lâ tezheb nefsüke aleyhim hasarât*). **Oraya dayanıyorum.**
...
**يَخْرُصُونَ** — **خ-ر-ص kökü `051-zariyat.md` 51/10'da çözümlendi** (*kutile'l-harrâsûn*) **ve orada bu ayet de anılmıştı.** Oraya dayanıyorum. **Kökün somut anlamı: ağaçtaki hurmayı gözle tahmin ederek ölçmek.** **Yani *hars*, ölçmeden yapılan tahmindir.**
...
**هُوَ ٱلَّذِى جَعَلَ لَكُمُ ٱلَّيْلَ لِتَسْكُنُوا۟ فِيهِ وَٱلنَّهَارَ مُبْصِرًا** (67) — **ayet `040-gafir.md` 40/61 ile kelime kelime aynıdır** ve orada işlendi. **Oraya dayanıyorum.**
...
**سُلْطَٰن** — **kelimenin "delil" anlamı `037-saffat.md` 37/156 ve `040-gafir.md` 40/35, 40/56'da işlendi.** **Oraya dayanıyorum:** *sultân*, Kur'an'da düzenli olarak **dayanak, hüccet** anlamında kullanılır.
...
**`021-enbiya.md` 21/88'de *ve necceynâhu mine'l-ğamm* işlenmişti** — **Yûnus peygamberin kurtarıldığı şey aynı köktendir.** **Bunu bir lafız gözlemi olarak kaydediyorum; iki ayetin birbirine gönderme yaptığı iddiasında değilim.**
...
**فَمَا سَأَلْتُكُم مِّنْ أَجْرٍ** (72) — **elçilerin ortak beyanıdır ve dizinde tablolandı** (`052-tur.md` 52/40, `038-sad.md` 38/86, `071-nuh.md` 71/3 bölümlerinde; Şuarâ 26/109 vd., Hûd 11/29). **Oraya dayanıyorum.**
...
**نَطْبَعُ عَلَىٰ قُلُوبِ ٱلْمُعْتَدِينَ** — **ط-ب-ع kökü:** **mühürlemek, damga basmak.** **Kök dizinde işlendi** (`047-muhammed.md` 47/16, `045-casiye.md` 45/23); **tekrarlamıyorum.**

**Ve dizim kaydedilmelidir: mühürlenen kalpler *mu'tedîn*in kalpleridir** — kök **ع-د-و**: **haddi aşmak.** **Yani mühür, bir vasfın ardından geliyor; vasıfsız bir gruba değil.**
...
| Ayet | Söyleyen | Cümle |
|---|---|---|
| **2** | *el-Kâfirûn* | *İnne hâzâ le-**sâhırun** mübîn* |
| **76** | Fir'avn ve çevresi | *İnne hâzâ le-**sihrun** mübîn* |
...
**وَلَا يُفْلِحُ ٱلسَّٰحِرُونَ** — **ve kök sûrede üç yerde bir hükümle geçiyor:**
...
**لِتَلْفِتَنَا عَمَّا وَجَدْنَا عَلَيْهِ ءَابَآءَنَا** (78) — **ve itirazın gerekçesi *atalar*dır.**
...
**إِنَّ ٱللَّهَ سَيُبْطِلُهُ** — **ve fiil gelecek zamandır: *se-yübtıluhû*.**
...
**إِنَّ ٱللَّهَ لَا يُصْلِحُ عَمَلَ ٱلْمُفْسِدِينَ** — **ve iki zıt kök aynı cümlede: ص-ل-ح ve ف-س-د.**
...
**Ve aracı belirtiliyor: *bi-kelimâtihî* — sözleriyle.** **Ve altmış dördüncü ayette aynı kelime geçmişti: *lâ tebdîle li-**kelimâti**llâh*.** **Sûre içinde doğrulanabilir bir bağdır: değişmeyen söz, hakkı gerçekleştiren araçtır.**
...
**فِتْنَة** — kök **ف-ت-ن**: **altını ateşte eritip saf olanı ayırmak.** **Kelime dizinde işlendi;** çekirdek anlam **sınama, yakıcı ayıklama**dır.
...
**Ve emrin bağlamı kaydedilmelidir: baskı altındaki bir topluluğa verilen ilk talimat *yerleşme* ve *namaz*dır.** **Bunu bir gözlem olarak kaydediyorum:** emirler kaçmak ya da savaşmak değil; **bir mekân kurmak ve düzeni ayakta tutmak.**
...
**ط-م-س kökü dizinde işlendi:** **`077-murselat.md`, `036-yasin.md` 36/66, `054-kamer.md` 54/37 ve `044-duhan.md`'de kök çözümlendi ve orada bu ayet anılmıştı.**
...
**Ve `044-duhan.md`'de bu dua "açık talep" olarak tablolanmıştı.**
...
**فَٱسْتَقِيمَا** — **X. bâb, kök ق-و-م: dosdoğru durmak.** **Kök `046-ahkaf.md` 46/13'te (*sümme'stekāmû*) çözümlendi;** oraya dayanıyorum.
...
**`040-gafir.md` 40/84-85'te** (*fe-lemmâ raev be'senâ kālû âmennâ billâhi vahdehû … fe-lem yekü yenfeuhüm îmânühüm lemmâ raev be'senâ*) **kaydedilenler şunlardı:** iman **delille değil gözle** geliyor; **ve reddedilişin gerekçesi bir kural olarak adlandırılıyor: *sünnetallâhi'lletî kad halet fî ıbâdih*** — süregelen işleyiş, geçmişte de böyle olmuş.

**`039-zumer.md` 39/56-59'da** üç mazeret tablolanmış ve orada kaydedilmişti: **ikinci mazeret ("bana yol gösterilseydi") *belâ kad câetke âyâtî* ile reddediliyor.**
...
**بَغْيًا وَعَدْوًا** — **ve *bağy* kelimesi yirmi üçüncü ayetten geliyor.**
...
| 2 | **Zırhınla / süsünle** — bazı dilciler *beden*i "zırh, göğüslük" anlamıyla da kaydeder; tanınması için |
...
|---|---|---|
| **87** | *Tebevveâ* — **emir** | **Mûsâ ve Hârûn** |
| **93** | *Bevve'nâ* — **haber** | **Allah** |
...
**Ve `045-casiye.md` 45/17'de aynı yapı işlendi** (*fe-me'htelefû illâ min ba'di mâ câehümü'l-ilm*); **`041-fussilet.md` 41/45'te de aynı hat vardı.** **Oraya dayanıyorum.**
...
**وَلَوْ جَآءَتْهُمْ كُلُّ ءَايَةٍ** — **ve yirminci ayetteki mucize talebi burada kapanıyor.**

**Bunu kendi okumam olarak kaydediyorum ve dayanağı iki ayetin konusudur:** yirminci ayette bir **âyet** istenmişti; **doksan yedinci ayet, her türlü âyetin gelmesinin de sonucu değiştirmeyeceğini söylüyor.** **Ve `013-rad.md` 13/31'de aynı mesele işlenmişti** (*ve lev enne kur'ânen süyyirat bihi'l-cibâl*) — orada cümle tamamlanmadan kesiliyordu. **Yûnus'ta cümle tamamlanıyor.**
...
**`037-saffat.md` 37/139-148'de kıssa ayrıntılı çözümlendi** (*ebeka*, *sâheme*, *iltekamehü'l-hût*, *mulîm*, *nebeznâhü bi'l-arâ'*, *yaktîn*, *mieti elfin ev yezîdûn*) **ve `021-enbiya.md` 21/87-88'de üç adlandırma tablolandı.** **Oraya dayanıyorum ve hiçbirini tekrarlamıyorum.**
...
**Bunu kendi okumam olarak kaydediyorum ve dayanağı ayetin kendi cümlesidir:** sûre, bir peygamberin adını taşıyor — **ama o adı, peygamberin başına gelenlerden değil, kavminin verdiği karardan alıyor.** **Ve `068-kalem.md` 68/48 bölümünde bu zaten kaydedilmişti:** *"Yûnus 10/98 kayda değer: Kur'an'da azap gelmeden iman eden tek toplum olarak Yûnus'un kavmi anılır. Yani peygamberin bıraktığı kavim, iman etmiştir."*

### Cümlenin kuruluşu: فَلَوْلَا … إِلَّا
...
**وَمَتَّعْنَٰهُمْ إِلَىٰ حِينٍ** — **ve bu terkip `037-saffat.md` 37/148 ile kelime kelime aynıdır:** *fe-âmenû **fe-metta'nâhüm ilâ hîn**.*
...
**Bunu kendi okumam olarak kaydediyorum:** ayetin gösterdiği şey, **bir topluluğun toptan yön değiştirebilmesidir.** Sûre boyunca hep bireyler anlatıldı — dua eden insan (12), bahçenin sahipleri (24), boğulan hükümdar (90). **Doksan sekizinci ayette özne bir *karye*dir: bir yerleşim, bir topluluk.**
...
**`002-bakara.md` 2/256'da (*lâ ikrâhe fi'd-dîn*) aynı kök işlendi ve orada kaydedilmişti:**

> **"*lâ* burada cinsi olumsuzlayan *lâ*dır. Yani 'bir miktar zorlama olmasın' değil: zorlamanın cinsi kaldırılıyor."** **Ve gerekçe: *kad tebeyyene'r-rüşdü mine'l-ğayy* — "ayrım ortadaysa, zorlamaya gerek yoktur."**
...
**Ve `050-kaf.md` 50/45'te bu ayet zaten anılmıştı** — orada *ve mâ ente aleyhim bi-cebbâr* işlenirken. **Oraya dayanıyorum.**
...
**Ve dizim kaydedilmelidir: hüküm bir vasfa bağlanıyor — *ellezîne lâ ya'kılûn*.** **`013-rad.md` 13/4 ve dizinin genel çizgisinde olduğu gibi: ayet bir gruba değil, bir vasfa hüküm kuruyor.**
...
**قُلِ ٱنظُرُوا۟ مَاذَا فِى ٱلسَّمَٰوَٰتِ وَٱلْأَرْضِ** — **ve emir kaydedilmelidir: *ünzurû* — bakın.**
...
**Bunu kendi okumam olarak kaydediyorum:** ikinci cevap tartışmaya girmiyor. **Şüpheye karşılık verilen şey bir delil değil, bir duruş.** **Ve `013-rad.md` 13/30'da aynı yapı kaydedilmişti: "cevap, tartışmaya girmeden bir konum bildirimiyle veriliyor."**

**ٱلَّذِى يَتَوَفَّىٰكُمْ** — **ve Allah, bu cümlede bir sıfatla anılıyor: "canınızı alan".**
...
**أَقِمْ وَجْهَكَ لِلدِّينِ حَنِيفًا** (105) — ***hanîf* kökü ح-ن-ف: eğilmek, bir yöne meyletmek;** ve Kur'an'da **her türlü ortak koşmadan uzak, tek yöne yönelmiş** anlamında kullanılır. **Kök `030-rum.md` 30/30'da işlendi; oraya dayanıyorum.**
...
**Yüz yedinci ayet, `035-fatir.md` 35/2 ile aynı yapıdadır.**
...
|---|---|---|
| Birinci yön | *Mâ **yeftahi**llâhu li'n-nâsi min rahmetin fe-lâ **mümsike** lehâ* | *Ve in yemseske'llâhu bi-**durrin** fe-lâ **kâşife** lehû illâ hû* |
...
**Ve Yûnus'un eklediği kaydedilmelidir: burada iki durum *zarar* ve *hayır*dır — yani muhatabın yaşadığı iki hâl.** **Fâtır'da konu rahmetin kendisiydi; Yûnus'ta kişinin başına gelen.**
...
**رَآدَّ** — kök **ر-د-د**: geri çevirmek. *Râdd* — geri çevirecek olan. **Ve `035-fatir.md` 35/2'deki *mürsil* ile aynı konumdadır: araya girecek olan.**
...
| Yön | Fiil | Edat |
|---|---|---|
| Doğru yol | *Yehtedî* | ***Li-**nefsih* — **lehine** |
| Sapma | *Yadıllu* | ***Aleyhâ*** — **aleyhine** |
...
**وَمَآ أَنَا۠ عَلَيْكُم بِوَكِيلٍ** — **ve terkip `039-zumer.md` 39/41 ile aynıdır** (*ve mâ ente aleyhim bi-vekîl*).
...
**و-ك-ل kökü:** **bir işi başkasına havale etmek.** *Vekîl* — **işi üstlenen, sonucundan sorumlu olan.**
...
**وَهُوَ خَيْرُ ٱلْحَٰكِمِينَ** — **ve sûrenin ح-ك-م hattı burada kapanıyor.**

| Ayet | İfade | Ne |
|---|---|---|
| **1** | *Tilke âyâtü'l-kitâbi'l-**hakîm*** | **Kitabın sıfatı** |
| **35** | *Fe-mâ leküm keyfe **tahkümûn*** | **Muhatabın hüküm vermesi** |
| **109** | *Hattâ **yahküme**llâh, ve hüve hayru'l-**hâkimîn*** | **Hükmün sahibi** |
...
| Konu | Dayanılan yer |
|---|---|
| *Tedbîr* ve د-ب-ر kökü | `032-secde.md` 32/5, `047-muhammed.md` 47/24, `079-naziat.md` |
| Şefaat kaydı | `002-bakara.md` 2/255, `039-zumer.md` 39/43-44 |
| *Sitte eyyâm* ve *istivâ* sınırı | `050-kaf.md` 50/38, `041-fussilet.md` 41/9-12, `032-secde.md` 32/4, `020-taha.md` 20/5 |
| *İtmi'nân* | `002-bakara.md` 2/260, `013-rad.md` 13/28 |
| *El-hamdü lillâhi rabbi'l-âlemîn* | `001-fatiha.md` 1/1, `039-zumer.md` 39/75 |
| Cezanın ertelenmesi | `035-fatir.md` 35/45, `018-kehf.md` 18/58 |
| Darda dua eden insan portresi | `039-zumer.md` 39/8 ve 39/49, `041-fussilet.md` 41/49-51 |
| *Mâ yûhâ ileyy* | `046-ahkaf.md` 46/9 |
| Denizde ihlâs sahnesi | `029-ankebut.md` 29/65, `031-lokman.md` 31/32 |
| Su-bitki-kuruma temsili | `018-kehf.md` 18/45, `039-zumer.md` 39/21, `056-vakia.md` 56/65 |
| Bahçe sahibinin zannı | `018-kehf.md` 18/35-36 |
| *Zuhruf* | `043-zuhruf.md` 43/35 |
| *İnne'z-zanne lâ yuğnî mine'l-hakk* | `053-necm.md` 53/28, `045-casiye.md`, `041-fussilet.md` 41/23 |
| *Hüden ve şifâ'* | `041-fussilet.md` 41/44 |
| *Lâ ya'zübü* ve *miskāle zerra* | `034-sebe.md` 34/3, `099-zilzal.md` 99/7-8 |
| *Lâ havfün aleyhim ve lâ hüm yahzenûn* | `046-ahkaf.md` 46/13, `041-fussilet.md` 41/30 |
| Son anda gelen iman | `039-zumer.md` 39/54-59, `040-gafir.md` 40/84-85 |
| Yûnus kıssası | `037-saffat.md` 37/139-148, `021-enbiya.md` 21/87-88, `068-kalem.md` 68/48-50 |
| Sorumluluk sınırı | `028-kasas.md` 28/56, `002-bakara.md` 2/256, `050-kaf.md` 50/45, `013-rad.md` 13/40 |
| *İmsâk / irsâl* simetrisi | `035-fatir.md` 35/2 |
| Peygambere yemin ettirilen üç yer | `034-sebe.md` 34/3, `064-tegabun.md` 64/7 |
| *Sûre getirin* meydan okuması | `002-bakara.md` 2/23, `052-tur.md` 52/34, `024-nur.md` |
| *Itmis alâ emvâlihim* | `077-murselat.md`, `036-yasin.md` 36/66, `044-duhan.md`, `054-kamer.md` |
| *Hüsnâ ve ziyâde* | `075-kiyame.md`, `080-abese.md` 80/40-41, `092-leyl.md` |
...
| 3 | *İstivâ* ifadesinin anlaşılma biçimi (*tefvîz* / *te'vîl*); *el-emr*in anlamı |
| 22 | *Ve cerayne bihim*teki iltifatın gerekçesi |
...
| Ayet | Sınır |
|---|---|
| **3** | *Sitte eyyâm* ve *istivâ*dan modern kozmolojiye gidilmez; `050-kaf.md` ve `041-fussilet.md`'deki sınır korunur |
...
| **61** | *Zerre*den atom çıkarılmaz; `034-sebe.md` 34/3'teki sınır korunur |
| **92** | *Bi-bedenike*den çağdaş arkeolojiye, belirli bir mumyaya ya da tarihî şahsa dair sonuç çıkarılmaz |
