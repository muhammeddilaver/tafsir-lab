...
| **ن-ق-م** | *fe'**ntekamnâ** minhüm* (25) | *innâ minhüm **müntekımûn*** (41), *i**ntekamnâ** minhüm* (55) |
| **ص-د-د** | *le-**yasuddûnehüm** ani's-sebîl* (37) | *minhü **yasıddûn*** (57), *velâ **yasuddennekümü**'ş-şeytân* (62) |
| **س-ء-ل** | *ve **yüs'elûn*** (19) | *ve sevfe **tüs'elûn*** (44), *ve**s'el** men erselnâ* (45) |
...
"Hâ-mîm. Apaçık kitaba andolsun. Biz onu, **akledesiniz diye**, Arapça bir Kur'an yaptık. O, katımızdaki **ana kitapta**dır; gerçekten yücedir, hikmetlidir."
...
**ب-ي-ن** kökü ve *mübîn* kelimesi dizinde birçok yerde işlendi (`046-ahkaf.md` 46/7-8'de *beyyinât* / *mübîn* karşıtlığı üzerinden ayrıntılı olarak). Kökün çekirdeği: **iki şeyin arasının açılması, aralık** — ve buradan **ayırt edilir hâle gelmek, açık olmak.**

***Mübîn* IV. bâbdan ism-i fâildir ve Arapçada bu kalıp hem geçişli hem geçişsiz okunabilir:**

| Okuma | Anlam |
|---|---|
| Geçişsiz | **Kendisi açık olan** kitap |
| Geçişli | **Açıklayan**, açığa çıkaran kitap |
...
**Kök `056-vakia.md`'de 56/37 (*uruben*) bahsinde çözümlendi; oraya dayanıyorum ve tekrarlamıyorum.** Orada kaydedilen çekirdek şuydu:
...
**ع-ق-ل** kökü dizinde işlendi (`067-mulk.md`, `049-hucurat.md`, `059-hasr.md`, `089-fecr.md`). **Kökün somut anlamı: bağlamak, tutmak, salıvermemek.** *İkāl* — devenin dizine vurulan bağ. Akıl, kökün resminde **kişiyi tutan, dağılmasını engelleyen** şeydir.
...
**Kök dizinde iki yerde geçti** (`062-cuma.md` 62/2 — *ümmî*; `075-kiyame.md` 75/12 — *emâmehû*). **Kıyâme bahsinde kökün ailesi şöyle verilmişti; oraya dayanıyorum:**
...
**Yani *ümm*, kökün resminde "doğuran" değil, öncelikle *dönülen*dir.** Kollar ondan ayrılır ve ona bağlanır.
...
**Bu ifadenin *levh-i mahfûz* ile aynı şey olup olmadığı klasik tefsirlerde tartışılmıştır.** `085-buruc.md`'de bu meseleye şöyle bir kayıt düşülmüştü ve aynı kaydı koruyorum:
...
**ع-ل-و** kökü dizinde birçok yerde işlendi (`087-ala.md`, `079-naziat.md`, `088-gasiye.md`); çekirdeği **yükseklik**tir. **ح-ك-م** kökü de işlendi (`002-bakara.md` 2/269'da *hakeme* — gem ile ilişkisi üzerinden; `046-ahkaf.md` 46/2). **Çekirdeği: engelleyip yerinde tutmak.**
...
### أَفَنَضْرِبُ … صَفْحًا — deyimin yapısı

**Fiil *daraba*dır ve burada bir deyim içindedir.** Dilciler bu terkibi şöyle açıklar: *darabe anhü* — bir şeyi birinden **uzaklaştırmak, çevirmek, geri çekmek.**

***Safhan* kelimesinin cümledeki işi üzerinde iki okuma nakledilir:**

| Okuma | *Safhan*ın işi | Anlam |
|---|---|---|
...
**İkisi de aynı kapıya çıkıyor ve tercih dayatmıyorum.** Kaydedilecek olan, fiilin *daraba* seçilmiş olmasıdır: **kelime bir el hareketi taşır — bir şeyi eliyle yana itmek.** Sûrenin ilk *daraba*sı budur; sonra 17. ve 57. ayetlerde kök geri dönecek.

### ٱلذِّكْر — hatırlatmanın kendisi

**ذ-ك-ر** kökü dizinde geniş olarak işlendi (`050-kaf.md`, `087-ala.md`, `074-muddessir.md`). **Çekirdeği: anmak, hatırda tutmak; ve dille anmak.**
...
**`049-hucurat.md` 49/11'de alay konusu ayrıntılı işlendi; oraya dayanıyorum.** Orada kaydedilen tespit şuydu: alay eden kişi karşısındakini kendi eğlencesinin **aracı** hâline getirir — özne olmaktan çıkarır.

### أَشَدَّ مِنْهُم بَطْشًا

**بَطْش — kök ب-ط-ش.** Kök `050-kaf.md`'de ve `085-buruc.md`'de işlendi. **Çekirdeği: bir şeyi şiddetle ve hızla kavramak, yakalayıp çarpmak.**

**`085-buruc.md`'de bu ayet zaten anılmıştı:** *"Onlardan daha güçlü olanları (eşedde minhüm batşen) helâk ettik"* (Zuhruf 43/8).
...
**Bu, Kur'an'ın Mekke muhataplarına karşı en sık kullandığı yöntemlerden biridir ve `078-nebe.md`'de şöyle kaydedilmişti:**
...
**Kök `078-nebe.md`'de ayrıntılı çözümlendi** (*mihâden*, Nebe' 78/6) ve `074-muddessir.md` ile `051-zariyat.md`'de de geçti. **Oradaki tespiti tekrarlamıyorum; özeti şudur:**
...
**س-ب-ل** kökü dizinde işlendi (`076-insan.md`, `047-muhammed.md`, `063-munafikun.md`). **Çekirdeği: uzanan, akan yol.** *Sebîl* — yol; *sâbil* — akan yağmur.
...
**Kök dizinde çok yerde işlendi** (`087-ala.md`, `056-vakia.md`, `067-mulk.md`, `054-kamer.md`, `089-fecr.md` ve başkaları). **Çekirdeği: ölçmek, miktarını belirlemek, biçmek.**
...
**İki dal arasındaki bağ dilcilerce şöyle kurulur:** ölüm bir **dürülme**, diriliş bir **açılma**dır. Türkçedeki "neşretmek" (yaymak, yayımlamak) aynı köktendir.

**Kelime bu ayette IV. bâbdadır (*enşera*)** ve dilciler bu kalıbın "diriltmek" anlamında yerleştiğini kaydeder. **Tekvîr 81/10'da *ve ize's-suhufü nüşiret* (sayfalar açıldığında) ifadesinde kökün birinci dalı işliyordu; `081-tekvir.md`'de işlendi.**

### كَذَٰلِكَ تُخْرَجُونَ — cümlenin yaptığı sıçrama

**"İşte siz de böyle çıkarılacaksınız."**

**Bu cümle, `050-kaf.md`'de aynı yapının işlendiği yerle birebir aynı işi yapıyor** ve orada şöyle kaydedilmişti: bitkinin topraktan çıkışı anlatılır, sonra hiç ara vermeden *kezâlike'l-hurûc* denir. **Kāf bahsinde bu, sûrenin delil biçimi olarak tespit edilmişti: delil bir kıyas değil, bir görüntü.**
...
**`071-nuh.md`'de bu ayet zaten anılmıştı** (*"ölü toprağa can verdik… işte diriliş de böyledir"* örnekleri arasında); oradaki bağı burada tamamlıyorum.
...
**فُلْك** — kök **ف-ل-ك**: dilcilerin verdiği çekirdek **yuvarlaklık ve dönme**dir. *Felek* — gök cismi yörüngesi; *felke* — iğ başındaki yuvarlak ağırlık. **Gemi için kullanılması, dilcilerce geminin yuvarlak gövdesi ya da suda dönerek/salınarak gitmesi üzerinden açıklanır; bu izahı nakledildiği şekliyle aktarıyorum.**
...
| Ayet | Nimet | Alan |
|---|---|---|
| 10 | Yer — beşik | **Durulan** |
| 10 | Yollar | **Gidilen** |
| 11 | Ölçülü su | **İçilen, bitiren** |
| 12 | Gemi ve hayvan | **Taşınan** |
...
**Bağlaçlar kaydedilmelidir.** Birinciden ikinciye geçiş ***sümme*** ile: Arapçada *sümme* **arada bir mesafe** bildirir (bu ayrım `046-ahkaf.md` 46/13'te işlenmişti). **Yani binmek ile anmak arasında bir aralık var: önce oturulur, yerleşilir, sonra anılır.**
...
**Ve bu ortaklık, otuz üçüncü ayette geçecek *meâric* (merdivenler) kelimesiyle birlikte düşünülebilir:** `070-mearic.md`'de kaydedildiği gibi, *meâric* Kur'an'da somut anlamıyla yalnız bu sûrede geçiyor. **Sûre insanın çıkma ve gitme araçlarına dikkat çeken bir sûredir.**

### سَخَّرَ — kök: س-خ-ر

**Kök `069-hakka.md`'de ve `049-hucurat.md`'de işlendi; oraya dayanıyorum.** Hakka bahsinde kaydedilen tespit şuydu:
...
**Kök `050-kaf.md`'de iki yerde işlendi** (*karîn*, 50/23 ve 50/27; ve *karn*, 50/36). **Oradaki tespit şuydu:**
...
"O'na, kullarından **bir parça** yakıştırdılar. Gerçekten insan **apaçık bir nankör**dür. Yoksa O, yarattıklarından kendine **kızlar** edindi de **oğulları** size mi ayırdı?"
...
**Geçişin sertliği kaydedilmelidir ve kendi okumam olarak veriyorum:** iki ayet arasındaki mesafe bir kelimedir. **Tesbih ile isnad yan yana konuyor** — ve aradaki bağlaç yalnızca *vâv*dır.
...
**Ve bu, `112-ihlas.md`'de işlenen çizgiyle aynıdır.** Orada kaydedilmişti:
...
***Em* burada *münkatıa*dır: "yoksa…" — ve dilciler bunu *bel + hemze* (aksine + inkâr sorusu) ile karşılar.**
...
**Aynı mantık Necm 53/21-22'de daha keskin bir cümleyle geçer:** *e-lekümü'z-zekeru ve lehü'l-ünsâ · tilke izen kısmetün dîzâ* — "erkek sizin, dişi O'nun mu? Bu, insafsız bir paylaştırmadır." **`053-necm.md`'de işlendi.**
...
**Bu ayet `081-tekvir.md`'de işlendi ve orada Nahl'in fiili (*desse* — gizlice toprağa sokmak) ile Tekvîr'in kelimesi (*mev'ûde* — üstüne ağırlık bindirilmiş) karşılaştırılmıştı.** Oraya dayanıyorum ve karşılaştırmayı üç sütuna çıkarıyorum:
...
**Üç ayet aynı olguyu üç ayrı yerden tutuyor.** Tekvîr'de kurbanın kendisi konuşturuluyordu — ve `081-tekvir.md`'de kaydedildiği gibi, soru faile değil kurbana yöneltilmişti. **Zuhruf'ta ise ne fail ne kurban muhatap: muhatap, *aynı şeyi hem küçümseyip hem yukarıya yakıştıran* zihindir.**

### بُشِّرَ — müjdelenmek

**ب-ش-ر** kökü dizinde işlendi (`002-bakara.md`, `080-abese.md`, `054-kamer.md` ve başkaları). **Çekirdeği: derinin dış yüzü (*beşere*); ve buradan, bir haberin yüze vurması.**
...
**Yani ayet, olayı adlandırırken tarafını belli ediyor:** olan şey bir **müjde**dir. Tepkinin yanlışlığı, fiilin seçilmesiyle daha cümlenin başında işaretlenmiş oluyor.

**Nahl 16/58'de aynı kök başka bir yerde döner: *min sûi mâ büşşira bih* — "müjdelendiği şeyin kötülüğünden".** Orada kelime bir kez daha, ama bu sefer kişinin kendi değerlendirmesiyle birlikte geliyor. **`080-abese.md`'de kökün "yüze vuran haber" çekirdeği işlenmişti; burada yüze vuran şey kararma oluyor.**

### ظَلَّ وَجْهُهُۥ مُسْوَدًّا

**ظَلَّ** — bir fiil değil, bir *nâkıs* fiildir: **gündüz boyunca bir hâlde olmak, o hâlde kalmak.** Dilciler *zalle*nin gündüzle, *bâte*nin geceyle ilişkili olduğunu kaydeder.
...
**Kök `068-kalem.md` 68/48'de (*mekzûm*) ayrıntılı işlendi; oraya dayanıyorum.** Orada kaydedilen şuydu:
...
**Kök `076-insan.md` 76/21'de (*hullû esâvira min fıdda*) işlendi.** **Anlamı: süs, takı, ziynet.** *Huliyy* — takı; *tahliye* — süsleme.

***Yüneşşeü* — ن-ش-أ kökünden, II. bâb, meçhul: "yetiştirilir".** **Kök `056-vakia.md` 56/35'te ayrıntılı işlendi;** orada kaydedilen çekirdek şuydu: *"yoktan var etmeyi değil, var olan bir zeminden yukarı doğru kurulmayı anlatır."*
...
**`081-tekvir.md`'de bu konuda düşülen kayıt burada da geçerlidir ve tekrarlıyorum:** cinsiyete dayalı seçici uygulamalar, doğum öncesi tespit imkânlarının yaygınlaştığı bazı ülkelerde ölçülebilir nüfus dengesizlikleri üretmiş ve yasal düzenlemelere konu olmuştur. **Bunu bir "ayetin bilimsel mucizesi" olarak değil, ayetin tarif ettiği saikin tarihe gömülmediğinin kaydı olarak yazıyorum.**
...
**ع-ب-د** kökü dizinde işlendi (`109-kafirun.md`, `053-necm.md`, `051-zariyat.md` ve başkaları). **Çekirdeğinde *boyun eğme* ve *yolun ayakla düzleşmesi* (*tarîkun muabbed*) resmi vardır.**
...
**Bu, sûrenin sonundaki 80. ayetle aynı hatta durur:** *ve rusülünâ ledeyhim yektübûn* — "elçilerimiz yanlarında yazıyorlar". **Aynı kök (ك-ت-ب), aynı iş: söylenenin kayda geçmesi.** `082-infitar.md` ve `083-mutaffifin.md`'de kayıt meselesi işlendi; oraya dayanıyorum.
...
**Bu, Ahkāf sûresinin yöntemiyle birebir aynıdır.** `046-ahkaf.md` 46/4'te kaydedilmişti: *"ayet iki tür delil istiyor: gözlem ve nakil. Üçüncü bir yol bırakmıyor."* **Zuhruf'ta da aynı iki yol soruluyor: tanık oldunuz mu (gözlem — 19), kitap mı verildi (nakil — 21).**
...
**`051-zariyat.md`'de bu kelime işlendi ve orada bu ayet de anılmıştı:** *"Onlar ancak tahmin yürütüyorlar."* (En'âm 6/116; Yûnus 10/66; Zuhruf 43/20). **Oraya dayanıyorum.**
...
***Bel* (idrâb edatı) `050-kaf.md` 50/2'de işlendi; oraya dayanıyorum.** Orada iki işlevi kaydedilmişti: öncekini iptal etmek, ya da öncekini bırakıp asıl meseleye atlamak. **Burada ikincisidir.**

**Dizim şöyle ilerledi:**

| Ayet | Aranan dayanak | Sonuç |
|---|---|---|
| 19 | Tanıklık — gözlem | Yok |
| 21 | Kitap — nakil | Yok |
| 22 | **Asıl dayanak** | **Atalar** |
...
### عَلَىٰٓ أُمَّةٍ — *ümmet* kelimesinin buradaki anlamı
...
**أ-م-م kökü** — `075-kiyame.md`'de kaydedildiği gibi ailesi şudur: *ümm* (anne, asıl), *ümmet* (topluluk), *imâm* (önde duran), *emâm* (ön taraf). **Ortak fikir: öncelik, önde olma, kaynakta olma.**
...
|---|---|
| **Din** | İnanç düzeni |
| **Millet / yol** | İzlenen çizgi |
| **Tarîka, sünnet** | Tutulan usul |
...
**Kök `046-ahkaf.md` 46/4'te (*esârate min ilm* — bilgi kalıntısı) çözümlendi; oraya dayanıyorum ve tekrarlamıyorum.** Orada kaydedilen şuydu:

> *"أ-ث-ر kökü: **iz, geride kalan işaret.** *Eser* — ayak izi, kalıntı, nakledilen haber."*

**Kök ayrıca `079-naziat.md`, `087-ala.md` ve `059-hasr.md`'de geçti; `079-naziat.md`'de bu ayet zaten anılmıştı.**
...
**Kendi okumam olarak kaydediyorum, dayanağı iki kelimenin kalıp ve bağlam farkıdır:** Ahkāf'ta istenen şey bir **bilgi** kırıntısıydı; Zuhruf'ta öne sürülen şey bir **iz**dir — yani içeriği olmayan, yalnız yönü olan bir işaret.
...
| Ayet | Kalıp | Tekrarlanan şey |
|---|---|---|
| 7 | *mâ ye'tîhim … illâ … yestehziûn* | **Alay** |
| 23 | *mâ erselnâ … illâ kâle* | **Atalar cümlesi** |
...
**Kök `056-vakia.md` 56/45'te çözümlendi; oraya dayanıyorum.** Orada kaydedilen şuydu:
...
1. **Miras, en çok mirası olanı ilgilendirir.** Mevcut düzenin sürmesinden en fazla çıkarı olan, mevcut düzende en yüksekte duranlardır.
2. **Ve sûre, sekiz ayet sonra bunu açıkça söyleyecek:** *lev lâ nüzzile hâze'l-kur'ânü alâ racülin mine'l-karyeteyni azîm* (31) — itiraz yine bir mevki ölçüsünden gelecek.
...
**Bu, `002-bakara.md` 2/170'te kaydedilen cevapla aynı hattadır** ve `071-nuh.md`'de de anılmıştı: *"Ya ataları hiçbir şey akletmiyor ve doğru yolu bulamıyor idiyseler?"* (Bakara 2/170).
...
**Bu, `046-ahkaf.md` 46/11'de kaydedilen tespitle aynıdır:** *"itiraz bir delil değil, bir sıralama varsayımıdır."* **Burada da öyle: cevap bir değerlendirme değil, bir konum ilanıdır.**
...
**Bu, `046-ahkaf.md`'de kaydedilen "delil mesafesi" tespitiyle aynı yerdedir: delil, muhatabın en yakınından alınıyor.**

### بَرَآء — kök: ب-ر-أ

**Kök dizinde birkaç yerde geçti** (`060-mumtehine.md`, `057-hadid.md`, `059-hasr.md`, `082-infitar.md`, `054-kamer.md`). **Burada kelimenin özel kalıbı üzerinde duruyorum.**
...
|---|---|---|
| 1 | *Mimmâ ta'büdûn*a bağlı (muttasıl) | Taptıklarınızdan uzağım — **beni yaratan hariç** (yani onlar O'na da tapıyordu) |
...
**Kök dizinde birçok yerde geçti** (`067-mulk.md`, `073-muzzemmil.md`, `084-insikak.md`, `082-infitar.md`, `054-kamer.md`, `077-murselat.md`). **Burada kökün çekirdeğini bir kez daha, bu ayetin gerektirdiği yönüyle açıyorum.**

**Kökün somut anlamı: yarmak, çatlatmak, bir şeyi boydan boya açmak.**

- **فَطَرَ النَّابُ** — devenin dişi eti yarıp çıktı.
- **اِنْفَطَرَتِ السَّمَاء** — gök yarıldı (İnfitâr 82/1 — `082-infitar.md`'de işlendi).
...
**Ve bu, dördüncü ayetle de bağlanıyor:** orada kitabın *ümmü'l-kitâb*ta — yani **asılda** olduğu söylenmişti. **Sûre, hem kitap hem insan için aynı şeyi soruyor: dayanağın asılda mı, yoksa izlerde mi?**
...
***Hâ* zamiri neye dönüyor?** Müfessirler burada iki okuma nakleder:
...
**"Büyü" ithamı Kur'an'da en sık kaydedilen itirazdır** ve `046-ahkaf.md` 46/7'de işlendi. Orada kaydedilen tespit şuydu: *"Karşı taraf 'anlamıyoruz' demiyor; etkiyi kabul edip kaynağı reddediyor."*

**Ve `054-kamer.md`'de aynı tavır kaydedilmişti** (*sihrun müstemirr*).

**Buraya Zuhruf'a özgü olanı ekliyorum:** burada "büyü" denen şey, ayetin kendi adlandırmasıyla **el-hakk**tır. Cümle şöyle kuruluyor: *ve lemmâ câehümü'l-**hakku** kālû hâzâ **sihrun***.
...
| Cümle | Öne alınan | Ne |
|---|---|---|
| *E-**hüm** yaksimûn* | **Onlar** | Soru — reddedilen |
| ***Nahnu** kasemnâ* | **Biz** | Cevap — sabitlenen |

**Aynı kalıp, arka arkaya, zıt öznelerle.** Bu doğrulanabilir bir dizim verisidir.

**`052-tur.md`'de bu ayet anılmıştı:** *"Rabbinin rahmetini onlar mı paylaştırıyor?"* (Zuhruf 43/32). **Oradaki bağı burada tamamlıyorum.**
...
**Bu, `046-ahkaf.md`'de kaydedilen "delil mesafesi" ilkesiyle aynıdır.**

**مَعِيشَة — kök ع-ي-ش:** yaşamak, geçinmek. *Maîşet* — geçim vasıtası, yaşamayı sağlayan şey. **Kelime *hayât*tan farklıdır: *hayât* canlılık, *maîşet* geçinme aracı.**
...
**Ve dikkat: cümle *fi'l-hayâti'd-dünyâ* kaydının hemen ardından geliyor.** Yani sıralanan şey **dünya hayatındaki** geçimdir. **Ahkāf 46/19'da başka bir *derecât* geçiyordu ve o başkaydı:** *ve li-küllin derecâtün mimmâ amilû* — **yapılana göre dereceler.** `046-ahkaf.md`'de işlendi.

**İki *derecât*ı tabloya koyuyorum, çünkü karışması sûrenin ana meselesini bozar:**
...
**Kelime س-خ-ر kökündendir ve kökün iki dalı `069-hakka.md` ile `049-hucurat.md`'de işlenmişti:** boyun eğdirme / hizmete koşma, ve alay etme. **Ortak çekirdek orada şöyle verilmişti:** *"birini kendi iradesi dışında bir konuma sokmak."*
...
| Taraf | Kelime | Fiil |
|---|---|---|
| Bir yanda | *rahmetü rabbik* | — (verilen) |
| Öte yanda | *mimmâ **yecmeûn*** | **Topladıkları** |

**ج-م-ع** kökü: toplamak, bir araya getirmek. **Ve fiilin muzâri gelmesi süreklilik bildiriyor: "toplayıp durdukları".**

**Kelime seçimi kaydedilmeye değer ve `104-humeze.md`'ye bağlanıyor.** Orada *cemea mâlen ve addedeh* (mal toplayıp saydı) işlenmişti ve kaydedilen tespit şuydu: **değerin, taşıyanın konumundan okunması.**
...
**Cümle bir *lev lâ* şartıyla açılıyor — bu kez "niçin olmadı" anlamında değil, "olmasaydı" anlamında (imtinâ' *lev lâ*sı): bir şeyin varlığı, başka bir şeyin olmamasına sebep olmuş.**
...
**`070-mearic.md`'de bu ayet zaten anılmıştı ve orada şu kaydedilmişti:**
...
**سُرُر** — *serîr*in çoğulu. Kök **س-ر-ر**: dilciler bu kelimeyi *sürûr* (sevinç) ile aynı kökten sayar ve bağı şöyle kurar: **serîr, sevinç ve rahatlık yeridir.**

**Kelime `056-vakia.md`'de cennet tasvirinde geçmişti** (*alâ süririn mevdûne*). **Ve bu, bloğun en dikkat çekici yönüne götürüyor.**
...
| *le-mâ* (şeddesiz) | لَمَا | *İn* tekid (*inne*nin hafifletilmişi) + *lâm* + *mâ* = "…gerçekten şudur" |
...
**Bunu kendi okumam olarak kaydediyorum, dayanağı ifadenin gereksiz görünen konumudur:** blok boyunca sayılan şeyler **evlerde**ydi — tavan, merdiven, kapı, koltuk. **Kapanış cümlesi başka bir yer adı veriyor: "Rabbinin katında".** İki mekân yan yana konuyor.

**و-ق-ي** kökü: korumak, bir şeyin önüne siper koymak. **Takvâ, kökün resminde *kendini bir şeyle korumak*tır.** Kök dizinde birçok yerde işlendi.

**Ve kelimenin seçimi ölçü meselesini kapatıyor:** blok boyunca insanları ayıran ölçüler sayıldı — servet, mevki, soy, görünüş. **Kapanışta sayılan ölçü bir *fiil*dir: sakınmak.** Verilmiş değil, yapılmış bir şey.
...
**Kök `079-naziat.md`'de *aşiyye* (akşam) olarak geçmişti; oraya dayanıyorum.** **Buraya kökün göze bakan dalını açıyorum, çünkü bu ayette işleyen odur.**
...
**Kök `050-kaf.md` 50/23 ve 50/27'de ayrıntılı işlendi; oraya dayanıyorum ve tekrarlamıyorum.** Orada kaydedilen: *"Somut anlamı: iki şeyi birbirine bağlamak, eşlemek. Karn — boynuz; ve nesil."*
...
> **Şart:** *men ya'şü an zikri'r-rahmân* — **insanın fiili**
> **Cevap:** *nukayyıd lehû şeytânen* — **sonuç**
...
**Birinci okuma çoğunluğun okumasıdır ve Kur'an'ın kendi içinde desteklenir:** Rahmân 55/17'de *rabbü'l-**meşrikayni** ve rabbü'l-**mağribeyn*** geçer (`055-rahman.md`'de işlendi) — orada dört uç ayrı ayrı sayılmıştır.
...
| Edat | Ayet | Ne |
|---|---|---|
| *lealle* | 3, 10, 28, 48 | **Umulan** — hâlâ mümkün |
| *leyte* | 38 | **Temenni edilen** — artık imkânsız |
...
| Görüş | Kim söylüyor |
|---|---|
| 1 | **Kişinin kendisi** — sözünün devamı |
| 2 | **Metin** — kişinin sözüne eklenen hüküm |
...
**ش-ر-ك** kökü: ortak olmak, bir şeyde pay sahibi olmak. **Kök dizinde işlendi** (`072-cin.md`, `073-muzzemmil.md`, `068-kalem.md`).
...
**Bunu bir dizim gözlemi olarak kaydediyorum ve `046-ahkaf.md` 46/35'te kaydedilen tespitle bağlıyorum:** orada sûre kendi işini tek kelimeyle sınırlamıştı — *belâğ* (ulaştırma). **Burada aynı sınır, bir soruyla çiziliyor.**
...
**ص-ر-ط** kökü: dilcilerin verdiği çekirdek, **geniş ve açık yol**dur; kelimenin *serata* (yutmak) ile ilişkisi kaydedilir — yolun, üzerinden gideni içine alması. **Kök `001-fatiha.md`'de işlendi.**

**ق-و-م** kökü ve *istikāme* `046-ahkaf.md` 46/13'te işlendi: **eğrilmeden devam etmek.**
...
| 2 | **Anılma, şeref** | Bu Kur'an sana ve kavmine bir **şan**dır (kelimenin *zikr* = anılmak anlamıyla) |
...
**Fiil yine *ceale*dir ve sûrede beşinci kez geliyor.** **Bu kez soru kipinde ve olumsuz cevap bekliyor.**
...
**ر-ح-م** kökü dizinde işlendi (`060-mumtehine.md`, `090-beled.md`, `049-hucurat.md` ve başkaları); çekirdeği **rahim** (döl yatağı) ile ilişkilidir: kuşatan, içinde büyüten.
...
**Arapçada bu bilinen bir kullanımdır ve dilciler bunu kaydeder: benzer şeyler birbirinin *ah* / *uht*u sayılır.**
...
| 2 | **O toplumda âlim/bilge anlamında bir unvan** | Bazı müfessirler, *sihr*in o devirde ileri bilgi için de kullanıldığını nakleder |
...
**Mushafta bu kelime sonundaki elif olmadan yazılır: أَيُّهَ.** `055-rahman.md`'de bu kaydedilmişti:
...
**Bunu bir kelime gözlemi olarak kaydediyorum:** söz vermek, kökün resminde **eğirmek**; sözden dönmek **çözmek**tir. **Yapılan iş geri alınıyor.**
...
> *"Sizi hor görülen bir sudan (*min mâin **mehîn***) yaratmadık mı?"* (Mürselât 77/20 — `077-murselat.md`'de işlendi)
> *"Sonra onun soyunu, dayanıksız bir suyun özünden yaptı."* (Secde 32/8'de de aynı kelime geçer.)
...
**Ve istenen şey bir delil değil, bir *nişan*dır.**
...
**Kendi okumam olarak kaydediyorum ve dayanağı bu dört geçiştir:** sûre altını yasaklamıyor ve kötülemiyor. **Yaptığı tek şey, altının *delil* olarak kullanılmasını göstermek.** Otuz beşinci ayette altın bir *metâ*dır; elli üçüncü ayette bir kanıt yerine konuyor. **Sûrenin itirazı buna.**
...
**Kök `101-karia.md` 101/8'de işlendi ve orada bu ayet zaten anılmıştı; `079-naziat.md`'de de anıldı.** Kāria bahsinde kaydedilen şuydu:
...
**`046-ahkaf.md` 46/35'te sûrenin kapanışında aynı kelime geçmişti ve orada kaydedilen şuydu:** *"kapanış, helâkin ölçüsünü fiile bağlıyor: fâsikūn — sınırdan çıkanlar. Bir soy, bir kavim ya da bir topluluk adı anılmıyor; vasıf anılıyor."*

**Aynı çizgiyi burada da koruyorum: hüküm, itaat edenlerin kim olduğuna değil, ne yaptığına bağlanıyor.**

### ءَاسَفُونَا — kök: أ-س-ف

**Kökün anlamı: şiddetli üzüntü; ve öfke.** Dilciler kökün iki dalını da kaydeder ve şöyle açıklar: *esef*, **karşılığı olmayan bir kayıp karşısındaki hâl**dir — bu hâl, alta bakınca üzüntü, üste bakınca öfkedir.
...
| Okuma | *Selefen* ne |
|---|---|
| 1 | **Öncü** — sonrakilerin önünde giden bir grup |
| 2 | **Geçmiş** — geride kalmış bir örnek |
...
| Ayet | İfade | Yön |
|---|---|---|
| 8 | *ve medâ **meselü'l-evvelîn*** | **Geçmişe** bakıyor |
| 56 | *ve **meselen li'l-âhirîn*** | **Geleceğe** bırakılıyor |
...
### ضُرِبَ … مَثَلًا — ve sûrenin ض-ر-ب örüntüsü
...
**Tercih dayatmıyorum.** Ama şu kaydedilebilir: **her iki okuyuşta da anlatılan şey bir tartışma değil, bir *tepki*dir** — ya gürültü ya sırt dönme. **İkisi de muhtevaya girmiyor.**
...
***Yahlüfûn* — خ-ل-ف kökünden: birinin ardından gelmek, yerine geçmek.** *Halîfe* aynı köktendir.
...
**`079-naziat.md`'de bu sınır işlenmişti ve orada bu sûre anılmıştı:** *"Saat'in bilgisi O'nun katındadır."* (Lokmân 31/34; Zuhruf 43/85; Fussilet 41/47). **Oraya dayanıyorum.**
...
**Kelimenin resmi kaydedilmeye değer:** şüphe, kökün resminde **bir şeyi elde tutup ovalamak**tır — bırakmamak, ama sonuca da varmamak.
...
**Ve `046-ahkaf.md` 46/35'te kaydedilen tespitle aynı hattadır:** orada sûre kendi işini *belâğ* (ulaştırma) diye sınırlamıştı. **Burada da bir sınır var ve sınırı koyan, işi yapanın kendisi.**
...
**ظ-ل-م** kökü: dilcilerin verdiği çekirdek **karanlık**tır; ve **bir şeyi yerinden başka bir yere koymak.** **Kök dizinde işlendi.**
...
**`046-ahkaf.md` 46/6'da benzeri işlenmişti:** *ve izâ huşira'n-nâsü kânû lehüm a'dâen ve kânû bi-ibâdetihim kâfirîn* — "insanlar toplandığında, onlara düşman olurlar ve onların kendilerine tapmasını inkâr ederler."
...
**Bu terkip Kur'an'da birçok yerde geçer ve `046-ahkaf.md` 46/13'te işlendi. Oradaki tespiti tekrarlıyorum:**
...
**Bunu bir gramer gözlemi olarak kaydediyorum ve `046-ahkaf.md` 46/13 ile bağlıyorum:** orada *kālû rabbüne'llâhü **sümme**'stekāmû* vardı ve şu kaydedilmişti: *"söz ile istikamet arasında bir zaman var: söylemek bir anda olur, doğru durmak sürer."*
...
| Ayet | İfade | Yüzde ne var |
|---|---|---|
| 17 | *zalle **vechühû müsveddâ*** | **Kararma** |
| 70 | ***tuhberûn*** | **Sevincin izi** |
...
**`056-vakia.md`'de bu ayet zaten anılmıştı ve orada şu kaydedilmişti:**
...
**أَكْوَاب** — *kûb*un çoğulu. **`088-gasiye.md` 88/14'te işlendi ve orada bu ayet anılmıştı:**
...
**Kök dizinde işlendi** (`057-hadid.md`, `089-fecr.md`). **Anlamı: mirasa konmak, birinden kalanı almak.**
...
**Bu ayrım kaydedilmeye değer ve `056-vakia.md`'de cennet tasvirlerinde işlenmişti:** *fâkihe*, temel gıda değildir. **Ekmek değil, meyvedir** — yani ihtiyaç değil, fazlalık.

**Ve bu, sûrenin ölçü meselesine bağlanıyor — kendi okumam olarak kaydediyorum:** cennet tasvirinde sayılan şeylerin çoğu **fazlalık**tır: altın tabak, süs, meyve. **Sûre bu fazlalıkları dünyada bir *metâ* diye adlandırmıştı (35).** Burada aynı cinsten şeyler, süresi belirtilmeden veriliyor: *ve entüm fîhâ **hâlidûn***.
...
**Ve kökün çekirdeği burada anlamlıdır:** dilciler *zulm*ü **"bir şeyi ait olduğu yerden başka bir yere koymak"** diye tarif eder.
...
**Bu ayet dizinde birkaç yerde anıldı** (`087-ala.md`, `069-hakka.md`, `074-muddessir.md`); burada ilk kez ayrıntılı işleniyor.

### يَٰمَٰلِكُ — isim mi, sıfat mı?

**Kelime bir görevlinin adı olarak anlaşılır ve klasik tefsirlerin çoğunda böyle nakledilir.**

**م-ل-ك** kökü: bir şeye sahip olmak, üzerinde tasarruf yetkisi bulunmak. **Kök `067-mulk.md`'de ayrıntılı işlendi ve orada bu sûrenin 85. ayeti de anılmıştı.**

**Kur'an'ın cehennem görevlileri hakkında verdiği diğer bilgiler `074-muddessir.md`'de toplanmıştı ve orada bu ayet anılmıştı:**
...
| Yer | Kelime | Ne |
|---|---|---|
| İsrâ 17/106 | *alâ mükşin* | **Ağır ağır, acele etmeden** okumak |
| Zuhruf 43/77 | *mâkisûn* | **Kalıcı, bekleyen** |
...
**`087-ala.md`'de de bu ayet anılmıştı** — orada *lâ yemûtü fîhâ ve lâ yahyâ* (A'lâ 87/13) ile birlikte. **İki ayet aynı şeyi söylüyor: ne bitiyor ne sürüyor.**
...
**ك-ر-ه** kökü `002-bakara.md` 2/216 ve 2/256'da, ayrıca `046-ahkaf.md` 46/15'te işlendi: **hoşlanmama, zorluk, ağırlık.**
...
**Bu, Kur'an'da bilinen bir üsluptur — `046-ahkaf.md`'de *ifk* kelimesinin sahibine geri verilmesi işlenmişti** (46/11 ve 46/28), **ve `068-kalem.md`, `086-tarik.md` gibi yerlerde benzeri kaydedilmişti** (*yekîdûne keyden ve ekîdü keydâ*).
...
**ن-ج-و** kökünün somut anlamı: **yüksekçe yer, tepe; ve bir şeyi ayırıp kurtarmak.** *Necât* (kurtuluş) aynı köktendir. **Dilciler *necvâ*yı şöyle açıklar: iki kişinin, ötekilerden ayrılıp kendilerine ait bir alanda konuşması** — yani sözü ayırmak.

**Kök `058-mucadele.md`'de işlendi** (orada *necvâ* konusu ayrıntılı ele alınmıştı); oraya dayanıyorum.
...
| Ayet | Yazılan |
|---|---|
| 19 | **Tanıklık** — açıkça söylenen |
| 80 | **Gizli ve fısıltı** — açıkça söylenmeyen |
...
**Kayıt meselesi `082-infitar.md` (*kirâmen kâtibîn*) ve `083-mutaffifin.md` (*kitâbün merkūm*) bölümlerinde ayrıntılı işlendi; oraya dayanıyorum ve tekrarlamıyorum. `050-kaf.md` 50/17-18'de (*rakîbun atîd*) da aynı konu ele alınmıştı.**
...
> **Şart:** *in kâne li'r-rahmâni veledün* — "Rahmân'ın bir çocuğu olsaydı"
> **Cevap:** *fe-ene evvelü'l-âbidîn* — "ilk kulluk eden ben olurdum"
...
**Üçüncü okumanın dayanağı bir kelime meselesidir ve nakledilmelidir:** dilciler *abide* (عَبِدَ) fiilinin, *abede*den (kulluk etmek) farklı olarak **"öfkelenmek, tiksinmek, reddetmek"** anlamına geldiğini kaydeder. **Bu okumaya göre *âbid*, "reddeden" demektir.** **Bu izahı nakledildiği şekliyle aktarıyorum; dilciler arasında yaygın olmadığı da kaydedilir.**
...
***Rabbi'l-arş* — ve arş kelimesi Kur'an'da birçok yerde geçer.** **`085-buruc.md`'de arş meselesine bir kayıt düşülmüştü ve aynı kaydı koruyorum: keyfiyeti hakkında tasvir üretilmez.**
...
**Aynı emir Tûr 52/45'te ve Meâric 70/42'de de geçer; `052-tur.md` ve `070-mearic.md`'de işlendi.**
...
**`067-mulk.md` bu fiille açılır (*tebâreke'llezî bi-yedihi'l-mülk*) ve orada bu sûrenin 85. ayeti anılmıştı:**
...
**`079-naziat.md`'de bu ayet anılmıştı; oraya dayanıyorum.**
...
**Bu, `085-buruc.md` ve `074-muddessir.md` gibi yerlerde işlenen çizgiyle uyumludur; oraya dayanıyorum.**

**ش-ف-ع** kökünün somut anlamı: **çift yapmak, tek olanı ikilemek.** *Şef'* — çift (karşıtı *vitr* — tek; Fecr 89/3'te geçer ve `089-fecr.md`'de işlendi). **Yani şefaat, kökün resminde: yalnız olanın yanına birinin katılması.**
...
| Şart | İfade |
|---|---|
| 1 | *Şehide bi'l-hakk* — **hakka tanıklık** |
| 2 | *Ve hüm ya'lemûn* — **bilerek** |
...
**Kök `046-ahkaf.md` 46/11'de işlendi; oraya dayanıyorum.** Orada kaydedilen şuydu:
...
| Okuyuş | Yazılış | İ'rab |
|---|---|---|
| *kîlihî* (esreli) | وَقِيلِهِ | Mecrûr |
| *kîlehû* (üstünlü) | وَقِيلَهُ | Mansûb |
...
|---|---|---|
| *kîlihî* (mecrûr) | Seksen beşinci ayetteki *ilmü's-sâah*a atıf — "ve onun sözünün bilgisi O'nun katındadır" | Söz de kayda geçmiş |
...
| *kîlehû* (mansûb) | Seksen üçüncü ayetteki *zerhüm*e — "ve onun sözünü bırak" | Zayıf bulunur |
...
| 53 | **Altın bilezik — ihtişam** | Fir'avn | Cevap verilmiyor; *zuhruf*un fiyatı 35'te söylenmişti |
...
- *Ezvâc* kelimesinin kapsamı (12) ve *ezvâcüküm*ün kimler olduğu (70).
