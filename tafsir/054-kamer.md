...
Elli beş ayet. Mekkî. Adını ilk ayetin son kelimesinden alıyor: **ٱلْقَمَر** — ay.
...
> *"Andolsun ki biz Kur'an'ı öğüt alınsın diye kolaylaştırdık; öğüt alan var mı?"* — **17, 22, 32, 40**

> **فَكَيْفَ كَانَ عَذَابِى وَنُذُرِ**
> *"Azabım ve uyarılarım nasılmış!"* — **16, 18, 21, 30**
...
**Ayet sayısı** yaygın sayımda elli beştir.

---

## Sûrenin sesi — elli beş ayet, tek harf
...
Aşağıda elli beş ayetin son kelimesi sırayla verilmiştir:
...
Bunun iki sonucu var ve ikisi de metnin okunuşunu belirliyor.
...
**Bir kayıt.** Fasıla birliğinden bir mucize iddiası çıkarmıyorum. Fasıla uyumu Arap şiirinde ve secide yaygın bir tekniktir; Kur'an'da da her sûrede bir düzeni vardır. Buradaki kayda değer olan **istisnasızlığı** ve **sûrenin uzunluğu**dur; ikisi de metnin sayılabilir verisidir.
...
## Nakaratların yerleşimi — tam tablo
...
Şimdi farkların ne anlama geldiğine bakalım.

**Bir — biri parmakla gösteriyor, öteki odayı tarıyor.**
...
Ve bu gramer farkı, iki sûrenin konusuyla birebir uyumludur:
...
**İki — Rahmân yalnız sorar, Kamer önce haber verir.**
...
**Üç — iki sûre de cevap vermiyor, ama sessizlikleri farklı.**
...
Ama iki sessizlik aynı türden değil:
...
Yani Rahmân'ın sorusu **kapatan** bir sorudur, Kamer'inki **açık bırakan.**

**Dört — ceza nakaratı Rahmân'da yoktur.**
...
Kamer bu işi ikiye bölmüş: nimet dili yok, uyarı dili var; ve uyarının kendi cümlesi var.
...
## Sûrede "göndermek" fiili — bir dizim gözlemi

Sûrede **ر-س-ل** kökü dört kez geçiyor ve dördünde de fiil ya da ism-i fâil biçimindedir:
...
**Dördünde de gönderilen şey bir peygamber değil.** Üçü azap vasıtası, biri imtihan vasıtası.
...
Bu kelime sûrede on bir kez geçer:
...
**Kelimenin iki okunuşu vardır ve ikisi de dilcilerce kaydedilir:**

- **نُذُر**, *nezîr*in çoğulu: **uyarıcılar** — yani peygamberler.
- **نُذُر**, *nüzr* / *nezîr*in masdar anlamlı çoğulu: **uyarılar** — yani getirilen haberler.
...
*İkterabeti's-sâatü ve'nşakka'l-kamer*
...
> *"Allah'ın **emri geldi**; onu acele istemeyin."* (Nahl 16/1) — emir henüz gelmemiştir.
> *"Ve **sûra üflendi**."* (Zümer 39/68) — kıyamet sahnesi mâzî ile.
> *"Cehennem o gün **getirildi**."* (Fecr 89/23) — Fecr bölümünde işlendi.
...
*Ve in yerav âyeten yu'ridû ve yekûlû sihrun müstemirr*
"Bir işaret görseler yüz çevirirler ve 'sürüp giden bir büyü' derler."

### Dizim — şart cümlesi ve zaman

Cümle bir şart yapısıdır: *in* (eğer) + *yerav* (görseler) → *yu'ridû* (yüz çevirirler) + *yekûlû* (derler). Üç fiil de **muzâri** (geniş/şimdiki zaman) ve **meczûm**dur.
...
Yani sûrenin başında bir grup insan gördükleri şeye *sihr* diyor; otuz iki ayet sonra bir başka grup *sehar*de kurtuluyor. Aynı üç harf.
...
**İkinci okuma: "geçici, geçip gidecek."** Kökün asıl anlamı olan *mürûr*dan: bu da geçer. Bu okumada söyledikleri şu olur: *"Bu, geçip gidecek bir büyü — üstünde durmaya değmez."*
...
Ayetteki biçim ism-i fâildir: *müstekırr* — **yerine oturan.**
...
Kelimenin gramerdeki konumu hakkında birden fazla çözüm nakledilir:
...
Anlam bakımından üçü de aynı yere çıkar ve tercih gerektirmez.
...
**Kendi okumam olarak kaydediyorum:** aynı kök, bir yerde onları geri çevirmesi gereken şeyi, bir yerde onların geri çevirdiği kişiyi adlandırıyor. *Zecr* gelmiştir; ama *zecr*e uğrayan haberin sahibi olmuştur. Bu tersine dönüş kökün kendisinde duruyor; ondan çıkardığım sonuç benimdir.

### حِكْمَةٌۢ بَٰلِغَةٌ — erişmiş hikmet
...
*Bâliğa* ism-i fâildir: **varmış, erişmiş, son noktasına ulaşmış.**

İki ayrı okuma yapılabilir ve ikisi de kaydedilmiştir:
...
Kelimenin i'râbı hakkında da birden çok çözüm var; en yaygın olanı, önceki ayetteki *mâ*dan bedel ya da mahzuf bir mübtedânın haberi sayılmasıdır (*hiye hikmetün bâliğa*). Anlam değişmiyor.

### فَمَا تُغْنِ ٱلنُّذُرُ — uyarılar fayda vermiyor
...
Cümlenin başındaki **مَا** üzerinde bir ihtilaf vardır:
...
İki okuma da aynı sonuca varır; ikincisi daha keskindir. **Tercih dayatmıyorum.**
...
Dört ve beşinci ayetler, sûrenin geri kalanı için bir **çerçeve** kuruyor ve bu çerçeve mantıksaldır:

1. Haber geldi (*câehüm*).
2. Haberde caydırıcılık vardı (*fîhi müzdecer*).
3. Hikmet tamdı ve ulaşmıştı (*hikmetün bâliğa*).
4. Fayda vermedi (*fe-mâ tuğni'n-nüzür*).
...
- **مُنْكَر** — hoş görülmeyen, reddedilen. Ve tam karşıtı **مَعْرُوف**tur — "bilinen, tanınan". **Yani Arapçada iyilik "tanınan", kötülük "tanınmayan" diye adlandırılır.**
...
*Huşşe'an ebsâruhüm yahrucûne mine'l-ecdâsi ke-ennehüm cerâdün münteşir*
"Gözleri düşkün halde kabirlerden çıkarlar; sanki yayılmış çekirgelerdir."
...
Kelimenin i'râbı **hâl**dir (durum bildiren mansûb): "…halde çıkarlar".
...
- **ٱلنُّشُور** — **diriliş.** *"Dirilip toplanma O'nadır"* (Mülk 67/15).
...
1. **Hız** — yürümek değil, seğirtmek.
2. **Boynun uzaması** — gövde öne eğilmiş, baş ileri.
3. **Gözün sabitlenmesi** — bakış bir noktadan ayrılmıyor.

Kur'an'daki üç geçişi de aynı sahnededir:

- *"Başlarını dikmiş, **koşarak** gelirler; gözleri kendilerine dönmez"* (İbrâhîm 14/43 — *mühti'îne mukni'î ruûsihim*).
- **Kamer 54/8** — burası.
- *"Sana doğru **boyun uzatarak** koşuşuyorlar"* (Meâric 70/36).
...
Bu izahı naklediyorum; kaynaklarda yaygın olarak bu şekilde birleştirilir.

### يَقُولُ ٱلْكَٰفِرُونَ — kâfirler der
...
*Kezzebet kablehüm kavmü Nûhın fe-kezzebû abdenâ ve kâlû mecnûnun ve'zducir*
"Onlardan önce Nûh kavmi de yalanladı. Kulumuzu yalanladılar, 'delidir' dediler ve o kovuldu."
...
*Fe-deâ Rabbehû ennî mağlûbun fe'ntasır*
"Bunun üzerine Rabbine dua etti: 'Ben yenildim; sen yardım et.'"
...
**Kendi okumam olarak kaydediyorum:** bu, bir şikâyet değil bir **durum bildirimi**dir. Cümlede suçlama yok, sıfat yok, hüküm yok. Yalnız bir bilanço var — ve bilançoyu veren, kaybeden taraftır.
...
*Fe-fetahnâ ebvâbe's-semâi bi-mâin münhemir — ve feccerne'l-arda uyûnen fe'lteka'l-mâü alâ emrin kad kudir*
"Biz de göğün kapılarını boşalan bir suyla açtık. Yeri de kaynaklar halinde fışkırttık. Su, takdir edilmiş bir iş üzerine buluştu."
...
*Ve hamelnâhu alâ zâti elvâhın ve düsür — tecrî bi-a'yüninâ cezâen li-men kâne küfir*
"Onu, levhalar ve çiviler sahibi (bir şey) üzerinde taşıdık. Gözlerimizin önünde akıp gidiyordu — inkâr edilmiş olana bir karşılık olarak."
...
|---|---|---|
| **Çiviler** | *Disâr*ın çoğulu: tahtaları birbirine tutturan çivi/mıh | Kökün "saplamak" anlamıyla doğrudan uyumlu; çoğunluğun görüşü |
...
Fiil **muzâri**dir — çevresindeki mâzî fiillerin arasında. Yani sahne bir an için **canlı** hale geliyor: taşıdık… akıyor. Aynı teknik yirminci ayette de kullanılacak (*tenziu'n-nâs* — söküp atıyor).
...
**جَزَاء** — **Kök: ج-ز-ي.** Karşılık, denk gelen ödeme. Kelime hem mükâfat hem ceza için kullanılır; nötrdür. İ'râbı **mef'ûl-i lieclih**tir (sebep bildiren mansûb): "…karşılığı olarak".

**كُفِرَ** — **Kök: ك-ف-ر**, ve fiil **edilgen**dir: "inkâr edildi / nankörlük edildi."
...
*Velekad tereknâhâ âyeten fehel min müddekir*
"Andolsun ki onu bir işaret olarak bıraktık. Öğüt alan var mı?"
...
1. **Bırakılmış bir işarete** (15) — geçmişte olan bir olayın kalıntısı.
2. **Kolaylaştırılmış bir Kur'an'a** (17, 22, 32, 40) — elde duran metin.
3. **Helâk edilmiş benzerlere** (51) — muhatabın kendi türünden olanlar.
...
**مُدَّكِر**, aslında **مُذْتَكِر**dir: **إِفْتِعَال** (VIII. bâb) kalıbının ism-i fâili, *iddekera* fiilinden.

Ses değişimi iki adımda olmuştur:
1. Kökün ذ harfi ile bâbın ت harfi yan yana geliyor: *müzteki r*.
2. İki harf birbirine uyum sağlıyor ve **د**de birleşiyor (idgâm): **müddekir.**
...
**VIII. bâbın anlam katkısı ise şudur:** kalıp burada **çaba ve edinme** bildirir. *Zekera* hatırlamaktır; *iddekera* **öğüt edinmek, ders çıkarmak**tır. Yani kelime pasif bir hatırlamayı değil, **bir şeyi alıp kendine mal etmeyi** anlatıyor.
...
**مِنْ** — bu *min*, dilcilerin **istiğrâk** ya da **zâide** dediği türdendir. Hâkka bölümünde aynı yapı işlenmişti (*fe-hel terâ lehüm min bâkıye*). İşlevi **olumsuzluğu ya da sorguyu tam kapsayıcı hale getirmek**tir: "herhangi biri", "bir tek kişi bile".
...
*Fe-keyfe kâne azâbî ve nüzür*
"Azabım ve uyarılarım nasılmış!"

### İkinci nakaratın ilk geçişi

Bu cümle sûrede altı kez geçer; dördü bu kalıpta (16, 18, 21, 30), ikisi emir kipinde (37, 39).

### كَيْفَ — soru mu değil mi

**كَيْفَ** hal soran bir edattır: "nasıl". Ama burada gerçek bir bilgi sorusu değildir.

Dilciler bu tür soruları ayrı adlandırır:
...
### عَذَابِى وَنُذُرِ — iki kelime, tek sahip

*Azâbî* — "benim azabım". *Nüzür* — yukarıda fasıla bölümünde gösterildiği gibi aslı *nüzürî*dir; **yâ fasıla için düşmüştür.**

Yani cümlede aynı sahip iki kez var, ama bir kez görünüyor.
...
*Velekad yessernâ'l-Kur'âne li'z-zikri fehel min müddekir*
"Andolsun ki biz Kur'an'ı öğüt için kolaylaştırdık. Öğüt alan var mı?"

### Birinci nakaratın tam hali

Bu cümle sûrede **dört kez** birebir aynı biçimde geçer: 17, 22, 32, 40. Ve dördü de bir kıssanın sonundadır.

### وَلَقَدْ — üç öğeli pekiştirme

Cümle üç pekiştirme öğesiyle açılıyor:

1. **وَ** — burada *vâv-ı kasem* (yemin vâvı) sayılır; cümlenin bir yemin cevabı olduğunu gösterir.
2. **لَ** — *lâm-ı cevâb*: yeminin cevabına giren pekiştirme lâmı.
3. **قَدْ** — mâzî fiilin başında **tahkîk** (kesinleştirme).
...
**Bir — kalıp.** Fiil **II. bâb** (*tef'îl*) kalıbındadır: *yessera*. Bu bâbın burada taşıdığı yük **ta'diye** (geçişli kılma) ve **tedrîc**dir: bir şeyi kolay **hale getirmek.** Yani Kur'an zaten kolay değildi de sonradan kolaylaştırıldı demek değil; **kolay olarak verildi** demektir.
...
**Bunu bir tercih olarak değil, bir bağlam gözlemi olarak kaydediyorum; bağlayıcı değildir.**

### Cümlenin mantığı

Nakaratın iki yarısı bir mantık kurar ve bu mantık sûrenin dört kıssasını da kapsar:

**Birinci yarı bir iddia:** araç kolaylaştırıldı.
**İkinci yarı bir soru:** peki kullanan var mı?
...
*Kezzebet Âdün fe-keyfe kâne azâbî ve nüzür*
"Âd yalanladı. Azabım ve uyarılarım nasılmış!"

### Kıssanın nakaratla açılması
...
*İnnâ erselnâ aleyhim rîhan sarsaran fî yevmi nahsin müstemirr*
"Biz onların üzerine, uğursuzluğu sürüp giden bir günde, uğultulu bir rüzgâr gönderdik."
...
### فِى يَوْمِ نَحْسٍ مُّسْتَمِرّ — üzerinde durulması gereken kayıt
...
**Ve burada bir kayıt zorunludur.**
...
**Bir.** Ayet bir gün türünden söz etmiyor; **belirli bir olayın günü**nden söz ediyor. *Nahs*, o günü onlar için ne olduğuyla niteliyor: o gün onlar için kötüye gitti. Cümle bir takvim bilgisi değil, bir olay tarifidir.

**İki.** Kur'an, olayları günlere ve alâmetlere bağlama tavrını açıkça reddeder:

> *"Onlara bir iyilik geldiğinde 'bu bizimdir' derler; bir kötülük isabet ettiğinde ise Mûsâ ve beraberindekileri **uğursuz sayarlar**. İyi bilin ki onların **uğuru Allah katındadır**."* (A'râf 7/131)
> *"Dediler ki: 'Biz sizin yüzünüzden **uğursuzluğa uğradık**.' Onlar dedi ki: '**Uğursuzluğunuz kendinizdendir**.'"* (Yâsîn 36/18-19)

İki ayette de kullanılan kök **ط-ي-ر**dır (*tıyera* — kuş uçurarak fal bakmak) ve iki ayette de **reddedilen tavır aynıdır**: olayın sebebini dışarıdaki bir işarete bağlamak.
...
İkinci ayette işlenen kelime burada geri geliyor ve tam olarak aynı biçimde: **مُّسْتَمِرّ.**
...
*Tenziu'n-nâse ke-ennehüm a'câzü nahlin munkair*
"İnsanları söküp atıyordu; sanki kökünden sökülmüş hurma kütükleriydiler."
...
Fiil **muzâri**dir, çevresindeki mâzî fiillerin arasında: *erselnâ* (mâzî) — *tenziu* (muzâri).
...
Ayet *"onları"* demiyor, *"insanları"* diyor — ve kelime **belirli**dir (*en-nâs*).
...
*Fe-keyfe kâne azâbî ve nüzür — velekad yessernâ'l-Kur'âne li'z-zikri fehel min müddekir*

### İki nakarat arka arkaya

Yirmi bir ve yirmi ikinci ayetler, iki nakaratın **peş peşe** geldiği yerlerden biridir. Sûrede bu durum iki kez vardır:

| Yer | Sıra |
|---|---|
| **16-17** | Ceza nakaratı → Zikir nakaratı |
| **21-22** | Ceza nakaratı → Zikir nakaratı |

Ve iki yerde de sıra aynı: **önce ceza, sonra zikir.**
...
*Kezzebet Semûdü bi'n-nüzür*
"Semûd, uyarıları yalanladı."

### Kalıptaki değişiklik

Önceki iki kıssada fiilin bir nesnesi yoktu: *kezzebet Âdün* — "Âd yalanladı", sadece. Burada nesne var: *bi'n-nüzür*.

Ve bu nesne, kalan iki kıssada da tekrarlanacak:
...
**Sıralamada bir yoğunlaşma var ve kendi okumam olarak kaydediyorum.** İlk iki kıssada fiil nesnesizdir — yalanlama mutlak olarak konuyor. Üç ve dördüncüde nesne *nüzür*dür. Beşincide nesne *âyâtinâ küllihâ* — "âyetlerimizin hepsi". Yani yalanlamanın kapsamı liste ilerledikçe genişletiliyor.
...
Bu dağılım doğruysa, *bi'n-nüzür* ifadesinde *nüzür*ün "uyarılar" (şey) anlamı öne çıkar; "uyarıcılar" (kişi) anlamı ikinci planda kalır. Bu bir yatkınlıktır, hüküm değil.
...
*Fe-kâlû e-beşeran minnâ vâhiden nettebiuhû innâ izen le-fî dalâlin ve su'ur — e-ülkıye'z-zikru aleyhi min beyninâ bel hüve kezzâbün eşir*
"Dediler ki: 'İçimizden bir tek insana mı uyacağız? O zaman biz sapkınlık ve çılgınlık içinde oluruz. Zikir, aramızdan ona mı verildi? Hayır, o yalancının teki, şımarığın biri.'"
...
**Sâd 38/8 ile karşılaştırma kayda değer**, çünkü lafız neredeyse birebir aynıdır ve orada söz **Mekkeliler**e aittir, burada **Semûd**a. Yani sûre, muhataplarına, kendi cümlelerini bir önceki kavmin ağzından dinletiyor.
...
| **Alevli ateş** | *Saîr*in çoğulu. Kur'an *saîr*i cehennem için kullanır (Mülk 67/5, 67/10-11) |
...
> *"Suçlular sapkınlık ve alevler içindedir."* (54/47)
...
Fiil **edilgen**dir: *ülkıye* — "atıldı". Fâil söylenmiyor.
...
*Se-ya'lemûne ğaden meni'l-kezzâbü'l-eşir*
"Yarın kimin yalancı ve şımarık olduğunu bilecekler."
...
### مُرْسِلُوا۟ ٱلنَّاقَةِ — kalıp

**مُرْسِلُو** ism-i fâildir ve **izâfe** halindedir; bu yüzden çoğul nûn'u düşmüştür (aslı *mürsilûne*).
...
**Ve nâkanın "fitne" diye adlandırılması üzerinde durmaya değer.**
...
### فَٱرْتَقِبْ ve وَٱصْطَبِرْ — iki emir, iki VIII. bâb
...
Kur'an sabır emrini genellikle **I. bâb**la verir: **ٱصْبِرْ** (*ısbir*) — Kalem 68/48, Müzzemmil 73/10, Meâric 70/5, Rûm 30/60.

Burada ise **VIII. bâb** kullanılmış: **ٱصْطَبِرْ** (*ıstabir*). Aslı *ıstabir*dir; ت harfi, kökün ص harfinin etkisiyle **ط**ya dönüşmüştür.

VIII. bâbın anlam katkısı **çaba ve edinme**dir. *Sabera* sabretmektir; *ıstabera* **sabrı üstlenmek, sabrı iş edinmek**tir.

**Ve bu kalıp Kur'an'da yalnız üç yerde geçer:**
...
Bu gözlemi kaydediyorum; üç ayetin lafızları doğrulanabilir.
...
## Su nöbeti — 54/28 üzerine

Bu ayet, sûrenin somut hukuk meselesini taşıyan tek ayetidir ve ayrı ele alınmayı hak ediyor.

### نَبِّئْهُمْ — haber ver

**Kök: ن-ب-أ**, dördüncü ayette işlendi: *nebe'*, önemi olan haberdir.

Fiil **II. bâb** (*tef'îl*) emir kipindedir: *nebbi'* — "onlara bildir". Yani Sâlih'e verilen görev, kural koymak değil **kuralı tebliğ etmek**tir.

### قِسْمَةٌ بَيْنَهُمْ — "aralarında bir paylaşımdır"
...
### كُلُّ شِرْبٍ مُّحْتَضَرٌ — her nöbette hazır bulunulur

**شِرْب — Kök: ش-ر-ب.** Ve burada bir kelime ayrımı var, dikkat gerektiriyor:
...
Ayetteki biçim **شِرْب**dir: eylem değil, **hak.** Yani "her içiş" değil, **"her sıra"**.
...
### Su hakkının paylaşımı — çöl hukukunun somut meselesi
...
**Ve düzenin niteliği önemlidir.** Ayet suyun deveye ait olduğunu söylemiyor; **paylaşıldığını** söylüyor. Yani konulan şey bir yasak değil, bir **sıra**dır. Kimse susuz bırakılmıyor; herkes kendi gününde alıyor.
...
Bu ayetin bugüne bakan yanı, "deve" kelimesinde değil **"kısmet" kelimesindedir.**
...
Bu son cümle benim okumamdır ve bir hüküm değil, bir gözlem olarak kaydediyorum.

---

## 54/29 — فَنَادَوْا۟ صَاحِبَهُمْ فَتَعَاطَىٰ فَعَقَرَ

*Fe-nâdev sâhıbehüm fe-teâtâ fe-akar*
"Arkadaşlarını çağırdılar; o da uzanıp aldı ve kesti."

### Üç fâ, üç fiil

Ayet dört kelimeden ibaret ve üçü fiil. Üçü de **فَ** ile bağlanmış.
...
Ve bu hız, on dokuzuncu ayetteki *sarsar* rüzgârının uzunluğuyla (yedi gece sekiz gün) ve otuz birinci ayetteki *sayha*nın anlıklığıyla birlikte okunmalıdır. Sûre süreleri farklı farklı veriyor; burada süre **sıfıra yakın.**

Bunu kendi okumam olarak kaydediyorum; *fâ* bağlacının işlevi ise gramer verisidir.
...
**Ve ayetin en dikkat çekici yanı burada: fiilin nesnesi söylenmiyor.**

*Teâtâ* — neyi aldı? Ayet söylemiyor. Kılıcı mı, bıçağı mı, başka bir aleti mi — hiçbiri yazmıyor.

Klasik tefsirlerde nesnenin "kılıç" olduğu yaygın olarak takdir edilir. **Kur'an bunu söylemiyor.**
...
Bu son cümle benim okumamdır; kökün iki anlamı dil verisidir.

### فَعَقَرَ — kesti

**Kök: ع-ق-ر.** Somut anlamı üzerinde durulmalı, çünkü Türkçe "kesmek" karşılığı kelimeyi tam vermiyor.

*Akara'l-beîra* — **deveyi ayaklarından vurdu, bacağını kesip yere düşürdü.** Yani *akr*, önce **hareket kabiliyetini yok etmek**tir; boğazlamak (*zebh*) ayrı bir kelimedir.
...
Bu bir tercih tespitidir; ayet numaraları doğrulanabilir.

---

## 54/31 — إِنَّآ أَرْسَلْنَا عَلَيْهِمْ صَيْحَةً وَٰحِدَةً فَكَانُوا۟ كَهَشِيمِ ٱلْمُحْتَظِرِ

*İnnâ erselnâ aleyhim sayhaten vâhideten fe-kânû ke-heşîmi'l-muhtazır*
"Biz onlara tek bir çığlık gönderdik; ağıl sahibinin kuru çalısına döndüler."
...
**Bir dil notu.** Peygamber'in dedelerinden birinin adı olan **Hâşim**in bu kökten geldiği ve *"tirit için ekmeği doğrayan"* anlamında verildiği yaygın olarak nakledilir. Bunu bir dil bilgisi olarak naklediyorum; ayetin anlamıyla ilgisi yoktur ve kurmuyorum.

**ٱلْمُحْتَظِر — Kök: ح-ظ-ر.** Ve bu kelime asıl anahtardır.

*Hazera* — **etrafını çevirmek, çit çekmek, kapatmak.** Ve buradan:
...
**Bir — kelimenin biçimi.** *Hâsıb* bir **ism-i fâil**dir: "çakıl savuran". Yani kelime rüzgârı değil, rüzgârın **yaptığı işi** adlandırıyor. Türkçeye "taş yağmuru" diye çevrildiğinde failin hareketi kayboluyor.
...
**آل — Kök**, dilcilerin çoğunluğuna göre **أ-و-ل**dir (*evl* — dönmek, varmak); bir kısmına göre *ehl* kelimesinden dönüşmüştür. Kesin bir hüküm vermiyorum.
...
**Ve kelimenin i'râbı kayda değer:** *ni'meten* **mansûb**dur ve **mef'ûl-i lieclih**tir (sebep bildiren mansûb). Yani "onları kurtardık — **çünkü/olarak** katımızdan bir nimet."
...
**شُكْر — Kök: ش-ك-ر.** Somut anlamı üzerinde dilcilerin naklettiği izah: *şekera'd-dâbbetü* — hayvan az yemle **semirdi**, besisi göründü. Yani *şükr*, **alınan şeyin görünür hale gelmesi**dir. Aynı kökten *şekûr* (çok şükreden) ve *meşkûr* (karşılığı verilen).

Ve şükrün tam karşıtı **كُفْر**dur: örtmek. **Şükür görünür kılmak, küfür örtmektir.**
...
*Velekad enzerahüm batşetenâ fe-temârav bi'n-nüzür*
"Andolsun ki o, onları yakalayışımıza karşı uyardı; ama onlar uyarıları tartışmaya döktüler."
...
Türevleri:
- **مِرْيَة / مُرْيَة** — şüphe. Kur'an'da: *"Bunda **şüphe** etme"* (Hûd 11/17; Secde 32/23 — *fe-lâ tekü fî **miryetin** minh*).
...
*Velekad râvedûhü an dayfihî fe-tamesnâ a'yünehüm fe-zûkû azâbî ve nüzür*
"Andolsun ki onlar, misafirlerini elde etmek için onu zorladılar. Biz de gözlerini sildik. 'Tadın azabımı ve uyarılarımı!'"
...
Yâsîn'de fiil **لَوْ** (şart) ile geliyor: *"Dileseydik gözlerini silerdik"* — yani olmamış bir imkândan söz ediliyor. Kamer'de fiil **mâzî**dir: *tamesnâ* — olmuş.
...
**ذُوقُوا — Kök: ذ-و-ق.** *Zâka* — tattı. Kelime dilin duyusudur ve **en yakın, en doğrudan temas**ı bildirir.
...
*Velekad sabbahahüm bükraten azâbün müstekırr — fe-zûkû azâbî ve nüzür*
"Andolsun ki sabahleyin erkenden onlara yerleşik bir azap geldi. 'Tadın azabımı ve uyarılarımı!'"
...
Nakaratın **dördüncü ve son** tam geçişi. Arkasında dört kıssa var: Nûh, Âd, Semûd, Lût.

Ve bu, sûrenin son *velekad yessernâ*sıdır. Bundan sonra beşinci kıssa gelecek ama nakaratla kapanmayacak.

---

## V. Âl-i Fir'avn — 54/41-42
...
*Velekad câe âle Fir'avne'n-nüzür — kezzebû bi-âyâtinâ küllihâ fe-ehaznâhüm ahze azîzin muktedir*
"Andolsun ki Fir'avn ailesine de uyarılar geldi. Âyetlerimizin hepsini yalanladılar; biz de onları, mutlak güç sahibi ve her şeye gücü yeten birinin yakalayışıyla yakaladık."
...
Ve sûrenin yaptığı iş zaten anlatmak değil, **listelemek**tir. Yukarıda "Sûrede olmayanlar" başlığında kaydettiğim gibi bu sûre kıssaların içeriğini değil, art arda gelişini kullanıyor. Beşinci kalem, listenin tamamlandığını gösteriyor.
...
## Muhataba dönüş — 54/43-48

## 54/43 — أَكُفَّارُكُمْ خَيْرٌ مِّنْ أُو۟لَٰٓئِكُمْ أَمْ لَكُم بَرَآءَةٌ فِى ٱلزُّبُرِ

*E-küffâruküm hayrun min ülâikum em leküm berâetün fi'z-zübür*
"Sizin kâfirleriniz onlardan daha mı iyi? Yoksa kitaplarda size ait bir beraat mi var?"

### Sûrenin dönüş noktası
...
**Terkip alışılmadıktır ve üzerinde durmaya değer.**

*Küffâr*, *kâfir*in çoğuludur. Ve **-küm** eki ile bir topluluğa nispet ediliyor: "sizin kâfirleriniz."
...
**Tercih dayatmıyorum.** İkisi de aynı sonuca varıyor: karşılaştırma yapılıyor.
...
### أَمْ لَكُم بَرَآءَةٌ — "yoksa bir beraatınız mı var?"
...
**Ve iki ihtimalin ne olduğu önemlidir:**

1. **Fiilî üstünlük** — "daha mı iyisiniz?"
2. **Yazılı bir muafiyet** — "yoksa belgeniz mi var?"
...
- **بَرَأَ** — yaratmak, yoktan çıkarmak. *el-Bâri'* — yaratan. Dilcilerin izahı: yaratmak, bir şeyi yokluktan **ayırmak**tır.

Ayetteki anlam birincisidir: **beraat, muafiyet, ilişik kesme belgesi.**

**Ve kelimenin taşıdığı resim belgeseldir.** Arapçada ve genel olarak eski hukuk dilinde *berâe*, birine verilen **yazılı bir güvence** ya da **ibra belgesi**dir. Türkçede kullandığımız "beraat etmek" aynı kelimeden gelir.

Yani soru şudur: **elinizde yazılı bir muafiyet mi var?**

Ve buradan doğrudan bir sonraki kelimeye geçiliyor.

### ٱلزُّبُر — yazılı olan

**Kök: ز-ب-ر.** Ve bu kök sûrenin son bölümünün anahtar köküdür; elli ikinci ayette geri gelecek.

Somut anlamı: **taşı ya da sert bir yüzeyi oyarak yazmak; sağlam ve kalıcı biçimde kaydetmek.**
...
- **زُبُر** — *zebûr*un ya da *zibr*in çoğulu: **yazılı sahifeler, kitaplar.**
...
Ve bu, ayetin sorusuna doğrudan bağlanıyor: *"kitaplarda size ait bir beraat mi var?"* — sorulan şey, **silinmeyecek bir kayıt**tır.
...
**Kelime sûrede iki kez geçiyor ve iki geçiş birbirinin cevabıdır:**
...
**Soru kırk üçüncü ayette soruluyor, cevap elli ikinci ayette veriliyor. Arada dokuz ayet var.**

Ve cevabın biçimi kayda değer: soru "muafiyet var mı" diye soruyor; cevap "muafiyet yok" demiyor. **"Kayıtlarda ne olduğunu"** söylüyor: yapılan her şey. Yani kayıt vardır — ama içindeki şey beraat değil, **döküm**dür.
...
*Em yekûlûne nahnü cemî'un müntesır — se-yühzemü'l-cem'u ve yüvellûne'd-dübür*
"Yoksa 'biz yenilmez bir topluluğuz' mu diyorlar? O topluluk bozguna uğratılacak ve arkalarını dönüp kaçacaklar."
...
*Beli's-sâatü mev'ıdühüm ve's-sâatü edhâ ve emerr*
"Hayır! Asıl vaat edilen vakit Saat'tir. Ve Saat, çok daha büyük bir belâ ve çok daha acıdır."
...
1. "Biz yenilmez bir topluluğuz" (44)
2. "O topluluk bozguna uğratılacak" (45)
3. **"Hayır — asıl vakit Saat'tir"** (46)
...
*İnne'l-mücrimîne fî dalâlin ve su'ur — yevme yüshabûne fi'n-nâri alâ vücûhihim zûkû messe sekar*
"Suçlular sapkınlık ve alevler içindedir. O gün yüzüstü ateşe sürüklenirler: 'Tadın sekarın dokunuşunu!'"
...
## Ölçü, emir, kayıt — 54/49-53

## 54/49 — إِنَّا كُلَّ شَىْءٍ خَلَقْنَٰهُ بِقَدَرٍ

*İnnâ külle şey'in halaknâhü bi-kader*
...
*Ve mâ emrunâ illâ vâhidetün ke-lemhın bi'l-basar*
"Bizim emrimiz, göz kırpması gibi tek bir iştir."
...
**Tercih dayatmıyorum.** İkisi de kaydedilmiştir ve pratik fark yaratmıyor: emir ya tek bir sözdür ya tek bir keredir; iki takdirde de anlatılan şey **bölünmezlik**tir.
...
> *"Saat'in işi, **göz kırpması gibidir** ya da daha yakındır."* (Nahl 16/77 — *ke-**lemhi'l-basari** ev hüve akreb*)
> *"Bizim emrimiz… **göz kırpması gibi**."* (Kamer 54/50 — *ke-lemhın **bi'l-basari***)
...
İzâfe, bakışı göze **ait** kılar: gözün lemhası. *Bâ* ise göze **alet** işlevi verir: gözle yapılan lemha.
...
| Ayet | Neye bakıyor | Ne söylüyor |
|---|---|---|
| **49** | **Yaratılana** | Her şey **ölçülü**dür |
| **50** | **Yaratana** | Emir **tek** ve **anlık**tır |
...
*Velekad ehleknâ eşyâaküm fehel min müddekir*
"Andolsun ki sizin benzerlerinizi helâk ettik. Öğüt alan var mı?"
...
- *"Daha önce **benzerlerine** yapıldığı gibi…"* (Sebe' 34/54 — *ke-mâ fuıle bi-**eşyâıhim** min kabl*).

**Kelimenin seçimi kayda değer ve iki şey yapıyor.**

**Bir — kavimleri muhataba bağlıyor.** Ayet "onlardan öncekileri helâk ettik" demiyor; **"sizin *eşyâ*ınızı"** diyor. Yani dört kıssanın kahramanları, muhatabın **kendi grubundan** sayılıyor.
...
| Sûre | Biçim | Fâil |
|---|---|---|
| Hâkka 69/5-6 | *ühlikû* — **edilgen** | **Söylenmiyor** |
| **Kamer 54/51** | *ehleknâ* — **etken** | ***Biz*** |
...
*Ve küllü şey'in fe'alûhü fi'z-zübür — ve küllü sağîrin ve kebîrin müstetar*
"Yaptıkları her şey kayıtlardadır. Küçük büyük her şey satır satır yazılmıştır."
...
*İnne'l-müttekîne fî cennâtin ve nehar*
"Muttakîler bahçelerde ve nehir(ler) içindedir."

### Sûrenin tek müjde ayeti
...
**İki nakarat sûresi, malzemesini tam ters uçlara yığmış.**

Ve bu, iki sûrenin nakaratlarının konusuyla uyumludur:
...
Bu kök bu tefsirde birçok yerde işlendi ve tekrarlamıyorum. Buradaki tek nokta şudur:
...
**Kendi okumam olarak kaydediyorum:** *ittikā*, kökü itibariyle **kendini bir şeyden korumak**tır — yani sûrenin baştan beri anlattığı şeyden. Sûre kırk dört ayet boyunca nelerden sakınılması gerektiğini saydı; kapanışta sakınanları anıyor. **Kelime, sûrenin muhtevasının karşılığıdır.**

### جَنَّٰتٍ وَنَهَرٍ — çoğul ve tekil

Ve burada bir dizim tuhaflığı var: **جَنَّات çoğul, نَهَر tekil.**
...
**Bu tuhaflık üzerinde birden fazla izah nakledilir:**
...
| **نُهُر'un hafifletilmişi** | *Nehr*in çoğulu olan *nühür*, hafifletilerek *nehar* okunmuş | Kaynaklarda nakledilir |
...
"Doğruluk makamında, gücü her şeye yeten bir hükümdarın katında."
...
| Kök | Sûredeki geçiş sayısı | Nerede |
|---|---|---|
| **ك-ذ-ب** — yalanlamak | **9** | Baştan sona dağılmış |
| **ص-د-ق** — doğruluk | **1** | **Son ayette** |
...
**Kendi okumam olarak kaydediyorum:** sûre, elli dördüncü ayette bir manzara verdi (*cennâtin ve nehar*); elli beşinci ayette manzarayı bırakıp **ilişkiyi** söylüyor. Ve sûrenin son kelimesi bir mekân adı değil, bir **sıfat**tır.
...
Yani *melîk*, *melik*ten daha ağırdır: **mülkü yerleşik ve tam olan.**
...
1. **Kudret**, cezayı kapatıyor (42).
2. **Ölçü**, yaratmayı tarif ediyor (49).
3. **Kudret**, sûreyi kapatıyor (55).
...
**1.** Bir vakit yaklaştı ve bir işaret gösterildi. (1)

**2.** İşareti gördüler ve reddettiler; reddederken ona bir ad koydular. (2)

**3.** Reddin ardından boşluk kalmadı; yerini hevâ aldı. (3a)

**4.** Ama her iş yerini bulur. (3b — **kural**)

**5.** Onlara caydırıcı haberler geldi; hikmet tamdı ve ulaştı. Fayda vermedi. (4-5)

**6.** Bir gün gelecek; o gün tanınmadık bir şeye çağrılacaklar ve zor bulacaklar. (6-8)

**7.** Ve bu ilk kez olmuyor. **İşte liste:**
...
**10.** "Biz yenilmez bir topluluğuz" mu diyorsunuz? O topluluk dağılacak. (44-45)

**11.** Ve asıl vakit bu bile değil: **Saat.** Daha büyük ve daha acı. (46)

**12.** Suçluların hali, Semûd'un kendi kelimeleriyle tarif ediliyor. (47-48)

**13.** **Çünkü:** her şey bir ölçüyle yaratıldı ve emir tek bir iştir. (49-50 — **kaynak**)

**14.** **Ve:** benzerleriniz helâk edildi; yaptığınız her şey silinmez kayıtlarda, satır satır. (51-53)

**15.** Sakınanlar ise bahçelerde, gerçek bir oturuşta, mülkü tam olanın katında. (54-55)

**Argümanın omurgası dört adımdır ve bunu kendi okumam olarak kaydediyorum:**
...
Ve muhataba dönüş (43-48) ile kapanış (54-55) bu dördünün arasına yerleştirilmiş durumda.

## Sûrede tekrar sayıları
...
**Bir — sûrenin en çok geçen anlamlı kelimesi *nüzür*dür (11).** Kıssaların adları değil, uyarının adı. Sûre kendini bu kelimeyle tanımlıyor.
...
**Bu iki gözlemi kendi okumam olarak kaydediyorum;** sayımlar doğrulanabilir.
...
Sûrenin nakaratı altı kez soruluyor ve bir kez bile cevaplanmıyor: *"Öğüt alan var mı?"*
...
**İki — bilmek ile ders çıkarmak aynı şey değil.**

Nakaratın kelimesi *âlim* değil, *müddekir*dir — ve yukarıda gösterdiğim gibi kelime VIII. bâbdadır: **öğüdü alıp kendine mal eden.**
...
**Üç — "sizin benzerleriniz."**

Elli birinci ayet, dört kavmi muhatabın kendi grubuna bağlıyor: *eşyâaküm.* Ve kelimenin kurduğu bağ soy bağı değil, **davranış bağı**dır.
...
**Dört — sıranın kaldırılması.**

Yirmi sekizinci ayetin altında kaydettiğim gözlem, sûrenin bugüne en somut bakan yeridir.
...
**Altı — kaydın büyüklüğe göre yapılmaması.**

Elli üçüncü ayet, kaydın *"küçük ve büyük"* ayrımı yapmadığını söylüyor.
...
**Yedi — "ben yenildim" diyebilmek.**

Onuncu ayetteki Nûh'un duası üç kelimedir ve içinde tek bir suçlama yoktur: *innî mağlûbun fe'ntasır.*

Ve kırk dördüncü ayette bunun tam tersi bir cümle var: *nahnü cemî'un müntesır.*
...
Rahmân'ın nakaratının tam karşıtı budur ve iki sûre bu noktada birbirine bakıyor.
...
- **نَهَر'in ne demek olduğu** (cins ismi / *nühür*ün hafifletilmişi / genişlik / aydınlık) ihtilaflıdır; dört izah verildi, birincinin fasıla verisiyle desteklendiği belirtildi ve **tercih dayatılmadı.**
