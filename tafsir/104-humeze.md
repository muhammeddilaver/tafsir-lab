...
Dokuz ayet, sayım yöntemine göre otuz üç kelime. Adını ilk ayetteki **همزة** kelimesinden alıyor.
...
Bu birleştirme sûrenin asıl fikridir ve metnin bütününü açıklar. Ona ayrı bir bölümde döneceğim.

Sûrenin iskeleti şöyledir:

1. **Hüküm** (1): bir vasıf tarif ediliyor ve o vasıf hakkında bir söz söyleniyor — *veyl*.
2. **Tarif** (2): o kişi ne yapıyor — topluyor ve sayıyor.
3. **Teşhis** (3): niçin yapıyor — malının kendisini ölümsüzleştirdiğini sanıyor.
4. **Ret ve akıbet** (4): *kellâ* — hayır; ve atılacak.
5. **Duraklama** (5): "sen ne bilirsin hutame nedir?"
6. **Tasvir** (6-9): ateşin ne olduğu, nereye ulaştığı, nasıl kapandığı.
...
"Veyl olsun arkadan çekiştirip yüze karşı ayıplayan her kişiye."
...
**Bir. Kelime bir cümle kurmuyor, bir hüküm ilan ediyor.** *Veylün* mübtedadır ve haberi *li-külli hümezeh*tir. Türkçede "…olsun" diye çevrilmesi bir dua kalıbı gibi durur; Arapçadaki kullanım ise daha çok bir **tespit** gibidir: bu vasfın karşılığı budur.
...
Ayetteki kelimeler fâil kalıbındadır. Yani tarif edilen kişi, alay edilen değil **alay eden**dir; ve arızî olarak değil, **süreklilik ve yoğunlukla.**
...
**Bu üçüncüsü, sûrenin mantığını anlamak için anahtardır.** İtiraz teolojik değil, **konumsal**dır: mesajın doğruluğu tartışılmıyor; mesajı taşıyan kişinin rütbesi tartışılıyor. Bir sözün doğru olması için söyleyenin zengin ve büyük olması gerektiği varsayılıyor.
...
### ٱلَّذِى — belirsiz bırakılmış bir belirlilik
...
### جَمَعَ مَالًا — mal topladı

**جمع** — bir araya getirmek, toplamak, birikim yapmak.
...
Bu, sûreyi bir gelir eleştirisinden ayıran ilk noktadır.

### وَعَدَّدَهُ — "onu sayıp durdu"

Sûrenin en yoğun kelimesi.

**Kalıp: تفعيل (tef'îl) babı.** Bu babın işlevlerinden biri **teksîr**dir: fiilin çokluğunu, tekrarını, yoğunluğunu bildirir. *Kesera* (kırdı) → *kessera* (paramparça etti); *kattale* (çokça öldürdü) gibi.

Yani *addede*, "saydı" değil **"sayıp durdu"**dur. Bir defalık bir işlem değil, tekrarlanan bir işlem.

**Kelimenin anlamında ihtilaf var** ve iki ana okuyuş kaynaklarda birlikte yer alır:
...
### İki fiilin sırası: topladı, sonra saydı

Cümlenin yapısı basit görünür ama tam bir teşhis içeriyor.
...
### Saymanın psikolojisi

Neden bir insan sahip olduğunu tekrar tekrar sayar?
...
Ayetin *tef'îl* kalıbını seçmesi tam bu noktaya oturuyor. Tekrar, fiilin doğasında değil, **fiilin işe yaramamasında**dır. Bir işlem sonucu veriyorsa tekrarlanmasına gerek kalmaz.
...
Aynı davranış Kur'an'da başka yerlerde de tarif edilir ve neredeyse hep aynı iki fiille:
...
Oradaki fiil **أخلد إلى الأرض**tir: "yere doğru kalıcılaştı" — yani yere çakıldı, yerden ayrılamaz hale geldi. Aynı kök, burada yükselememeyi anlatıyor. Kalıcılık arayışının kişiyi yere sabitlemesi, iki ayet arasında kurulan sessiz bir bağdır.
...
Aynı çizginin başka biçimleri: anıt yaptırmak, isim verilen bina bırakmak, soy adını sürdürmek, vakıf kurmak. Hepsinin ortak yapısı, **kendinden sonra kalacak bir nesneye kendini bağlamak**tır.
...
*Kellâ le-yünbezenne fi'l-hutame*
"Hayır! Andolsun ki mutlaka Hutame'ye atılacaktır."
...
1. Söylenmemiş bir yemin
2. *Lâmü'l-kasem* — yeminin lâmı
3. *Nûn-ı te'kîd-i sakîle* — ağır pekiştirme nûnu
...
*Elletî tettali'u ale'l-ef'ide*
"O ateş ki kalplerin üzerine çıkar / kalplere işler."
...
*İnnehâ aleyhim mü'sade*
"O, üzerlerine kapatılmıştır."
...
Dizim şöyledir: *innehâ* — *aleyhim* — *mü'sade*.
...
Sûrenin son ayeti, ve anlamı üzerinde en çok ihtilaf edilen ayeti.

### Kıraat farkı: عَمَد / عُمُد

Kelime iki şekilde okunmuştur ve her iki okuyuş da kıraat imamları arasında naklediliyor:

- **عَمَدٍ** (*amed*) — fetha-fetha
- **عُمُدٍ** (*umud*) — damme-damme
...
Ayetin ne anlattığı konusunda müfessirler ayrılır. Başlıca görüşler:
...
Sûre **"uzatılmış"** kelimesiyle kapanıyor. Ve bu, sûrenin en sıkı bağını kuruyor.

Adamın istediği şeyin adı **خلود** idi — kalıcılık, sürekliliği. Üçüncü ayette *ahledeh*: "onu ebedîleştirdi" sanıyordu.

Sûrenin son kelimesi **ممددة**: uzatılmış.
...
### Sûrenin asıl fikri: alay ile biriktirmenin aynı kişide birleşmesi

Sûrenin başında not ettiğim soruya dönüyoruz: **neden bu iki huy aynı portrede?**
...
**Birinci adım: üstünlük duygusu ilişkiseldir.**
...
**İkinci adım: aradaki mesafeyi büyütmenin iki yolu vardır.**

Kendinizi yukarı çekmek, ya da karşınızdakini aşağı itmek. Sonuç aynıdır: mesafe büyür.
...
**Üçüncü adım: iki hamle birbirine muhtaçtır.**
...
**Dördüncü adım: ikisinin de ortak kaynağı üçüncü ayettedir.**
...
Sûre bu yüzden ikisini ayırmıyor. **Aynı iştahın iki yüzü olduğu için tek portrede birleştiriyor.**

Ve buradan sûrenin cezayla kurduğu simetri de anlaşılıyor:
...
Üçlü içinde Hümeze'nin ayırt edici yeri şudur:
...
**Birincisi: sûre bir gelir grubunu değil bir ilişkiyi tarif ediyor.**

Bunu en başta belirtmek gerekiyor, çünkü sûrenin en kolay suistimal edilen tarafı burasıdır.
...
**Beşincisi: sûreyi kimin üzerine okumak.**

Sûrenin en ciddi tuzağı budur ve açıkça söylenmesi gerekir.

Hümeze, küçümseyen kişiyi tarif ediyor. Bu metni eline alıp başkalarını — zenginleri, tanıdıkları, kamuya mal olmuş kişileri — bu tarife yerleştirmek ve onlar hakkında hüküm vermek, **sûrenin tarif ettiği fiilin kendisini işlemektir.** Bir metni birilerini aşağı yerleştirmek için kullanmak, tam olarak *lemz*dir.

Sûrenin ilk kelimesi *veyl*dir ve o kelime bir hüküm bildirir. Hüküm verme yetkisi metnin sahibindedir, metni okuyanın değil. Okuyana düşen şey, tarifi kendi üzerinde denemektir: **topladığım şeyi sayıyor muyum, ondan ne bekliyorum, ve başkalarına bakışım o beklentiyle şekilleniyor mu?**

Metin bir tanı aracıdır; ve tanı önce kendine konulur.
